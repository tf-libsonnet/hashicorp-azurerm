...
`azurerm.vmware_private_cloud.withInternetConnectionEnabled` constructs a mixin object that can be merged into the `vmware_private_cloud`
...
`azurerm.vmware_private_cloud.withLocation` constructs a mixin object that can be merged into the `vmware_private_cloud`
...
`azurerm.vmware_private_cloud.withManagementCluster` constructs a mixin object that can be merged into the `vmware_private_cloud`
...
`azurerm.vmware_private_cloud.withManagementClusterMixin` constructs a mixin object that can be merged into the `vmware_private_cloud`
Terraform resource block to set or update the management_cluster field.
...
`azurerm.vmware_private_cloud.withNetworkSubnetCidr` constructs a mixin object that can be merged into the `vmware_private_cloud`
...
`azurerm.vmware_private_cloud.withNsxtPassword` constructs a mixin object that can be merged into the `vmware_private_cloud`
...
`azurerm.vmware_private_cloud.withSkuName` constructs a mixin object that can be merged into the `vmware_private_cloud`
...
`azurerm.vmware_private_cloud.withTags` constructs a mixin object that can be merged into the `vmware_private_cloud`
...
`azurerm.vmware_private_cloud.withVcenterPassword` constructs a mixin object that can be merged into the `vmware_private_cloud`
