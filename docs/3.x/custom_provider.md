...
**Args**:
  ...
  - `action` (`list[obj]`):  When `null`, the `action` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.custom_provider.action.new](#fn-custom_provideractionnew) constructor.
  - `resource_type` (`list[obj]`):  When `null`, the `resource_type` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.custom_provider.resource_type.new](#fn-custom_providerresource_typenew) constructor.
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.custom_provider.timeouts.new](#fn-custom_providertimeoutsnew) constructor.
  - `validation` (`list[obj]`):  When `null`, the `validation` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.custom_provider.validation.new](#fn-custom_providervalidationnew) constructor.
...
Unlike [azurerm.custom_provider.new](#fn-custom_providernew), this function will not inject the `resource`
