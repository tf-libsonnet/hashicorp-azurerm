...
`azurerm.synapse_sql_pool_extended_auditing_policy.withStorageAccountAccessKey` constructs a mixin object that can be merged into the `synapse_sql_pool_extended_auditing_policy`
