...
`azurerm.nginx_deployment.withDiagnoseSupportEnabled` constructs a mixin object that can be merged into the `nginx_deployment`
...
`azurerm.nginx_deployment.withFrontendPrivate` constructs a mixin object that can be merged into the `nginx_deployment`
...
`azurerm.nginx_deployment.withFrontendPrivateMixin` constructs a mixin object that can be merged into the `nginx_deployment`
Terraform resource block to set or update the frontend_private field.
...
`azurerm.nginx_deployment.withFrontendPublic` constructs a mixin object that can be merged into the `nginx_deployment`
...
`azurerm.nginx_deployment.withFrontendPublicMixin` constructs a mixin object that can be merged into the `nginx_deployment`
Terraform resource block to set or update the frontend_public field.
...
`azurerm.nginx_deployment.withIdentity` constructs a mixin object that can be merged into the `nginx_deployment`
...
`azurerm.nginx_deployment.withIdentityMixin` constructs a mixin object that can be merged into the `nginx_deployment`
Terraform resource block to set or update the identity field.
...
`azurerm.nginx_deployment.withLocation` constructs a mixin object that can be merged into the `nginx_deployment`
...
`azurerm.nginx_deployment.withLoggingStorageAccount` constructs a mixin object that can be merged into the `nginx_deployment`
...
`azurerm.nginx_deployment.withLoggingStorageAccountMixin` constructs a mixin object that can be merged into the `nginx_deployment`
Terraform resource block to set or update the logging_storage_account field.
...
`azurerm.nginx_deployment.withManagedResourceGroup` constructs a mixin object that can be merged into the `nginx_deployment`
...
`azurerm.nginx_deployment.withName` constructs a mixin object that can be merged into the `nginx_deployment`
...
`azurerm.nginx_deployment.withNetworkInterface` constructs a mixin object that can be merged into the `nginx_deployment`
...
`azurerm.nginx_deployment.withNetworkInterfaceMixin` constructs a mixin object that can be merged into the `nginx_deployment`
Terraform resource block to set or update the network_interface field.
...
`azurerm.nginx_deployment.withResourceGroupName` constructs a mixin object that can be merged into the `nginx_deployment`
...
`azurerm.nginx_deployment.withSku` constructs a mixin object that can be merged into the `nginx_deployment`
...
`azurerm.nginx_deployment.withTags` constructs a mixin object that can be merged into the `nginx_deployment`
...
`azurerm.nginx_deployment.withTimeouts` constructs a mixin object that can be merged into the `nginx_deployment`
...
`azurerm.nginx_deployment.withTimeoutsMixin` constructs a mixin object that can be merged into the `nginx_deployment`
Terraform resource block to set or update the timeouts field.
