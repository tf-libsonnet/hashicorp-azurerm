...
`azurerm.storage_account.withAccessTier` constructs a mixin object that can be merged into the `storage_account`
...
`azurerm.storage_account.withAccountKind` constructs a mixin object that can be merged into the `storage_account`
...
**Args**:
  - `resourceLabel` (`string`): The name label of the block to update.
  - `value` (`TODO`): The value to set for the `account_kind` field.
...
`azurerm.storage_account.withAccountReplicationType` constructs a mixin object that can be merged into the `storage_account`
...
**Args**:
  - `resourceLabel` (`string`): The name label of the block to update.
  - `value` (`TODO`): The value to set for the `account_replication_type` field.
...
`azurerm.storage_account.withAccountTier` constructs a mixin object that can be merged into the `storage_account`
...
**Args**:
  - `resourceLabel` (`string`): The name label of the block to update.
  - `value` (`TODO`): The value to set for the `account_tier` field.
...
`azurerm.storage_account.withAllowNestedItemsToBePublic` constructs a mixin object that can be merged into the `storage_account`
...
**Args**:
  - `resourceLabel` (`string`): The name label of the block to update.
  - `value` (`TODO`): The value to set for the `allow_nested_items_to_be_public` field.
...
`azurerm.storage_account.withAzureFilesAuthentication` constructs a mixin object that can be merged into the `storage_account`
...
**Args**:
  - `resourceLabel` (`string`): The name label of the block to update.
  - `value` (`TODO`): The value to set for the `azure_files_authentication` field.
...
`azurerm.storage_account.withAzureFilesAuthenticationMixin` constructs a mixin object that can be merged into the `storage_account`
Terraform resource block to set or update the azure_files_authentication field.

This function will append the passed in array or object to the existing array. If you wish
to instead replace the array with the passed in `value`, use the [azurerm.storage_account.withAzureFilesAuthentication](TODO)
function.
...
`azurerm.storage_account.withBlobProperties` constructs a mixin object that can be merged into the `storage_account`
...
**Args**:
  - `resourceLabel` (`string`): The name label of the block to update.
  - `value` (`TODO`): The value to set for the `blob_properties` field.
...
`azurerm.storage_account.withBlobPropertiesMixin` constructs a mixin object that can be merged into the `storage_account`
Terraform resource block to set or update the blob_properties field.

This function will append the passed in array or object to the existing array. If you wish
to instead replace the array with the passed in `value`, use the [azurerm.storage_account.withBlobProperties](TODO)
function.
...
`azurerm.storage_account.withCrossTenantReplicationEnabled` constructs a mixin object that can be merged into the `storage_account`
...
**Args**:
  - `resourceLabel` (`string`): The name label of the block to update.
  - `value` (`TODO`): The value to set for the `cross_tenant_replication_enabled` field.
...
`azurerm.storage_account.withCustomDomain` constructs a mixin object that can be merged into the `storage_account`
...
**Args**:
  - `resourceLabel` (`string`): The name label of the block to update.
  - `value` (`TODO`): The value to set for the `custom_domain` field.
...
`azurerm.storage_account.withCustomDomainMixin` constructs a mixin object that can be merged into the `storage_account`
Terraform resource block to set or update the custom_domain field.

This function will append the passed in array or object to the existing array. If you wish
to instead replace the array with the passed in `value`, use the [azurerm.storage_account.withCustomDomain](TODO)
function.
...
`azurerm.storage_account.withCustomerManagedKey` constructs a mixin object that can be merged into the `storage_account`
...
`azurerm.storage_account.withCustomerManagedKeyMixin` constructs a mixin object that can be merged into the `storage_account`
Terraform resource block to set or update the customer_managed_key field.

This function will append the passed in array or object to the existing array. If you wish
to instead replace the array with the passed in `value`, use the [azurerm.storage_account.withCustomerManagedKey](TODO)
function.
...
`azurerm.storage_account.withDefaultToOauthAuthentication` constructs a mixin object that can be merged into the `storage_account`
...
**Args**:
  - `resourceLabel` (`string`): The name label of the block to update.
  - `value` (`TODO`): The value to set for the `default_to_oauth_authentication` field.
...
`azurerm.storage_account.withEdgeZone` constructs a mixin object that can be merged into the `storage_account`
...
`azurerm.storage_account.withEnableHttpsTrafficOnly` constructs a mixin object that can be merged into the `storage_account`
...
**Args**:
  - `resourceLabel` (`string`): The name label of the block to update.
  - `value` (`TODO`): The value to set for the `enable_https_traffic_only` field.
...
`azurerm.storage_account.withIdentity` constructs a mixin object that can be merged into the `storage_account`
...
`azurerm.storage_account.withIdentityMixin` constructs a mixin object that can be merged into the `storage_account`
Terraform resource block to set or update the identity field.

This function will append the passed in array or object to the existing array. If you wish
to instead replace the array with the passed in `value`, use the [azurerm.storage_account.withIdentity](TODO)
function.
...
`azurerm.storage_account.withImmutabilityPolicy` constructs a mixin object that can be merged into the `storage_account`
...
**Args**:
  - `resourceLabel` (`string`): The name label of the block to update.
  - `value` (`TODO`): The value to set for the `immutability_policy` field.
...
`azurerm.storage_account.withImmutabilityPolicyMixin` constructs a mixin object that can be merged into the `storage_account`
Terraform resource block to set or update the immutability_policy field.

This function will append the passed in array or object to the existing array. If you wish
to instead replace the array with the passed in `value`, use the [azurerm.storage_account.withImmutabilityPolicy](TODO)
function.
...
`azurerm.storage_account.withInfrastructureEncryptionEnabled` constructs a mixin object that can be merged into the `storage_account`
...
`azurerm.storage_account.withIsHnsEnabled` constructs a mixin object that can be merged into the `storage_account`
...
**Args**:
  - `resourceLabel` (`string`): The name label of the block to update.
  - `value` (`TODO`): The value to set for the `is_hns_enabled` field.
...
`azurerm.storage_account.withLargeFileShareEnabled` constructs a mixin object that can be merged into the `storage_account`
...
**Args**:
  - `resourceLabel` (`string`): The name label of the block to update.
  - `value` (`TODO`): The value to set for the `large_file_share_enabled` field.
...
`azurerm.storage_account.withLocation` constructs a mixin object that can be merged into the `storage_account`
...
`azurerm.storage_account.withNetworkRules` constructs a mixin object that can be merged into the `storage_account`
...
`azurerm.storage_account.withNetworkRulesMixin` constructs a mixin object that can be merged into the `storage_account`
Terraform resource block to set or update the network_rules field.

This function will append the passed in array or object to the existing array. If you wish
to instead replace the array with the passed in `value`, use the [azurerm.storage_account.withNetworkRules](TODO)
function.
...
`azurerm.storage_account.withNfsv3Enabled` constructs a mixin object that can be merged into the `storage_account`
...
**Args**:
  - `resourceLabel` (`string`): The name label of the block to update.
  - `value` (`TODO`): The value to set for the `nfsv3_enabled` field.
...
`azurerm.storage_account.withPublicNetworkAccessEnabled` constructs a mixin object that can be merged into the `storage_account`
...
`azurerm.storage_account.withQueueEncryptionKeyType` constructs a mixin object that can be merged into the `storage_account`
...
**Args**:
  - `resourceLabel` (`string`): The name label of the block to update.
  - `value` (`TODO`): The value to set for the `queue_encryption_key_type` field.
...
`azurerm.storage_account.withQueueProperties` constructs a mixin object that can be merged into the `storage_account`
...
**Args**:
  - `resourceLabel` (`string`): The name label of the block to update.
  - `value` (`TODO`): The value to set for the `queue_properties` field.
...
`azurerm.storage_account.withQueuePropertiesMixin` constructs a mixin object that can be merged into the `storage_account`
Terraform resource block to set or update the queue_properties field.

This function will append the passed in array or object to the existing array. If you wish
to instead replace the array with the passed in `value`, use the [azurerm.storage_account.withQueueProperties](TODO)
function.
...
`azurerm.storage_account.withRouting` constructs a mixin object that can be merged into the `storage_account`
...
`azurerm.storage_account.withRoutingMixin` constructs a mixin object that can be merged into the `storage_account`
Terraform resource block to set or update the routing field.

This function will append the passed in array or object to the existing array. If you wish
to instead replace the array with the passed in `value`, use the [azurerm.storage_account.withRouting](TODO)
function.
...
`azurerm.storage_account.withSasPolicy` constructs a mixin object that can be merged into the `storage_account`
...
**Args**:
  - `resourceLabel` (`string`): The name label of the block to update.
  - `value` (`TODO`): The value to set for the `sas_policy` field.
...
`azurerm.storage_account.withSasPolicyMixin` constructs a mixin object that can be merged into the `storage_account`
Terraform resource block to set or update the sas_policy field.

This function will append the passed in array or object to the existing array. If you wish
to instead replace the array with the passed in `value`, use the [azurerm.storage_account.withSasPolicy](TODO)
function.
...
`azurerm.storage_account.withSftpEnabled` constructs a mixin object that can be merged into the `storage_account`
...
**Args**:
  - `resourceLabel` (`string`): The name label of the block to update.
  - `value` (`TODO`): The value to set for the `sftp_enabled` field.
...
`azurerm.storage_account.withShareProperties` constructs a mixin object that can be merged into the `storage_account`
...
**Args**:
  - `resourceLabel` (`string`): The name label of the block to update.
  - `value` (`TODO`): The value to set for the `share_properties` field.
...
`azurerm.storage_account.withSharePropertiesMixin` constructs a mixin object that can be merged into the `storage_account`
Terraform resource block to set or update the share_properties field.

This function will append the passed in array or object to the existing array. If you wish
to instead replace the array with the passed in `value`, use the [azurerm.storage_account.withShareProperties](TODO)
function.
...
`azurerm.storage_account.withSharedAccessKeyEnabled` constructs a mixin object that can be merged into the `storage_account`
...
**Args**:
  - `resourceLabel` (`string`): The name label of the block to update.
  - `value` (`TODO`): The value to set for the `shared_access_key_enabled` field.
...
`azurerm.storage_account.withStaticWebsite` constructs a mixin object that can be merged into the `storage_account`
...
**Args**:
  - `resourceLabel` (`string`): The name label of the block to update.
  - `value` (`TODO`): The value to set for the `static_website` field.
...
`azurerm.storage_account.withStaticWebsiteMixin` constructs a mixin object that can be merged into the `storage_account`
Terraform resource block to set or update the static_website field.

This function will append the passed in array or object to the existing array. If you wish
to instead replace the array with the passed in `value`, use the [azurerm.storage_account.withStaticWebsite](TODO)
function.
...
`azurerm.storage_account.withTableEncryptionKeyType` constructs a mixin object that can be merged into the `storage_account`
...
**Args**:
  - `resourceLabel` (`string`): The name label of the block to update.
  - `value` (`TODO`): The value to set for the `table_encryption_key_type` field.
...
`azurerm.storage_account.withTags` constructs a mixin object that can be merged into the `storage_account`
