...
`azurerm.dev_test_windows_virtual_machine.withAllowClaim` constructs a mixin object that can be merged into the `dev_test_windows_virtual_machine`
...
`azurerm.dev_test_windows_virtual_machine.withDisallowPublicIpAddress` constructs a mixin object that can be merged into the `dev_test_windows_virtual_machine`
...
`azurerm.dev_test_windows_virtual_machine.withGalleryImageReference` constructs a mixin object that can be merged into the `dev_test_windows_virtual_machine`
...
`azurerm.dev_test_windows_virtual_machine.withGalleryImageReferenceMixin` constructs a mixin object that can be merged into the `dev_test_windows_virtual_machine`
Terraform resource block to set or update the gallery_image_reference field.
...
`azurerm.dev_test_windows_virtual_machine.withInboundNatRule` constructs a mixin object that can be merged into the `dev_test_windows_virtual_machine`
...
`azurerm.dev_test_windows_virtual_machine.withInboundNatRuleMixin` constructs a mixin object that can be merged into the `dev_test_windows_virtual_machine`
Terraform resource block to set or update the inbound_nat_rule field.
...
`azurerm.dev_test_windows_virtual_machine.withLabName` constructs a mixin object that can be merged into the `dev_test_windows_virtual_machine`
...
`azurerm.dev_test_windows_virtual_machine.withLabSubnetName` constructs a mixin object that can be merged into the `dev_test_windows_virtual_machine`
...
`azurerm.dev_test_windows_virtual_machine.withLabVirtualNetworkId` constructs a mixin object that can be merged into the `dev_test_windows_virtual_machine`
...
`azurerm.dev_test_windows_virtual_machine.withLocation` constructs a mixin object that can be merged into the `dev_test_windows_virtual_machine`
...
`azurerm.dev_test_windows_virtual_machine.withName` constructs a mixin object that can be merged into the `dev_test_windows_virtual_machine`
...
`azurerm.dev_test_windows_virtual_machine.withNotes` constructs a mixin object that can be merged into the `dev_test_windows_virtual_machine`
...
`azurerm.dev_test_windows_virtual_machine.withPassword` constructs a mixin object that can be merged into the `dev_test_windows_virtual_machine`
...
`azurerm.dev_test_windows_virtual_machine.withResourceGroupName` constructs a mixin object that can be merged into the `dev_test_windows_virtual_machine`
...
`azurerm.dev_test_windows_virtual_machine.withSize` constructs a mixin object that can be merged into the `dev_test_windows_virtual_machine`
...
`azurerm.dev_test_windows_virtual_machine.withStorageType` constructs a mixin object that can be merged into the `dev_test_windows_virtual_machine`
...
`azurerm.dev_test_windows_virtual_machine.withTags` constructs a mixin object that can be merged into the `dev_test_windows_virtual_machine`
...
`azurerm.dev_test_windows_virtual_machine.withTimeouts` constructs a mixin object that can be merged into the `dev_test_windows_virtual_machine`
...
`azurerm.dev_test_windows_virtual_machine.withTimeoutsMixin` constructs a mixin object that can be merged into the `dev_test_windows_virtual_machine`
Terraform resource block to set or update the timeouts field.
...
`azurerm.dev_test_windows_virtual_machine.withUsername` constructs a mixin object that can be merged into the `dev_test_windows_virtual_machine`
