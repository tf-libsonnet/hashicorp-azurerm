...
`azurerm.virtual_hub_connection.withInternetSecurityEnabled` constructs a mixin object that can be merged into the `virtual_hub_connection`
...
`azurerm.virtual_hub_connection.withName` constructs a mixin object that can be merged into the `virtual_hub_connection`
...
`azurerm.virtual_hub_connection.withRemoteVirtualNetworkId` constructs a mixin object that can be merged into the `virtual_hub_connection`
...
`azurerm.virtual_hub_connection.withRouting` constructs a mixin object that can be merged into the `virtual_hub_connection`
...
`azurerm.virtual_hub_connection.withRoutingMixin` constructs a mixin object that can be merged into the `virtual_hub_connection`
Terraform resource block to set or update the routing field.
...
`azurerm.virtual_hub_connection.withTimeouts` constructs a mixin object that can be merged into the `virtual_hub_connection`
...
`azurerm.virtual_hub_connection.withTimeoutsMixin` constructs a mixin object that can be merged into the `virtual_hub_connection`
Terraform resource block to set or update the timeouts field.
...
`azurerm.virtual_hub_connection.withVirtualHubId` constructs a mixin object that can be merged into the `virtual_hub_connection`
