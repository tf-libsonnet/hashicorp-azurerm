...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.storage_sync_group.timeouts.new](#fn-storage_sync_grouptimeoutsnew) constructor.
...
Unlike [azurerm.storage_sync_group.new](#fn-storage_sync_groupnew), this function will not inject the `resource`
