...
`azurerm.data_factory_integration_runtime_managed.withCatalogInfo` constructs a mixin object that can be merged into the `data_factory_integration_runtime_managed`
...
`azurerm.data_factory_integration_runtime_managed.withCatalogInfoMixin` constructs a mixin object that can be merged into the `data_factory_integration_runtime_managed`
Terraform resource block to set or update the catalog_info field.
...
`azurerm.data_factory_integration_runtime_managed.withCustomSetupScript` constructs a mixin object that can be merged into the `data_factory_integration_runtime_managed`
...
`azurerm.data_factory_integration_runtime_managed.withCustomSetupScriptMixin` constructs a mixin object that can be merged into the `data_factory_integration_runtime_managed`
Terraform resource block to set or update the custom_setup_script field.
...
`azurerm.data_factory_integration_runtime_managed.withDataFactoryId` constructs a mixin object that can be merged into the `data_factory_integration_runtime_managed`
...
`azurerm.data_factory_integration_runtime_managed.withDescription` constructs a mixin object that can be merged into the `data_factory_integration_runtime_managed`
...
`azurerm.data_factory_integration_runtime_managed.withEdition` constructs a mixin object that can be merged into the `data_factory_integration_runtime_managed`
...
`azurerm.data_factory_integration_runtime_managed.withLicenseType` constructs a mixin object that can be merged into the `data_factory_integration_runtime_managed`
...
`azurerm.data_factory_integration_runtime_managed.withLocation` constructs a mixin object that can be merged into the `data_factory_integration_runtime_managed`
...
`azurerm.data_factory_integration_runtime_managed.withMaxParallelExecutionsPerNode` constructs a mixin object that can be merged into the `data_factory_integration_runtime_managed`
...
`azurerm.data_factory_integration_runtime_managed.withName` constructs a mixin object that can be merged into the `data_factory_integration_runtime_managed`
...
`azurerm.data_factory_integration_runtime_managed.withNodeSize` constructs a mixin object that can be merged into the `data_factory_integration_runtime_managed`
...
`azurerm.data_factory_integration_runtime_managed.withNumberOfNodes` constructs a mixin object that can be merged into the `data_factory_integration_runtime_managed`
...
`azurerm.data_factory_integration_runtime_managed.withTimeouts` constructs a mixin object that can be merged into the `data_factory_integration_runtime_managed`
...
`azurerm.data_factory_integration_runtime_managed.withTimeoutsMixin` constructs a mixin object that can be merged into the `data_factory_integration_runtime_managed`
Terraform resource block to set or update the timeouts field.
...
`azurerm.data_factory_integration_runtime_managed.withVnetIntegration` constructs a mixin object that can be merged into the `data_factory_integration_runtime_managed`
...
`azurerm.data_factory_integration_runtime_managed.withVnetIntegrationMixin` constructs a mixin object that can be merged into the `data_factory_integration_runtime_managed`
Terraform resource block to set or update the vnet_integration field.
