...
`azurerm.web_pubsub_network_acl.withDefaultAction` constructs a mixin object that can be merged into the `web_pubsub_network_acl`
...
`azurerm.web_pubsub_network_acl.withPrivateEndpoint` constructs a mixin object that can be merged into the `web_pubsub_network_acl`
...
`azurerm.web_pubsub_network_acl.withPrivateEndpointMixin` constructs a mixin object that can be merged into the `web_pubsub_network_acl`
Terraform resource block to set or update the private_endpoint field.
...
`azurerm.web_pubsub_network_acl.withPublicNetwork` constructs a mixin object that can be merged into the `web_pubsub_network_acl`
...
`azurerm.web_pubsub_network_acl.withPublicNetworkMixin` constructs a mixin object that can be merged into the `web_pubsub_network_acl`
Terraform resource block to set or update the public_network field.
...
`azurerm.web_pubsub_network_acl.withTimeouts` constructs a mixin object that can be merged into the `web_pubsub_network_acl`
...
`azurerm.web_pubsub_network_acl.withTimeoutsMixin` constructs a mixin object that can be merged into the `web_pubsub_network_acl`
Terraform resource block to set or update the timeouts field.
...
`azurerm.web_pubsub_network_acl.withWebPubsubId` constructs a mixin object that can be merged into the `web_pubsub_network_acl`
