...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.spring_cloud_app_cosmosdb_association.timeouts.new](#fn-spring_cloud_app_cosmosdb_associationtimeoutsnew) constructor.
...
Unlike [azurerm.spring_cloud_app_cosmosdb_association.new](#fn-spring_cloud_app_cosmosdb_associationnew), this function will not inject the `resource`
