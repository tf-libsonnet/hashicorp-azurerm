...
`azurerm.spring_cloud_app_cosmosdb_association.withApiType` constructs a mixin object that can be merged into the `spring_cloud_app_cosmosdb_association`
...
`azurerm.spring_cloud_app_cosmosdb_association.withCosmosdbAccessKey` constructs a mixin object that can be merged into the `spring_cloud_app_cosmosdb_association`
...
`azurerm.spring_cloud_app_cosmosdb_association.withCosmosdbAccountId` constructs a mixin object that can be merged into the `spring_cloud_app_cosmosdb_association`
...
`azurerm.spring_cloud_app_cosmosdb_association.withCosmosdbCassandraKeyspaceName` constructs a mixin object that can be merged into the `spring_cloud_app_cosmosdb_association`
...
`azurerm.spring_cloud_app_cosmosdb_association.withCosmosdbGremlinDatabaseName` constructs a mixin object that can be merged into the `spring_cloud_app_cosmosdb_association`
...
`azurerm.spring_cloud_app_cosmosdb_association.withCosmosdbGremlinGraphName` constructs a mixin object that can be merged into the `spring_cloud_app_cosmosdb_association`
...
`azurerm.spring_cloud_app_cosmosdb_association.withCosmosdbMongoDatabaseName` constructs a mixin object that can be merged into the `spring_cloud_app_cosmosdb_association`
...
`azurerm.spring_cloud_app_cosmosdb_association.withCosmosdbSqlDatabaseName` constructs a mixin object that can be merged into the `spring_cloud_app_cosmosdb_association`
...
`azurerm.spring_cloud_app_cosmosdb_association.withName` constructs a mixin object that can be merged into the `spring_cloud_app_cosmosdb_association`
...
`azurerm.spring_cloud_app_cosmosdb_association.withSpringCloudAppId` constructs a mixin object that can be merged into the `spring_cloud_app_cosmosdb_association`
...
`azurerm.spring_cloud_app_cosmosdb_association.withTimeouts` constructs a mixin object that can be merged into the `spring_cloud_app_cosmosdb_association`
...
`azurerm.spring_cloud_app_cosmosdb_association.withTimeoutsMixin` constructs a mixin object that can be merged into the `spring_cloud_app_cosmosdb_association`
Terraform resource block to set or update the timeouts field.
