...
`azurerm.sql_server.withAdministratorLogin` constructs a mixin object that can be merged into the `sql_server`
...
`azurerm.sql_server.withAdministratorLoginPassword` constructs a mixin object that can be merged into the `sql_server`
...
`azurerm.sql_server.withConnectionPolicy` constructs a mixin object that can be merged into the `sql_server`
...
`azurerm.sql_server.withIdentity` constructs a mixin object that can be merged into the `sql_server`
...
`azurerm.sql_server.withIdentityMixin` constructs a mixin object that can be merged into the `sql_server`
Terraform resource block to set or update the identity field.
...
`azurerm.sql_server.withLocation` constructs a mixin object that can be merged into the `sql_server`
...
`azurerm.sql_server.withName` constructs a mixin object that can be merged into the `sql_server`
...
`azurerm.sql_server.withResourceGroupName` constructs a mixin object that can be merged into the `sql_server`
...
`azurerm.sql_server.withTags` constructs a mixin object that can be merged into the `sql_server`
...
`azurerm.sql_server.withThreatDetectionPolicy` constructs a mixin object that can be merged into the `sql_server`
...
`azurerm.sql_server.withThreatDetectionPolicyMixin` constructs a mixin object that can be merged into the `sql_server`
Terraform resource block to set or update the threat_detection_policy field.
...
`azurerm.sql_server.withTimeouts` constructs a mixin object that can be merged into the `sql_server`
...
`azurerm.sql_server.withTimeoutsMixin` constructs a mixin object that can be merged into the `sql_server`
Terraform resource block to set or update the timeouts field.
...
`azurerm.sql_server.withVersion` constructs a mixin object that can be merged into the `sql_server`
