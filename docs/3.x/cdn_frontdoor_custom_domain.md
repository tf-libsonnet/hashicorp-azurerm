...
`azurerm.cdn_frontdoor_custom_domain.withCdnFrontdoorProfileId` constructs a mixin object that can be merged into the `cdn_frontdoor_custom_domain`
...
`azurerm.cdn_frontdoor_custom_domain.withDnsZoneId` constructs a mixin object that can be merged into the `cdn_frontdoor_custom_domain`
...
`azurerm.cdn_frontdoor_custom_domain.withHostName` constructs a mixin object that can be merged into the `cdn_frontdoor_custom_domain`
...
`azurerm.cdn_frontdoor_custom_domain.withTls` constructs a mixin object that can be merged into the `cdn_frontdoor_custom_domain`
...
`azurerm.cdn_frontdoor_custom_domain.withTlsMixin` constructs a mixin object that can be merged into the `cdn_frontdoor_custom_domain`
Terraform resource block to set or update the tls field.
