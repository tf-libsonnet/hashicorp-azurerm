...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.resource_group_template_deployment.timeouts.new](#fn-resource_group_template_deploymenttimeoutsnew) constructor.
...
Unlike [azurerm.resource_group_template_deployment.new](#fn-resource_group_template_deploymentnew), this function will not inject the `resource`
