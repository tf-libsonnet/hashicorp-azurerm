...
`azurerm.machine_learning_synapse_spark.withMachineLearningWorkspaceId` constructs a mixin object that can be merged into the `machine_learning_synapse_spark`
