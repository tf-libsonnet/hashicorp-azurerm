...
`azurerm.automation_software_update_configuration.withAutomationAccountId` constructs a mixin object that can be merged into the `automation_software_update_configuration`
...
`azurerm.automation_software_update_configuration.withDuration` constructs a mixin object that can be merged into the `automation_software_update_configuration`
...
`azurerm.automation_software_update_configuration.withLinux` constructs a mixin object that can be merged into the `automation_software_update_configuration`
...
`azurerm.automation_software_update_configuration.withLinuxMixin` constructs a mixin object that can be merged into the `automation_software_update_configuration`
Terraform resource block to set or update the linux field.
...
`azurerm.automation_software_update_configuration.withName` constructs a mixin object that can be merged into the `automation_software_update_configuration`
...
`azurerm.automation_software_update_configuration.withNonAzureComputerNames` constructs a mixin object that can be merged into the `automation_software_update_configuration`
...
`azurerm.automation_software_update_configuration.withOperatingSystem` constructs a mixin object that can be merged into the `automation_software_update_configuration`
...
`azurerm.automation_software_update_configuration.withPostTask` constructs a mixin object that can be merged into the `automation_software_update_configuration`
...
`azurerm.automation_software_update_configuration.withPostTaskMixin` constructs a mixin object that can be merged into the `automation_software_update_configuration`
Terraform resource block to set or update the post_task field.
...
`azurerm.automation_software_update_configuration.withPreTask` constructs a mixin object that can be merged into the `automation_software_update_configuration`
...
`azurerm.automation_software_update_configuration.withPreTaskMixin` constructs a mixin object that can be merged into the `automation_software_update_configuration`
Terraform resource block to set or update the pre_task field.
...
`azurerm.automation_software_update_configuration.withSchedule` constructs a mixin object that can be merged into the `automation_software_update_configuration`
...
`azurerm.automation_software_update_configuration.withScheduleMixin` constructs a mixin object that can be merged into the `automation_software_update_configuration`
Terraform resource block to set or update the schedule field.
...
`azurerm.automation_software_update_configuration.withTarget` constructs a mixin object that can be merged into the `automation_software_update_configuration`
...
`azurerm.automation_software_update_configuration.withTargetMixin` constructs a mixin object that can be merged into the `automation_software_update_configuration`
Terraform resource block to set or update the target field.
...
`azurerm.automation_software_update_configuration.withTimeouts` constructs a mixin object that can be merged into the `automation_software_update_configuration`
...
`azurerm.automation_software_update_configuration.withTimeoutsMixin` constructs a mixin object that can be merged into the `automation_software_update_configuration`
Terraform resource block to set or update the timeouts field.
...
`azurerm.automation_software_update_configuration.withVirtualMachineIds` constructs a mixin object that can be merged into the `automation_software_update_configuration`
...
`azurerm.automation_software_update_configuration.withWindows` constructs a mixin object that can be merged into the `automation_software_update_configuration`
...
`azurerm.automation_software_update_configuration.withWindowsMixin` constructs a mixin object that can be merged into the `automation_software_update_configuration`
Terraform resource block to set or update the windows field.
