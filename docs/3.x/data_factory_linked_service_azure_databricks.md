...
`azurerm.data_factory_linked_service_azure_databricks.withAccessToken` constructs a mixin object that can be merged into the `data_factory_linked_service_azure_databricks`
...
`azurerm.data_factory_linked_service_azure_databricks.withAdbDomain` constructs a mixin object that can be merged into the `data_factory_linked_service_azure_databricks`
...
`azurerm.data_factory_linked_service_azure_databricks.withAdditionalProperties` constructs a mixin object that can be merged into the `data_factory_linked_service_azure_databricks`
...
`azurerm.data_factory_linked_service_azure_databricks.withAnnotations` constructs a mixin object that can be merged into the `data_factory_linked_service_azure_databricks`
...
`azurerm.data_factory_linked_service_azure_databricks.withDataFactoryId` constructs a mixin object that can be merged into the `data_factory_linked_service_azure_databricks`
...
`azurerm.data_factory_linked_service_azure_databricks.withDescription` constructs a mixin object that can be merged into the `data_factory_linked_service_azure_databricks`
...
`azurerm.data_factory_linked_service_azure_databricks.withExistingClusterId` constructs a mixin object that can be merged into the `data_factory_linked_service_azure_databricks`
...
`azurerm.data_factory_linked_service_azure_databricks.withInstancePool` constructs a mixin object that can be merged into the `data_factory_linked_service_azure_databricks`
...
`azurerm.data_factory_linked_service_azure_databricks.withInstancePoolMixin` constructs a mixin object that can be merged into the `data_factory_linked_service_azure_databricks`
Terraform resource block to set or update the instance_pool field.
...
`azurerm.data_factory_linked_service_azure_databricks.withIntegrationRuntimeName` constructs a mixin object that can be merged into the `data_factory_linked_service_azure_databricks`
...
`azurerm.data_factory_linked_service_azure_databricks.withKeyVaultPassword` constructs a mixin object that can be merged into the `data_factory_linked_service_azure_databricks`
...
`azurerm.data_factory_linked_service_azure_databricks.withKeyVaultPasswordMixin` constructs a mixin object that can be merged into the `data_factory_linked_service_azure_databricks`
Terraform resource block to set or update the key_vault_password field.
...
`azurerm.data_factory_linked_service_azure_databricks.withMsiWorkSpaceResourceId` constructs a mixin object that can be merged into the `data_factory_linked_service_azure_databricks`
...
`azurerm.data_factory_linked_service_azure_databricks.withName` constructs a mixin object that can be merged into the `data_factory_linked_service_azure_databricks`
...
`azurerm.data_factory_linked_service_azure_databricks.withNewClusterConfig` constructs a mixin object that can be merged into the `data_factory_linked_service_azure_databricks`
...
`azurerm.data_factory_linked_service_azure_databricks.withNewClusterConfigMixin` constructs a mixin object that can be merged into the `data_factory_linked_service_azure_databricks`
Terraform resource block to set or update the new_cluster_config field.
...
`azurerm.data_factory_linked_service_azure_databricks.withParameters` constructs a mixin object that can be merged into the `data_factory_linked_service_azure_databricks`
...
`azurerm.data_factory_linked_service_azure_databricks.withTimeouts` constructs a mixin object that can be merged into the `data_factory_linked_service_azure_databricks`
...
`azurerm.data_factory_linked_service_azure_databricks.withTimeoutsMixin` constructs a mixin object that can be merged into the `data_factory_linked_service_azure_databricks`
Terraform resource block to set or update the timeouts field.
