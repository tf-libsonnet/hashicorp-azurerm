...
`azurerm.hpc_cache_access_policy.withAccessRule` constructs a mixin object that can be merged into the `hpc_cache_access_policy`
...
`azurerm.hpc_cache_access_policy.withAccessRuleMixin` constructs a mixin object that can be merged into the `hpc_cache_access_policy`
Terraform resource block to set or update the access_rule field.
...
`azurerm.hpc_cache_access_policy.withHpcCacheId` constructs a mixin object that can be merged into the `hpc_cache_access_policy`
...
`azurerm.hpc_cache_access_policy.withName` constructs a mixin object that can be merged into the `hpc_cache_access_policy`
...
`azurerm.hpc_cache_access_policy.withTimeouts` constructs a mixin object that can be merged into the `hpc_cache_access_policy`
...
`azurerm.hpc_cache_access_policy.withTimeoutsMixin` constructs a mixin object that can be merged into the `hpc_cache_access_policy`
Terraform resource block to set or update the timeouts field.
