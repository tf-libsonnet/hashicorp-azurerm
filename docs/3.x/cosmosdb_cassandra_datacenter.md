...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.cosmosdb_cassandra_datacenter.timeouts.new](#fn-cosmosdb_cassandra_datacentertimeoutsnew) constructor.
...
Unlike [azurerm.cosmosdb_cassandra_datacenter.new](#fn-cosmosdb_cassandra_datacenternew), this function will not inject the `resource`
