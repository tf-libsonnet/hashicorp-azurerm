...
`azurerm.servicebus_subscription.withAutoDeleteOnIdle` constructs a mixin object that can be merged into the `servicebus_subscription`
...
`azurerm.servicebus_subscription.withClientScopedSubscription` constructs a mixin object that can be merged into the `servicebus_subscription`
...
`azurerm.servicebus_subscription.withClientScopedSubscriptionEnabled` constructs a mixin object that can be merged into the `servicebus_subscription`
...
`azurerm.servicebus_subscription.withClientScopedSubscriptionMixin` constructs a mixin object that can be merged into the `servicebus_subscription`
Terraform resource block to set or update the client_scoped_subscription field.
...
`azurerm.servicebus_subscription.withDeadLetteringOnFilterEvaluationError` constructs a mixin object that can be merged into the `servicebus_subscription`
...
`azurerm.servicebus_subscription.withDeadLetteringOnMessageExpiration` constructs a mixin object that can be merged into the `servicebus_subscription`
...
`azurerm.servicebus_subscription.withDefaultMessageTtl` constructs a mixin object that can be merged into the `servicebus_subscription`
...
`azurerm.servicebus_subscription.withEnableBatchedOperations` constructs a mixin object that can be merged into the `servicebus_subscription`
...
`azurerm.servicebus_subscription.withForwardDeadLetteredMessagesTo` constructs a mixin object that can be merged into the `servicebus_subscription`
...
`azurerm.servicebus_subscription.withForwardTo` constructs a mixin object that can be merged into the `servicebus_subscription`
...
`azurerm.servicebus_subscription.withLockDuration` constructs a mixin object that can be merged into the `servicebus_subscription`
...
`azurerm.servicebus_subscription.withMaxDeliveryCount` constructs a mixin object that can be merged into the `servicebus_subscription`
...
`azurerm.servicebus_subscription.withName` constructs a mixin object that can be merged into the `servicebus_subscription`
...
`azurerm.servicebus_subscription.withRequiresSession` constructs a mixin object that can be merged into the `servicebus_subscription`
...
`azurerm.servicebus_subscription.withStatus` constructs a mixin object that can be merged into the `servicebus_subscription`
...
`azurerm.servicebus_subscription.withTimeouts` constructs a mixin object that can be merged into the `servicebus_subscription`
...
`azurerm.servicebus_subscription.withTimeoutsMixin` constructs a mixin object that can be merged into the `servicebus_subscription`
Terraform resource block to set or update the timeouts field.
...
`azurerm.servicebus_subscription.withTopicId` constructs a mixin object that can be merged into the `servicebus_subscription`
