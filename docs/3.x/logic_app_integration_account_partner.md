...
`azurerm.logic_app_integration_account_partner.withBusinessIdentity` constructs a mixin object that can be merged into the `logic_app_integration_account_partner`
...
`azurerm.logic_app_integration_account_partner.withBusinessIdentityMixin` constructs a mixin object that can be merged into the `logic_app_integration_account_partner`
Terraform resource block to set or update the business_identity field.
...
`azurerm.logic_app_integration_account_partner.withIntegrationAccountName` constructs a mixin object that can be merged into the `logic_app_integration_account_partner`
...
`azurerm.logic_app_integration_account_partner.withMetadata` constructs a mixin object that can be merged into the `logic_app_integration_account_partner`
...
`azurerm.logic_app_integration_account_partner.withName` constructs a mixin object that can be merged into the `logic_app_integration_account_partner`
...
`azurerm.logic_app_integration_account_partner.withResourceGroupName` constructs a mixin object that can be merged into the `logic_app_integration_account_partner`
...
`azurerm.logic_app_integration_account_partner.withTimeouts` constructs a mixin object that can be merged into the `logic_app_integration_account_partner`
...
`azurerm.logic_app_integration_account_partner.withTimeoutsMixin` constructs a mixin object that can be merged into the `logic_app_integration_account_partner`
Terraform resource block to set or update the timeouts field.
