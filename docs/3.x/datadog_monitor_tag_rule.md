...
`azurerm.datadog_monitor_tag_rule.withDatadogMonitorId` constructs a mixin object that can be merged into the `datadog_monitor_tag_rule`
...
`azurerm.datadog_monitor_tag_rule.withLog` constructs a mixin object that can be merged into the `datadog_monitor_tag_rule`
...
`azurerm.datadog_monitor_tag_rule.withLogMixin` constructs a mixin object that can be merged into the `datadog_monitor_tag_rule`
Terraform resource block to set or update the log field.
...
`azurerm.datadog_monitor_tag_rule.withMetric` constructs a mixin object that can be merged into the `datadog_monitor_tag_rule`
...
`azurerm.datadog_monitor_tag_rule.withMetricMixin` constructs a mixin object that can be merged into the `datadog_monitor_tag_rule`
Terraform resource block to set or update the metric field.
...
`azurerm.datadog_monitor_tag_rule.withName` constructs a mixin object that can be merged into the `datadog_monitor_tag_rule`
...
`azurerm.datadog_monitor_tag_rule.withTimeouts` constructs a mixin object that can be merged into the `datadog_monitor_tag_rule`
...
`azurerm.datadog_monitor_tag_rule.withTimeoutsMixin` constructs a mixin object that can be merged into the `datadog_monitor_tag_rule`
Terraform resource block to set or update the timeouts field.
