...
`azurerm.app_service_certificate_order.withAutoRenew` constructs a mixin object that can be merged into the `app_service_certificate_order`
...
`azurerm.app_service_certificate_order.withCsr` constructs a mixin object that can be merged into the `app_service_certificate_order`
...
`azurerm.app_service_certificate_order.withDistinguishedName` constructs a mixin object that can be merged into the `app_service_certificate_order`
...
`azurerm.app_service_certificate_order.withKeySize` constructs a mixin object that can be merged into the `app_service_certificate_order`
...
`azurerm.app_service_certificate_order.withLocation` constructs a mixin object that can be merged into the `app_service_certificate_order`
...
`azurerm.app_service_certificate_order.withProductType` constructs a mixin object that can be merged into the `app_service_certificate_order`
...
`azurerm.app_service_certificate_order.withTags` constructs a mixin object that can be merged into the `app_service_certificate_order`
...
`azurerm.app_service_certificate_order.withValidityInYears` constructs a mixin object that can be merged into the `app_service_certificate_order`
