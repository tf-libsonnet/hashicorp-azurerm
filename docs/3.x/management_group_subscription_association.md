...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.management_group_subscription_association.timeouts.new](#fn-timeoutsnew) constructor.
...
Unlike [azurerm.management_group_subscription_association.new](#fn-new), this function will not inject the `resource`
