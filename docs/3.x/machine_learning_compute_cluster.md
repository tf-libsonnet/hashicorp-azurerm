...
`azurerm.machine_learning_compute_cluster.withDescription` constructs a mixin object that can be merged into the `machine_learning_compute_cluster`
...
`azurerm.machine_learning_compute_cluster.withIdentity` constructs a mixin object that can be merged into the `machine_learning_compute_cluster`
...
`azurerm.machine_learning_compute_cluster.withIdentityMixin` constructs a mixin object that can be merged into the `machine_learning_compute_cluster`
Terraform resource block to set or update the identity field.
...
`azurerm.machine_learning_compute_cluster.withLocalAuthEnabled` constructs a mixin object that can be merged into the `machine_learning_compute_cluster`
...
`azurerm.machine_learning_compute_cluster.withLocation` constructs a mixin object that can be merged into the `machine_learning_compute_cluster`
...
`azurerm.machine_learning_compute_cluster.withMachineLearningWorkspaceId` constructs a mixin object that can be merged into the `machine_learning_compute_cluster`
...
`azurerm.machine_learning_compute_cluster.withName` constructs a mixin object that can be merged into the `machine_learning_compute_cluster`
...
`azurerm.machine_learning_compute_cluster.withScaleSettings` constructs a mixin object that can be merged into the `machine_learning_compute_cluster`
...
`azurerm.machine_learning_compute_cluster.withScaleSettingsMixin` constructs a mixin object that can be merged into the `machine_learning_compute_cluster`
Terraform resource block to set or update the scale_settings field.
...
`azurerm.machine_learning_compute_cluster.withSsh` constructs a mixin object that can be merged into the `machine_learning_compute_cluster`
...
`azurerm.machine_learning_compute_cluster.withSshMixin` constructs a mixin object that can be merged into the `machine_learning_compute_cluster`
Terraform resource block to set or update the ssh field.
...
`azurerm.machine_learning_compute_cluster.withSshPublicAccessEnabled` constructs a mixin object that can be merged into the `machine_learning_compute_cluster`
...
`azurerm.machine_learning_compute_cluster.withSubnetResourceId` constructs a mixin object that can be merged into the `machine_learning_compute_cluster`
...
`azurerm.machine_learning_compute_cluster.withTags` constructs a mixin object that can be merged into the `machine_learning_compute_cluster`
...
`azurerm.machine_learning_compute_cluster.withTimeouts` constructs a mixin object that can be merged into the `machine_learning_compute_cluster`
...
`azurerm.machine_learning_compute_cluster.withTimeoutsMixin` constructs a mixin object that can be merged into the `machine_learning_compute_cluster`
Terraform resource block to set or update the timeouts field.
...
`azurerm.machine_learning_compute_cluster.withVmPriority` constructs a mixin object that can be merged into the `machine_learning_compute_cluster`
...
`azurerm.machine_learning_compute_cluster.withVmSize` constructs a mixin object that can be merged into the `machine_learning_compute_cluster`
