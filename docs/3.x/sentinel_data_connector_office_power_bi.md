...
`azurerm.sentinel_data_connector_office_power_bi.withLogAnalyticsWorkspaceId` constructs a mixin object that can be merged into the `sentinel_data_connector_office_power_bi`
...
`azurerm.sentinel_data_connector_office_power_bi.withName` constructs a mixin object that can be merged into the `sentinel_data_connector_office_power_bi`
...
`azurerm.sentinel_data_connector_office_power_bi.withTenantId` constructs a mixin object that can be merged into the `sentinel_data_connector_office_power_bi`
...
`azurerm.sentinel_data_connector_office_power_bi.withTimeouts` constructs a mixin object that can be merged into the `sentinel_data_connector_office_power_bi`
...
`azurerm.sentinel_data_connector_office_power_bi.withTimeoutsMixin` constructs a mixin object that can be merged into the `sentinel_data_connector_office_power_bi`
Terraform resource block to set or update the timeouts field.
