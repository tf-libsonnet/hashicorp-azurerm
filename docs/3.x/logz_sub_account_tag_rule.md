...
`azurerm.logz_sub_account_tag_rule.withLogzSubAccountId` constructs a mixin object that can be merged into the `logz_sub_account_tag_rule`
...
`azurerm.logz_sub_account_tag_rule.withSendAadLogs` constructs a mixin object that can be merged into the `logz_sub_account_tag_rule`
...
`azurerm.logz_sub_account_tag_rule.withSendActivityLogs` constructs a mixin object that can be merged into the `logz_sub_account_tag_rule`
...
`azurerm.logz_sub_account_tag_rule.withSendSubscriptionLogs` constructs a mixin object that can be merged into the `logz_sub_account_tag_rule`
...
`azurerm.logz_sub_account_tag_rule.withTagFilter` constructs a mixin object that can be merged into the `logz_sub_account_tag_rule`
...
`azurerm.logz_sub_account_tag_rule.withTagFilterMixin` constructs a mixin object that can be merged into the `logz_sub_account_tag_rule`
Terraform resource block to set or update the tag_filter field.
...
`azurerm.logz_sub_account_tag_rule.withTimeouts` constructs a mixin object that can be merged into the `logz_sub_account_tag_rule`
...
`azurerm.logz_sub_account_tag_rule.withTimeoutsMixin` constructs a mixin object that can be merged into the `logz_sub_account_tag_rule`
Terraform resource block to set or update the timeouts field.
