...
`azurerm.logic_app_integration_account_assembly.withAssemblyName` constructs a mixin object that can be merged into the `logic_app_integration_account_assembly`
...
`azurerm.logic_app_integration_account_assembly.withAssemblyVersion` constructs a mixin object that can be merged into the `logic_app_integration_account_assembly`
...
`azurerm.logic_app_integration_account_assembly.withContent` constructs a mixin object that can be merged into the `logic_app_integration_account_assembly`
...
`azurerm.logic_app_integration_account_assembly.withContentLinkUri` constructs a mixin object that can be merged into the `logic_app_integration_account_assembly`
...
`azurerm.logic_app_integration_account_assembly.withIntegrationAccountName` constructs a mixin object that can be merged into the `logic_app_integration_account_assembly`
...
`azurerm.logic_app_integration_account_assembly.withMetadata` constructs a mixin object that can be merged into the `logic_app_integration_account_assembly`
...
`azurerm.logic_app_integration_account_assembly.withName` constructs a mixin object that can be merged into the `logic_app_integration_account_assembly`
...
`azurerm.logic_app_integration_account_assembly.withResourceGroupName` constructs a mixin object that can be merged into the `logic_app_integration_account_assembly`
...
`azurerm.logic_app_integration_account_assembly.withTimeouts` constructs a mixin object that can be merged into the `logic_app_integration_account_assembly`
...
`azurerm.logic_app_integration_account_assembly.withTimeoutsMixin` constructs a mixin object that can be merged into the `logic_app_integration_account_assembly`
Terraform resource block to set or update the timeouts field.
