...
`azurerm.eventhub.withCaptureDescription` constructs a mixin object that can be merged into the `eventhub`
...
`azurerm.eventhub.withCaptureDescriptionMixin` constructs a mixin object that can be merged into the `eventhub`
Terraform resource block to set or update the capture_description field.
...
`azurerm.eventhub.withMessageRetention` constructs a mixin object that can be merged into the `eventhub`
...
`azurerm.eventhub.withPartitionCount` constructs a mixin object that can be merged into the `eventhub`
...
`azurerm.eventhub.withStatus` constructs a mixin object that can be merged into the `eventhub`
