...
`azurerm.monitor_data_collection_rule.withDataFlow` constructs a mixin object that can be merged into the `monitor_data_collection_rule`
...
`azurerm.monitor_data_collection_rule.withDataFlowMixin` constructs a mixin object that can be merged into the `monitor_data_collection_rule`
Terraform resource block to set or update the data_flow field.
...
`azurerm.monitor_data_collection_rule.withDataSources` constructs a mixin object that can be merged into the `monitor_data_collection_rule`
...
`azurerm.monitor_data_collection_rule.withDataSourcesMixin` constructs a mixin object that can be merged into the `monitor_data_collection_rule`
Terraform resource block to set or update the data_sources field.
...
`azurerm.monitor_data_collection_rule.withDescription` constructs a mixin object that can be merged into the `monitor_data_collection_rule`
...
`azurerm.monitor_data_collection_rule.withDestinations` constructs a mixin object that can be merged into the `monitor_data_collection_rule`
...
`azurerm.monitor_data_collection_rule.withDestinationsMixin` constructs a mixin object that can be merged into the `monitor_data_collection_rule`
Terraform resource block to set or update the destinations field.
...
`azurerm.monitor_data_collection_rule.withKind` constructs a mixin object that can be merged into the `monitor_data_collection_rule`
...
`azurerm.monitor_data_collection_rule.withLocation` constructs a mixin object that can be merged into the `monitor_data_collection_rule`
...
`azurerm.monitor_data_collection_rule.withName` constructs a mixin object that can be merged into the `monitor_data_collection_rule`
...
`azurerm.monitor_data_collection_rule.withResourceGroupName` constructs a mixin object that can be merged into the `monitor_data_collection_rule`
...
`azurerm.monitor_data_collection_rule.withTags` constructs a mixin object that can be merged into the `monitor_data_collection_rule`
...
`azurerm.monitor_data_collection_rule.withTimeouts` constructs a mixin object that can be merged into the `monitor_data_collection_rule`
...
`azurerm.monitor_data_collection_rule.withTimeoutsMixin` constructs a mixin object that can be merged into the `monitor_data_collection_rule`
Terraform resource block to set or update the timeouts field.
