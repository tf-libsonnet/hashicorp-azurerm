...
`azurerm.firewall_policy_rule_collection_group.withApplicationRuleCollection` constructs a mixin object that can be merged into the `firewall_policy_rule_collection_group`
...
`azurerm.firewall_policy_rule_collection_group.withApplicationRuleCollectionMixin` constructs a mixin object that can be merged into the `firewall_policy_rule_collection_group`
Terraform resource block to set or update the application_rule_collection field.
...
`azurerm.firewall_policy_rule_collection_group.withFirewallPolicyId` constructs a mixin object that can be merged into the `firewall_policy_rule_collection_group`
...
`azurerm.firewall_policy_rule_collection_group.withName` constructs a mixin object that can be merged into the `firewall_policy_rule_collection_group`
...
`azurerm.firewall_policy_rule_collection_group.withNatRuleCollection` constructs a mixin object that can be merged into the `firewall_policy_rule_collection_group`
...
`azurerm.firewall_policy_rule_collection_group.withNatRuleCollectionMixin` constructs a mixin object that can be merged into the `firewall_policy_rule_collection_group`
Terraform resource block to set or update the nat_rule_collection field.
...
`azurerm.firewall_policy_rule_collection_group.withNetworkRuleCollection` constructs a mixin object that can be merged into the `firewall_policy_rule_collection_group`
...
`azurerm.firewall_policy_rule_collection_group.withNetworkRuleCollectionMixin` constructs a mixin object that can be merged into the `firewall_policy_rule_collection_group`
Terraform resource block to set or update the network_rule_collection field.
...
`azurerm.firewall_policy_rule_collection_group.withPriority` constructs a mixin object that can be merged into the `firewall_policy_rule_collection_group`
...
`azurerm.firewall_policy_rule_collection_group.withTimeouts` constructs a mixin object that can be merged into the `firewall_policy_rule_collection_group`
...
`azurerm.firewall_policy_rule_collection_group.withTimeoutsMixin` constructs a mixin object that can be merged into the `firewall_policy_rule_collection_group`
Terraform resource block to set or update the timeouts field.
