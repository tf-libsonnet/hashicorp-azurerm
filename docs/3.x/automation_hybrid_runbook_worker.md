...
`azurerm.automation_hybrid_runbook_worker.withAutomationAccountName` constructs a mixin object that can be merged into the `automation_hybrid_runbook_worker`
...
`azurerm.automation_hybrid_runbook_worker.withResourceGroupName` constructs a mixin object that can be merged into the `automation_hybrid_runbook_worker`
...
`azurerm.automation_hybrid_runbook_worker.withTimeouts` constructs a mixin object that can be merged into the `automation_hybrid_runbook_worker`
...
`azurerm.automation_hybrid_runbook_worker.withTimeoutsMixin` constructs a mixin object that can be merged into the `automation_hybrid_runbook_worker`
Terraform resource block to set or update the timeouts field.
...
`azurerm.automation_hybrid_runbook_worker.withVmResourceId` constructs a mixin object that can be merged into the `automation_hybrid_runbook_worker`
...
`azurerm.automation_hybrid_runbook_worker.withWorkerGroupName` constructs a mixin object that can be merged into the `automation_hybrid_runbook_worker`
...
`azurerm.automation_hybrid_runbook_worker.withWorkerId` constructs a mixin object that can be merged into the `automation_hybrid_runbook_worker`
