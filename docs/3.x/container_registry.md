...
`azurerm.container_registry.withAdminEnabled` constructs a mixin object that can be merged into the `container_registry`
...
`azurerm.container_registry.withAnonymousPullEnabled` constructs a mixin object that can be merged into the `container_registry`
...
`azurerm.container_registry.withDataEndpointEnabled` constructs a mixin object that can be merged into the `container_registry`
...
`azurerm.container_registry.withEncryption` constructs a mixin object that can be merged into the `container_registry`
...
`azurerm.container_registry.withExportPolicyEnabled` constructs a mixin object that can be merged into the `container_registry`
...
`azurerm.container_registry.withGeoreplications` constructs a mixin object that can be merged into the `container_registry`
...
`azurerm.container_registry.withGeoreplicationsMixin` constructs a mixin object that can be merged into the `container_registry`
Terraform resource block to set or update the georeplications field.
...
`azurerm.container_registry.withIdentity` constructs a mixin object that can be merged into the `container_registry`
...
`azurerm.container_registry.withIdentityMixin` constructs a mixin object that can be merged into the `container_registry`
Terraform resource block to set or update the identity field.
...
`azurerm.container_registry.withLocation` constructs a mixin object that can be merged into the `container_registry`
...
`azurerm.container_registry.withName` constructs a mixin object that can be merged into the `container_registry`
...
`azurerm.container_registry.withNetworkRuleBypassOption` constructs a mixin object that can be merged into the `container_registry`
...
`azurerm.container_registry.withNetworkRuleSet` constructs a mixin object that can be merged into the `container_registry`
...
`azurerm.container_registry.withPublicNetworkAccessEnabled` constructs a mixin object that can be merged into the `container_registry`
...
`azurerm.container_registry.withQuarantinePolicyEnabled` constructs a mixin object that can be merged into the `container_registry`
...
`azurerm.container_registry.withResourceGroupName` constructs a mixin object that can be merged into the `container_registry`
...
`azurerm.container_registry.withRetentionPolicy` constructs a mixin object that can be merged into the `container_registry`
...
`azurerm.container_registry.withSku` constructs a mixin object that can be merged into the `container_registry`
...
`azurerm.container_registry.withTags` constructs a mixin object that can be merged into the `container_registry`
...
`azurerm.container_registry.withTimeouts` constructs a mixin object that can be merged into the `container_registry`
...
`azurerm.container_registry.withTimeoutsMixin` constructs a mixin object that can be merged into the `container_registry`
Terraform resource block to set or update the timeouts field.
...
`azurerm.container_registry.withTrustPolicy` constructs a mixin object that can be merged into the `container_registry`
...
`azurerm.container_registry.withZoneRedundancyEnabled` constructs a mixin object that can be merged into the `container_registry`
