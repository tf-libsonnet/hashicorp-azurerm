...
`azurerm.dedicated_host.withAutoReplaceOnFailure` constructs a mixin object that can be merged into the `dedicated_host`
...
`azurerm.dedicated_host.withDedicatedHostGroupId` constructs a mixin object that can be merged into the `dedicated_host`
...
`azurerm.dedicated_host.withLicenseType` constructs a mixin object that can be merged into the `dedicated_host`
...
`azurerm.dedicated_host.withLocation` constructs a mixin object that can be merged into the `dedicated_host`
...
`azurerm.dedicated_host.withPlatformFaultDomain` constructs a mixin object that can be merged into the `dedicated_host`
...
`azurerm.dedicated_host.withSkuName` constructs a mixin object that can be merged into the `dedicated_host`
...
`azurerm.dedicated_host.withTags` constructs a mixin object that can be merged into the `dedicated_host`
