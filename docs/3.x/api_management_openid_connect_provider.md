...
**Args**:
  ...
  - `metadata_endpoint` (`string`): Set the `metadata_endpoint` field on the resulting resource block.
  - `name` (`string`): Set the `name` field on the resulting resource block.
  - `resource_group_name` (`string`): Set the `resource_group_name` field on the resulting resource block.
  - `timeouts` (`obj`): Set the `timeouts` field on the resulting resource block. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management_openid_connect_provider.timeouts.new](#fn-timeoutsnew) constructor.
...
Unlike [azurerm.api_management_openid_connect_provider.new](#fn-new), this function will not inject the `resource`
...
**Args**:
  ...
  - `metadata_endpoint` (`string`): Set the `metadata_endpoint` field on the resulting object.
  - `name` (`string`): Set the `name` field on the resulting object.
  - `resource_group_name` (`string`): Set the `resource_group_name` field on the resulting object.
  - `timeouts` (`obj`): Set the `timeouts` field on the resulting object. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management_openid_connect_provider.timeouts.new](#fn-timeoutsnew) constructor.
...
`azurerm.string.withMetadataEndpoint` constructs a mixin object that can be merged into the `string`
