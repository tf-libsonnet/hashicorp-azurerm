...
`azurerm.web_application_firewall_policy.withCustomRules` constructs a mixin object that can be merged into the `web_application_firewall_policy`
...
`azurerm.web_application_firewall_policy.withCustomRulesMixin` constructs a mixin object that can be merged into the `web_application_firewall_policy`
Terraform resource block to set or update the custom_rules field.
...
`azurerm.web_application_firewall_policy.withLocation` constructs a mixin object that can be merged into the `web_application_firewall_policy`
...
`azurerm.web_application_firewall_policy.withManagedRules` constructs a mixin object that can be merged into the `web_application_firewall_policy`
...
`azurerm.web_application_firewall_policy.withManagedRulesMixin` constructs a mixin object that can be merged into the `web_application_firewall_policy`
Terraform resource block to set or update the managed_rules field.
...
`azurerm.web_application_firewall_policy.withName` constructs a mixin object that can be merged into the `web_application_firewall_policy`
...
`azurerm.web_application_firewall_policy.withPolicySettings` constructs a mixin object that can be merged into the `web_application_firewall_policy`
...
`azurerm.web_application_firewall_policy.withPolicySettingsMixin` constructs a mixin object that can be merged into the `web_application_firewall_policy`
Terraform resource block to set or update the policy_settings field.
...
`azurerm.web_application_firewall_policy.withResourceGroupName` constructs a mixin object that can be merged into the `web_application_firewall_policy`
...
`azurerm.web_application_firewall_policy.withTags` constructs a mixin object that can be merged into the `web_application_firewall_policy`
...
`azurerm.web_application_firewall_policy.withTimeouts` constructs a mixin object that can be merged into the `web_application_firewall_policy`
...
`azurerm.web_application_firewall_policy.withTimeoutsMixin` constructs a mixin object that can be merged into the `web_application_firewall_policy`
Terraform resource block to set or update the timeouts field.
