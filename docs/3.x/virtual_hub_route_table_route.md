...
`azurerm.virtual_hub_route_table_route.withDestinations` constructs a mixin object that can be merged into the `virtual_hub_route_table_route`
...
`azurerm.virtual_hub_route_table_route.withDestinationsType` constructs a mixin object that can be merged into the `virtual_hub_route_table_route`
...
`azurerm.virtual_hub_route_table_route.withName` constructs a mixin object that can be merged into the `virtual_hub_route_table_route`
...
`azurerm.virtual_hub_route_table_route.withNextHop` constructs a mixin object that can be merged into the `virtual_hub_route_table_route`
...
`azurerm.virtual_hub_route_table_route.withNextHopType` constructs a mixin object that can be merged into the `virtual_hub_route_table_route`
...
`azurerm.virtual_hub_route_table_route.withRouteTableId` constructs a mixin object that can be merged into the `virtual_hub_route_table_route`
...
`azurerm.virtual_hub_route_table_route.withTimeouts` constructs a mixin object that can be merged into the `virtual_hub_route_table_route`
...
`azurerm.virtual_hub_route_table_route.withTimeoutsMixin` constructs a mixin object that can be merged into the `virtual_hub_route_table_route`
Terraform resource block to set or update the timeouts field.
