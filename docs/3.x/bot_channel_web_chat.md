...
**Args**:
  ...
  - `site_names` (`list`): 
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.bot_channel_web_chat.timeouts.new](#fn-bot_channel_web_chattimeoutsnew) constructor.
...
Unlike [azurerm.bot_channel_web_chat.new](#fn-bot_channel_web_chatnew), this function will not inject the `resource`
