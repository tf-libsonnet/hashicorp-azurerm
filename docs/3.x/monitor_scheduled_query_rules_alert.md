...
`azurerm.monitor_scheduled_query_rules_alert.withAction` constructs a mixin object that can be merged into the `monitor_scheduled_query_rules_alert`
...
`azurerm.monitor_scheduled_query_rules_alert.withActionMixin` constructs a mixin object that can be merged into the `monitor_scheduled_query_rules_alert`
Terraform resource block to set or update the action field.
...
`azurerm.monitor_scheduled_query_rules_alert.withAuthorizedResourceIds` constructs a mixin object that can be merged into the `monitor_scheduled_query_rules_alert`
...
`azurerm.monitor_scheduled_query_rules_alert.withAutoMitigationEnabled` constructs a mixin object that can be merged into the `monitor_scheduled_query_rules_alert`
...
`azurerm.monitor_scheduled_query_rules_alert.withDataSourceId` constructs a mixin object that can be merged into the `monitor_scheduled_query_rules_alert`
...
`azurerm.monitor_scheduled_query_rules_alert.withDescription` constructs a mixin object that can be merged into the `monitor_scheduled_query_rules_alert`
...
`azurerm.monitor_scheduled_query_rules_alert.withEnabled` constructs a mixin object that can be merged into the `monitor_scheduled_query_rules_alert`
...
`azurerm.monitor_scheduled_query_rules_alert.withFrequency` constructs a mixin object that can be merged into the `monitor_scheduled_query_rules_alert`
...
`azurerm.monitor_scheduled_query_rules_alert.withLocation` constructs a mixin object that can be merged into the `monitor_scheduled_query_rules_alert`
...
`azurerm.monitor_scheduled_query_rules_alert.withName` constructs a mixin object that can be merged into the `monitor_scheduled_query_rules_alert`
...
`azurerm.monitor_scheduled_query_rules_alert.withQuery` constructs a mixin object that can be merged into the `monitor_scheduled_query_rules_alert`
...
`azurerm.monitor_scheduled_query_rules_alert.withQueryType` constructs a mixin object that can be merged into the `monitor_scheduled_query_rules_alert`
...
`azurerm.monitor_scheduled_query_rules_alert.withResourceGroupName` constructs a mixin object that can be merged into the `monitor_scheduled_query_rules_alert`
...
`azurerm.monitor_scheduled_query_rules_alert.withSeverity` constructs a mixin object that can be merged into the `monitor_scheduled_query_rules_alert`
...
`azurerm.monitor_scheduled_query_rules_alert.withTags` constructs a mixin object that can be merged into the `monitor_scheduled_query_rules_alert`
...
`azurerm.monitor_scheduled_query_rules_alert.withThrottling` constructs a mixin object that can be merged into the `monitor_scheduled_query_rules_alert`
...
`azurerm.monitor_scheduled_query_rules_alert.withTimeWindow` constructs a mixin object that can be merged into the `monitor_scheduled_query_rules_alert`
...
`azurerm.monitor_scheduled_query_rules_alert.withTimeouts` constructs a mixin object that can be merged into the `monitor_scheduled_query_rules_alert`
...
`azurerm.monitor_scheduled_query_rules_alert.withTimeoutsMixin` constructs a mixin object that can be merged into the `monitor_scheduled_query_rules_alert`
Terraform resource block to set or update the timeouts field.
...
`azurerm.monitor_scheduled_query_rules_alert.withTrigger` constructs a mixin object that can be merged into the `monitor_scheduled_query_rules_alert`
...
`azurerm.monitor_scheduled_query_rules_alert.withTriggerMixin` constructs a mixin object that can be merged into the `monitor_scheduled_query_rules_alert`
Terraform resource block to set or update the trigger field.
