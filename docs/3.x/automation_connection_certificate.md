...
**Args**:
  ...
  - `automation_certificate_name` (`string`): Set the `automation_certificate_name` field on the resulting resource block.
  ...
  - `timeouts` (`obj`): Set the `timeouts` field on the resulting resource block. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.automation_connection_certificate.timeouts.new](#fn-timeoutsnew) constructor.
...
Unlike [azurerm.automation_connection_certificate.new](#fn-new), this function will not inject the `resource`
...
**Args**:
  ...
  - `automation_certificate_name` (`string`): Set the `automation_certificate_name` field on the resulting object.
  ...
  - `timeouts` (`obj`): Set the `timeouts` field on the resulting object. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.automation_connection_certificate.timeouts.new](#fn-timeoutsnew) constructor.
...
`azurerm.string.withAutomationCertificateName` constructs a mixin object that can be merged into the `string`
