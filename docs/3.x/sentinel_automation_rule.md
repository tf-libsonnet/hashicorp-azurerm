...
`azurerm.sentinel_automation_rule.withActionIncident` constructs a mixin object that can be merged into the `sentinel_automation_rule`
...
`azurerm.sentinel_automation_rule.withActionIncidentMixin` constructs a mixin object that can be merged into the `sentinel_automation_rule`
Terraform resource block to set or update the action_incident field.
...
`azurerm.sentinel_automation_rule.withActionPlaybook` constructs a mixin object that can be merged into the `sentinel_automation_rule`
...
`azurerm.sentinel_automation_rule.withActionPlaybookMixin` constructs a mixin object that can be merged into the `sentinel_automation_rule`
Terraform resource block to set or update the action_playbook field.
...
`azurerm.sentinel_automation_rule.withCondition` constructs a mixin object that can be merged into the `sentinel_automation_rule`
...
`azurerm.sentinel_automation_rule.withConditionMixin` constructs a mixin object that can be merged into the `sentinel_automation_rule`
Terraform resource block to set or update the condition field.
...
`azurerm.sentinel_automation_rule.withDisplayName` constructs a mixin object that can be merged into the `sentinel_automation_rule`
...
`azurerm.sentinel_automation_rule.withEnabled` constructs a mixin object that can be merged into the `sentinel_automation_rule`
...
`azurerm.sentinel_automation_rule.withExpiration` constructs a mixin object that can be merged into the `sentinel_automation_rule`
...
`azurerm.sentinel_automation_rule.withLogAnalyticsWorkspaceId` constructs a mixin object that can be merged into the `sentinel_automation_rule`
...
`azurerm.sentinel_automation_rule.withName` constructs a mixin object that can be merged into the `sentinel_automation_rule`
...
`azurerm.sentinel_automation_rule.withOrder` constructs a mixin object that can be merged into the `sentinel_automation_rule`
...
`azurerm.sentinel_automation_rule.withTimeouts` constructs a mixin object that can be merged into the `sentinel_automation_rule`
...
`azurerm.sentinel_automation_rule.withTimeoutsMixin` constructs a mixin object that can be merged into the `sentinel_automation_rule`
Terraform resource block to set or update the timeouts field.
