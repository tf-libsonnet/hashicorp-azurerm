...
**Args**:
  ...
  - `value` (`string`): 
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.key_vault_secret.timeouts.new](#fn-key_vault_secrettimeoutsnew) constructor.
...
Unlike [azurerm.key_vault_secret.new](#fn-key_vault_secretnew), this function will not inject the `resource`
