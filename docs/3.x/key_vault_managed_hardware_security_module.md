...
`azurerm.key_vault_managed_hardware_security_module.withAdminObjectIds` constructs a mixin object that can be merged into the `key_vault_managed_hardware_security_module`
...
`azurerm.key_vault_managed_hardware_security_module.withLocation` constructs a mixin object that can be merged into the `key_vault_managed_hardware_security_module`
...
`azurerm.key_vault_managed_hardware_security_module.withNetworkAcls` constructs a mixin object that can be merged into the `key_vault_managed_hardware_security_module`
...
`azurerm.key_vault_managed_hardware_security_module.withNetworkAclsMixin` constructs a mixin object that can be merged into the `key_vault_managed_hardware_security_module`
Terraform resource block to set or update the network_acls field.
...
`azurerm.key_vault_managed_hardware_security_module.withPublicNetworkAccessEnabled` constructs a mixin object that can be merged into the `key_vault_managed_hardware_security_module`
...
`azurerm.key_vault_managed_hardware_security_module.withPurgeProtectionEnabled` constructs a mixin object that can be merged into the `key_vault_managed_hardware_security_module`
...
`azurerm.key_vault_managed_hardware_security_module.withSkuName` constructs a mixin object that can be merged into the `key_vault_managed_hardware_security_module`
...
`azurerm.key_vault_managed_hardware_security_module.withSoftDeleteRetentionDays` constructs a mixin object that can be merged into the `key_vault_managed_hardware_security_module`
...
`azurerm.key_vault_managed_hardware_security_module.withTags` constructs a mixin object that can be merged into the `key_vault_managed_hardware_security_module`
...
`azurerm.key_vault_managed_hardware_security_module.withTenantId` constructs a mixin object that can be merged into the `key_vault_managed_hardware_security_module`
