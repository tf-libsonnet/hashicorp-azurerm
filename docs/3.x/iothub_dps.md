...
`azurerm.iothub_dps.withAllocationPolicy` constructs a mixin object that can be merged into the `iothub_dps`
...
`azurerm.iothub_dps.withDataResidencyEnabled` constructs a mixin object that can be merged into the `iothub_dps`
...
`azurerm.iothub_dps.withIpFilterRule` constructs a mixin object that can be merged into the `iothub_dps`
...
`azurerm.iothub_dps.withIpFilterRuleMixin` constructs a mixin object that can be merged into the `iothub_dps`
Terraform resource block to set or update the ip_filter_rule field.
...
`azurerm.iothub_dps.withLinkedHub` constructs a mixin object that can be merged into the `iothub_dps`
...
`azurerm.iothub_dps.withLinkedHubMixin` constructs a mixin object that can be merged into the `iothub_dps`
Terraform resource block to set or update the linked_hub field.
...
`azurerm.iothub_dps.withLocation` constructs a mixin object that can be merged into the `iothub_dps`
...
`azurerm.iothub_dps.withPublicNetworkAccessEnabled` constructs a mixin object that can be merged into the `iothub_dps`
...
`azurerm.iothub_dps.withSku` constructs a mixin object that can be merged into the `iothub_dps`
...
`azurerm.iothub_dps.withSkuMixin` constructs a mixin object that can be merged into the `iothub_dps`
Terraform resource block to set or update the sku field.
