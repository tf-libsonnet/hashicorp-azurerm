...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.virtual_desktop_application.timeouts.new](#fn-virtual_desktop_applicationtimeoutsnew) constructor.
...
Unlike [azurerm.virtual_desktop_application.new](#fn-virtual_desktop_applicationnew), this function will not inject the `resource`
