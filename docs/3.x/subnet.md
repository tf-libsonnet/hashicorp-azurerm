...
`azurerm.subnet.withAddressPrefixes` constructs a mixin object that can be merged into the `subnet`
...
`azurerm.subnet.withDelegation` constructs a mixin object that can be merged into the `subnet`
...
`azurerm.subnet.withDelegationMixin` constructs a mixin object that can be merged into the `subnet`
Terraform resource block to set or update the delegation field.
...
`azurerm.subnet.withEnforcePrivateLinkEndpointNetworkPolicies` constructs a mixin object that can be merged into the `subnet`
...
`azurerm.subnet.withEnforcePrivateLinkServiceNetworkPolicies` constructs a mixin object that can be merged into the `subnet`
...
`azurerm.subnet.withName` constructs a mixin object that can be merged into the `subnet`
...
`azurerm.subnet.withPrivateEndpointNetworkPoliciesEnabled` constructs a mixin object that can be merged into the `subnet`
...
`azurerm.subnet.withPrivateLinkServiceNetworkPoliciesEnabled` constructs a mixin object that can be merged into the `subnet`
...
`azurerm.subnet.withResourceGroupName` constructs a mixin object that can be merged into the `subnet`
...
`azurerm.subnet.withServiceEndpointPolicyIds` constructs a mixin object that can be merged into the `subnet`
...
`azurerm.subnet.withServiceEndpoints` constructs a mixin object that can be merged into the `subnet`
...
`azurerm.subnet.withTimeouts` constructs a mixin object that can be merged into the `subnet`
...
`azurerm.subnet.withTimeoutsMixin` constructs a mixin object that can be merged into the `subnet`
Terraform resource block to set or update the timeouts field.
...
`azurerm.subnet.withVirtualNetworkName` constructs a mixin object that can be merged into the `subnet`
