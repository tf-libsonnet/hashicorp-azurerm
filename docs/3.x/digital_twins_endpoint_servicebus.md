...
`azurerm.digital_twins_endpoint_servicebus.withDeadLetterStorageSecret` constructs a mixin object that can be merged into the `digital_twins_endpoint_servicebus`
...
`azurerm.digital_twins_endpoint_servicebus.withDigitalTwinsId` constructs a mixin object that can be merged into the `digital_twins_endpoint_servicebus`
...
`azurerm.digital_twins_endpoint_servicebus.withName` constructs a mixin object that can be merged into the `digital_twins_endpoint_servicebus`
...
`azurerm.digital_twins_endpoint_servicebus.withServicebusPrimaryConnectionString` constructs a mixin object that can be merged into the `digital_twins_endpoint_servicebus`
...
`azurerm.digital_twins_endpoint_servicebus.withServicebusSecondaryConnectionString` constructs a mixin object that can be merged into the `digital_twins_endpoint_servicebus`
...
`azurerm.digital_twins_endpoint_servicebus.withTimeouts` constructs a mixin object that can be merged into the `digital_twins_endpoint_servicebus`
...
`azurerm.digital_twins_endpoint_servicebus.withTimeoutsMixin` constructs a mixin object that can be merged into the `digital_twins_endpoint_servicebus`
Terraform resource block to set or update the timeouts field.
