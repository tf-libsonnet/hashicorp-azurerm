...
`azurerm.postgresql_server.withAdministratorLogin` constructs a mixin object that can be merged into the `postgresql_server`
...
`azurerm.postgresql_server.withAdministratorLoginPassword` constructs a mixin object that can be merged into the `postgresql_server`
...
`azurerm.postgresql_server.withAutoGrowEnabled` constructs a mixin object that can be merged into the `postgresql_server`
...
`azurerm.postgresql_server.withBackupRetentionDays` constructs a mixin object that can be merged into the `postgresql_server`
...
`azurerm.postgresql_server.withCreateMode` constructs a mixin object that can be merged into the `postgresql_server`
...
`azurerm.postgresql_server.withCreationSourceServerId` constructs a mixin object that can be merged into the `postgresql_server`
...
`azurerm.postgresql_server.withGeoRedundantBackupEnabled` constructs a mixin object that can be merged into the `postgresql_server`
...
`azurerm.postgresql_server.withIdentity` constructs a mixin object that can be merged into the `postgresql_server`
...
`azurerm.postgresql_server.withIdentityMixin` constructs a mixin object that can be merged into the `postgresql_server`
Terraform resource block to set or update the identity field.
...
`azurerm.postgresql_server.withInfrastructureEncryptionEnabled` constructs a mixin object that can be merged into the `postgresql_server`
...
`azurerm.postgresql_server.withLocation` constructs a mixin object that can be merged into the `postgresql_server`
...
`azurerm.postgresql_server.withName` constructs a mixin object that can be merged into the `postgresql_server`
...
`azurerm.postgresql_server.withPublicNetworkAccessEnabled` constructs a mixin object that can be merged into the `postgresql_server`
...
`azurerm.postgresql_server.withResourceGroupName` constructs a mixin object that can be merged into the `postgresql_server`
...
`azurerm.postgresql_server.withRestorePointInTime` constructs a mixin object that can be merged into the `postgresql_server`
...
`azurerm.postgresql_server.withSkuName` constructs a mixin object that can be merged into the `postgresql_server`
...
`azurerm.postgresql_server.withSslEnforcementEnabled` constructs a mixin object that can be merged into the `postgresql_server`
...
`azurerm.postgresql_server.withSslMinimalTlsVersionEnforced` constructs a mixin object that can be merged into the `postgresql_server`
...
`azurerm.postgresql_server.withStorageMb` constructs a mixin object that can be merged into the `postgresql_server`
...
`azurerm.postgresql_server.withTags` constructs a mixin object that can be merged into the `postgresql_server`
...
`azurerm.postgresql_server.withThreatDetectionPolicy` constructs a mixin object that can be merged into the `postgresql_server`
...
`azurerm.postgresql_server.withThreatDetectionPolicyMixin` constructs a mixin object that can be merged into the `postgresql_server`
Terraform resource block to set or update the threat_detection_policy field.
...
`azurerm.postgresql_server.withTimeouts` constructs a mixin object that can be merged into the `postgresql_server`
...
`azurerm.postgresql_server.withTimeoutsMixin` constructs a mixin object that can be merged into the `postgresql_server`
Terraform resource block to set or update the timeouts field.
...
`azurerm.postgresql_server.withVersion` constructs a mixin object that can be merged into the `postgresql_server`
