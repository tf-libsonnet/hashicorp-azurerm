...
`azurerm.cdn_endpoint.withContentTypesToCompress` constructs a mixin object that can be merged into the `cdn_endpoint`
...
`azurerm.cdn_endpoint.withDeliveryRule` constructs a mixin object that can be merged into the `cdn_endpoint`
...
`azurerm.cdn_endpoint.withDeliveryRuleMixin` constructs a mixin object that can be merged into the `cdn_endpoint`
Terraform resource block to set or update the delivery_rule field.
...
`azurerm.cdn_endpoint.withGeoFilter` constructs a mixin object that can be merged into the `cdn_endpoint`
...
`azurerm.cdn_endpoint.withGeoFilterMixin` constructs a mixin object that can be merged into the `cdn_endpoint`
Terraform resource block to set or update the geo_filter field.
...
`azurerm.cdn_endpoint.withGlobalDeliveryRule` constructs a mixin object that can be merged into the `cdn_endpoint`
...
`azurerm.cdn_endpoint.withGlobalDeliveryRuleMixin` constructs a mixin object that can be merged into the `cdn_endpoint`
Terraform resource block to set or update the global_delivery_rule field.
...
`azurerm.cdn_endpoint.withIsCompressionEnabled` constructs a mixin object that can be merged into the `cdn_endpoint`
...
`azurerm.cdn_endpoint.withIsHttpAllowed` constructs a mixin object that can be merged into the `cdn_endpoint`
...
`azurerm.cdn_endpoint.withIsHttpsAllowed` constructs a mixin object that can be merged into the `cdn_endpoint`
...
`azurerm.cdn_endpoint.withLocation` constructs a mixin object that can be merged into the `cdn_endpoint`
...
`azurerm.cdn_endpoint.withName` constructs a mixin object that can be merged into the `cdn_endpoint`
...
`azurerm.cdn_endpoint.withOptimizationType` constructs a mixin object that can be merged into the `cdn_endpoint`
...
`azurerm.cdn_endpoint.withOrigin` constructs a mixin object that can be merged into the `cdn_endpoint`
...
`azurerm.cdn_endpoint.withOriginHostHeader` constructs a mixin object that can be merged into the `cdn_endpoint`
...
`azurerm.cdn_endpoint.withOriginMixin` constructs a mixin object that can be merged into the `cdn_endpoint`
Terraform resource block to set or update the origin field.
...
`azurerm.cdn_endpoint.withOriginPath` constructs a mixin object that can be merged into the `cdn_endpoint`
...
`azurerm.cdn_endpoint.withProbePath` constructs a mixin object that can be merged into the `cdn_endpoint`
...
`azurerm.cdn_endpoint.withProfileName` constructs a mixin object that can be merged into the `cdn_endpoint`
...
`azurerm.cdn_endpoint.withQuerystringCachingBehaviour` constructs a mixin object that can be merged into the `cdn_endpoint`
...
`azurerm.cdn_endpoint.withResourceGroupName` constructs a mixin object that can be merged into the `cdn_endpoint`
...
`azurerm.cdn_endpoint.withTags` constructs a mixin object that can be merged into the `cdn_endpoint`
...
`azurerm.cdn_endpoint.withTimeouts` constructs a mixin object that can be merged into the `cdn_endpoint`
...
`azurerm.cdn_endpoint.withTimeoutsMixin` constructs a mixin object that can be merged into the `cdn_endpoint`
Terraform resource block to set or update the timeouts field.
