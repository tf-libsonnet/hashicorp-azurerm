...
**Args**:
  ...
  - `delivery_rule` (`list[obj]`):  When `null`, the `delivery_rule` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.cdn_endpoint.delivery_rule.new](#fn-cdn_endpointdelivery_rulenew) constructor.
  - `geo_filter` (`list[obj]`):  When `null`, the `geo_filter` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.cdn_endpoint.geo_filter.new](#fn-cdn_endpointgeo_filternew) constructor.
  - `global_delivery_rule` (`list[obj]`):  When `null`, the `global_delivery_rule` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.cdn_endpoint.global_delivery_rule.new](#fn-cdn_endpointglobal_delivery_rulenew) constructor.
  - `origin` (`list[obj]`):  When `null`, the `origin` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.cdn_endpoint.origin.new](#fn-cdn_endpointoriginnew) constructor.
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.cdn_endpoint.timeouts.new](#fn-cdn_endpointtimeoutsnew) constructor.
...
Unlike [azurerm.cdn_endpoint.new](#fn-cdn_endpointnew), this function will not inject the `resource`
