---
permalink: /private_dns_cname_record/
---

# private_dns_cname_record

`private_dns_cname_record` represents the `azurerm_private_dns_cname_record` Terraform resource.
...
`azurerm.private_dns_cname_record.withRecord` constructs a mixin object that can be merged into the `private_dns_cname_record`
...
`azurerm.private_dns_cname_record.withTags` constructs a mixin object that can be merged into the `private_dns_cname_record`
...
`azurerm.private_dns_cname_record.withTtl` constructs a mixin object that can be merged into the `private_dns_cname_record`
