...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.virtual_network_peering.timeouts.new](#fn-virtual_network_peeringtimeoutsnew) constructor.
...
Unlike [azurerm.virtual_network_peering.new](#fn-virtual_network_peeringnew), this function will not inject the `resource`
