...
`azurerm.virtual_network_peering.withAllowForwardedTraffic` constructs a mixin object that can be merged into the `virtual_network_peering`
...
`azurerm.virtual_network_peering.withAllowGatewayTransit` constructs a mixin object that can be merged into the `virtual_network_peering`
...
`azurerm.virtual_network_peering.withAllowVirtualNetworkAccess` constructs a mixin object that can be merged into the `virtual_network_peering`
...
`azurerm.virtual_network_peering.withName` constructs a mixin object that can be merged into the `virtual_network_peering`
...
`azurerm.virtual_network_peering.withRemoteVirtualNetworkId` constructs a mixin object that can be merged into the `virtual_network_peering`
...
`azurerm.virtual_network_peering.withResourceGroupName` constructs a mixin object that can be merged into the `virtual_network_peering`
...
`azurerm.virtual_network_peering.withTimeouts` constructs a mixin object that can be merged into the `virtual_network_peering`
...
`azurerm.virtual_network_peering.withTimeoutsMixin` constructs a mixin object that can be merged into the `virtual_network_peering`
Terraform resource block to set or update the timeouts field.
...
`azurerm.virtual_network_peering.withUseRemoteGateways` constructs a mixin object that can be merged into the `virtual_network_peering`
...
`azurerm.virtual_network_peering.withVirtualNetworkName` constructs a mixin object that can be merged into the `virtual_network_peering`
