...
`azurerm.virtual_hub_bgp_connection.withName` constructs a mixin object that can be merged into the `virtual_hub_bgp_connection`
...
`azurerm.virtual_hub_bgp_connection.withPeerAsn` constructs a mixin object that can be merged into the `virtual_hub_bgp_connection`
...
`azurerm.virtual_hub_bgp_connection.withPeerIp` constructs a mixin object that can be merged into the `virtual_hub_bgp_connection`
...
`azurerm.virtual_hub_bgp_connection.withTimeouts` constructs a mixin object that can be merged into the `virtual_hub_bgp_connection`
...
`azurerm.virtual_hub_bgp_connection.withTimeoutsMixin` constructs a mixin object that can be merged into the `virtual_hub_bgp_connection`
Terraform resource block to set or update the timeouts field.
...
`azurerm.virtual_hub_bgp_connection.withVirtualHubId` constructs a mixin object that can be merged into the `virtual_hub_bgp_connection`
...
`azurerm.virtual_hub_bgp_connection.withVirtualNetworkConnectionId` constructs a mixin object that can be merged into the `virtual_hub_bgp_connection`
