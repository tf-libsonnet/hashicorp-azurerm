...
`azurerm.lighthouse_assignment.withLighthouseDefinitionId` constructs a mixin object that can be merged into the `lighthouse_assignment`
...
`azurerm.lighthouse_assignment.withName` constructs a mixin object that can be merged into the `lighthouse_assignment`
...
`azurerm.lighthouse_assignment.withScope` constructs a mixin object that can be merged into the `lighthouse_assignment`
...
`azurerm.lighthouse_assignment.withTimeouts` constructs a mixin object that can be merged into the `lighthouse_assignment`
...
`azurerm.lighthouse_assignment.withTimeoutsMixin` constructs a mixin object that can be merged into the `lighthouse_assignment`
Terraform resource block to set or update the timeouts field.
