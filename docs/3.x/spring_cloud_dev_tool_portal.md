...
`azurerm.spring_cloud_dev_tool_portal.withApplicationAcceleratorEnabled` constructs a mixin object that can be merged into the `spring_cloud_dev_tool_portal`
...
`azurerm.spring_cloud_dev_tool_portal.withApplicationLiveViewEnabled` constructs a mixin object that can be merged into the `spring_cloud_dev_tool_portal`
...
`azurerm.spring_cloud_dev_tool_portal.withName` constructs a mixin object that can be merged into the `spring_cloud_dev_tool_portal`
...
`azurerm.spring_cloud_dev_tool_portal.withPublicNetworkAccessEnabled` constructs a mixin object that can be merged into the `spring_cloud_dev_tool_portal`
...
`azurerm.spring_cloud_dev_tool_portal.withSpringCloudServiceId` constructs a mixin object that can be merged into the `spring_cloud_dev_tool_portal`
...
`azurerm.spring_cloud_dev_tool_portal.withSso` constructs a mixin object that can be merged into the `spring_cloud_dev_tool_portal`
...
`azurerm.spring_cloud_dev_tool_portal.withSsoMixin` constructs a mixin object that can be merged into the `spring_cloud_dev_tool_portal`
Terraform resource block to set or update the sso field.
...
`azurerm.spring_cloud_dev_tool_portal.withTimeouts` constructs a mixin object that can be merged into the `spring_cloud_dev_tool_portal`
...
`azurerm.spring_cloud_dev_tool_portal.withTimeoutsMixin` constructs a mixin object that can be merged into the `spring_cloud_dev_tool_portal`
Terraform resource block to set or update the timeouts field.
