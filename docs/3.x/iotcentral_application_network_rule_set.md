...
`azurerm.iotcentral_application_network_rule_set.withApplyToDevice` constructs a mixin object that can be merged into the `iotcentral_application_network_rule_set`
...
`azurerm.iotcentral_application_network_rule_set.withDefaultAction` constructs a mixin object that can be merged into the `iotcentral_application_network_rule_set`
...
`azurerm.iotcentral_application_network_rule_set.withIotcentralApplicationId` constructs a mixin object that can be merged into the `iotcentral_application_network_rule_set`
...
`azurerm.iotcentral_application_network_rule_set.withIpRule` constructs a mixin object that can be merged into the `iotcentral_application_network_rule_set`
...
`azurerm.iotcentral_application_network_rule_set.withIpRuleMixin` constructs a mixin object that can be merged into the `iotcentral_application_network_rule_set`
Terraform resource block to set or update the ip_rule field.
...
`azurerm.iotcentral_application_network_rule_set.withTimeouts` constructs a mixin object that can be merged into the `iotcentral_application_network_rule_set`
...
`azurerm.iotcentral_application_network_rule_set.withTimeoutsMixin` constructs a mixin object that can be merged into the `iotcentral_application_network_rule_set`
Terraform resource block to set or update the timeouts field.
