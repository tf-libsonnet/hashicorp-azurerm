...
**Args**:
  ...
  - `ip_rule` (`list[obj]`):  When `null`, the `ip_rule` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.iotcentral_application_network_rule_set.ip_rule.new](#fn-iotcentral_application_network_rule_setip_rulenew) constructor.
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.iotcentral_application_network_rule_set.timeouts.new](#fn-iotcentral_application_network_rule_settimeoutsnew) constructor.
...
Unlike [azurerm.iotcentral_application_network_rule_set.new](#fn-iotcentral_application_network_rule_setnew), this function will not inject the `resource`
