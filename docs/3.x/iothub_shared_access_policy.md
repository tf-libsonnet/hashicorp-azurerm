...
`azurerm.iothub_shared_access_policy.withDeviceConnect` constructs a mixin object that can be merged into the `iothub_shared_access_policy`
...
`azurerm.iothub_shared_access_policy.withRegistryRead` constructs a mixin object that can be merged into the `iothub_shared_access_policy`
...
`azurerm.iothub_shared_access_policy.withRegistryWrite` constructs a mixin object that can be merged into the `iothub_shared_access_policy`
...
`azurerm.iothub_shared_access_policy.withServiceConnect` constructs a mixin object that can be merged into the `iothub_shared_access_policy`
