...
`azurerm.hpc_cache_blob_target.withAccessPolicyName` constructs a mixin object that can be merged into the `hpc_cache_blob_target`
...
`azurerm.hpc_cache_blob_target.withCacheName` constructs a mixin object that can be merged into the `hpc_cache_blob_target`
...
`azurerm.hpc_cache_blob_target.withName` constructs a mixin object that can be merged into the `hpc_cache_blob_target`
...
`azurerm.hpc_cache_blob_target.withNamespacePath` constructs a mixin object that can be merged into the `hpc_cache_blob_target`
...
`azurerm.hpc_cache_blob_target.withResourceGroupName` constructs a mixin object that can be merged into the `hpc_cache_blob_target`
...
`azurerm.hpc_cache_blob_target.withStorageContainerId` constructs a mixin object that can be merged into the `hpc_cache_blob_target`
...
`azurerm.hpc_cache_blob_target.withTimeouts` constructs a mixin object that can be merged into the `hpc_cache_blob_target`
...
`azurerm.hpc_cache_blob_target.withTimeoutsMixin` constructs a mixin object that can be merged into the `hpc_cache_blob_target`
Terraform resource block to set or update the timeouts field.
