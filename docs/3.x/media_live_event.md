...
`azurerm.media_live_event.withAutoStartEnabled` constructs a mixin object that can be merged into the `media_live_event`
...
`azurerm.media_live_event.withCrossSiteAccessPolicy` constructs a mixin object that can be merged into the `media_live_event`
...
`azurerm.media_live_event.withCrossSiteAccessPolicyMixin` constructs a mixin object that can be merged into the `media_live_event`
Terraform resource block to set or update the cross_site_access_policy field.
...
`azurerm.media_live_event.withDescription` constructs a mixin object that can be merged into the `media_live_event`
...
`azurerm.media_live_event.withEncoding` constructs a mixin object that can be merged into the `media_live_event`
...
`azurerm.media_live_event.withEncodingMixin` constructs a mixin object that can be merged into the `media_live_event`
Terraform resource block to set or update the encoding field.
...
`azurerm.media_live_event.withHostnamePrefix` constructs a mixin object that can be merged into the `media_live_event`
...
`azurerm.media_live_event.withInput` constructs a mixin object that can be merged into the `media_live_event`
...
`azurerm.media_live_event.withInputMixin` constructs a mixin object that can be merged into the `media_live_event`
Terraform resource block to set or update the input field.
...
`azurerm.media_live_event.withLocation` constructs a mixin object that can be merged into the `media_live_event`
...
`azurerm.media_live_event.withMediaServicesAccountName` constructs a mixin object that can be merged into the `media_live_event`
...
`azurerm.media_live_event.withName` constructs a mixin object that can be merged into the `media_live_event`
...
`azurerm.media_live_event.withPreview` constructs a mixin object that can be merged into the `media_live_event`
...
`azurerm.media_live_event.withPreviewMixin` constructs a mixin object that can be merged into the `media_live_event`
Terraform resource block to set or update the preview field.
...
`azurerm.media_live_event.withResourceGroupName` constructs a mixin object that can be merged into the `media_live_event`
...
`azurerm.media_live_event.withTags` constructs a mixin object that can be merged into the `media_live_event`
...
`azurerm.media_live_event.withTimeouts` constructs a mixin object that can be merged into the `media_live_event`
...
`azurerm.media_live_event.withTimeoutsMixin` constructs a mixin object that can be merged into the `media_live_event`
Terraform resource block to set or update the timeouts field.
...
`azurerm.media_live_event.withTranscriptionLanguages` constructs a mixin object that can be merged into the `media_live_event`
...
`azurerm.media_live_event.withUseStaticHostname` constructs a mixin object that can be merged into the `media_live_event`
