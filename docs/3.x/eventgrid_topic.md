...
`azurerm.eventgrid_topic.withIdentity` constructs a mixin object that can be merged into the `eventgrid_topic`
...
`azurerm.eventgrid_topic.withIdentityMixin` constructs a mixin object that can be merged into the `eventgrid_topic`
Terraform resource block to set or update the identity field.
...
`azurerm.eventgrid_topic.withInboundIpRule` constructs a mixin object that can be merged into the `eventgrid_topic`
...
`azurerm.eventgrid_topic.withInputMappingDefaultValues` constructs a mixin object that can be merged into the `eventgrid_topic`
...
`azurerm.eventgrid_topic.withInputMappingDefaultValuesMixin` constructs a mixin object that can be merged into the `eventgrid_topic`
Terraform resource block to set or update the input_mapping_default_values field.
...
`azurerm.eventgrid_topic.withInputMappingFields` constructs a mixin object that can be merged into the `eventgrid_topic`
...
`azurerm.eventgrid_topic.withInputMappingFieldsMixin` constructs a mixin object that can be merged into the `eventgrid_topic`
Terraform resource block to set or update the input_mapping_fields field.
...
`azurerm.eventgrid_topic.withInputSchema` constructs a mixin object that can be merged into the `eventgrid_topic`
...
`azurerm.eventgrid_topic.withLocalAuthEnabled` constructs a mixin object that can be merged into the `eventgrid_topic`
...
`azurerm.eventgrid_topic.withLocation` constructs a mixin object that can be merged into the `eventgrid_topic`
...
`azurerm.eventgrid_topic.withName` constructs a mixin object that can be merged into the `eventgrid_topic`
...
`azurerm.eventgrid_topic.withPublicNetworkAccessEnabled` constructs a mixin object that can be merged into the `eventgrid_topic`
...
`azurerm.eventgrid_topic.withResourceGroupName` constructs a mixin object that can be merged into the `eventgrid_topic`
...
`azurerm.eventgrid_topic.withTags` constructs a mixin object that can be merged into the `eventgrid_topic`
...
`azurerm.eventgrid_topic.withTimeouts` constructs a mixin object that can be merged into the `eventgrid_topic`
...
`azurerm.eventgrid_topic.withTimeoutsMixin` constructs a mixin object that can be merged into the `eventgrid_topic`
Terraform resource block to set or update the timeouts field.
