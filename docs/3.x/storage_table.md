...
`azurerm.storage_table.withAcl` constructs a mixin object that can be merged into the `storage_table`
...
`azurerm.storage_table.withAclMixin` constructs a mixin object that can be merged into the `storage_table`
Terraform resource block to set or update the acl field.
...
`azurerm.storage_table.withName` constructs a mixin object that can be merged into the `storage_table`
...
`azurerm.storage_table.withStorageAccountName` constructs a mixin object that can be merged into the `storage_table`
...
`azurerm.storage_table.withTimeouts` constructs a mixin object that can be merged into the `storage_table`
...
`azurerm.storage_table.withTimeoutsMixin` constructs a mixin object that can be merged into the `storage_table`
Terraform resource block to set or update the timeouts field.
