...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management_api_schema.timeouts.new](#fn-api_management_api_schematimeoutsnew) constructor.
...
Unlike [azurerm.api_management_api_schema.new](#fn-api_management_api_schemanew), this function will not inject the `resource`
