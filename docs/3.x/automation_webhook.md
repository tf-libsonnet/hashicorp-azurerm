...
`azurerm.automation_webhook.withAutomationAccountName` constructs a mixin object that can be merged into the `automation_webhook`
...
`azurerm.automation_webhook.withEnabled` constructs a mixin object that can be merged into the `automation_webhook`
...
`azurerm.automation_webhook.withExpiryTime` constructs a mixin object that can be merged into the `automation_webhook`
...
`azurerm.automation_webhook.withName` constructs a mixin object that can be merged into the `automation_webhook`
...
`azurerm.automation_webhook.withParameters` constructs a mixin object that can be merged into the `automation_webhook`
...
`azurerm.automation_webhook.withResourceGroupName` constructs a mixin object that can be merged into the `automation_webhook`
...
`azurerm.automation_webhook.withRunOnWorkerGroup` constructs a mixin object that can be merged into the `automation_webhook`
...
`azurerm.automation_webhook.withRunbookName` constructs a mixin object that can be merged into the `automation_webhook`
...
`azurerm.automation_webhook.withTimeouts` constructs a mixin object that can be merged into the `automation_webhook`
...
`azurerm.automation_webhook.withTimeoutsMixin` constructs a mixin object that can be merged into the `automation_webhook`
Terraform resource block to set or update the timeouts field.
...
`azurerm.automation_webhook.withUri` constructs a mixin object that can be merged into the `automation_webhook`
