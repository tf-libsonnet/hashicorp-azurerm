...
`azurerm.spring_cloud_gateway.withApiMetadata` constructs a mixin object that can be merged into the `spring_cloud_gateway`
...
`azurerm.spring_cloud_gateway.withApiMetadataMixin` constructs a mixin object that can be merged into the `spring_cloud_gateway`
Terraform resource block to set or update the api_metadata field.
...
`azurerm.spring_cloud_gateway.withCors` constructs a mixin object that can be merged into the `spring_cloud_gateway`
...
`azurerm.spring_cloud_gateway.withCorsMixin` constructs a mixin object that can be merged into the `spring_cloud_gateway`
Terraform resource block to set or update the cors field.
...
`azurerm.spring_cloud_gateway.withHttpsOnly` constructs a mixin object that can be merged into the `spring_cloud_gateway`
...
`azurerm.spring_cloud_gateway.withInstanceCount` constructs a mixin object that can be merged into the `spring_cloud_gateway`
...
`azurerm.spring_cloud_gateway.withName` constructs a mixin object that can be merged into the `spring_cloud_gateway`
...
`azurerm.spring_cloud_gateway.withPublicNetworkAccessEnabled` constructs a mixin object that can be merged into the `spring_cloud_gateway`
...
`azurerm.spring_cloud_gateway.withQuota` constructs a mixin object that can be merged into the `spring_cloud_gateway`
...
`azurerm.spring_cloud_gateway.withQuotaMixin` constructs a mixin object that can be merged into the `spring_cloud_gateway`
Terraform resource block to set or update the quota field.
...
`azurerm.spring_cloud_gateway.withSpringCloudServiceId` constructs a mixin object that can be merged into the `spring_cloud_gateway`
...
`azurerm.spring_cloud_gateway.withSso` constructs a mixin object that can be merged into the `spring_cloud_gateway`
...
`azurerm.spring_cloud_gateway.withSsoMixin` constructs a mixin object that can be merged into the `spring_cloud_gateway`
Terraform resource block to set or update the sso field.
...
`azurerm.spring_cloud_gateway.withTimeouts` constructs a mixin object that can be merged into the `spring_cloud_gateway`
...
`azurerm.spring_cloud_gateway.withTimeoutsMixin` constructs a mixin object that can be merged into the `spring_cloud_gateway`
Terraform resource block to set or update the timeouts field.
