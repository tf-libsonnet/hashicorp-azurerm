...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.logic_app_integration_account_session.timeouts.new](#fn-logic_app_integration_account_sessiontimeoutsnew) constructor.
...
Unlike [azurerm.logic_app_integration_account_session.new](#fn-logic_app_integration_account_sessionnew), this function will not inject the `resource`
