---
permalink: /logic_app_integration_account_session/
---

# logic_app_integration_account_session

`logic_app_integration_account_session` represents the `azurerm_logic_app_integration_account_session` Terraform resource.
...
`azurerm.logic_app_integration_account_session.withContent` constructs a mixin object that can be merged into the `logic_app_integration_account_session`
...
`azurerm.logic_app_integration_account_session.withIntegrationAccountName` constructs a mixin object that can be merged into the `logic_app_integration_account_session`
...
`azurerm.logic_app_integration_account_session.withName` constructs a mixin object that can be merged into the `logic_app_integration_account_session`
...
`azurerm.logic_app_integration_account_session.withResourceGroupName` constructs a mixin object that can be merged into the `logic_app_integration_account_session`
...
`azurerm.logic_app_integration_account_session.withTimeouts` constructs a mixin object that can be merged into the `logic_app_integration_account_session`
...
`azurerm.logic_app_integration_account_session.withTimeoutsMixin` constructs a mixin object that can be merged into the `logic_app_integration_account_session`
Terraform resource block to set or update the timeouts field.
