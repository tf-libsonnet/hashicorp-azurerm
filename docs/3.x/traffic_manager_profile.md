...
`azurerm.traffic_manager_profile.withDnsConfig` constructs a mixin object that can be merged into the `traffic_manager_profile`
...
`azurerm.traffic_manager_profile.withDnsConfigMixin` constructs a mixin object that can be merged into the `traffic_manager_profile`
Terraform resource block to set or update the dns_config field.
...
`azurerm.traffic_manager_profile.withMaxReturn` constructs a mixin object that can be merged into the `traffic_manager_profile`
...
`azurerm.traffic_manager_profile.withMonitorConfig` constructs a mixin object that can be merged into the `traffic_manager_profile`
...
`azurerm.traffic_manager_profile.withMonitorConfigMixin` constructs a mixin object that can be merged into the `traffic_manager_profile`
Terraform resource block to set or update the monitor_config field.
...
`azurerm.traffic_manager_profile.withName` constructs a mixin object that can be merged into the `traffic_manager_profile`
...
`azurerm.traffic_manager_profile.withProfileStatus` constructs a mixin object that can be merged into the `traffic_manager_profile`
...
`azurerm.traffic_manager_profile.withResourceGroupName` constructs a mixin object that can be merged into the `traffic_manager_profile`
...
`azurerm.traffic_manager_profile.withTags` constructs a mixin object that can be merged into the `traffic_manager_profile`
...
`azurerm.traffic_manager_profile.withTimeouts` constructs a mixin object that can be merged into the `traffic_manager_profile`
...
`azurerm.traffic_manager_profile.withTimeoutsMixin` constructs a mixin object that can be merged into the `traffic_manager_profile`
Terraform resource block to set or update the timeouts field.
...
`azurerm.traffic_manager_profile.withTrafficRoutingMethod` constructs a mixin object that can be merged into the `traffic_manager_profile`
...
`azurerm.traffic_manager_profile.withTrafficViewEnabled` constructs a mixin object that can be merged into the `traffic_manager_profile`
