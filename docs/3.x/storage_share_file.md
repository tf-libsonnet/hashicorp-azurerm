...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.storage_share_file.timeouts.new](#fn-storage_share_filetimeoutsnew) constructor.
...
Unlike [azurerm.storage_share_file.new](#fn-storage_share_filenew), this function will not inject the `resource`
