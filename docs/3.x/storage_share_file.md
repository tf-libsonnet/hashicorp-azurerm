...
`azurerm.storage_share_file.withContentDisposition` constructs a mixin object that can be merged into the `storage_share_file`
...
`azurerm.storage_share_file.withContentEncoding` constructs a mixin object that can be merged into the `storage_share_file`
...
`azurerm.storage_share_file.withContentMd5` constructs a mixin object that can be merged into the `storage_share_file`
...
`azurerm.storage_share_file.withContentType` constructs a mixin object that can be merged into the `storage_share_file`
...
`azurerm.storage_share_file.withMetadata` constructs a mixin object that can be merged into the `storage_share_file`
...
`azurerm.storage_share_file.withName` constructs a mixin object that can be merged into the `storage_share_file`
...
`azurerm.storage_share_file.withPath` constructs a mixin object that can be merged into the `storage_share_file`
...
`azurerm.storage_share_file.withSource` constructs a mixin object that can be merged into the `storage_share_file`
...
`azurerm.storage_share_file.withStorageShareId` constructs a mixin object that can be merged into the `storage_share_file`
...
`azurerm.storage_share_file.withTimeouts` constructs a mixin object that can be merged into the `storage_share_file`
...
`azurerm.storage_share_file.withTimeoutsMixin` constructs a mixin object that can be merged into the `storage_share_file`
Terraform resource block to set or update the timeouts field.
