...
`azurerm.spring_cloud_app.withAddonJson` constructs a mixin object that can be merged into the `spring_cloud_app`
...
`azurerm.spring_cloud_app.withCustomPersistentDisk` constructs a mixin object that can be merged into the `spring_cloud_app`
...
`azurerm.spring_cloud_app.withCustomPersistentDiskMixin` constructs a mixin object that can be merged into the `spring_cloud_app`
Terraform resource block to set or update the custom_persistent_disk field.
...
`azurerm.spring_cloud_app.withHttpsOnly` constructs a mixin object that can be merged into the `spring_cloud_app`
...
`azurerm.spring_cloud_app.withIdentity` constructs a mixin object that can be merged into the `spring_cloud_app`
...
`azurerm.spring_cloud_app.withIdentityMixin` constructs a mixin object that can be merged into the `spring_cloud_app`
Terraform resource block to set or update the identity field.
...
`azurerm.spring_cloud_app.withIngressSettings` constructs a mixin object that can be merged into the `spring_cloud_app`
...
`azurerm.spring_cloud_app.withIngressSettingsMixin` constructs a mixin object that can be merged into the `spring_cloud_app`
Terraform resource block to set or update the ingress_settings field.
...
`azurerm.spring_cloud_app.withIsPublic` constructs a mixin object that can be merged into the `spring_cloud_app`
...
`azurerm.spring_cloud_app.withName` constructs a mixin object that can be merged into the `spring_cloud_app`
...
`azurerm.spring_cloud_app.withPersistentDisk` constructs a mixin object that can be merged into the `spring_cloud_app`
...
`azurerm.spring_cloud_app.withPersistentDiskMixin` constructs a mixin object that can be merged into the `spring_cloud_app`
Terraform resource block to set or update the persistent_disk field.
...
`azurerm.spring_cloud_app.withPublicEndpointEnabled` constructs a mixin object that can be merged into the `spring_cloud_app`
...
`azurerm.spring_cloud_app.withResourceGroupName` constructs a mixin object that can be merged into the `spring_cloud_app`
...
`azurerm.spring_cloud_app.withServiceName` constructs a mixin object that can be merged into the `spring_cloud_app`
...
`azurerm.spring_cloud_app.withTimeouts` constructs a mixin object that can be merged into the `spring_cloud_app`
...
`azurerm.spring_cloud_app.withTimeoutsMixin` constructs a mixin object that can be merged into the `spring_cloud_app`
Terraform resource block to set or update the timeouts field.
...
`azurerm.spring_cloud_app.withTlsEnabled` constructs a mixin object that can be merged into the `spring_cloud_app`
