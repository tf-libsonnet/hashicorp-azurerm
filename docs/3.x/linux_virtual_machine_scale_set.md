...
`azurerm.linux_virtual_machine_scale_set.withAdditionalCapabilities` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withAdditionalCapabilitiesMixin` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
Terraform resource block to set or update the additional_capabilities field.
...
`azurerm.linux_virtual_machine_scale_set.withAdminPassword` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withAdminSshKey` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withAdminSshKeyMixin` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
Terraform resource block to set or update the admin_ssh_key field.
...
`azurerm.linux_virtual_machine_scale_set.withAdminUsername` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withAutomaticInstanceRepair` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withAutomaticInstanceRepairMixin` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
Terraform resource block to set or update the automatic_instance_repair field.
...
`azurerm.linux_virtual_machine_scale_set.withAutomaticOsUpgradePolicy` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withAutomaticOsUpgradePolicyMixin` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
Terraform resource block to set or update the automatic_os_upgrade_policy field.
...
`azurerm.linux_virtual_machine_scale_set.withBootDiagnostics` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withBootDiagnosticsMixin` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
Terraform resource block to set or update the boot_diagnostics field.
...
`azurerm.linux_virtual_machine_scale_set.withCapacityReservationGroupId` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withComputerNamePrefix` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withCustomData` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withDataDisk` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withDataDiskMixin` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
Terraform resource block to set or update the data_disk field.
...
`azurerm.linux_virtual_machine_scale_set.withDisablePasswordAuthentication` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withDoNotRunExtensionsOnOverprovisionedMachines` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withEdgeZone` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withEncryptionAtHostEnabled` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withEvictionPolicy` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withExtension` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withExtensionMixin` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
Terraform resource block to set or update the extension field.
...
`azurerm.linux_virtual_machine_scale_set.withExtensionOperationsEnabled` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withExtensionsTimeBudget` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withGalleryApplication` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withGalleryApplicationMixin` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
Terraform resource block to set or update the gallery_application field.
...
`azurerm.linux_virtual_machine_scale_set.withGalleryApplications` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withGalleryApplicationsMixin` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
Terraform resource block to set or update the gallery_applications field.
...
`azurerm.linux_virtual_machine_scale_set.withHealthProbeId` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withHostGroupId` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withIdentity` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withIdentityMixin` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
Terraform resource block to set or update the identity field.
...
`azurerm.linux_virtual_machine_scale_set.withInstances` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withLocation` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withMaxBidPrice` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withName` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withNetworkInterface` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withNetworkInterfaceMixin` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
Terraform resource block to set or update the network_interface field.
...
`azurerm.linux_virtual_machine_scale_set.withOsDisk` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withOsDiskMixin` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
Terraform resource block to set or update the os_disk field.
...
`azurerm.linux_virtual_machine_scale_set.withOverprovision` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withPlan` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withPlanMixin` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
Terraform resource block to set or update the plan field.
...
`azurerm.linux_virtual_machine_scale_set.withPlatformFaultDomainCount` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withPriority` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withProvisionVmAgent` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withProximityPlacementGroupId` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withResourceGroupName` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withRollingUpgradePolicy` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withRollingUpgradePolicyMixin` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
Terraform resource block to set or update the rolling_upgrade_policy field.
...
`azurerm.linux_virtual_machine_scale_set.withScaleIn` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withScaleInMixin` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
Terraform resource block to set or update the scale_in field.
...
`azurerm.linux_virtual_machine_scale_set.withScaleInPolicy` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withSecret` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withSecretMixin` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
Terraform resource block to set or update the secret field.
...
`azurerm.linux_virtual_machine_scale_set.withSecureBootEnabled` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withSinglePlacementGroup` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withSku` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withSourceImageId` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withSourceImageReference` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withSourceImageReferenceMixin` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
Terraform resource block to set or update the source_image_reference field.
...
`azurerm.linux_virtual_machine_scale_set.withSpotRestore` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withSpotRestoreMixin` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
Terraform resource block to set or update the spot_restore field.
...
`azurerm.linux_virtual_machine_scale_set.withTags` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withTerminateNotification` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withTerminateNotificationMixin` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
Terraform resource block to set or update the terminate_notification field.
...
`azurerm.linux_virtual_machine_scale_set.withTerminationNotification` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withTerminationNotificationMixin` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
Terraform resource block to set or update the termination_notification field.
...
`azurerm.linux_virtual_machine_scale_set.withTimeouts` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withTimeoutsMixin` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
Terraform resource block to set or update the timeouts field.
...
`azurerm.linux_virtual_machine_scale_set.withUpgradeMode` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withUserData` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withVtpmEnabled` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withZoneBalance` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
...
`azurerm.linux_virtual_machine_scale_set.withZones` constructs a mixin object that can be merged into the `linux_virtual_machine_scale_set`
