...
`azurerm.lb_probe.withIntervalInSeconds` constructs a mixin object that can be merged into the `lb_probe`
...
`azurerm.lb_probe.withLoadbalancerId` constructs a mixin object that can be merged into the `lb_probe`
...
`azurerm.lb_probe.withName` constructs a mixin object that can be merged into the `lb_probe`
...
`azurerm.lb_probe.withNumberOfProbes` constructs a mixin object that can be merged into the `lb_probe`
...
`azurerm.lb_probe.withPort` constructs a mixin object that can be merged into the `lb_probe`
...
`azurerm.lb_probe.withProbeThreshold` constructs a mixin object that can be merged into the `lb_probe`
...
`azurerm.lb_probe.withProtocol` constructs a mixin object that can be merged into the `lb_probe`
...
`azurerm.lb_probe.withRequestPath` constructs a mixin object that can be merged into the `lb_probe`
...
`azurerm.lb_probe.withTimeouts` constructs a mixin object that can be merged into the `lb_probe`
...
`azurerm.lb_probe.withTimeoutsMixin` constructs a mixin object that can be merged into the `lb_probe`
Terraform resource block to set or update the timeouts field.
