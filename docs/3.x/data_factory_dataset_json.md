...
`azurerm.data_factory_dataset_json.withAdditionalProperties` constructs a mixin object that can be merged into the `data_factory_dataset_json`
...
`azurerm.data_factory_dataset_json.withAnnotations` constructs a mixin object that can be merged into the `data_factory_dataset_json`
...
`azurerm.data_factory_dataset_json.withAzureBlobStorageLocation` constructs a mixin object that can be merged into the `data_factory_dataset_json`
...
`azurerm.data_factory_dataset_json.withAzureBlobStorageLocationMixin` constructs a mixin object that can be merged into the `data_factory_dataset_json`
Terraform resource block to set or update the azure_blob_storage_location field.
...
`azurerm.data_factory_dataset_json.withDataFactoryId` constructs a mixin object that can be merged into the `data_factory_dataset_json`
...
`azurerm.data_factory_dataset_json.withDescription` constructs a mixin object that can be merged into the `data_factory_dataset_json`
...
`azurerm.data_factory_dataset_json.withEncoding` constructs a mixin object that can be merged into the `data_factory_dataset_json`
...
`azurerm.data_factory_dataset_json.withFolder` constructs a mixin object that can be merged into the `data_factory_dataset_json`
...
`azurerm.data_factory_dataset_json.withHttpServerLocation` constructs a mixin object that can be merged into the `data_factory_dataset_json`
...
`azurerm.data_factory_dataset_json.withHttpServerLocationMixin` constructs a mixin object that can be merged into the `data_factory_dataset_json`
Terraform resource block to set or update the http_server_location field.
...
`azurerm.data_factory_dataset_json.withLinkedServiceName` constructs a mixin object that can be merged into the `data_factory_dataset_json`
...
`azurerm.data_factory_dataset_json.withName` constructs a mixin object that can be merged into the `data_factory_dataset_json`
...
`azurerm.data_factory_dataset_json.withParameters` constructs a mixin object that can be merged into the `data_factory_dataset_json`
...
`azurerm.data_factory_dataset_json.withSchemaColumn` constructs a mixin object that can be merged into the `data_factory_dataset_json`
...
`azurerm.data_factory_dataset_json.withSchemaColumnMixin` constructs a mixin object that can be merged into the `data_factory_dataset_json`
Terraform resource block to set or update the schema_column field.
...
`azurerm.data_factory_dataset_json.withTimeouts` constructs a mixin object that can be merged into the `data_factory_dataset_json`
...
`azurerm.data_factory_dataset_json.withTimeoutsMixin` constructs a mixin object that can be merged into the `data_factory_dataset_json`
Terraform resource block to set or update the timeouts field.
