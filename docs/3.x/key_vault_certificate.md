...
`azurerm.key_vault_certificate.withCertificate` constructs a mixin object that can be merged into the `key_vault_certificate`
...
`azurerm.key_vault_certificate.withCertificateMixin` constructs a mixin object that can be merged into the `key_vault_certificate`
Terraform resource block to set or update the certificate field.
...
`azurerm.key_vault_certificate.withCertificatePolicy` constructs a mixin object that can be merged into the `key_vault_certificate`
...
`azurerm.key_vault_certificate.withCertificatePolicyMixin` constructs a mixin object that can be merged into the `key_vault_certificate`
Terraform resource block to set or update the certificate_policy field.
...
`azurerm.key_vault_certificate.withKeyVaultId` constructs a mixin object that can be merged into the `key_vault_certificate`
...
`azurerm.key_vault_certificate.withName` constructs a mixin object that can be merged into the `key_vault_certificate`
...
`azurerm.key_vault_certificate.withTags` constructs a mixin object that can be merged into the `key_vault_certificate`
...
`azurerm.key_vault_certificate.withTimeouts` constructs a mixin object that can be merged into the `key_vault_certificate`
...
`azurerm.key_vault_certificate.withTimeoutsMixin` constructs a mixin object that can be merged into the `key_vault_certificate`
Terraform resource block to set or update the timeouts field.
