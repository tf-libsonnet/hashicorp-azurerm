...
`azurerm.hdinsight_hadoop_cluster.withClusterVersion` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`
...
`azurerm.hdinsight_hadoop_cluster.withComponentVersion` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`
...
`azurerm.hdinsight_hadoop_cluster.withComponentVersionMixin` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`
Terraform resource block to set or update the component_version field.
...
`azurerm.hdinsight_hadoop_cluster.withComputeIsolation` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`
...
`azurerm.hdinsight_hadoop_cluster.withComputeIsolationMixin` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`
Terraform resource block to set or update the compute_isolation field.
...
`azurerm.hdinsight_hadoop_cluster.withDiskEncryption` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`
...
`azurerm.hdinsight_hadoop_cluster.withDiskEncryptionMixin` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`
Terraform resource block to set or update the disk_encryption field.
...
`azurerm.hdinsight_hadoop_cluster.withExtension` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`
...
`azurerm.hdinsight_hadoop_cluster.withExtensionMixin` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`
Terraform resource block to set or update the extension field.
...
`azurerm.hdinsight_hadoop_cluster.withGateway` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`
...
`azurerm.hdinsight_hadoop_cluster.withGatewayMixin` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`
Terraform resource block to set or update the gateway field.
...
`azurerm.hdinsight_hadoop_cluster.withLocation` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`
...
`azurerm.hdinsight_hadoop_cluster.withMetastores` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`
...
`azurerm.hdinsight_hadoop_cluster.withMetastoresMixin` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`
Terraform resource block to set or update the metastores field.
...
`azurerm.hdinsight_hadoop_cluster.withMonitor` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`
...
`azurerm.hdinsight_hadoop_cluster.withMonitorMixin` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`
Terraform resource block to set or update the monitor field.
...
`azurerm.hdinsight_hadoop_cluster.withName` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`
...
`azurerm.hdinsight_hadoop_cluster.withNetwork` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`
...
`azurerm.hdinsight_hadoop_cluster.withNetworkMixin` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`
Terraform resource block to set or update the network field.
...
`azurerm.hdinsight_hadoop_cluster.withResourceGroupName` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`
...
`azurerm.hdinsight_hadoop_cluster.withRoles` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`
...
`azurerm.hdinsight_hadoop_cluster.withRolesMixin` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`
Terraform resource block to set or update the roles field.
...
`azurerm.hdinsight_hadoop_cluster.withSecurityProfile` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`
...
`azurerm.hdinsight_hadoop_cluster.withSecurityProfileMixin` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`
Terraform resource block to set or update the security_profile field.
...
`azurerm.hdinsight_hadoop_cluster.withStorageAccount` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`
...
`azurerm.hdinsight_hadoop_cluster.withStorageAccountGen2` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`
...
`azurerm.hdinsight_hadoop_cluster.withStorageAccountGen2Mixin` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`
Terraform resource block to set or update the storage_account_gen2 field.
...
`azurerm.hdinsight_hadoop_cluster.withStorageAccountMixin` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`
Terraform resource block to set or update the storage_account field.
...
`azurerm.hdinsight_hadoop_cluster.withTags` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`
...
`azurerm.hdinsight_hadoop_cluster.withTier` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`
...
`azurerm.hdinsight_hadoop_cluster.withTimeouts` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`
...
`azurerm.hdinsight_hadoop_cluster.withTimeoutsMixin` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`
Terraform resource block to set or update the timeouts field.
...
`azurerm.hdinsight_hadoop_cluster.withTlsMinVersion` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`
