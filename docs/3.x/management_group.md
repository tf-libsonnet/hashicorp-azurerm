...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.management_group.timeouts.new](#fn-management_grouptimeoutsnew) constructor.
...
Unlike [azurerm.management_group.new](#fn-management_groupnew), this function will not inject the `resource`
