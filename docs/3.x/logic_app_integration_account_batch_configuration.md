...
`azurerm.logic_app_integration_account_batch_configuration.withBatchGroupName` constructs a mixin object that can be merged into the `logic_app_integration_account_batch_configuration`
...
`azurerm.logic_app_integration_account_batch_configuration.withIntegrationAccountName` constructs a mixin object that can be merged into the `logic_app_integration_account_batch_configuration`
...
`azurerm.logic_app_integration_account_batch_configuration.withMetadata` constructs a mixin object that can be merged into the `logic_app_integration_account_batch_configuration`
...
`azurerm.logic_app_integration_account_batch_configuration.withName` constructs a mixin object that can be merged into the `logic_app_integration_account_batch_configuration`
...
`azurerm.logic_app_integration_account_batch_configuration.withReleaseCriteria` constructs a mixin object that can be merged into the `logic_app_integration_account_batch_configuration`
...
`azurerm.logic_app_integration_account_batch_configuration.withReleaseCriteriaMixin` constructs a mixin object that can be merged into the `logic_app_integration_account_batch_configuration`
Terraform resource block to set or update the release_criteria field.
...
`azurerm.logic_app_integration_account_batch_configuration.withResourceGroupName` constructs a mixin object that can be merged into the `logic_app_integration_account_batch_configuration`
...
`azurerm.logic_app_integration_account_batch_configuration.withTimeouts` constructs a mixin object that can be merged into the `logic_app_integration_account_batch_configuration`
...
`azurerm.logic_app_integration_account_batch_configuration.withTimeoutsMixin` constructs a mixin object that can be merged into the `logic_app_integration_account_batch_configuration`
Terraform resource block to set or update the timeouts field.
