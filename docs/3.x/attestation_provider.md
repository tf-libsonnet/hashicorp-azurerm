...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.attestation_provider.timeouts.new](#fn-attestation_providertimeoutsnew) constructor.
...
Unlike [azurerm.attestation_provider.new](#fn-attestation_providernew), this function will not inject the `resource`
