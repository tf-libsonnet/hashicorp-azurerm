...
`azurerm.frontdoor.withBackendPool` constructs a mixin object that can be merged into the `frontdoor`
...
`azurerm.frontdoor.withBackendPoolHealthProbe` constructs a mixin object that can be merged into the `frontdoor`
...
`azurerm.frontdoor.withBackendPoolHealthProbeMixin` constructs a mixin object that can be merged into the `frontdoor`
Terraform resource block to set or update the backend_pool_health_probe field.
...
`azurerm.frontdoor.withBackendPoolLoadBalancing` constructs a mixin object that can be merged into the `frontdoor`
...
`azurerm.frontdoor.withBackendPoolLoadBalancingMixin` constructs a mixin object that can be merged into the `frontdoor`
Terraform resource block to set or update the backend_pool_load_balancing field.
...
`azurerm.frontdoor.withBackendPoolMixin` constructs a mixin object that can be merged into the `frontdoor`
Terraform resource block to set or update the backend_pool field.
...
`azurerm.frontdoor.withBackendPoolSettings` constructs a mixin object that can be merged into the `frontdoor`
...
`azurerm.frontdoor.withBackendPoolSettingsMixin` constructs a mixin object that can be merged into the `frontdoor`
Terraform resource block to set or update the backend_pool_settings field.
...
`azurerm.frontdoor.withFriendlyName` constructs a mixin object that can be merged into the `frontdoor`
...
`azurerm.frontdoor.withFrontendEndpoint` constructs a mixin object that can be merged into the `frontdoor`
...
`azurerm.frontdoor.withFrontendEndpointMixin` constructs a mixin object that can be merged into the `frontdoor`
Terraform resource block to set or update the frontend_endpoint field.
...
`azurerm.frontdoor.withLoadBalancerEnabled` constructs a mixin object that can be merged into the `frontdoor`
...
`azurerm.frontdoor.withName` constructs a mixin object that can be merged into the `frontdoor`
...
`azurerm.frontdoor.withResourceGroupName` constructs a mixin object that can be merged into the `frontdoor`
...
`azurerm.frontdoor.withRoutingRule` constructs a mixin object that can be merged into the `frontdoor`
...
`azurerm.frontdoor.withRoutingRuleMixin` constructs a mixin object that can be merged into the `frontdoor`
Terraform resource block to set or update the routing_rule field.
...
`azurerm.frontdoor.withTags` constructs a mixin object that can be merged into the `frontdoor`
...
`azurerm.frontdoor.withTimeouts` constructs a mixin object that can be merged into the `frontdoor`
...
`azurerm.frontdoor.withTimeoutsMixin` constructs a mixin object that can be merged into the `frontdoor`
Terraform resource block to set or update the timeouts field.
