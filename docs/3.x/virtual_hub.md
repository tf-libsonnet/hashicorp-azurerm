...
`azurerm.virtual_hub.withAddressPrefix` constructs a mixin object that can be merged into the `virtual_hub`
...
`azurerm.virtual_hub.withLocation` constructs a mixin object that can be merged into the `virtual_hub`
...
`azurerm.virtual_hub.withRoute` constructs a mixin object that can be merged into the `virtual_hub`
...
`azurerm.virtual_hub.withRouteMixin` constructs a mixin object that can be merged into the `virtual_hub`
Terraform resource block to set or update the route field.
...
`azurerm.virtual_hub.withSku` constructs a mixin object that can be merged into the `virtual_hub`
...
`azurerm.virtual_hub.withTags` constructs a mixin object that can be merged into the `virtual_hub`
...
`azurerm.virtual_hub.withVirtualWanId` constructs a mixin object that can be merged into the `virtual_hub`
