...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.backup_container_storage_account.timeouts.new](#fn-backup_container_storage_accounttimeoutsnew) constructor.
...
Unlike [azurerm.backup_container_storage_account.new](#fn-backup_container_storage_accountnew), this function will not inject the `resource`
