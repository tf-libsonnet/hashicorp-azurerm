---
permalink: /private_dns_resolver/
---

# private_dns_resolver

`private_dns_resolver` represents the `azurerm_private_dns_resolver` Terraform resource.
...
`azurerm.private_dns_resolver.withLocation` constructs a mixin object that can be merged into the `private_dns_resolver`
...
`azurerm.private_dns_resolver.withName` constructs a mixin object that can be merged into the `private_dns_resolver`
...
`azurerm.private_dns_resolver.withResourceGroupName` constructs a mixin object that can be merged into the `private_dns_resolver`
...
`azurerm.private_dns_resolver.withTags` constructs a mixin object that can be merged into the `private_dns_resolver`
...
`azurerm.private_dns_resolver.withTimeouts` constructs a mixin object that can be merged into the `private_dns_resolver`
...
`azurerm.private_dns_resolver.withTimeoutsMixin` constructs a mixin object that can be merged into the `private_dns_resolver`
Terraform resource block to set or update the timeouts field.
...
`azurerm.private_dns_resolver.withVirtualNetworkId` constructs a mixin object that can be merged into the `private_dns_resolver`
