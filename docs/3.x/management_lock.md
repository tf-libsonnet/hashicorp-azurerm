...
`azurerm.management_lock.withLockLevel` constructs a mixin object that can be merged into the `management_lock`
...
`azurerm.management_lock.withName` constructs a mixin object that can be merged into the `management_lock`
...
`azurerm.management_lock.withNotes` constructs a mixin object that can be merged into the `management_lock`
...
`azurerm.management_lock.withScope` constructs a mixin object that can be merged into the `management_lock`
...
`azurerm.management_lock.withTimeouts` constructs a mixin object that can be merged into the `management_lock`
...
`azurerm.management_lock.withTimeoutsMixin` constructs a mixin object that can be merged into the `management_lock`
Terraform resource block to set or update the timeouts field.
