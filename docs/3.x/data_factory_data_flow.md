...
`azurerm.data_factory_data_flow.withAnnotations` constructs a mixin object that can be merged into the `data_factory_data_flow`
...
`azurerm.data_factory_data_flow.withDataFactoryId` constructs a mixin object that can be merged into the `data_factory_data_flow`
...
`azurerm.data_factory_data_flow.withDescription` constructs a mixin object that can be merged into the `data_factory_data_flow`
...
`azurerm.data_factory_data_flow.withFolder` constructs a mixin object that can be merged into the `data_factory_data_flow`
...
`azurerm.data_factory_data_flow.withName` constructs a mixin object that can be merged into the `data_factory_data_flow`
...
`azurerm.data_factory_data_flow.withScript` constructs a mixin object that can be merged into the `data_factory_data_flow`
...
`azurerm.data_factory_data_flow.withScriptLines` constructs a mixin object that can be merged into the `data_factory_data_flow`
...
`azurerm.data_factory_data_flow.withSink` constructs a mixin object that can be merged into the `data_factory_data_flow`
...
`azurerm.data_factory_data_flow.withSinkMixin` constructs a mixin object that can be merged into the `data_factory_data_flow`
Terraform resource block to set or update the sink field.
...
`azurerm.data_factory_data_flow.withSource` constructs a mixin object that can be merged into the `data_factory_data_flow`
...
`azurerm.data_factory_data_flow.withSourceMixin` constructs a mixin object that can be merged into the `data_factory_data_flow`
Terraform resource block to set or update the source field.
...
`azurerm.data_factory_data_flow.withTimeouts` constructs a mixin object that can be merged into the `data_factory_data_flow`
...
`azurerm.data_factory_data_flow.withTimeoutsMixin` constructs a mixin object that can be merged into the `data_factory_data_flow`
Terraform resource block to set or update the timeouts field.
...
`azurerm.data_factory_data_flow.withTransformation` constructs a mixin object that can be merged into the `data_factory_data_flow`
...
`azurerm.data_factory_data_flow.withTransformationMixin` constructs a mixin object that can be merged into the `data_factory_data_flow`
Terraform resource block to set or update the transformation field.
