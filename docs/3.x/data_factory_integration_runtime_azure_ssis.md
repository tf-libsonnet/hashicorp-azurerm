...
Unlike [azurerm.data_factory_integration_runtime_azure_ssis.new](#fn-data_factory_integration_runtime_azure_ssisnew), this function will not inject the `resource`
