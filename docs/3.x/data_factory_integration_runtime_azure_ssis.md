...
`azurerm.data_factory_integration_runtime_azure_ssis.withCatalogInfo` constructs a mixin object that can be merged into the `data_factory_integration_runtime_azure_ssis`
...
`azurerm.data_factory_integration_runtime_azure_ssis.withCatalogInfoMixin` constructs a mixin object that can be merged into the `data_factory_integration_runtime_azure_ssis`
Terraform resource block to set or update the catalog_info field.
...
`azurerm.data_factory_integration_runtime_azure_ssis.withCustomSetupScript` constructs a mixin object that can be merged into the `data_factory_integration_runtime_azure_ssis`
...
`azurerm.data_factory_integration_runtime_azure_ssis.withCustomSetupScriptMixin` constructs a mixin object that can be merged into the `data_factory_integration_runtime_azure_ssis`
Terraform resource block to set or update the custom_setup_script field.
...
`azurerm.data_factory_integration_runtime_azure_ssis.withDataFactoryId` constructs a mixin object that can be merged into the `data_factory_integration_runtime_azure_ssis`
...
`azurerm.data_factory_integration_runtime_azure_ssis.withDescription` constructs a mixin object that can be merged into the `data_factory_integration_runtime_azure_ssis`
...
`azurerm.data_factory_integration_runtime_azure_ssis.withEdition` constructs a mixin object that can be merged into the `data_factory_integration_runtime_azure_ssis`
...
`azurerm.data_factory_integration_runtime_azure_ssis.withExpressCustomSetup` constructs a mixin object that can be merged into the `data_factory_integration_runtime_azure_ssis`
...
`azurerm.data_factory_integration_runtime_azure_ssis.withExpressCustomSetupMixin` constructs a mixin object that can be merged into the `data_factory_integration_runtime_azure_ssis`
Terraform resource block to set or update the express_custom_setup field.
...
`azurerm.data_factory_integration_runtime_azure_ssis.withExpressVnetIntegration` constructs a mixin object that can be merged into the `data_factory_integration_runtime_azure_ssis`
...
`azurerm.data_factory_integration_runtime_azure_ssis.withExpressVnetIntegrationMixin` constructs a mixin object that can be merged into the `data_factory_integration_runtime_azure_ssis`
Terraform resource block to set or update the express_vnet_integration field.
...
`azurerm.data_factory_integration_runtime_azure_ssis.withLicenseType` constructs a mixin object that can be merged into the `data_factory_integration_runtime_azure_ssis`
...
`azurerm.data_factory_integration_runtime_azure_ssis.withLocation` constructs a mixin object that can be merged into the `data_factory_integration_runtime_azure_ssis`
...
`azurerm.data_factory_integration_runtime_azure_ssis.withMaxParallelExecutionsPerNode` constructs a mixin object that can be merged into the `data_factory_integration_runtime_azure_ssis`
...
`azurerm.data_factory_integration_runtime_azure_ssis.withName` constructs a mixin object that can be merged into the `data_factory_integration_runtime_azure_ssis`
...
`azurerm.data_factory_integration_runtime_azure_ssis.withNodeSize` constructs a mixin object that can be merged into the `data_factory_integration_runtime_azure_ssis`
...
`azurerm.data_factory_integration_runtime_azure_ssis.withNumberOfNodes` constructs a mixin object that can be merged into the `data_factory_integration_runtime_azure_ssis`
...
`azurerm.data_factory_integration_runtime_azure_ssis.withPackageStore` constructs a mixin object that can be merged into the `data_factory_integration_runtime_azure_ssis`
...
`azurerm.data_factory_integration_runtime_azure_ssis.withPackageStoreMixin` constructs a mixin object that can be merged into the `data_factory_integration_runtime_azure_ssis`
Terraform resource block to set or update the package_store field.
...
`azurerm.data_factory_integration_runtime_azure_ssis.withProxy` constructs a mixin object that can be merged into the `data_factory_integration_runtime_azure_ssis`
...
`azurerm.data_factory_integration_runtime_azure_ssis.withProxyMixin` constructs a mixin object that can be merged into the `data_factory_integration_runtime_azure_ssis`
Terraform resource block to set or update the proxy field.
...
`azurerm.data_factory_integration_runtime_azure_ssis.withTimeouts` constructs a mixin object that can be merged into the `data_factory_integration_runtime_azure_ssis`
...
`azurerm.data_factory_integration_runtime_azure_ssis.withTimeoutsMixin` constructs a mixin object that can be merged into the `data_factory_integration_runtime_azure_ssis`
Terraform resource block to set or update the timeouts field.
...
`azurerm.data_factory_integration_runtime_azure_ssis.withVnetIntegration` constructs a mixin object that can be merged into the `data_factory_integration_runtime_azure_ssis`
...
`azurerm.data_factory_integration_runtime_azure_ssis.withVnetIntegrationMixin` constructs a mixin object that can be merged into the `data_factory_integration_runtime_azure_ssis`
Terraform resource block to set or update the vnet_integration field.
