...
`azurerm.healthcare_medtech_service_fhir_destination.withDestinationFhirMappingJson` constructs a mixin object that can be merged into the `healthcare_medtech_service_fhir_destination`
...
`azurerm.healthcare_medtech_service_fhir_destination.withDestinationFhirServiceId` constructs a mixin object that can be merged into the `healthcare_medtech_service_fhir_destination`
...
`azurerm.healthcare_medtech_service_fhir_destination.withDestinationIdentityResolutionType` constructs a mixin object that can be merged into the `healthcare_medtech_service_fhir_destination`
...
`azurerm.healthcare_medtech_service_fhir_destination.withLocation` constructs a mixin object that can be merged into the `healthcare_medtech_service_fhir_destination`
...
`azurerm.healthcare_medtech_service_fhir_destination.withMedtechServiceId` constructs a mixin object that can be merged into the `healthcare_medtech_service_fhir_destination`
...
`azurerm.healthcare_medtech_service_fhir_destination.withName` constructs a mixin object that can be merged into the `healthcare_medtech_service_fhir_destination`
...
`azurerm.healthcare_medtech_service_fhir_destination.withTimeouts` constructs a mixin object that can be merged into the `healthcare_medtech_service_fhir_destination`
...
`azurerm.healthcare_medtech_service_fhir_destination.withTimeoutsMixin` constructs a mixin object that can be merged into the `healthcare_medtech_service_fhir_destination`
Terraform resource block to set or update the timeouts field.
