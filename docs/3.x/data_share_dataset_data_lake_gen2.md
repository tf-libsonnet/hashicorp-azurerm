...
`azurerm.data_share_dataset_data_lake_gen2.withFilePath` constructs a mixin object that can be merged into the `data_share_dataset_data_lake_gen2`
...
`azurerm.data_share_dataset_data_lake_gen2.withFileSystemName` constructs a mixin object that can be merged into the `data_share_dataset_data_lake_gen2`
...
`azurerm.data_share_dataset_data_lake_gen2.withFolderPath` constructs a mixin object that can be merged into the `data_share_dataset_data_lake_gen2`
...
`azurerm.data_share_dataset_data_lake_gen2.withStorageAccountId` constructs a mixin object that can be merged into the `data_share_dataset_data_lake_gen2`
