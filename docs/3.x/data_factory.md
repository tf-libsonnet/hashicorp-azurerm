...
`azurerm.data_factory.withCustomerManagedKeyId` constructs a mixin object that can be merged into the `data_factory`
...
`azurerm.data_factory.withCustomerManagedKeyIdentityId` constructs a mixin object that can be merged into the `data_factory`
...
`azurerm.data_factory.withGithubConfiguration` constructs a mixin object that can be merged into the `data_factory`
...
`azurerm.data_factory.withGithubConfigurationMixin` constructs a mixin object that can be merged into the `data_factory`
Terraform resource block to set or update the github_configuration field.
...
`azurerm.data_factory.withGlobalParameter` constructs a mixin object that can be merged into the `data_factory`
...
`azurerm.data_factory.withGlobalParameterMixin` constructs a mixin object that can be merged into the `data_factory`
Terraform resource block to set or update the global_parameter field.
...
`azurerm.data_factory.withIdentity` constructs a mixin object that can be merged into the `data_factory`
...
`azurerm.data_factory.withIdentityMixin` constructs a mixin object that can be merged into the `data_factory`
Terraform resource block to set or update the identity field.
...
`azurerm.data_factory.withLocation` constructs a mixin object that can be merged into the `data_factory`
...
`azurerm.data_factory.withManagedVirtualNetworkEnabled` constructs a mixin object that can be merged into the `data_factory`
...
`azurerm.data_factory.withName` constructs a mixin object that can be merged into the `data_factory`
...
`azurerm.data_factory.withPublicNetworkEnabled` constructs a mixin object that can be merged into the `data_factory`
...
`azurerm.data_factory.withPurviewId` constructs a mixin object that can be merged into the `data_factory`
...
`azurerm.data_factory.withResourceGroupName` constructs a mixin object that can be merged into the `data_factory`
...
`azurerm.data_factory.withTags` constructs a mixin object that can be merged into the `data_factory`
...
`azurerm.data_factory.withTimeouts` constructs a mixin object that can be merged into the `data_factory`
...
`azurerm.data_factory.withTimeoutsMixin` constructs a mixin object that can be merged into the `data_factory`
Terraform resource block to set or update the timeouts field.
...
`azurerm.data_factory.withVstsConfiguration` constructs a mixin object that can be merged into the `data_factory`
...
`azurerm.data_factory.withVstsConfigurationMixin` constructs a mixin object that can be merged into the `data_factory`
Terraform resource block to set or update the vsts_configuration field.
