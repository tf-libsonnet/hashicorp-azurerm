...
`azurerm.static_site.withIdentity` constructs a mixin object that can be merged into the `static_site`
...
`azurerm.static_site.withIdentityMixin` constructs a mixin object that can be merged into the `static_site`
Terraform resource block to set or update the identity field.
...
`azurerm.static_site.withLocation` constructs a mixin object that can be merged into the `static_site`
...
`azurerm.static_site.withName` constructs a mixin object that can be merged into the `static_site`
...
`azurerm.static_site.withResourceGroupName` constructs a mixin object that can be merged into the `static_site`
...
`azurerm.static_site.withSkuSize` constructs a mixin object that can be merged into the `static_site`
...
`azurerm.static_site.withSkuTier` constructs a mixin object that can be merged into the `static_site`
...
`azurerm.static_site.withTags` constructs a mixin object that can be merged into the `static_site`
...
`azurerm.static_site.withTimeouts` constructs a mixin object that can be merged into the `static_site`
...
`azurerm.static_site.withTimeoutsMixin` constructs a mixin object that can be merged into the `static_site`
Terraform resource block to set or update the timeouts field.
