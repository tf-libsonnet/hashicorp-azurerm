---
permalink: /static_site/
---

# static_site

`static_site` represents the `azurerm_static_site` Terraform resource.
...
**Args**:
  ...
  - `sku_size` (`string`): Set the `sku_size` field on the resulting resource block. When `null`, the `sku_size` field will be omitted from the resulting object.
  ...
  - `identity` (`list[obj]`): Set the `identity` field on the resulting resource block. When `null`, the `identity` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.static_site.identity.new](#fn-identitynew) constructor.
  - `timeouts` (`obj`): Set the `timeouts` field on the resulting resource block. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.static_site.timeouts.new](#fn-timeoutsnew) constructor.
...
Unlike [azurerm.static_site.new](#fn-new), this function will not inject the `resource`
...
**Args**:
  ...
  - `sku_size` (`string`): Set the `sku_size` field on the resulting object. When `null`, the `sku_size` field will be omitted from the resulting object.
  ...
  - `identity` (`list[obj]`): Set the `identity` field on the resulting object. When `null`, the `identity` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.static_site.identity.new](#fn-identitynew) constructor.
  - `timeouts` (`obj`): Set the `timeouts` field on the resulting object. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.static_site.timeouts.new](#fn-timeoutsnew) constructor.
...
`azurerm.string.withSkuSize` constructs a mixin object that can be merged into the `string`
...
**Args**:
  - `resourceLabel` (`string`): The name label of the block to update.
  - `value` (`string`): The value to set for the `sku_size` field.
