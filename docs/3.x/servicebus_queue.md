...
`azurerm.servicebus_queue.withAutoDeleteOnIdle` constructs a mixin object that can be merged into the `servicebus_queue`
...
`azurerm.servicebus_queue.withDeadLetteringOnMessageExpiration` constructs a mixin object that can be merged into the `servicebus_queue`
...
`azurerm.servicebus_queue.withDefaultMessageTtl` constructs a mixin object that can be merged into the `servicebus_queue`
...
`azurerm.servicebus_queue.withDuplicateDetectionHistoryTimeWindow` constructs a mixin object that can be merged into the `servicebus_queue`
...
`azurerm.servicebus_queue.withEnableBatchedOperations` constructs a mixin object that can be merged into the `servicebus_queue`
...
`azurerm.servicebus_queue.withEnableExpress` constructs a mixin object that can be merged into the `servicebus_queue`
...
`azurerm.servicebus_queue.withEnablePartitioning` constructs a mixin object that can be merged into the `servicebus_queue`
...
`azurerm.servicebus_queue.withForwardDeadLetteredMessagesTo` constructs a mixin object that can be merged into the `servicebus_queue`
...
`azurerm.servicebus_queue.withForwardTo` constructs a mixin object that can be merged into the `servicebus_queue`
...
`azurerm.servicebus_queue.withLockDuration` constructs a mixin object that can be merged into the `servicebus_queue`
...
`azurerm.servicebus_queue.withMaxDeliveryCount` constructs a mixin object that can be merged into the `servicebus_queue`
...
`azurerm.servicebus_queue.withMaxMessageSizeInKilobytes` constructs a mixin object that can be merged into the `servicebus_queue`
...
`azurerm.servicebus_queue.withMaxSizeInMegabytes` constructs a mixin object that can be merged into the `servicebus_queue`
...
`azurerm.servicebus_queue.withRequiresDuplicateDetection` constructs a mixin object that can be merged into the `servicebus_queue`
...
`azurerm.servicebus_queue.withRequiresSession` constructs a mixin object that can be merged into the `servicebus_queue`
...
`azurerm.servicebus_queue.withStatus` constructs a mixin object that can be merged into the `servicebus_queue`
