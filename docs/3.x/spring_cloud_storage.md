...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.spring_cloud_storage.timeouts.new](#fn-spring_cloud_storagetimeoutsnew) constructor.
...
Unlike [azurerm.spring_cloud_storage.new](#fn-spring_cloud_storagenew), this function will not inject the `resource`
