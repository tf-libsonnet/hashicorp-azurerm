---
permalink: /spring_cloud_storage/
---

# spring_cloud_storage

`spring_cloud_storage` represents the `azurerm_spring_cloud_storage` Terraform resource.
...
`azurerm.spring_cloud_storage.withName` constructs a mixin object that can be merged into the `spring_cloud_storage`
...
`azurerm.spring_cloud_storage.withSpringCloudServiceId` constructs a mixin object that can be merged into the `spring_cloud_storage`
...
`azurerm.spring_cloud_storage.withStorageAccountKey` constructs a mixin object that can be merged into the `spring_cloud_storage`
...
`azurerm.spring_cloud_storage.withStorageAccountName` constructs a mixin object that can be merged into the `spring_cloud_storage`
...
`azurerm.spring_cloud_storage.withTimeouts` constructs a mixin object that can be merged into the `spring_cloud_storage`
...
`azurerm.spring_cloud_storage.withTimeoutsMixin` constructs a mixin object that can be merged into the `spring_cloud_storage`
Terraform resource block to set or update the timeouts field.
