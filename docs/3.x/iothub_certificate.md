...
`azurerm.iothub_certificate.withCertificateContent` constructs a mixin object that can be merged into the `iothub_certificate`
...
`azurerm.iothub_certificate.withIothubName` constructs a mixin object that can be merged into the `iothub_certificate`
...
`azurerm.iothub_certificate.withIsVerified` constructs a mixin object that can be merged into the `iothub_certificate`
...
`azurerm.iothub_certificate.withName` constructs a mixin object that can be merged into the `iothub_certificate`
...
`azurerm.iothub_certificate.withResourceGroupName` constructs a mixin object that can be merged into the `iothub_certificate`
...
`azurerm.iothub_certificate.withTimeouts` constructs a mixin object that can be merged into the `iothub_certificate`
...
`azurerm.iothub_certificate.withTimeoutsMixin` constructs a mixin object that can be merged into the `iothub_certificate`
Terraform resource block to set or update the timeouts field.
