...
**Args**:
  ...
  - `blob_storage_endpoint` (`string`): Set the `blob_storage_endpoint` field on the resulting resource block. When `null`, the `blob_storage_endpoint` field will be omitted from the resulting object.
...
**Args**:
  - `blob_storage_endpoint` (`string`): Set the `blob_storage_endpoint` field on the resulting object. When `null`, the `blob_storage_endpoint` field will be omitted from the resulting object.
...
`azurerm.string.withBlobStorageEndpoint` constructs a mixin object that can be merged into the `string`
...
`azurerm.string.withStorageAccountSubscriptionId` constructs a mixin object that can be merged into the `string`
