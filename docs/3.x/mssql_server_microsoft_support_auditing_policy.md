...
Unlike [azurerm.mssql_server_microsoft_support_auditing_policy.new](#fn-mssql_server_microsoft_support_auditing_policynew), this function will not inject the `resource`
