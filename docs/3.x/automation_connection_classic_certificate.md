...
`azurerm.automation_connection_classic_certificate.withName` constructs a mixin object that can be merged into the `automation_connection_classic_certificate`
