...
**Args**:
  ...
  - `certificate_asset_name` (`string`): Set the `certificate_asset_name` field on the resulting resource block.
  ...
  - `subscription_name` (`string`): Set the `subscription_name` field on the resulting resource block.
  - `timeouts` (`obj`): Set the `timeouts` field on the resulting resource block. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.automation_connection_classic_certificate.timeouts.new](#fn-timeoutsnew) constructor.
...
**Args**:
  ...
  - `certificate_asset_name` (`string`): Set the `certificate_asset_name` field on the resulting object.
  ...
  - `subscription_name` (`string`): Set the `subscription_name` field on the resulting object.
