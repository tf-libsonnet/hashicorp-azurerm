...
`azurerm.bool.withDynamicFilenameEnabled` constructs a mixin object that can be merged into the `bool`
...
`azurerm.bool.withDynamicPathEnabled` constructs a mixin object that can be merged into the `bool`
