...
`azurerm.storage_account_network_rules.withBypass` constructs a mixin object that can be merged into the `storage_account_network_rules`
...
`azurerm.storage_account_network_rules.withDefaultAction` constructs a mixin object that can be merged into the `storage_account_network_rules`
...
`azurerm.storage_account_network_rules.withIpRules` constructs a mixin object that can be merged into the `storage_account_network_rules`
...
`azurerm.storage_account_network_rules.withPrivateLinkAccess` constructs a mixin object that can be merged into the `storage_account_network_rules`
...
`azurerm.storage_account_network_rules.withPrivateLinkAccessMixin` constructs a mixin object that can be merged into the `storage_account_network_rules`
Terraform resource block to set or update the private_link_access field.
...
`azurerm.storage_account_network_rules.withStorageAccountId` constructs a mixin object that can be merged into the `storage_account_network_rules`
...
`azurerm.storage_account_network_rules.withTimeouts` constructs a mixin object that can be merged into the `storage_account_network_rules`
...
`azurerm.storage_account_network_rules.withTimeoutsMixin` constructs a mixin object that can be merged into the `storage_account_network_rules`
Terraform resource block to set or update the timeouts field.
...
`azurerm.storage_account_network_rules.withVirtualNetworkSubnetIds` constructs a mixin object that can be merged into the `storage_account_network_rules`
