...
`azurerm.automation_variable_int.withDescription` constructs a mixin object that can be merged into the `automation_variable_int`
...
`azurerm.automation_variable_int.withEncrypted` constructs a mixin object that can be merged into the `automation_variable_int`
...
`azurerm.automation_variable_int.withValue` constructs a mixin object that can be merged into the `automation_variable_int`
