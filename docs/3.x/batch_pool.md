...
`azurerm.batch_pool.withAccountName` constructs a mixin object that can be merged into the `batch_pool`
...
`azurerm.batch_pool.withAutoScale` constructs a mixin object that can be merged into the `batch_pool`
...
`azurerm.batch_pool.withAutoScaleMixin` constructs a mixin object that can be merged into the `batch_pool`
Terraform resource block to set or update the auto_scale field.
...
`azurerm.batch_pool.withCertificate` constructs a mixin object that can be merged into the `batch_pool`
...
`azurerm.batch_pool.withCertificateMixin` constructs a mixin object that can be merged into the `batch_pool`
Terraform resource block to set or update the certificate field.
...
`azurerm.batch_pool.withContainerConfiguration` constructs a mixin object that can be merged into the `batch_pool`
...
`azurerm.batch_pool.withContainerConfigurationMixin` constructs a mixin object that can be merged into the `batch_pool`
Terraform resource block to set or update the container_configuration field.
...
`azurerm.batch_pool.withDataDisks` constructs a mixin object that can be merged into the `batch_pool`
...
`azurerm.batch_pool.withDataDisksMixin` constructs a mixin object that can be merged into the `batch_pool`
Terraform resource block to set or update the data_disks field.
...
`azurerm.batch_pool.withDiskEncryption` constructs a mixin object that can be merged into the `batch_pool`
...
`azurerm.batch_pool.withDiskEncryptionMixin` constructs a mixin object that can be merged into the `batch_pool`
Terraform resource block to set or update the disk_encryption field.
...
`azurerm.batch_pool.withDisplayName` constructs a mixin object that can be merged into the `batch_pool`
...
`azurerm.batch_pool.withExtensions` constructs a mixin object that can be merged into the `batch_pool`
...
`azurerm.batch_pool.withExtensionsMixin` constructs a mixin object that can be merged into the `batch_pool`
Terraform resource block to set or update the extensions field.
...
`azurerm.batch_pool.withFixedScale` constructs a mixin object that can be merged into the `batch_pool`
...
`azurerm.batch_pool.withFixedScaleMixin` constructs a mixin object that can be merged into the `batch_pool`
Terraform resource block to set or update the fixed_scale field.
...
`azurerm.batch_pool.withIdentity` constructs a mixin object that can be merged into the `batch_pool`
...
`azurerm.batch_pool.withIdentityMixin` constructs a mixin object that can be merged into the `batch_pool`
Terraform resource block to set or update the identity field.
...
`azurerm.batch_pool.withInterNodeCommunication` constructs a mixin object that can be merged into the `batch_pool`
...
`azurerm.batch_pool.withLicenseType` constructs a mixin object that can be merged into the `batch_pool`
...
`azurerm.batch_pool.withMaxTasksPerNode` constructs a mixin object that can be merged into the `batch_pool`
...
`azurerm.batch_pool.withMetadata` constructs a mixin object that can be merged into the `batch_pool`
...
`azurerm.batch_pool.withMount` constructs a mixin object that can be merged into the `batch_pool`
...
`azurerm.batch_pool.withMountMixin` constructs a mixin object that can be merged into the `batch_pool`
Terraform resource block to set or update the mount field.
...
`azurerm.batch_pool.withName` constructs a mixin object that can be merged into the `batch_pool`
...
`azurerm.batch_pool.withNetworkConfiguration` constructs a mixin object that can be merged into the `batch_pool`
...
`azurerm.batch_pool.withNetworkConfigurationMixin` constructs a mixin object that can be merged into the `batch_pool`
Terraform resource block to set or update the network_configuration field.
...
`azurerm.batch_pool.withNodeAgentSkuId` constructs a mixin object that can be merged into the `batch_pool`
...
`azurerm.batch_pool.withNodePlacement` constructs a mixin object that can be merged into the `batch_pool`
...
`azurerm.batch_pool.withNodePlacementMixin` constructs a mixin object that can be merged into the `batch_pool`
Terraform resource block to set or update the node_placement field.
...
`azurerm.batch_pool.withOsDiskPlacement` constructs a mixin object that can be merged into the `batch_pool`
...
`azurerm.batch_pool.withResourceGroupName` constructs a mixin object that can be merged into the `batch_pool`
...
`azurerm.batch_pool.withStartTask` constructs a mixin object that can be merged into the `batch_pool`
...
`azurerm.batch_pool.withStartTaskMixin` constructs a mixin object that can be merged into the `batch_pool`
Terraform resource block to set or update the start_task field.
...
`azurerm.batch_pool.withStopPendingResizeOperation` constructs a mixin object that can be merged into the `batch_pool`
...
`azurerm.batch_pool.withStorageImageReference` constructs a mixin object that can be merged into the `batch_pool`
...
`azurerm.batch_pool.withStorageImageReferenceMixin` constructs a mixin object that can be merged into the `batch_pool`
Terraform resource block to set or update the storage_image_reference field.
...
`azurerm.batch_pool.withTaskSchedulingPolicy` constructs a mixin object that can be merged into the `batch_pool`
...
`azurerm.batch_pool.withTaskSchedulingPolicyMixin` constructs a mixin object that can be merged into the `batch_pool`
Terraform resource block to set or update the task_scheduling_policy field.
...
`azurerm.batch_pool.withTimeouts` constructs a mixin object that can be merged into the `batch_pool`
...
`azurerm.batch_pool.withTimeoutsMixin` constructs a mixin object that can be merged into the `batch_pool`
Terraform resource block to set or update the timeouts field.
...
`azurerm.batch_pool.withUserAccounts` constructs a mixin object that can be merged into the `batch_pool`
...
`azurerm.batch_pool.withUserAccountsMixin` constructs a mixin object that can be merged into the `batch_pool`
Terraform resource block to set or update the user_accounts field.
...
`azurerm.batch_pool.withVmSize` constructs a mixin object that can be merged into the `batch_pool`
...
`azurerm.batch_pool.withWindows` constructs a mixin object that can be merged into the `batch_pool`
...
`azurerm.batch_pool.withWindowsMixin` constructs a mixin object that can be merged into the `batch_pool`
Terraform resource block to set or update the windows field.
