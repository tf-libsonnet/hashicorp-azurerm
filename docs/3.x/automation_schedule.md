...
`azurerm.automation_schedule.withAutomationAccountName` constructs a mixin object that can be merged into the `automation_schedule`
...
`azurerm.automation_schedule.withDescription` constructs a mixin object that can be merged into the `automation_schedule`
...
`azurerm.automation_schedule.withExpiryTime` constructs a mixin object that can be merged into the `automation_schedule`
...
`azurerm.automation_schedule.withFrequency` constructs a mixin object that can be merged into the `automation_schedule`
...
`azurerm.automation_schedule.withInterval` constructs a mixin object that can be merged into the `automation_schedule`
...
`azurerm.automation_schedule.withMonthDays` constructs a mixin object that can be merged into the `automation_schedule`
...
`azurerm.automation_schedule.withMonthlyOccurrence` constructs a mixin object that can be merged into the `automation_schedule`
...
`azurerm.automation_schedule.withMonthlyOccurrenceMixin` constructs a mixin object that can be merged into the `automation_schedule`
Terraform resource block to set or update the monthly_occurrence field.
...
`azurerm.automation_schedule.withName` constructs a mixin object that can be merged into the `automation_schedule`
...
`azurerm.automation_schedule.withResourceGroupName` constructs a mixin object that can be merged into the `automation_schedule`
...
`azurerm.automation_schedule.withStartTime` constructs a mixin object that can be merged into the `automation_schedule`
...
`azurerm.automation_schedule.withTimeouts` constructs a mixin object that can be merged into the `automation_schedule`
...
`azurerm.automation_schedule.withTimeoutsMixin` constructs a mixin object that can be merged into the `automation_schedule`
Terraform resource block to set or update the timeouts field.
...
`azurerm.automation_schedule.withTimezone` constructs a mixin object that can be merged into the `automation_schedule`
...
`azurerm.automation_schedule.withWeekDays` constructs a mixin object that can be merged into the `automation_schedule`
