...
`azurerm.lighthouse_definition.withAuthorization` constructs a mixin object that can be merged into the `lighthouse_definition`
...
`azurerm.lighthouse_definition.withAuthorizationMixin` constructs a mixin object that can be merged into the `lighthouse_definition`
Terraform resource block to set or update the authorization field.
...
`azurerm.lighthouse_definition.withDescription` constructs a mixin object that can be merged into the `lighthouse_definition`
...
`azurerm.lighthouse_definition.withEligibleAuthorization` constructs a mixin object that can be merged into the `lighthouse_definition`
...
`azurerm.lighthouse_definition.withEligibleAuthorizationMixin` constructs a mixin object that can be merged into the `lighthouse_definition`
Terraform resource block to set or update the eligible_authorization field.
...
`azurerm.lighthouse_definition.withLighthouseDefinitionId` constructs a mixin object that can be merged into the `lighthouse_definition`
...
`azurerm.lighthouse_definition.withManagingTenantId` constructs a mixin object that can be merged into the `lighthouse_definition`
...
`azurerm.lighthouse_definition.withName` constructs a mixin object that can be merged into the `lighthouse_definition`
...
`azurerm.lighthouse_definition.withPlan` constructs a mixin object that can be merged into the `lighthouse_definition`
...
`azurerm.lighthouse_definition.withPlanMixin` constructs a mixin object that can be merged into the `lighthouse_definition`
Terraform resource block to set or update the plan field.
...
`azurerm.lighthouse_definition.withScope` constructs a mixin object that can be merged into the `lighthouse_definition`
...
`azurerm.lighthouse_definition.withTimeouts` constructs a mixin object that can be merged into the `lighthouse_definition`
...
`azurerm.lighthouse_definition.withTimeoutsMixin` constructs a mixin object that can be merged into the `lighthouse_definition`
Terraform resource block to set or update the timeouts field.
