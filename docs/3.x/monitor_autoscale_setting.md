...
`azurerm.monitor_autoscale_setting.withEnabled` constructs a mixin object that can be merged into the `monitor_autoscale_setting`
...
`azurerm.monitor_autoscale_setting.withLocation` constructs a mixin object that can be merged into the `monitor_autoscale_setting`
...
`azurerm.monitor_autoscale_setting.withName` constructs a mixin object that can be merged into the `monitor_autoscale_setting`
...
`azurerm.monitor_autoscale_setting.withNotification` constructs a mixin object that can be merged into the `monitor_autoscale_setting`
...
`azurerm.monitor_autoscale_setting.withNotificationMixin` constructs a mixin object that can be merged into the `monitor_autoscale_setting`
Terraform resource block to set or update the notification field.
...
`azurerm.monitor_autoscale_setting.withProfile` constructs a mixin object that can be merged into the `monitor_autoscale_setting`
...
`azurerm.monitor_autoscale_setting.withProfileMixin` constructs a mixin object that can be merged into the `monitor_autoscale_setting`
Terraform resource block to set or update the profile field.
...
`azurerm.monitor_autoscale_setting.withResourceGroupName` constructs a mixin object that can be merged into the `monitor_autoscale_setting`
...
`azurerm.monitor_autoscale_setting.withTags` constructs a mixin object that can be merged into the `monitor_autoscale_setting`
...
`azurerm.monitor_autoscale_setting.withTargetResourceId` constructs a mixin object that can be merged into the `monitor_autoscale_setting`
...
`azurerm.monitor_autoscale_setting.withTimeouts` constructs a mixin object that can be merged into the `monitor_autoscale_setting`
...
`azurerm.monitor_autoscale_setting.withTimeoutsMixin` constructs a mixin object that can be merged into the `monitor_autoscale_setting`
Terraform resource block to set or update the timeouts field.
