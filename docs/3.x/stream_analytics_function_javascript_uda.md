...
`azurerm.stream_analytics_function_javascript_uda.withInput` constructs a mixin object that can be merged into the `stream_analytics_function_javascript_uda`
...
`azurerm.stream_analytics_function_javascript_uda.withInputMixin` constructs a mixin object that can be merged into the `stream_analytics_function_javascript_uda`
Terraform resource block to set or update the input field.
...
`azurerm.stream_analytics_function_javascript_uda.withName` constructs a mixin object that can be merged into the `stream_analytics_function_javascript_uda`
...
`azurerm.stream_analytics_function_javascript_uda.withOutput` constructs a mixin object that can be merged into the `stream_analytics_function_javascript_uda`
...
`azurerm.stream_analytics_function_javascript_uda.withOutputMixin` constructs a mixin object that can be merged into the `stream_analytics_function_javascript_uda`
Terraform resource block to set or update the output field.
...
`azurerm.stream_analytics_function_javascript_uda.withScript` constructs a mixin object that can be merged into the `stream_analytics_function_javascript_uda`
...
`azurerm.stream_analytics_function_javascript_uda.withStreamAnalyticsJobId` constructs a mixin object that can be merged into the `stream_analytics_function_javascript_uda`
...
`azurerm.stream_analytics_function_javascript_uda.withTimeouts` constructs a mixin object that can be merged into the `stream_analytics_function_javascript_uda`
...
`azurerm.stream_analytics_function_javascript_uda.withTimeoutsMixin` constructs a mixin object that can be merged into the `stream_analytics_function_javascript_uda`
Terraform resource block to set or update the timeouts field.
