...
`azurerm.digital_twins_time_series_database_connection.withDigitalTwinsId` constructs a mixin object that can be merged into the `digital_twins_time_series_database_connection`
...
`azurerm.digital_twins_time_series_database_connection.withEventhubConsumerGroupName` constructs a mixin object that can be merged into the `digital_twins_time_series_database_connection`
...
`azurerm.digital_twins_time_series_database_connection.withEventhubName` constructs a mixin object that can be merged into the `digital_twins_time_series_database_connection`
...
`azurerm.digital_twins_time_series_database_connection.withEventhubNamespaceEndpointUri` constructs a mixin object that can be merged into the `digital_twins_time_series_database_connection`
...
`azurerm.digital_twins_time_series_database_connection.withEventhubNamespaceId` constructs a mixin object that can be merged into the `digital_twins_time_series_database_connection`
...
`azurerm.digital_twins_time_series_database_connection.withKustoClusterId` constructs a mixin object that can be merged into the `digital_twins_time_series_database_connection`
...
`azurerm.digital_twins_time_series_database_connection.withKustoClusterUri` constructs a mixin object that can be merged into the `digital_twins_time_series_database_connection`
...
`azurerm.digital_twins_time_series_database_connection.withKustoDatabaseName` constructs a mixin object that can be merged into the `digital_twins_time_series_database_connection`
...
`azurerm.digital_twins_time_series_database_connection.withKustoTableName` constructs a mixin object that can be merged into the `digital_twins_time_series_database_connection`
...
`azurerm.digital_twins_time_series_database_connection.withName` constructs a mixin object that can be merged into the `digital_twins_time_series_database_connection`
...
`azurerm.digital_twins_time_series_database_connection.withTimeouts` constructs a mixin object that can be merged into the `digital_twins_time_series_database_connection`
...
`azurerm.digital_twins_time_series_database_connection.withTimeoutsMixin` constructs a mixin object that can be merged into the `digital_twins_time_series_database_connection`
Terraform resource block to set or update the timeouts field.
