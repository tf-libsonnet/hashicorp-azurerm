...
**Args**:
  ...
  - `usage_model` (`string`): 
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.hpc_cache_blob_nfs_target.timeouts.new](#fn-hpc_cache_blob_nfs_targettimeoutsnew) constructor.
...
Unlike [azurerm.hpc_cache_blob_nfs_target.new](#fn-hpc_cache_blob_nfs_targetnew), this function will not inject the `resource`
