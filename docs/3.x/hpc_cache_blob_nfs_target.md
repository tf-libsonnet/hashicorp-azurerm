...
`azurerm.hpc_cache_blob_nfs_target.withAccessPolicyName` constructs a mixin object that can be merged into the `hpc_cache_blob_nfs_target`
...
`azurerm.hpc_cache_blob_nfs_target.withCacheName` constructs a mixin object that can be merged into the `hpc_cache_blob_nfs_target`
...
`azurerm.hpc_cache_blob_nfs_target.withName` constructs a mixin object that can be merged into the `hpc_cache_blob_nfs_target`
...
`azurerm.hpc_cache_blob_nfs_target.withNamespacePath` constructs a mixin object that can be merged into the `hpc_cache_blob_nfs_target`
...
`azurerm.hpc_cache_blob_nfs_target.withResourceGroupName` constructs a mixin object that can be merged into the `hpc_cache_blob_nfs_target`
...
`azurerm.hpc_cache_blob_nfs_target.withStorageContainerId` constructs a mixin object that can be merged into the `hpc_cache_blob_nfs_target`
...
`azurerm.hpc_cache_blob_nfs_target.withTimeouts` constructs a mixin object that can be merged into the `hpc_cache_blob_nfs_target`
...
`azurerm.hpc_cache_blob_nfs_target.withTimeoutsMixin` constructs a mixin object that can be merged into the `hpc_cache_blob_nfs_target`
Terraform resource block to set or update the timeouts field.
...
`azurerm.hpc_cache_blob_nfs_target.withUsageModel` constructs a mixin object that can be merged into the `hpc_cache_blob_nfs_target`
