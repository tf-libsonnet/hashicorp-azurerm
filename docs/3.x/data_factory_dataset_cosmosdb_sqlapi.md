...
`azurerm.data_factory_dataset_cosmosdb_sqlapi.withParameters` constructs a mixin object that can be merged into the `data_factory_dataset_cosmosdb_sqlapi`
