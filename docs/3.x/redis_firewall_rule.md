...
`azurerm.redis_firewall_rule.withEndIp` constructs a mixin object that can be merged into the `redis_firewall_rule`
...
`azurerm.redis_firewall_rule.withName` constructs a mixin object that can be merged into the `redis_firewall_rule`
...
`azurerm.redis_firewall_rule.withRedisCacheName` constructs a mixin object that can be merged into the `redis_firewall_rule`
...
`azurerm.redis_firewall_rule.withResourceGroupName` constructs a mixin object that can be merged into the `redis_firewall_rule`
...
`azurerm.redis_firewall_rule.withStartIp` constructs a mixin object that can be merged into the `redis_firewall_rule`
...
`azurerm.redis_firewall_rule.withTimeouts` constructs a mixin object that can be merged into the `redis_firewall_rule`
...
`azurerm.redis_firewall_rule.withTimeoutsMixin` constructs a mixin object that can be merged into the `redis_firewall_rule`
Terraform resource block to set or update the timeouts field.
