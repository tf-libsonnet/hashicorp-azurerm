...
`azurerm.key_vault_managed_storage_account.withRegenerationPeriod` constructs a mixin object that can be merged into the `key_vault_managed_storage_account`
