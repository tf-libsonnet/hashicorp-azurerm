...
`azurerm.mysql_server_key.withKeyVaultKeyId` constructs a mixin object that can be merged into the `mysql_server_key`
...
`azurerm.mysql_server_key.withServerId` constructs a mixin object that can be merged into the `mysql_server_key`
...
`azurerm.mysql_server_key.withTimeouts` constructs a mixin object that can be merged into the `mysql_server_key`
...
`azurerm.mysql_server_key.withTimeoutsMixin` constructs a mixin object that can be merged into the `mysql_server_key`
Terraform resource block to set or update the timeouts field.
