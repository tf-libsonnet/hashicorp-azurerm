...
`azurerm.cosmosdb_table.withAccountName` constructs a mixin object that can be merged into the `cosmosdb_table`
...
`azurerm.cosmosdb_table.withAutoscaleSettings` constructs a mixin object that can be merged into the `cosmosdb_table`
...
`azurerm.cosmosdb_table.withAutoscaleSettingsMixin` constructs a mixin object that can be merged into the `cosmosdb_table`
Terraform resource block to set or update the autoscale_settings field.
...
`azurerm.cosmosdb_table.withName` constructs a mixin object that can be merged into the `cosmosdb_table`
...
`azurerm.cosmosdb_table.withResourceGroupName` constructs a mixin object that can be merged into the `cosmosdb_table`
...
`azurerm.cosmosdb_table.withThroughput` constructs a mixin object that can be merged into the `cosmosdb_table`
...
`azurerm.cosmosdb_table.withTimeouts` constructs a mixin object that can be merged into the `cosmosdb_table`
...
`azurerm.cosmosdb_table.withTimeoutsMixin` constructs a mixin object that can be merged into the `cosmosdb_table`
Terraform resource block to set or update the timeouts field.
