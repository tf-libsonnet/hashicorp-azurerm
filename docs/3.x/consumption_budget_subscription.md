...
`azurerm.consumption_budget_subscription.withAmount` constructs a mixin object that can be merged into the `consumption_budget_subscription`
...
`azurerm.consumption_budget_subscription.withEtag` constructs a mixin object that can be merged into the `consumption_budget_subscription`
...
`azurerm.consumption_budget_subscription.withFilter` constructs a mixin object that can be merged into the `consumption_budget_subscription`
...
`azurerm.consumption_budget_subscription.withFilterMixin` constructs a mixin object that can be merged into the `consumption_budget_subscription`
Terraform resource block to set or update the filter field.
...
`azurerm.consumption_budget_subscription.withName` constructs a mixin object that can be merged into the `consumption_budget_subscription`
...
`azurerm.consumption_budget_subscription.withNotification` constructs a mixin object that can be merged into the `consumption_budget_subscription`
...
`azurerm.consumption_budget_subscription.withNotificationMixin` constructs a mixin object that can be merged into the `consumption_budget_subscription`
Terraform resource block to set or update the notification field.
...
`azurerm.consumption_budget_subscription.withSubscriptionId` constructs a mixin object that can be merged into the `consumption_budget_subscription`
...
`azurerm.consumption_budget_subscription.withTimeGrain` constructs a mixin object that can be merged into the `consumption_budget_subscription`
...
`azurerm.consumption_budget_subscription.withTimePeriod` constructs a mixin object that can be merged into the `consumption_budget_subscription`
...
`azurerm.consumption_budget_subscription.withTimePeriodMixin` constructs a mixin object that can be merged into the `consumption_budget_subscription`
Terraform resource block to set or update the time_period field.
...
`azurerm.consumption_budget_subscription.withTimeouts` constructs a mixin object that can be merged into the `consumption_budget_subscription`
...
`azurerm.consumption_budget_subscription.withTimeoutsMixin` constructs a mixin object that can be merged into the `consumption_budget_subscription`
Terraform resource block to set or update the timeouts field.
