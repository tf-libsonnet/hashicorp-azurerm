...
`azurerm.eventgrid_event_subscription.withAdvancedFilter` constructs a mixin object that can be merged into the `eventgrid_event_subscription`
...
`azurerm.eventgrid_event_subscription.withAdvancedFilterMixin` constructs a mixin object that can be merged into the `eventgrid_event_subscription`
Terraform resource block to set or update the advanced_filter field.
...
`azurerm.eventgrid_event_subscription.withAdvancedFilteringOnArraysEnabled` constructs a mixin object that can be merged into the `eventgrid_event_subscription`
...
`azurerm.eventgrid_event_subscription.withAzureFunctionEndpoint` constructs a mixin object that can be merged into the `eventgrid_event_subscription`
...
`azurerm.eventgrid_event_subscription.withAzureFunctionEndpointMixin` constructs a mixin object that can be merged into the `eventgrid_event_subscription`
Terraform resource block to set or update the azure_function_endpoint field.
...
`azurerm.eventgrid_event_subscription.withDeadLetterIdentity` constructs a mixin object that can be merged into the `eventgrid_event_subscription`
...
`azurerm.eventgrid_event_subscription.withDeadLetterIdentityMixin` constructs a mixin object that can be merged into the `eventgrid_event_subscription`
Terraform resource block to set or update the dead_letter_identity field.
...
`azurerm.eventgrid_event_subscription.withDeliveryIdentity` constructs a mixin object that can be merged into the `eventgrid_event_subscription`
...
`azurerm.eventgrid_event_subscription.withDeliveryIdentityMixin` constructs a mixin object that can be merged into the `eventgrid_event_subscription`
Terraform resource block to set or update the delivery_identity field.
...
`azurerm.eventgrid_event_subscription.withDeliveryProperty` constructs a mixin object that can be merged into the `eventgrid_event_subscription`
...
`azurerm.eventgrid_event_subscription.withDeliveryPropertyMixin` constructs a mixin object that can be merged into the `eventgrid_event_subscription`
Terraform resource block to set or update the delivery_property field.
...
`azurerm.eventgrid_event_subscription.withEventDeliverySchema` constructs a mixin object that can be merged into the `eventgrid_event_subscription`
...
`azurerm.eventgrid_event_subscription.withEventhubEndpointId` constructs a mixin object that can be merged into the `eventgrid_event_subscription`
...
`azurerm.eventgrid_event_subscription.withExpirationTimeUtc` constructs a mixin object that can be merged into the `eventgrid_event_subscription`
...
`azurerm.eventgrid_event_subscription.withHybridConnectionEndpointId` constructs a mixin object that can be merged into the `eventgrid_event_subscription`
...
`azurerm.eventgrid_event_subscription.withIncludedEventTypes` constructs a mixin object that can be merged into the `eventgrid_event_subscription`
...
`azurerm.eventgrid_event_subscription.withLabels` constructs a mixin object that can be merged into the `eventgrid_event_subscription`
...
`azurerm.eventgrid_event_subscription.withName` constructs a mixin object that can be merged into the `eventgrid_event_subscription`
...
`azurerm.eventgrid_event_subscription.withRetryPolicy` constructs a mixin object that can be merged into the `eventgrid_event_subscription`
...
`azurerm.eventgrid_event_subscription.withRetryPolicyMixin` constructs a mixin object that can be merged into the `eventgrid_event_subscription`
Terraform resource block to set or update the retry_policy field.
...
`azurerm.eventgrid_event_subscription.withScope` constructs a mixin object that can be merged into the `eventgrid_event_subscription`
...
`azurerm.eventgrid_event_subscription.withServiceBusQueueEndpointId` constructs a mixin object that can be merged into the `eventgrid_event_subscription`
...
`azurerm.eventgrid_event_subscription.withServiceBusTopicEndpointId` constructs a mixin object that can be merged into the `eventgrid_event_subscription`
...
`azurerm.eventgrid_event_subscription.withStorageBlobDeadLetterDestination` constructs a mixin object that can be merged into the `eventgrid_event_subscription`
...
`azurerm.eventgrid_event_subscription.withStorageBlobDeadLetterDestinationMixin` constructs a mixin object that can be merged into the `eventgrid_event_subscription`
Terraform resource block to set or update the storage_blob_dead_letter_destination field.
...
`azurerm.eventgrid_event_subscription.withStorageQueueEndpoint` constructs a mixin object that can be merged into the `eventgrid_event_subscription`
...
`azurerm.eventgrid_event_subscription.withStorageQueueEndpointMixin` constructs a mixin object that can be merged into the `eventgrid_event_subscription`
Terraform resource block to set or update the storage_queue_endpoint field.
...
`azurerm.eventgrid_event_subscription.withSubjectFilter` constructs a mixin object that can be merged into the `eventgrid_event_subscription`
...
`azurerm.eventgrid_event_subscription.withSubjectFilterMixin` constructs a mixin object that can be merged into the `eventgrid_event_subscription`
Terraform resource block to set or update the subject_filter field.
...
`azurerm.eventgrid_event_subscription.withTimeouts` constructs a mixin object that can be merged into the `eventgrid_event_subscription`
...
`azurerm.eventgrid_event_subscription.withTimeoutsMixin` constructs a mixin object that can be merged into the `eventgrid_event_subscription`
Terraform resource block to set or update the timeouts field.
...
`azurerm.eventgrid_event_subscription.withWebhookEndpoint` constructs a mixin object that can be merged into the `eventgrid_event_subscription`
...
`azurerm.eventgrid_event_subscription.withWebhookEndpointMixin` constructs a mixin object that can be merged into the `eventgrid_event_subscription`
Terraform resource block to set or update the webhook_endpoint field.
