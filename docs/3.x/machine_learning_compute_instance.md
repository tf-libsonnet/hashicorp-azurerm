...
`azurerm.machine_learning_compute_instance.withAssignToUser` constructs a mixin object that can be merged into the `machine_learning_compute_instance`
...
`azurerm.machine_learning_compute_instance.withAssignToUserMixin` constructs a mixin object that can be merged into the `machine_learning_compute_instance`
Terraform resource block to set or update the assign_to_user field.
...
`azurerm.machine_learning_compute_instance.withAuthorizationType` constructs a mixin object that can be merged into the `machine_learning_compute_instance`
...
`azurerm.machine_learning_compute_instance.withDescription` constructs a mixin object that can be merged into the `machine_learning_compute_instance`
...
`azurerm.machine_learning_compute_instance.withIdentity` constructs a mixin object that can be merged into the `machine_learning_compute_instance`
...
`azurerm.machine_learning_compute_instance.withIdentityMixin` constructs a mixin object that can be merged into the `machine_learning_compute_instance`
Terraform resource block to set or update the identity field.
...
`azurerm.machine_learning_compute_instance.withLocalAuthEnabled` constructs a mixin object that can be merged into the `machine_learning_compute_instance`
...
`azurerm.machine_learning_compute_instance.withLocation` constructs a mixin object that can be merged into the `machine_learning_compute_instance`
...
`azurerm.machine_learning_compute_instance.withMachineLearningWorkspaceId` constructs a mixin object that can be merged into the `machine_learning_compute_instance`
...
`azurerm.machine_learning_compute_instance.withName` constructs a mixin object that can be merged into the `machine_learning_compute_instance`
...
`azurerm.machine_learning_compute_instance.withSsh` constructs a mixin object that can be merged into the `machine_learning_compute_instance`
...
`azurerm.machine_learning_compute_instance.withSshMixin` constructs a mixin object that can be merged into the `machine_learning_compute_instance`
Terraform resource block to set or update the ssh field.
...
`azurerm.machine_learning_compute_instance.withSubnetResourceId` constructs a mixin object that can be merged into the `machine_learning_compute_instance`
...
`azurerm.machine_learning_compute_instance.withTags` constructs a mixin object that can be merged into the `machine_learning_compute_instance`
...
`azurerm.machine_learning_compute_instance.withTimeouts` constructs a mixin object that can be merged into the `machine_learning_compute_instance`
...
`azurerm.machine_learning_compute_instance.withTimeoutsMixin` constructs a mixin object that can be merged into the `machine_learning_compute_instance`
Terraform resource block to set or update the timeouts field.
...
`azurerm.machine_learning_compute_instance.withVirtualMachineSize` constructs a mixin object that can be merged into the `machine_learning_compute_instance`
