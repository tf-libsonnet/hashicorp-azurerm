...
**Args**:
  ...
  - `name` (`string`): 
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.mssql_managed_database.timeouts.new](#fn-mssql_managed_databasetimeoutsnew) constructor.
...
Unlike [azurerm.mssql_managed_database.new](#fn-mssql_managed_databasenew), this function will not inject the `resource`
