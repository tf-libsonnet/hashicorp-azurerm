...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.logic_app_integration_account.timeouts.new](#fn-logic_app_integration_accounttimeoutsnew) constructor.
...
Unlike [azurerm.logic_app_integration_account.new](#fn-logic_app_integration_accountnew), this function will not inject the `resource`
