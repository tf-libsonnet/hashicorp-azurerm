...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.stream_analytics_output_cosmosdb.timeouts.new](#fn-stream_analytics_output_cosmosdbtimeoutsnew) constructor.
...
Unlike [azurerm.stream_analytics_output_cosmosdb.new](#fn-stream_analytics_output_cosmosdbnew), this function will not inject the `resource`
