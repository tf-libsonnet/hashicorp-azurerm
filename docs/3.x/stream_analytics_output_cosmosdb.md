...
`azurerm.stream_analytics_output_cosmosdb.withContainerName` constructs a mixin object that can be merged into the `stream_analytics_output_cosmosdb`
...
`azurerm.stream_analytics_output_cosmosdb.withCosmosdbAccountKey` constructs a mixin object that can be merged into the `stream_analytics_output_cosmosdb`
...
`azurerm.stream_analytics_output_cosmosdb.withCosmosdbSqlDatabaseId` constructs a mixin object that can be merged into the `stream_analytics_output_cosmosdb`
...
`azurerm.stream_analytics_output_cosmosdb.withDocumentId` constructs a mixin object that can be merged into the `stream_analytics_output_cosmosdb`
...
`azurerm.stream_analytics_output_cosmosdb.withName` constructs a mixin object that can be merged into the `stream_analytics_output_cosmosdb`
...
`azurerm.stream_analytics_output_cosmosdb.withPartitionKey` constructs a mixin object that can be merged into the `stream_analytics_output_cosmosdb`
...
`azurerm.stream_analytics_output_cosmosdb.withStreamAnalyticsJobId` constructs a mixin object that can be merged into the `stream_analytics_output_cosmosdb`
...
`azurerm.stream_analytics_output_cosmosdb.withTimeouts` constructs a mixin object that can be merged into the `stream_analytics_output_cosmosdb`
...
`azurerm.stream_analytics_output_cosmosdb.withTimeoutsMixin` constructs a mixin object that can be merged into the `stream_analytics_output_cosmosdb`
Terraform resource block to set or update the timeouts field.
