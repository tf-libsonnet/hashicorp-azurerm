...
`azurerm.iothub.withCloudToDevice` constructs a mixin object that can be merged into the `iothub`
...
`azurerm.iothub.withCloudToDeviceMixin` constructs a mixin object that can be merged into the `iothub`
Terraform resource block to set or update the cloud_to_device field.
...
`azurerm.iothub.withEndpoint` constructs a mixin object that can be merged into the `iothub`
...
`azurerm.iothub.withEnrichment` constructs a mixin object that can be merged into the `iothub`
...
`azurerm.iothub.withEventHubPartitionCount` constructs a mixin object that can be merged into the `iothub`
...
`azurerm.iothub.withEventHubRetentionInDays` constructs a mixin object that can be merged into the `iothub`
...
`azurerm.iothub.withFallbackRoute` constructs a mixin object that can be merged into the `iothub`
...
`azurerm.iothub.withFallbackRouteMixin` constructs a mixin object that can be merged into the `iothub`
Terraform resource block to set or update the fallback_route field.
...
`azurerm.iothub.withFileUpload` constructs a mixin object that can be merged into the `iothub`
...
`azurerm.iothub.withFileUploadMixin` constructs a mixin object that can be merged into the `iothub`
Terraform resource block to set or update the file_upload field.
...
`azurerm.iothub.withIdentity` constructs a mixin object that can be merged into the `iothub`
...
`azurerm.iothub.withIdentityMixin` constructs a mixin object that can be merged into the `iothub`
Terraform resource block to set or update the identity field.
...
`azurerm.iothub.withLocation` constructs a mixin object that can be merged into the `iothub`
...
`azurerm.iothub.withMinTlsVersion` constructs a mixin object that can be merged into the `iothub`
...
`azurerm.iothub.withName` constructs a mixin object that can be merged into the `iothub`
...
`azurerm.iothub.withNetworkRuleSet` constructs a mixin object that can be merged into the `iothub`
...
`azurerm.iothub.withNetworkRuleSetMixin` constructs a mixin object that can be merged into the `iothub`
Terraform resource block to set or update the network_rule_set field.
...
`azurerm.iothub.withPublicNetworkAccessEnabled` constructs a mixin object that can be merged into the `iothub`
...
`azurerm.iothub.withResourceGroupName` constructs a mixin object that can be merged into the `iothub`
...
`azurerm.iothub.withRoute` constructs a mixin object that can be merged into the `iothub`
...
`azurerm.iothub.withSku` constructs a mixin object that can be merged into the `iothub`
...
`azurerm.iothub.withSkuMixin` constructs a mixin object that can be merged into the `iothub`
Terraform resource block to set or update the sku field.
...
`azurerm.iothub.withTags` constructs a mixin object that can be merged into the `iothub`
...
`azurerm.iothub.withTimeouts` constructs a mixin object that can be merged into the `iothub`
...
`azurerm.iothub.withTimeoutsMixin` constructs a mixin object that can be merged into the `iothub`
Terraform resource block to set or update the timeouts field.
