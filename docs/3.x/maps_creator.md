...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.maps_creator.timeouts.new](#fn-maps_creatortimeoutsnew) constructor.
...
Unlike [azurerm.maps_creator.new](#fn-maps_creatornew), this function will not inject the `resource`
