...
`azurerm.app_service_environment_v3.withAllowNewPrivateEndpointConnections` constructs a mixin object that can be merged into the `app_service_environment_v3`
...
`azurerm.app_service_environment_v3.withClusterSetting` constructs a mixin object that can be merged into the `app_service_environment_v3`
...
`azurerm.app_service_environment_v3.withClusterSettingMixin` constructs a mixin object that can be merged into the `app_service_environment_v3`
Terraform resource block to set or update the cluster_setting field.
...
`azurerm.app_service_environment_v3.withDedicatedHostCount` constructs a mixin object that can be merged into the `app_service_environment_v3`
...
`azurerm.app_service_environment_v3.withInternalLoadBalancingMode` constructs a mixin object that can be merged into the `app_service_environment_v3`
...
`azurerm.app_service_environment_v3.withName` constructs a mixin object that can be merged into the `app_service_environment_v3`
...
`azurerm.app_service_environment_v3.withResourceGroupName` constructs a mixin object that can be merged into the `app_service_environment_v3`
...
`azurerm.app_service_environment_v3.withSubnetId` constructs a mixin object that can be merged into the `app_service_environment_v3`
...
`azurerm.app_service_environment_v3.withTags` constructs a mixin object that can be merged into the `app_service_environment_v3`
...
`azurerm.app_service_environment_v3.withTimeouts` constructs a mixin object that can be merged into the `app_service_environment_v3`
...
`azurerm.app_service_environment_v3.withTimeoutsMixin` constructs a mixin object that can be merged into the `app_service_environment_v3`
Terraform resource block to set or update the timeouts field.
...
`azurerm.app_service_environment_v3.withZoneRedundant` constructs a mixin object that can be merged into the `app_service_environment_v3`
