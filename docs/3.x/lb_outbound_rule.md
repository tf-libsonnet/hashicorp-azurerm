...
**Args**:
  ...
  - `name` (`string`): 
  - `protocol` (`string`): 
  - `frontend_ip_configuration` (`list[obj]`):  When `null`, the `frontend_ip_configuration` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.lb_outbound_rule.frontend_ip_configuration.new](#fn-lb_outbound_rulefrontend_ip_configurationnew) constructor.
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.lb_outbound_rule.timeouts.new](#fn-lb_outbound_ruletimeoutsnew) constructor.
...
Unlike [azurerm.lb_outbound_rule.new](#fn-lb_outbound_rulenew), this function will not inject the `resource`
