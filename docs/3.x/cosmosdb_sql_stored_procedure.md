...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.cosmosdb_sql_stored_procedure.timeouts.new](#fn-cosmosdb_sql_stored_proceduretimeoutsnew) constructor.
...
Unlike [azurerm.cosmosdb_sql_stored_procedure.new](#fn-cosmosdb_sql_stored_procedurenew), this function will not inject the `resource`
