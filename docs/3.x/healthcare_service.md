...
`azurerm.healthcare_service.withAccessPolicyObjectIds` constructs a mixin object that can be merged into the `healthcare_service`
...
`azurerm.healthcare_service.withAuthenticationConfiguration` constructs a mixin object that can be merged into the `healthcare_service`
...
`azurerm.healthcare_service.withAuthenticationConfigurationMixin` constructs a mixin object that can be merged into the `healthcare_service`
Terraform resource block to set or update the authentication_configuration field.
...
`azurerm.healthcare_service.withCorsConfiguration` constructs a mixin object that can be merged into the `healthcare_service`
...
`azurerm.healthcare_service.withCorsConfigurationMixin` constructs a mixin object that can be merged into the `healthcare_service`
Terraform resource block to set or update the cors_configuration field.
...
`azurerm.healthcare_service.withCosmosdbKeyVaultKeyVersionlessId` constructs a mixin object that can be merged into the `healthcare_service`
...
`azurerm.healthcare_service.withCosmosdbThroughput` constructs a mixin object that can be merged into the `healthcare_service`
...
`azurerm.healthcare_service.withKind` constructs a mixin object that can be merged into the `healthcare_service`
...
`azurerm.healthcare_service.withLocation` constructs a mixin object that can be merged into the `healthcare_service`
...
`azurerm.healthcare_service.withName` constructs a mixin object that can be merged into the `healthcare_service`
...
`azurerm.healthcare_service.withPublicNetworkAccessEnabled` constructs a mixin object that can be merged into the `healthcare_service`
...
`azurerm.healthcare_service.withResourceGroupName` constructs a mixin object that can be merged into the `healthcare_service`
...
`azurerm.healthcare_service.withTags` constructs a mixin object that can be merged into the `healthcare_service`
...
`azurerm.healthcare_service.withTimeouts` constructs a mixin object that can be merged into the `healthcare_service`
...
`azurerm.healthcare_service.withTimeoutsMixin` constructs a mixin object that can be merged into the `healthcare_service`
Terraform resource block to set or update the timeouts field.
