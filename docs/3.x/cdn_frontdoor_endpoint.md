...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.cdn_frontdoor_endpoint.timeouts.new](#fn-cdn_frontdoor_endpointtimeoutsnew) constructor.
...
Unlike [azurerm.cdn_frontdoor_endpoint.new](#fn-cdn_frontdoor_endpointnew), this function will not inject the `resource`
