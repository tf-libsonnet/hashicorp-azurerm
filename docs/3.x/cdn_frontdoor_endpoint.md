...
`azurerm.cdn_frontdoor_endpoint.withCdnFrontdoorProfileId` constructs a mixin object that can be merged into the `cdn_frontdoor_endpoint`
...
`azurerm.cdn_frontdoor_endpoint.withEnabled` constructs a mixin object that can be merged into the `cdn_frontdoor_endpoint`
...
`azurerm.cdn_frontdoor_endpoint.withTags` constructs a mixin object that can be merged into the `cdn_frontdoor_endpoint`
