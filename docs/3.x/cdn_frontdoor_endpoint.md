---
permalink: /cdn_frontdoor_endpoint/
---

# cdn_frontdoor_endpoint

`cdn_frontdoor_endpoint` represents the `azurerm_cdn_frontdoor_endpoint` Terraform resource.
...
**Args**:
  ...
  - `timeouts` (`obj`): Set the `timeouts` field on the resulting resource block. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.cdn_frontdoor_endpoint.timeouts.new](#fn-timeoutsnew) constructor.
...
Unlike [azurerm.cdn_frontdoor_endpoint.new](#fn-new), this function will not inject the `resource`
...
**Args**:
  ...
  - `timeouts` (`obj`): Set the `timeouts` field on the resulting object. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.cdn_frontdoor_endpoint.timeouts.new](#fn-timeoutsnew) constructor.
