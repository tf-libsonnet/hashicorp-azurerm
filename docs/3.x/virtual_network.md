...
`azurerm.virtual_network.withAddressSpace` constructs a mixin object that can be merged into the `virtual_network`
...
`azurerm.virtual_network.withBgpCommunity` constructs a mixin object that can be merged into the `virtual_network`
...
`azurerm.virtual_network.withDdosProtectionPlan` constructs a mixin object that can be merged into the `virtual_network`
...
`azurerm.virtual_network.withDdosProtectionPlanMixin` constructs a mixin object that can be merged into the `virtual_network`
Terraform resource block to set or update the ddos_protection_plan field.
...
`azurerm.virtual_network.withDnsServers` constructs a mixin object that can be merged into the `virtual_network`
...
`azurerm.virtual_network.withEdgeZone` constructs a mixin object that can be merged into the `virtual_network`
...
`azurerm.virtual_network.withFlowTimeoutInMinutes` constructs a mixin object that can be merged into the `virtual_network`
...
`azurerm.virtual_network.withLocation` constructs a mixin object that can be merged into the `virtual_network`
...
`azurerm.virtual_network.withName` constructs a mixin object that can be merged into the `virtual_network`
...
`azurerm.virtual_network.withResourceGroupName` constructs a mixin object that can be merged into the `virtual_network`
...
`azurerm.virtual_network.withSubnet` constructs a mixin object that can be merged into the `virtual_network`
...
`azurerm.virtual_network.withTags` constructs a mixin object that can be merged into the `virtual_network`
...
`azurerm.virtual_network.withTimeouts` constructs a mixin object that can be merged into the `virtual_network`
...
`azurerm.virtual_network.withTimeoutsMixin` constructs a mixin object that can be merged into the `virtual_network`
Terraform resource block to set or update the timeouts field.
