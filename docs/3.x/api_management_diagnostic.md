...
`azurerm.api_management_diagnostic.withAlwaysLogErrors` constructs a mixin object that can be merged into the `api_management_diagnostic`
...
`azurerm.api_management_diagnostic.withApiManagementLoggerId` constructs a mixin object that can be merged into the `api_management_diagnostic`
...
`azurerm.api_management_diagnostic.withApiManagementName` constructs a mixin object that can be merged into the `api_management_diagnostic`
...
`azurerm.api_management_diagnostic.withBackendRequest` constructs a mixin object that can be merged into the `api_management_diagnostic`
...
`azurerm.api_management_diagnostic.withBackendRequestMixin` constructs a mixin object that can be merged into the `api_management_diagnostic`
Terraform resource block to set or update the backend_request field.
...
`azurerm.api_management_diagnostic.withBackendResponse` constructs a mixin object that can be merged into the `api_management_diagnostic`
...
`azurerm.api_management_diagnostic.withBackendResponseMixin` constructs a mixin object that can be merged into the `api_management_diagnostic`
Terraform resource block to set or update the backend_response field.
...
`azurerm.api_management_diagnostic.withFrontendRequest` constructs a mixin object that can be merged into the `api_management_diagnostic`
...
`azurerm.api_management_diagnostic.withFrontendRequestMixin` constructs a mixin object that can be merged into the `api_management_diagnostic`
Terraform resource block to set or update the frontend_request field.
...
`azurerm.api_management_diagnostic.withFrontendResponse` constructs a mixin object that can be merged into the `api_management_diagnostic`
...
`azurerm.api_management_diagnostic.withFrontendResponseMixin` constructs a mixin object that can be merged into the `api_management_diagnostic`
Terraform resource block to set or update the frontend_response field.
...
`azurerm.api_management_diagnostic.withHttpCorrelationProtocol` constructs a mixin object that can be merged into the `api_management_diagnostic`
...
`azurerm.api_management_diagnostic.withIdentifier` constructs a mixin object that can be merged into the `api_management_diagnostic`
...
`azurerm.api_management_diagnostic.withLogClientIp` constructs a mixin object that can be merged into the `api_management_diagnostic`
...
`azurerm.api_management_diagnostic.withOperationNameFormat` constructs a mixin object that can be merged into the `api_management_diagnostic`
...
`azurerm.api_management_diagnostic.withResourceGroupName` constructs a mixin object that can be merged into the `api_management_diagnostic`
...
`azurerm.api_management_diagnostic.withSamplingPercentage` constructs a mixin object that can be merged into the `api_management_diagnostic`
...
`azurerm.api_management_diagnostic.withTimeouts` constructs a mixin object that can be merged into the `api_management_diagnostic`
...
`azurerm.api_management_diagnostic.withTimeoutsMixin` constructs a mixin object that can be merged into the `api_management_diagnostic`
Terraform resource block to set or update the timeouts field.
...
`azurerm.api_management_diagnostic.withVerbosity` constructs a mixin object that can be merged into the `api_management_diagnostic`
