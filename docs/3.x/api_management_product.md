...
`azurerm.api_management_product.withApprovalRequired` constructs a mixin object that can be merged into the `api_management_product`
...
`azurerm.api_management_product.withDescription` constructs a mixin object that can be merged into the `api_management_product`
...
`azurerm.api_management_product.withDisplayName` constructs a mixin object that can be merged into the `api_management_product`
...
`azurerm.api_management_product.withPublished` constructs a mixin object that can be merged into the `api_management_product`
...
`azurerm.api_management_product.withSubscriptionRequired` constructs a mixin object that can be merged into the `api_management_product`
...
`azurerm.api_management_product.withSubscriptionsLimit` constructs a mixin object that can be merged into the `api_management_product`
...
`azurerm.api_management_product.withTerms` constructs a mixin object that can be merged into the `api_management_product`
