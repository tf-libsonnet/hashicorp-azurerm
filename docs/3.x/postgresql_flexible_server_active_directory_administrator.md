...
`azurerm.postgresql_flexible_server_active_directory_administrator.withResourceGroupName` constructs a mixin object that can be merged into the `postgresql_flexible_server_active_directory_administrator`
