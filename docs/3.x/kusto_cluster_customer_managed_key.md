...
`azurerm.kusto_cluster_customer_managed_key.withClusterId` constructs a mixin object that can be merged into the `kusto_cluster_customer_managed_key`
...
`azurerm.kusto_cluster_customer_managed_key.withKeyName` constructs a mixin object that can be merged into the `kusto_cluster_customer_managed_key`
...
`azurerm.kusto_cluster_customer_managed_key.withKeyVaultId` constructs a mixin object that can be merged into the `kusto_cluster_customer_managed_key`
...
`azurerm.kusto_cluster_customer_managed_key.withKeyVersion` constructs a mixin object that can be merged into the `kusto_cluster_customer_managed_key`
...
`azurerm.kusto_cluster_customer_managed_key.withTimeouts` constructs a mixin object that can be merged into the `kusto_cluster_customer_managed_key`
...
`azurerm.kusto_cluster_customer_managed_key.withTimeoutsMixin` constructs a mixin object that can be merged into the `kusto_cluster_customer_managed_key`
Terraform resource block to set or update the timeouts field.
...
`azurerm.kusto_cluster_customer_managed_key.withUserIdentity` constructs a mixin object that can be merged into the `kusto_cluster_customer_managed_key`
