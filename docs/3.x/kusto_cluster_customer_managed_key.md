...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.kusto_cluster_customer_managed_key.timeouts.new](#fn-kusto_cluster_customer_managed_keytimeoutsnew) constructor.
...
Unlike [azurerm.kusto_cluster_customer_managed_key.new](#fn-kusto_cluster_customer_managed_keynew), this function will not inject the `resource`
