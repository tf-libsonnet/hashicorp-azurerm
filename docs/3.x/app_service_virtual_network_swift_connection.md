---
permalink: /app_service_virtual_network_swift_connection/
---

# app_service_virtual_network_swift_connection

`app_service_virtual_network_swift_connection` represents the `azurerm_app_service_virtual_network_swift_connection` Terraform resource.
...
`azurerm.app_service_virtual_network_swift_connection.withAppServiceId` constructs a mixin object that can be merged into the `app_service_virtual_network_swift_connection`
...
`azurerm.app_service_virtual_network_swift_connection.withSubnetId` constructs a mixin object that can be merged into the `app_service_virtual_network_swift_connection`
...
`azurerm.app_service_virtual_network_swift_connection.withTimeouts` constructs a mixin object that can be merged into the `app_service_virtual_network_swift_connection`
...
`azurerm.app_service_virtual_network_swift_connection.withTimeoutsMixin` constructs a mixin object that can be merged into the `app_service_virtual_network_swift_connection`
Terraform resource block to set or update the timeouts field.
