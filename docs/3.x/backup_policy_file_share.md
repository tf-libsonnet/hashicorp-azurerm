...
`azurerm.backup_policy_file_share.withBackup` constructs a mixin object that can be merged into the `backup_policy_file_share`
...
`azurerm.backup_policy_file_share.withBackupMixin` constructs a mixin object that can be merged into the `backup_policy_file_share`
Terraform resource block to set or update the backup field.
...
`azurerm.backup_policy_file_share.withRetentionDaily` constructs a mixin object that can be merged into the `backup_policy_file_share`
...
`azurerm.backup_policy_file_share.withRetentionDailyMixin` constructs a mixin object that can be merged into the `backup_policy_file_share`
Terraform resource block to set or update the retention_daily field.
...
`azurerm.backup_policy_file_share.withRetentionMonthly` constructs a mixin object that can be merged into the `backup_policy_file_share`
...
`azurerm.backup_policy_file_share.withRetentionMonthlyMixin` constructs a mixin object that can be merged into the `backup_policy_file_share`
Terraform resource block to set or update the retention_monthly field.
...
`azurerm.backup_policy_file_share.withRetentionWeekly` constructs a mixin object that can be merged into the `backup_policy_file_share`
...
`azurerm.backup_policy_file_share.withRetentionWeeklyMixin` constructs a mixin object that can be merged into the `backup_policy_file_share`
Terraform resource block to set or update the retention_weekly field.
...
`azurerm.backup_policy_file_share.withRetentionYearly` constructs a mixin object that can be merged into the `backup_policy_file_share`
...
`azurerm.backup_policy_file_share.withRetentionYearlyMixin` constructs a mixin object that can be merged into the `backup_policy_file_share`
Terraform resource block to set or update the retention_yearly field.
...
`azurerm.backup_policy_file_share.withTimezone` constructs a mixin object that can be merged into the `backup_policy_file_share`
