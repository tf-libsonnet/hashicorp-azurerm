...
`azurerm.stream_analytics_output_servicebus_queue.withAuthenticationMode` constructs a mixin object that can be merged into the `stream_analytics_output_servicebus_queue`
...
`azurerm.stream_analytics_output_servicebus_queue.withName` constructs a mixin object that can be merged into the `stream_analytics_output_servicebus_queue`
...
`azurerm.stream_analytics_output_servicebus_queue.withPropertyColumns` constructs a mixin object that can be merged into the `stream_analytics_output_servicebus_queue`
...
`azurerm.stream_analytics_output_servicebus_queue.withQueueName` constructs a mixin object that can be merged into the `stream_analytics_output_servicebus_queue`
...
`azurerm.stream_analytics_output_servicebus_queue.withResourceGroupName` constructs a mixin object that can be merged into the `stream_analytics_output_servicebus_queue`
...
`azurerm.stream_analytics_output_servicebus_queue.withSerialization` constructs a mixin object that can be merged into the `stream_analytics_output_servicebus_queue`
...
`azurerm.stream_analytics_output_servicebus_queue.withSerializationMixin` constructs a mixin object that can be merged into the `stream_analytics_output_servicebus_queue`
Terraform resource block to set or update the serialization field.
...
`azurerm.stream_analytics_output_servicebus_queue.withServicebusNamespace` constructs a mixin object that can be merged into the `stream_analytics_output_servicebus_queue`
...
`azurerm.stream_analytics_output_servicebus_queue.withSharedAccessPolicyKey` constructs a mixin object that can be merged into the `stream_analytics_output_servicebus_queue`
...
`azurerm.stream_analytics_output_servicebus_queue.withSharedAccessPolicyName` constructs a mixin object that can be merged into the `stream_analytics_output_servicebus_queue`
...
`azurerm.stream_analytics_output_servicebus_queue.withStreamAnalyticsJobName` constructs a mixin object that can be merged into the `stream_analytics_output_servicebus_queue`
...
`azurerm.stream_analytics_output_servicebus_queue.withSystemPropertyColumns` constructs a mixin object that can be merged into the `stream_analytics_output_servicebus_queue`
...
`azurerm.stream_analytics_output_servicebus_queue.withTimeouts` constructs a mixin object that can be merged into the `stream_analytics_output_servicebus_queue`
...
`azurerm.stream_analytics_output_servicebus_queue.withTimeoutsMixin` constructs a mixin object that can be merged into the `stream_analytics_output_servicebus_queue`
Terraform resource block to set or update the timeouts field.
