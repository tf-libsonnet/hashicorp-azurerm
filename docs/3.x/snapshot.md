...
`azurerm.snapshot.withCreateOption` constructs a mixin object that can be merged into the `snapshot`
...
`azurerm.snapshot.withDiskSizeGb` constructs a mixin object that can be merged into the `snapshot`
...
`azurerm.snapshot.withEncryptionSettings` constructs a mixin object that can be merged into the `snapshot`
...
`azurerm.snapshot.withEncryptionSettingsMixin` constructs a mixin object that can be merged into the `snapshot`
Terraform resource block to set or update the encryption_settings field.
...
`azurerm.snapshot.withLocation` constructs a mixin object that can be merged into the `snapshot`
...
`azurerm.snapshot.withSourceResourceId` constructs a mixin object that can be merged into the `snapshot`
...
`azurerm.snapshot.withSourceUri` constructs a mixin object that can be merged into the `snapshot`
...
`azurerm.snapshot.withStorageAccountId` constructs a mixin object that can be merged into the `snapshot`
...
`azurerm.snapshot.withTags` constructs a mixin object that can be merged into the `snapshot`
