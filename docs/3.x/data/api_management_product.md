...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.data.api_management_product.timeouts.new](#fn-api_management_producttimeoutsnew) constructor.
...
Unlike [azurerm.data.api_management_product.new](#fn-api_management_productnew), this function will not inject the `data source`
