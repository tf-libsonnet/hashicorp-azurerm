...
**Args**:
  ...
  - `service_id` (`string`): 
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.data.private_link_service_endpoint_connections.timeouts.new](#fn-private_link_service_endpoint_connectionstimeoutsnew) constructor.
...
Unlike [azurerm.data.private_link_service_endpoint_connections.new](#fn-private_link_service_endpoint_connectionsnew), this function will not inject the `data source`
