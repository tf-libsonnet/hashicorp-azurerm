...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.data.shared_image.timeouts.new](#fn-shared_imagetimeoutsnew) constructor.
...
Unlike [azurerm.data.shared_image.new](#fn-shared_imagenew), this function will not inject the `data source`
