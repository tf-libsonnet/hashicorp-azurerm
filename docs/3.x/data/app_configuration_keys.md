...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.data.app_configuration_keys.timeouts.new](#fn-app_configuration_keystimeoutsnew) constructor.
...
Unlike [azurerm.data.app_configuration_keys.new](#fn-app_configuration_keysnew), this function will not inject the `data source`
