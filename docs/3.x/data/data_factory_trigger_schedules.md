---
permalink: /data/data_factory_trigger_schedules/
---

# data.data_factory_trigger_schedules

`data_factory_trigger_schedules` represents the `azurerm_data_factory_trigger_schedules` Terraform data source.
