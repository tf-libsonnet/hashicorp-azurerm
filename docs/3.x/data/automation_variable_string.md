...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.data.automation_variable_string.timeouts.new](#fn-automation_variable_stringtimeoutsnew) constructor.
...
Unlike [azurerm.data.automation_variable_string.new](#fn-automation_variable_stringnew), this function will not inject the `data source`
