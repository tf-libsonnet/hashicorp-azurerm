---
permalink: /data/network_manager_network_group/
---

# data.network_manager_network_group

`network_manager_network_group` represents the `azurerm_network_manager_network_group` Terraform data source.
