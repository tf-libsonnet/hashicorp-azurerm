---
permalink: /data/container_app_environment_certificate/
---

# data.container_app_environment_certificate

`container_app_environment_certificate` represents the `azurerm_container_app_environment_certificate` Terraform data source.
