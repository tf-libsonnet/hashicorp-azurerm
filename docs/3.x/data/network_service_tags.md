...
`azurerm.string.withLocationFilter` constructs a mixin object that can be merged into the `string`
...
`azurerm.string.withService` constructs a mixin object that can be merged into the `string`
