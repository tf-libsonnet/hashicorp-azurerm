---
permalink: /data/data_factory_trigger_schedule/
---

# data.data_factory_trigger_schedule

`data_factory_trigger_schedule` represents the `azurerm_data_factory_trigger_schedule` Terraform data source.
