---
permalink: /data/key_vault_managed_hardware_security_module_role_definition/
---

# data.key_vault_managed_hardware_security_module_role_definition

`key_vault_managed_hardware_security_module_role_definition` represents the `azurerm_key_vault_managed_hardware_security_module_role_definition` Terraform data source.
