...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.data.storage_encryption_scope.timeouts.new](#fn-storage_encryption_scopetimeoutsnew) constructor.
...
Unlike [azurerm.data.storage_encryption_scope.new](#fn-storage_encryption_scopenew), this function will not inject the `data source`
