...
`azurerm.storage_account_sas.withConnectionString` constructs a mixin object that can be merged into the `storage_account_sas`
...
`azurerm.storage_account_sas.withExpiry` constructs a mixin object that can be merged into the `storage_account_sas`
...
`azurerm.storage_account_sas.withHttpsOnly` constructs a mixin object that can be merged into the `storage_account_sas`
...
`azurerm.storage_account_sas.withIpAddresses` constructs a mixin object that can be merged into the `storage_account_sas`
...
`azurerm.storage_account_sas.withPermissions` constructs a mixin object that can be merged into the `storage_account_sas`
...
`azurerm.storage_account_sas.withPermissionsMixin` constructs a mixin object that can be merged into the `storage_account_sas`
Terraform data source block to set or update the permissions field.
...
`azurerm.storage_account_sas.withResourceTypes` constructs a mixin object that can be merged into the `storage_account_sas`
...
`azurerm.storage_account_sas.withResourceTypesMixin` constructs a mixin object that can be merged into the `storage_account_sas`
Terraform data source block to set or update the resource_types field.
...
`azurerm.storage_account_sas.withServices` constructs a mixin object that can be merged into the `storage_account_sas`
...
`azurerm.storage_account_sas.withServicesMixin` constructs a mixin object that can be merged into the `storage_account_sas`
Terraform data source block to set or update the services field.
...
`azurerm.storage_account_sas.withSignedVersion` constructs a mixin object that can be merged into the `storage_account_sas`
...
`azurerm.storage_account_sas.withStart` constructs a mixin object that can be merged into the `storage_account_sas`
...
`azurerm.storage_account_sas.withTimeouts` constructs a mixin object that can be merged into the `storage_account_sas`
...
`azurerm.storage_account_sas.withTimeoutsMixin` constructs a mixin object that can be merged into the `storage_account_sas`
Terraform data source block to set or update the timeouts field.
