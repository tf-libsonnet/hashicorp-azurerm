...
`resources` represents the `azurerm_resources` Terraform data source.
...
* [`fn withRequiredTags()`](#fn-withrequiredtags)
...
`azurerm.resources.withName` constructs a mixin object that can be merged into the `resources`
...
`azurerm.resources.withRequiredTags` constructs a mixin object that can be merged into the `resources`
...
`azurerm.resources.withResourceGroupName` constructs a mixin object that can be merged into the `resources`
...
`azurerm.resources.withTimeouts` constructs a mixin object that can be merged into the `resources`
...
`azurerm.resources.withTimeoutsMixin` constructs a mixin object that can be merged into the `resources`
Terraform data source block to set or update the timeouts field.
...
`azurerm.resources.withType` constructs a mixin object that can be merged into the `resources`
