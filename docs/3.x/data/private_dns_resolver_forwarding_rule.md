---
permalink: /data/private_dns_resolver_forwarding_rule/
---

# data.private_dns_resolver_forwarding_rule

`private_dns_resolver_forwarding_rule` represents the `azurerm_private_dns_resolver_forwarding_rule` Terraform data source.
