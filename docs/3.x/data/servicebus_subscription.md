...
`azurerm.servicebus_subscription.withNamespaceName` constructs a mixin object that can be merged into the `servicebus_subscription`
...
`azurerm.servicebus_subscription.withResourceGroupName` constructs a mixin object that can be merged into the `servicebus_subscription`
...
`azurerm.servicebus_subscription.withTopicName` constructs a mixin object that can be merged into the `servicebus_subscription`
