...
`azurerm.storage_account_blob_container_sas.withCacheControl` constructs a mixin object that can be merged into the `storage_account_blob_container_sas`
...
`azurerm.storage_account_blob_container_sas.withConnectionString` constructs a mixin object that can be merged into the `storage_account_blob_container_sas`
...
`azurerm.storage_account_blob_container_sas.withContainerName` constructs a mixin object that can be merged into the `storage_account_blob_container_sas`
...
`azurerm.storage_account_blob_container_sas.withContentDisposition` constructs a mixin object that can be merged into the `storage_account_blob_container_sas`
...
`azurerm.storage_account_blob_container_sas.withContentEncoding` constructs a mixin object that can be merged into the `storage_account_blob_container_sas`
...
`azurerm.storage_account_blob_container_sas.withContentLanguage` constructs a mixin object that can be merged into the `storage_account_blob_container_sas`
...
`azurerm.storage_account_blob_container_sas.withContentType` constructs a mixin object that can be merged into the `storage_account_blob_container_sas`
...
`azurerm.storage_account_blob_container_sas.withExpiry` constructs a mixin object that can be merged into the `storage_account_blob_container_sas`
...
`azurerm.storage_account_blob_container_sas.withHttpsOnly` constructs a mixin object that can be merged into the `storage_account_blob_container_sas`
...
`azurerm.storage_account_blob_container_sas.withIpAddress` constructs a mixin object that can be merged into the `storage_account_blob_container_sas`
...
`azurerm.storage_account_blob_container_sas.withPermissions` constructs a mixin object that can be merged into the `storage_account_blob_container_sas`
...
`azurerm.storage_account_blob_container_sas.withPermissionsMixin` constructs a mixin object that can be merged into the `storage_account_blob_container_sas`
Terraform data source block to set or update the permissions field.
...
`azurerm.storage_account_blob_container_sas.withStart` constructs a mixin object that can be merged into the `storage_account_blob_container_sas`
...
`azurerm.storage_account_blob_container_sas.withTimeouts` constructs a mixin object that can be merged into the `storage_account_blob_container_sas`
...
`azurerm.storage_account_blob_container_sas.withTimeoutsMixin` constructs a mixin object that can be merged into the `storage_account_blob_container_sas`
Terraform data source block to set or update the timeouts field.
