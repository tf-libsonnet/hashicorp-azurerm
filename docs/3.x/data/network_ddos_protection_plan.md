...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.data.network_ddos_protection_plan.timeouts.new](#fn-network_ddos_protection_plantimeoutsnew) constructor.
...
Unlike [azurerm.data.network_ddos_protection_plan.new](#fn-network_ddos_protection_plannew), this function will not inject the `data source`
