...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.data.cdn_frontdoor_secret.timeouts.new](#fn-cdn_frontdoor_secrettimeoutsnew) constructor.
...
Unlike [azurerm.data.cdn_frontdoor_secret.new](#fn-cdn_frontdoor_secretnew), this function will not inject the `data source`
