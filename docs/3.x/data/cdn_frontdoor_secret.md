...
`azurerm.cdn_frontdoor_secret.withProfileName` constructs a mixin object that can be merged into the `cdn_frontdoor_secret`
...
`azurerm.cdn_frontdoor_secret.withResourceGroupName` constructs a mixin object that can be merged into the `cdn_frontdoor_secret`
