---
permalink: /data/cdn_frontdoor_secret/
---

# data.cdn_frontdoor_secret

`cdn_frontdoor_secret` represents the `azurerm_cdn_frontdoor_secret` Terraform data source.
...
**Args**:
  ...
  - `timeouts` (`obj`): Set the `timeouts` field on the resulting data source block. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.data.cdn_frontdoor_secret.timeouts.new](#fn-timeoutsnew) constructor.
...
Unlike [azurerm.data.cdn_frontdoor_secret.new](#fn-new), this function will not inject the `data source`
...
**Args**:
  ...
  - `timeouts` (`obj`): Set the `timeouts` field on the resulting object. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.data.cdn_frontdoor_secret.timeouts.new](#fn-timeoutsnew) constructor.
