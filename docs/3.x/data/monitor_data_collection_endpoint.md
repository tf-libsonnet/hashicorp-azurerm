...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.data.monitor_data_collection_endpoint.timeouts.new](#fn-monitor_data_collection_endpointtimeoutsnew) constructor.
...
Unlike [azurerm.data.monitor_data_collection_endpoint.new](#fn-monitor_data_collection_endpointnew), this function will not inject the `data source`
