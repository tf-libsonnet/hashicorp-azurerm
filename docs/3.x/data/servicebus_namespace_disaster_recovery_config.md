...
**Args**:
  ...
  - `alias_authorization_rule_id` (`string`): Set the `alias_authorization_rule_id` field on the resulting data source block. When `null`, the `alias_authorization_rule_id` field will be omitted from the resulting object.
...
Unlike [azurerm.data.servicebus_namespace_disaster_recovery_config.new](#fn-new), this function will not inject the `data source`
