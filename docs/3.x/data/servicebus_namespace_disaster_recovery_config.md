...
`azurerm.servicebus_namespace_disaster_recovery_config.withNamespaceName` constructs a mixin object that can be merged into the `servicebus_namespace_disaster_recovery_config`
