---
permalink: /data/virtual_desktop_workspace/
---

# data.virtual_desktop_workspace

`virtual_desktop_workspace` represents the `azurerm_virtual_desktop_workspace` Terraform data source.
