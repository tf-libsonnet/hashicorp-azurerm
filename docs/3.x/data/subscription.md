...
**Args**:
  ...
  - `subscription_id` (`string`): Set the `subscription_id` field on the resulting data source block. When `null`, the `subscription_id` field will be omitted from the resulting object.
  - `timeouts` (`obj`): Set the `timeouts` field on the resulting data source block. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.data.subscription.timeouts.new](#fn-timeoutsnew) constructor.
...
Unlike [azurerm.data.subscription.new](#fn-new), this function will not inject the `data source`
...
**Args**:
  ...
  - `timeouts` (`obj`): Set the `timeouts` field on the resulting object. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.data.subscription.timeouts.new](#fn-timeoutsnew) constructor.
