---
permalink: /data/palo_alto_local_rulestack/
---

# data.palo_alto_local_rulestack

`palo_alto_local_rulestack` represents the `azurerm_palo_alto_local_rulestack` Terraform data source.
