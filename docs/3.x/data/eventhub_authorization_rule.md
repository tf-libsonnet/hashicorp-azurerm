...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.data.eventhub_authorization_rule.timeouts.new](#fn-eventhub_authorization_ruletimeoutsnew) constructor.
...
Unlike [azurerm.data.eventhub_authorization_rule.new](#fn-eventhub_authorization_rulenew), this function will not inject the `data source`
