...
`azurerm.public_maintenance_configurations.withLocation` constructs a mixin object that can be merged into the `public_maintenance_configurations`
...
`azurerm.public_maintenance_configurations.withRecurEvery` constructs a mixin object that can be merged into the `public_maintenance_configurations`
...
`azurerm.public_maintenance_configurations.withScope` constructs a mixin object that can be merged into the `public_maintenance_configurations`
...
`azurerm.public_maintenance_configurations.withTimeouts` constructs a mixin object that can be merged into the `public_maintenance_configurations`
...
`azurerm.public_maintenance_configurations.withTimeoutsMixin` constructs a mixin object that can be merged into the `public_maintenance_configurations`
Terraform data source block to set or update the timeouts field.
