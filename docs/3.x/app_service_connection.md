...
`azurerm.app_service_connection.withAppServiceId` constructs a mixin object that can be merged into the `app_service_connection`
...
`azurerm.app_service_connection.withAuthentication` constructs a mixin object that can be merged into the `app_service_connection`
...
`azurerm.app_service_connection.withAuthenticationMixin` constructs a mixin object that can be merged into the `app_service_connection`
Terraform resource block to set or update the authentication field.
...
`azurerm.app_service_connection.withClientType` constructs a mixin object that can be merged into the `app_service_connection`
...
`azurerm.app_service_connection.withName` constructs a mixin object that can be merged into the `app_service_connection`
...
`azurerm.app_service_connection.withTargetResourceId` constructs a mixin object that can be merged into the `app_service_connection`
...
`azurerm.app_service_connection.withTimeouts` constructs a mixin object that can be merged into the `app_service_connection`
...
`azurerm.app_service_connection.withTimeoutsMixin` constructs a mixin object that can be merged into the `app_service_connection`
Terraform resource block to set or update the timeouts field.
...
`azurerm.app_service_connection.withVnetSolution` constructs a mixin object that can be merged into the `app_service_connection`
