---
permalink: /databox_edge_device/
---

# databox_edge_device

`databox_edge_device` represents the `azurerm_databox_edge_device` Terraform resource.
...
`azurerm.databox_edge_device.withLocation` constructs a mixin object that can be merged into the `databox_edge_device`
...
`azurerm.databox_edge_device.withName` constructs a mixin object that can be merged into the `databox_edge_device`
...
`azurerm.databox_edge_device.withResourceGroupName` constructs a mixin object that can be merged into the `databox_edge_device`
...
`azurerm.databox_edge_device.withSkuName` constructs a mixin object that can be merged into the `databox_edge_device`
...
`azurerm.databox_edge_device.withTags` constructs a mixin object that can be merged into the `databox_edge_device`
...
`azurerm.databox_edge_device.withTimeouts` constructs a mixin object that can be merged into the `databox_edge_device`
...
`azurerm.databox_edge_device.withTimeoutsMixin` constructs a mixin object that can be merged into the `databox_edge_device`
Terraform resource block to set or update the timeouts field.
