...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.databox_edge_device.timeouts.new](#fn-databox_edge_devicetimeoutsnew) constructor.
...
Unlike [azurerm.databox_edge_device.new](#fn-databox_edge_devicenew), this function will not inject the `resource`
