...
`azurerm.api_management_subscription.withAllowTracing` constructs a mixin object that can be merged into the `api_management_subscription`
...
`azurerm.api_management_subscription.withApiId` constructs a mixin object that can be merged into the `api_management_subscription`
...
`azurerm.api_management_subscription.withApiManagementName` constructs a mixin object that can be merged into the `api_management_subscription`
...
`azurerm.api_management_subscription.withDisplayName` constructs a mixin object that can be merged into the `api_management_subscription`
...
`azurerm.api_management_subscription.withPrimaryKey` constructs a mixin object that can be merged into the `api_management_subscription`
...
`azurerm.api_management_subscription.withProductId` constructs a mixin object that can be merged into the `api_management_subscription`
...
`azurerm.api_management_subscription.withResourceGroupName` constructs a mixin object that can be merged into the `api_management_subscription`
...
`azurerm.api_management_subscription.withSecondaryKey` constructs a mixin object that can be merged into the `api_management_subscription`
...
`azurerm.api_management_subscription.withState` constructs a mixin object that can be merged into the `api_management_subscription`
...
`azurerm.api_management_subscription.withSubscriptionId` constructs a mixin object that can be merged into the `api_management_subscription`
...
`azurerm.api_management_subscription.withTimeouts` constructs a mixin object that can be merged into the `api_management_subscription`
...
`azurerm.api_management_subscription.withTimeoutsMixin` constructs a mixin object that can be merged into the `api_management_subscription`
Terraform resource block to set or update the timeouts field.
...
`azurerm.api_management_subscription.withUserId` constructs a mixin object that can be merged into the `api_management_subscription`
