...
`azurerm.automation_connection_service_principal.withDescription` constructs a mixin object that can be merged into the `automation_connection_service_principal`
