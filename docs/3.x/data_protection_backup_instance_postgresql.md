...
`azurerm.data_protection_backup_instance_postgresql.withLocation` constructs a mixin object that can be merged into the `data_protection_backup_instance_postgresql`
