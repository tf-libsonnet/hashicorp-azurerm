...
**Args**:
  ...
  - `rule` (`list[obj]`): Set the `rule` field on the resulting resource block. When `null`, the `rule` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.firewall_nat_rule_collection.rule.new](#fn-rulenew) constructor.
  - `timeouts` (`obj`): Set the `timeouts` field on the resulting resource block. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.firewall_nat_rule_collection.timeouts.new](#fn-timeoutsnew) constructor.
...
**Args**:
  ...
  - `rule` (`list[obj]`): Set the `rule` field on the resulting object. When `null`, the `rule` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.firewall_nat_rule_collection.rule.new](#fn-rulenew) constructor.
  - `timeouts` (`obj`): Set the `timeouts` field on the resulting object. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.firewall_nat_rule_collection.timeouts.new](#fn-timeoutsnew) constructor.
...
**Args**:
  ...
  - `destination_addresses` (`list`): Set the `destination_addresses` field on the resulting object.
  ...
  - `translated_address` (`string`): Set the `translated_address` field on the resulting object.
  - `translated_port` (`string`): Set the `translated_port` field on the resulting object.
