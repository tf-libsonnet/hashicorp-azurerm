...
`azurerm.shared_image.withAcceleratedNetworkSupportEnabled` constructs a mixin object that can be merged into the `shared_image`
...
`azurerm.shared_image.withArchitecture` constructs a mixin object that can be merged into the `shared_image`
...
`azurerm.shared_image.withDescription` constructs a mixin object that can be merged into the `shared_image`
...
`azurerm.shared_image.withDiskTypesNotAllowed` constructs a mixin object that can be merged into the `shared_image`
...
`azurerm.shared_image.withEndOfLifeDate` constructs a mixin object that can be merged into the `shared_image`
...
`azurerm.shared_image.withEula` constructs a mixin object that can be merged into the `shared_image`
...
`azurerm.shared_image.withGalleryName` constructs a mixin object that can be merged into the `shared_image`
...
`azurerm.shared_image.withHyperVGeneration` constructs a mixin object that can be merged into the `shared_image`
...
`azurerm.shared_image.withIdentifier` constructs a mixin object that can be merged into the `shared_image`
...
`azurerm.shared_image.withIdentifierMixin` constructs a mixin object that can be merged into the `shared_image`
Terraform resource block to set or update the identifier field.
...
`azurerm.shared_image.withLocation` constructs a mixin object that can be merged into the `shared_image`
...
`azurerm.shared_image.withMaxRecommendedMemoryInGb` constructs a mixin object that can be merged into the `shared_image`
...
`azurerm.shared_image.withMaxRecommendedVcpuCount` constructs a mixin object that can be merged into the `shared_image`
...
`azurerm.shared_image.withMinRecommendedMemoryInGb` constructs a mixin object that can be merged into the `shared_image`
...
`azurerm.shared_image.withMinRecommendedVcpuCount` constructs a mixin object that can be merged into the `shared_image`
...
`azurerm.shared_image.withName` constructs a mixin object that can be merged into the `shared_image`
...
`azurerm.shared_image.withOsType` constructs a mixin object that can be merged into the `shared_image`
...
`azurerm.shared_image.withPrivacyStatementUri` constructs a mixin object that can be merged into the `shared_image`
...
`azurerm.shared_image.withPurchasePlan` constructs a mixin object that can be merged into the `shared_image`
...
`azurerm.shared_image.withPurchasePlanMixin` constructs a mixin object that can be merged into the `shared_image`
Terraform resource block to set or update the purchase_plan field.
...
`azurerm.shared_image.withReleaseNoteUri` constructs a mixin object that can be merged into the `shared_image`
...
`azurerm.shared_image.withResourceGroupName` constructs a mixin object that can be merged into the `shared_image`
...
`azurerm.shared_image.withSpecialized` constructs a mixin object that can be merged into the `shared_image`
...
`azurerm.shared_image.withTags` constructs a mixin object that can be merged into the `shared_image`
...
`azurerm.shared_image.withTimeouts` constructs a mixin object that can be merged into the `shared_image`
...
`azurerm.shared_image.withTimeoutsMixin` constructs a mixin object that can be merged into the `shared_image`
Terraform resource block to set or update the timeouts field.
...
`azurerm.shared_image.withTrustedLaunchEnabled` constructs a mixin object that can be merged into the `shared_image`
