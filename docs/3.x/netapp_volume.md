...
`azurerm.netapp_volume.withAzureVmwareDataStoreEnabled` constructs a mixin object that can be merged into the `netapp_volume`
...
`azurerm.netapp_volume.withCreateFromSnapshotResourceId` constructs a mixin object that can be merged into the `netapp_volume`
...
`azurerm.netapp_volume.withDataProtectionReplication` constructs a mixin object that can be merged into the `netapp_volume`
...
`azurerm.netapp_volume.withDataProtectionReplicationMixin` constructs a mixin object that can be merged into the `netapp_volume`
Terraform resource block to set or update the data_protection_replication field.
...
`azurerm.netapp_volume.withDataProtectionSnapshotPolicy` constructs a mixin object that can be merged into the `netapp_volume`
...
`azurerm.netapp_volume.withDataProtectionSnapshotPolicyMixin` constructs a mixin object that can be merged into the `netapp_volume`
Terraform resource block to set or update the data_protection_snapshot_policy field.
...
`azurerm.netapp_volume.withExportPolicyRule` constructs a mixin object that can be merged into the `netapp_volume`
...
`azurerm.netapp_volume.withExportPolicyRuleMixin` constructs a mixin object that can be merged into the `netapp_volume`
Terraform resource block to set or update the export_policy_rule field.
...
`azurerm.netapp_volume.withLocation` constructs a mixin object that can be merged into the `netapp_volume`
...
`azurerm.netapp_volume.withNetworkFeatures` constructs a mixin object that can be merged into the `netapp_volume`
...
`azurerm.netapp_volume.withProtocols` constructs a mixin object that can be merged into the `netapp_volume`
...
`azurerm.netapp_volume.withServiceLevel` constructs a mixin object that can be merged into the `netapp_volume`
...
`azurerm.netapp_volume.withSnapshotDirectoryVisible` constructs a mixin object that can be merged into the `netapp_volume`
...
`azurerm.netapp_volume.withStorageQuotaInGb` constructs a mixin object that can be merged into the `netapp_volume`
...
`azurerm.netapp_volume.withSubnetId` constructs a mixin object that can be merged into the `netapp_volume`
...
`azurerm.netapp_volume.withTags` constructs a mixin object that can be merged into the `netapp_volume`
...
`azurerm.netapp_volume.withThroughputInMibps` constructs a mixin object that can be merged into the `netapp_volume`
...
`azurerm.netapp_volume.withVolumePath` constructs a mixin object that can be merged into the `netapp_volume`
