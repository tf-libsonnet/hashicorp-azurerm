...
`azurerm.hdinsight_hbase_cluster.withClusterVersion` constructs a mixin object that can be merged into the `hdinsight_hbase_cluster`
...
`azurerm.hdinsight_hbase_cluster.withComponentVersion` constructs a mixin object that can be merged into the `hdinsight_hbase_cluster`
...
`azurerm.hdinsight_hbase_cluster.withComponentVersionMixin` constructs a mixin object that can be merged into the `hdinsight_hbase_cluster`
Terraform resource block to set or update the component_version field.
...
`azurerm.hdinsight_hbase_cluster.withComputeIsolation` constructs a mixin object that can be merged into the `hdinsight_hbase_cluster`
...
`azurerm.hdinsight_hbase_cluster.withComputeIsolationMixin` constructs a mixin object that can be merged into the `hdinsight_hbase_cluster`
Terraform resource block to set or update the compute_isolation field.
...
`azurerm.hdinsight_hbase_cluster.withDiskEncryption` constructs a mixin object that can be merged into the `hdinsight_hbase_cluster`
...
`azurerm.hdinsight_hbase_cluster.withDiskEncryptionMixin` constructs a mixin object that can be merged into the `hdinsight_hbase_cluster`
Terraform resource block to set or update the disk_encryption field.
...
`azurerm.hdinsight_hbase_cluster.withExtension` constructs a mixin object that can be merged into the `hdinsight_hbase_cluster`
...
`azurerm.hdinsight_hbase_cluster.withExtensionMixin` constructs a mixin object that can be merged into the `hdinsight_hbase_cluster`
Terraform resource block to set or update the extension field.
...
`azurerm.hdinsight_hbase_cluster.withGateway` constructs a mixin object that can be merged into the `hdinsight_hbase_cluster`
...
`azurerm.hdinsight_hbase_cluster.withGatewayMixin` constructs a mixin object that can be merged into the `hdinsight_hbase_cluster`
Terraform resource block to set or update the gateway field.
...
`azurerm.hdinsight_hbase_cluster.withLocation` constructs a mixin object that can be merged into the `hdinsight_hbase_cluster`
...
`azurerm.hdinsight_hbase_cluster.withMetastores` constructs a mixin object that can be merged into the `hdinsight_hbase_cluster`
...
`azurerm.hdinsight_hbase_cluster.withMetastoresMixin` constructs a mixin object that can be merged into the `hdinsight_hbase_cluster`
Terraform resource block to set or update the metastores field.
...
`azurerm.hdinsight_hbase_cluster.withMonitor` constructs a mixin object that can be merged into the `hdinsight_hbase_cluster`
...
`azurerm.hdinsight_hbase_cluster.withMonitorMixin` constructs a mixin object that can be merged into the `hdinsight_hbase_cluster`
Terraform resource block to set or update the monitor field.
...
`azurerm.hdinsight_hbase_cluster.withName` constructs a mixin object that can be merged into the `hdinsight_hbase_cluster`
...
`azurerm.hdinsight_hbase_cluster.withNetwork` constructs a mixin object that can be merged into the `hdinsight_hbase_cluster`
...
`azurerm.hdinsight_hbase_cluster.withNetworkMixin` constructs a mixin object that can be merged into the `hdinsight_hbase_cluster`
Terraform resource block to set or update the network field.
...
`azurerm.hdinsight_hbase_cluster.withResourceGroupName` constructs a mixin object that can be merged into the `hdinsight_hbase_cluster`
...
`azurerm.hdinsight_hbase_cluster.withRoles` constructs a mixin object that can be merged into the `hdinsight_hbase_cluster`
...
`azurerm.hdinsight_hbase_cluster.withRolesMixin` constructs a mixin object that can be merged into the `hdinsight_hbase_cluster`
Terraform resource block to set or update the roles field.
...
`azurerm.hdinsight_hbase_cluster.withSecurityProfile` constructs a mixin object that can be merged into the `hdinsight_hbase_cluster`
...
`azurerm.hdinsight_hbase_cluster.withSecurityProfileMixin` constructs a mixin object that can be merged into the `hdinsight_hbase_cluster`
Terraform resource block to set or update the security_profile field.
...
`azurerm.hdinsight_hbase_cluster.withStorageAccount` constructs a mixin object that can be merged into the `hdinsight_hbase_cluster`
...
`azurerm.hdinsight_hbase_cluster.withStorageAccountGen2` constructs a mixin object that can be merged into the `hdinsight_hbase_cluster`
...
`azurerm.hdinsight_hbase_cluster.withStorageAccountGen2Mixin` constructs a mixin object that can be merged into the `hdinsight_hbase_cluster`
Terraform resource block to set or update the storage_account_gen2 field.
...
`azurerm.hdinsight_hbase_cluster.withStorageAccountMixin` constructs a mixin object that can be merged into the `hdinsight_hbase_cluster`
Terraform resource block to set or update the storage_account field.
...
`azurerm.hdinsight_hbase_cluster.withTags` constructs a mixin object that can be merged into the `hdinsight_hbase_cluster`
...
`azurerm.hdinsight_hbase_cluster.withTier` constructs a mixin object that can be merged into the `hdinsight_hbase_cluster`
...
`azurerm.hdinsight_hbase_cluster.withTimeouts` constructs a mixin object that can be merged into the `hdinsight_hbase_cluster`
...
`azurerm.hdinsight_hbase_cluster.withTimeoutsMixin` constructs a mixin object that can be merged into the `hdinsight_hbase_cluster`
Terraform resource block to set or update the timeouts field.
...
`azurerm.hdinsight_hbase_cluster.withTlsMinVersion` constructs a mixin object that can be merged into the `hdinsight_hbase_cluster`
