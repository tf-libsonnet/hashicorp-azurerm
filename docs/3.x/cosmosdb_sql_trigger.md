...
`azurerm.cosmosdb_sql_trigger.withBody` constructs a mixin object that can be merged into the `cosmosdb_sql_trigger`
...
`azurerm.cosmosdb_sql_trigger.withContainerId` constructs a mixin object that can be merged into the `cosmosdb_sql_trigger`
...
`azurerm.cosmosdb_sql_trigger.withName` constructs a mixin object that can be merged into the `cosmosdb_sql_trigger`
...
`azurerm.cosmosdb_sql_trigger.withOperation` constructs a mixin object that can be merged into the `cosmosdb_sql_trigger`
...
`azurerm.cosmosdb_sql_trigger.withTimeouts` constructs a mixin object that can be merged into the `cosmosdb_sql_trigger`
...
`azurerm.cosmosdb_sql_trigger.withTimeoutsMixin` constructs a mixin object that can be merged into the `cosmosdb_sql_trigger`
Terraform resource block to set or update the timeouts field.
...
`azurerm.cosmosdb_sql_trigger.withType` constructs a mixin object that can be merged into the `cosmosdb_sql_trigger`
