...
`azurerm.kusto_cluster.withAllowedFqdns` constructs a mixin object that can be merged into the `kusto_cluster`
...
`azurerm.kusto_cluster.withAllowedIpRanges` constructs a mixin object that can be merged into the `kusto_cluster`
...
`azurerm.kusto_cluster.withAutoStopEnabled` constructs a mixin object that can be merged into the `kusto_cluster`
...
`azurerm.kusto_cluster.withDiskEncryptionEnabled` constructs a mixin object that can be merged into the `kusto_cluster`
...
`azurerm.kusto_cluster.withDoubleEncryptionEnabled` constructs a mixin object that can be merged into the `kusto_cluster`
...
`azurerm.kusto_cluster.withEngine` constructs a mixin object that can be merged into the `kusto_cluster`
...
`azurerm.kusto_cluster.withIdentity` constructs a mixin object that can be merged into the `kusto_cluster`
...
`azurerm.kusto_cluster.withIdentityMixin` constructs a mixin object that can be merged into the `kusto_cluster`
Terraform resource block to set or update the identity field.
...
`azurerm.kusto_cluster.withLanguageExtensions` constructs a mixin object that can be merged into the `kusto_cluster`
...
`azurerm.kusto_cluster.withLocation` constructs a mixin object that can be merged into the `kusto_cluster`
...
`azurerm.kusto_cluster.withName` constructs a mixin object that can be merged into the `kusto_cluster`
...
`azurerm.kusto_cluster.withOptimizedAutoScale` constructs a mixin object that can be merged into the `kusto_cluster`
...
`azurerm.kusto_cluster.withOptimizedAutoScaleMixin` constructs a mixin object that can be merged into the `kusto_cluster`
Terraform resource block to set or update the optimized_auto_scale field.
...
`azurerm.kusto_cluster.withOutboundNetworkAccessRestricted` constructs a mixin object that can be merged into the `kusto_cluster`
...
`azurerm.kusto_cluster.withPublicIpType` constructs a mixin object that can be merged into the `kusto_cluster`
...
`azurerm.kusto_cluster.withPublicNetworkAccessEnabled` constructs a mixin object that can be merged into the `kusto_cluster`
...
`azurerm.kusto_cluster.withPurgeEnabled` constructs a mixin object that can be merged into the `kusto_cluster`
...
`azurerm.kusto_cluster.withResourceGroupName` constructs a mixin object that can be merged into the `kusto_cluster`
...
`azurerm.kusto_cluster.withSku` constructs a mixin object that can be merged into the `kusto_cluster`
...
`azurerm.kusto_cluster.withSkuMixin` constructs a mixin object that can be merged into the `kusto_cluster`
Terraform resource block to set or update the sku field.
...
`azurerm.kusto_cluster.withStreamingIngestionEnabled` constructs a mixin object that can be merged into the `kusto_cluster`
...
`azurerm.kusto_cluster.withTags` constructs a mixin object that can be merged into the `kusto_cluster`
...
`azurerm.kusto_cluster.withTimeouts` constructs a mixin object that can be merged into the `kusto_cluster`
...
`azurerm.kusto_cluster.withTimeoutsMixin` constructs a mixin object that can be merged into the `kusto_cluster`
Terraform resource block to set or update the timeouts field.
...
`azurerm.kusto_cluster.withTrustedExternalTenants` constructs a mixin object that can be merged into the `kusto_cluster`
...
`azurerm.kusto_cluster.withVirtualNetworkConfiguration` constructs a mixin object that can be merged into the `kusto_cluster`
...
`azurerm.kusto_cluster.withVirtualNetworkConfigurationMixin` constructs a mixin object that can be merged into the `kusto_cluster`
Terraform resource block to set or update the virtual_network_configuration field.
...
`azurerm.kusto_cluster.withZones` constructs a mixin object that can be merged into the `kusto_cluster`
