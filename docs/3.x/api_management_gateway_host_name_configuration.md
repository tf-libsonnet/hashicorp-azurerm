...
`azurerm.api_management_gateway_host_name_configuration.withCertificateId` constructs a mixin object that can be merged into the `api_management_gateway_host_name_configuration`
...
`azurerm.api_management_gateway_host_name_configuration.withHostName` constructs a mixin object that can be merged into the `api_management_gateway_host_name_configuration`
...
`azurerm.api_management_gateway_host_name_configuration.withHttp2Enabled` constructs a mixin object that can be merged into the `api_management_gateway_host_name_configuration`
...
`azurerm.api_management_gateway_host_name_configuration.withRequestClientCertificateEnabled` constructs a mixin object that can be merged into the `api_management_gateway_host_name_configuration`
...
`azurerm.api_management_gateway_host_name_configuration.withTls10Enabled` constructs a mixin object that can be merged into the `api_management_gateway_host_name_configuration`
...
`azurerm.api_management_gateway_host_name_configuration.withTls11Enabled` constructs a mixin object that can be merged into the `api_management_gateway_host_name_configuration`
