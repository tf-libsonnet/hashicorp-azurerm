...
`azurerm.media_live_event_output.withArchiveWindowDuration` constructs a mixin object that can be merged into the `media_live_event_output`
...
`azurerm.media_live_event_output.withAssetName` constructs a mixin object that can be merged into the `media_live_event_output`
...
`azurerm.media_live_event_output.withDescription` constructs a mixin object that can be merged into the `media_live_event_output`
...
`azurerm.media_live_event_output.withHlsFragmentsPerTsSegment` constructs a mixin object that can be merged into the `media_live_event_output`
...
`azurerm.media_live_event_output.withLiveEventId` constructs a mixin object that can be merged into the `media_live_event_output`
...
`azurerm.media_live_event_output.withManifestName` constructs a mixin object that can be merged into the `media_live_event_output`
...
`azurerm.media_live_event_output.withName` constructs a mixin object that can be merged into the `media_live_event_output`
...
`azurerm.media_live_event_output.withOutputSnapTimeInSeconds` constructs a mixin object that can be merged into the `media_live_event_output`
...
`azurerm.media_live_event_output.withTimeouts` constructs a mixin object that can be merged into the `media_live_event_output`
...
`azurerm.media_live_event_output.withTimeoutsMixin` constructs a mixin object that can be merged into the `media_live_event_output`
Terraform resource block to set or update the timeouts field.
