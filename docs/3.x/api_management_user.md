...
**Args**:
  ...
  - `user_id` (`string`): 
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management_user.timeouts.new](#fn-api_management_usertimeoutsnew) constructor.
...
Unlike [azurerm.api_management_user.new](#fn-api_management_usernew), this function will not inject the `resource`
