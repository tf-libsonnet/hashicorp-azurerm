...
`azurerm.redis_cache.withCapacity` constructs a mixin object that can be merged into the `redis_cache`
...
`azurerm.redis_cache.withEnableNonSslPort` constructs a mixin object that can be merged into the `redis_cache`
...
`azurerm.redis_cache.withFamily` constructs a mixin object that can be merged into the `redis_cache`
...
`azurerm.redis_cache.withIdentity` constructs a mixin object that can be merged into the `redis_cache`
...
`azurerm.redis_cache.withIdentityMixin` constructs a mixin object that can be merged into the `redis_cache`
Terraform resource block to set or update the identity field.
...
`azurerm.redis_cache.withLocation` constructs a mixin object that can be merged into the `redis_cache`
...
`azurerm.redis_cache.withMinimumTlsVersion` constructs a mixin object that can be merged into the `redis_cache`
...
`azurerm.redis_cache.withName` constructs a mixin object that can be merged into the `redis_cache`
...
`azurerm.redis_cache.withPatchSchedule` constructs a mixin object that can be merged into the `redis_cache`
...
`azurerm.redis_cache.withPatchScheduleMixin` constructs a mixin object that can be merged into the `redis_cache`
Terraform resource block to set or update the patch_schedule field.
...
`azurerm.redis_cache.withPrivateStaticIpAddress` constructs a mixin object that can be merged into the `redis_cache`
...
`azurerm.redis_cache.withPublicNetworkAccessEnabled` constructs a mixin object that can be merged into the `redis_cache`
...
`azurerm.redis_cache.withRedisConfiguration` constructs a mixin object that can be merged into the `redis_cache`
...
`azurerm.redis_cache.withRedisConfigurationMixin` constructs a mixin object that can be merged into the `redis_cache`
Terraform resource block to set or update the redis_configuration field.
...
`azurerm.redis_cache.withRedisVersion` constructs a mixin object that can be merged into the `redis_cache`
...
`azurerm.redis_cache.withReplicasPerMaster` constructs a mixin object that can be merged into the `redis_cache`
...
`azurerm.redis_cache.withReplicasPerPrimary` constructs a mixin object that can be merged into the `redis_cache`
...
`azurerm.redis_cache.withResourceGroupName` constructs a mixin object that can be merged into the `redis_cache`
...
`azurerm.redis_cache.withShardCount` constructs a mixin object that can be merged into the `redis_cache`
...
`azurerm.redis_cache.withSkuName` constructs a mixin object that can be merged into the `redis_cache`
...
`azurerm.redis_cache.withSubnetId` constructs a mixin object that can be merged into the `redis_cache`
...
`azurerm.redis_cache.withTags` constructs a mixin object that can be merged into the `redis_cache`
...
`azurerm.redis_cache.withTenantSettings` constructs a mixin object that can be merged into the `redis_cache`
...
`azurerm.redis_cache.withTimeouts` constructs a mixin object that can be merged into the `redis_cache`
...
`azurerm.redis_cache.withTimeoutsMixin` constructs a mixin object that can be merged into the `redis_cache`
Terraform resource block to set or update the timeouts field.
...
`azurerm.redis_cache.withZones` constructs a mixin object that can be merged into the `redis_cache`
