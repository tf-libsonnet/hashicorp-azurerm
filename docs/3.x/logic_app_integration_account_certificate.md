...
`azurerm.logic_app_integration_account_certificate.withResourceGroupName` constructs a mixin object that can be merged into the `logic_app_integration_account_certificate`
