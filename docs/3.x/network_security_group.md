...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.network_security_group.timeouts.new](#fn-network_security_grouptimeoutsnew) constructor.
...
Unlike [azurerm.network_security_group.new](#fn-network_security_groupnew), this function will not inject the `resource`
