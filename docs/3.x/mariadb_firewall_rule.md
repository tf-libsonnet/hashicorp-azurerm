...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.mariadb_firewall_rule.timeouts.new](#fn-mariadb_firewall_ruletimeoutsnew) constructor.
...
Unlike [azurerm.mariadb_firewall_rule.new](#fn-mariadb_firewall_rulenew), this function will not inject the `resource`
