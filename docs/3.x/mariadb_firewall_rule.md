---
permalink: /mariadb_firewall_rule/
---

# mariadb_firewall_rule

`mariadb_firewall_rule` represents the `azurerm_mariadb_firewall_rule` Terraform resource.
...
`azurerm.mariadb_firewall_rule.withEndIpAddress` constructs a mixin object that can be merged into the `mariadb_firewall_rule`
...
`azurerm.mariadb_firewall_rule.withName` constructs a mixin object that can be merged into the `mariadb_firewall_rule`
...
`azurerm.mariadb_firewall_rule.withResourceGroupName` constructs a mixin object that can be merged into the `mariadb_firewall_rule`
...
`azurerm.mariadb_firewall_rule.withServerName` constructs a mixin object that can be merged into the `mariadb_firewall_rule`
...
`azurerm.mariadb_firewall_rule.withStartIpAddress` constructs a mixin object that can be merged into the `mariadb_firewall_rule`
...
`azurerm.mariadb_firewall_rule.withTimeouts` constructs a mixin object that can be merged into the `mariadb_firewall_rule`
...
`azurerm.mariadb_firewall_rule.withTimeoutsMixin` constructs a mixin object that can be merged into the `mariadb_firewall_rule`
Terraform resource block to set or update the timeouts field.
