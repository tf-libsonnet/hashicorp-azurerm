...
`azurerm.private_dns_resolver_dns_forwarding_ruleset.withResourceGroupName` constructs a mixin object that can be merged into the `private_dns_resolver_dns_forwarding_ruleset`
