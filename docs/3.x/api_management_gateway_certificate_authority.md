...
**Args**:
  ...
  - `is_trusted` (`bool`): Set the `is_trusted` field on the resulting resource block. When `null`, the `is_trusted` field will be omitted from the resulting object.
  - `timeouts` (`obj`): Set the `timeouts` field on the resulting resource block. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management_gateway_certificate_authority.timeouts.new](#fn-timeoutsnew) constructor.
...
Unlike [azurerm.api_management_gateway_certificate_authority.new](#fn-new), this function will not inject the `resource`
...
**Args**:
  ...
  - `is_trusted` (`bool`): Set the `is_trusted` field on the resulting object. When `null`, the `is_trusted` field will be omitted from the resulting object.
...
`azurerm.bool.withIsTrusted` constructs a mixin object that can be merged into the `bool`
