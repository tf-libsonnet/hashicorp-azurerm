...
`azurerm.api_management_certificate.withApiManagementName` constructs a mixin object that can be merged into the `api_management_certificate`
...
`azurerm.api_management_certificate.withData` constructs a mixin object that can be merged into the `api_management_certificate`
...
`azurerm.api_management_certificate.withKeyVaultIdentityClientId` constructs a mixin object that can be merged into the `api_management_certificate`
...
`azurerm.api_management_certificate.withKeyVaultSecretId` constructs a mixin object that can be merged into the `api_management_certificate`
...
`azurerm.api_management_certificate.withName` constructs a mixin object that can be merged into the `api_management_certificate`
...
`azurerm.api_management_certificate.withPassword` constructs a mixin object that can be merged into the `api_management_certificate`
...
`azurerm.api_management_certificate.withResourceGroupName` constructs a mixin object that can be merged into the `api_management_certificate`
...
`azurerm.api_management_certificate.withTimeouts` constructs a mixin object that can be merged into the `api_management_certificate`
...
`azurerm.api_management_certificate.withTimeoutsMixin` constructs a mixin object that can be merged into the `api_management_certificate`
Terraform resource block to set or update the timeouts field.
