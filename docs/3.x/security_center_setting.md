...
**Args**:
  ...
  - `enabled` (`bool`): 
  - `setting_name` (`string`): 
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.security_center_setting.timeouts.new](#fn-security_center_settingtimeoutsnew) constructor.
...
Unlike [azurerm.security_center_setting.new](#fn-security_center_settingnew), this function will not inject the `resource`
