...
`azurerm.security_center_setting.withEnabled` constructs a mixin object that can be merged into the `security_center_setting`
...
`azurerm.security_center_setting.withSettingName` constructs a mixin object that can be merged into the `security_center_setting`
...
`azurerm.security_center_setting.withTimeouts` constructs a mixin object that can be merged into the `security_center_setting`
...
`azurerm.security_center_setting.withTimeoutsMixin` constructs a mixin object that can be merged into the `security_center_setting`
Terraform resource block to set or update the timeouts field.
