...
`azurerm.backup_policy_vm_workload.withName` constructs a mixin object that can be merged into the `backup_policy_vm_workload`
...
`azurerm.backup_policy_vm_workload.withProtectionPolicy` constructs a mixin object that can be merged into the `backup_policy_vm_workload`
...
`azurerm.backup_policy_vm_workload.withProtectionPolicyMixin` constructs a mixin object that can be merged into the `backup_policy_vm_workload`
Terraform resource block to set or update the protection_policy field.
...
`azurerm.backup_policy_vm_workload.withRecoveryVaultName` constructs a mixin object that can be merged into the `backup_policy_vm_workload`
...
`azurerm.backup_policy_vm_workload.withResourceGroupName` constructs a mixin object that can be merged into the `backup_policy_vm_workload`
...
`azurerm.backup_policy_vm_workload.withSettings` constructs a mixin object that can be merged into the `backup_policy_vm_workload`
...
`azurerm.backup_policy_vm_workload.withSettingsMixin` constructs a mixin object that can be merged into the `backup_policy_vm_workload`
Terraform resource block to set or update the settings field.
...
`azurerm.backup_policy_vm_workload.withTimeouts` constructs a mixin object that can be merged into the `backup_policy_vm_workload`
...
`azurerm.backup_policy_vm_workload.withTimeoutsMixin` constructs a mixin object that can be merged into the `backup_policy_vm_workload`
Terraform resource block to set or update the timeouts field.
...
`azurerm.backup_policy_vm_workload.withWorkloadType` constructs a mixin object that can be merged into the `backup_policy_vm_workload`
