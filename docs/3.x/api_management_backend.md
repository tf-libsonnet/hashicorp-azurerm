...
`azurerm.api_management_backend.withApiManagementName` constructs a mixin object that can be merged into the `api_management_backend`
...
`azurerm.api_management_backend.withCredentials` constructs a mixin object that can be merged into the `api_management_backend`
...
`azurerm.api_management_backend.withCredentialsMixin` constructs a mixin object that can be merged into the `api_management_backend`
Terraform resource block to set or update the credentials field.
...
`azurerm.api_management_backend.withDescription` constructs a mixin object that can be merged into the `api_management_backend`
...
`azurerm.api_management_backend.withName` constructs a mixin object that can be merged into the `api_management_backend`
...
`azurerm.api_management_backend.withProtocol` constructs a mixin object that can be merged into the `api_management_backend`
...
`azurerm.api_management_backend.withProxy` constructs a mixin object that can be merged into the `api_management_backend`
...
`azurerm.api_management_backend.withProxyMixin` constructs a mixin object that can be merged into the `api_management_backend`
Terraform resource block to set or update the proxy field.
...
`azurerm.api_management_backend.withResourceGroupName` constructs a mixin object that can be merged into the `api_management_backend`
...
`azurerm.api_management_backend.withResourceId` constructs a mixin object that can be merged into the `api_management_backend`
...
`azurerm.api_management_backend.withServiceFabricCluster` constructs a mixin object that can be merged into the `api_management_backend`
...
`azurerm.api_management_backend.withServiceFabricClusterMixin` constructs a mixin object that can be merged into the `api_management_backend`
Terraform resource block to set or update the service_fabric_cluster field.
...
`azurerm.api_management_backend.withTimeouts` constructs a mixin object that can be merged into the `api_management_backend`
...
`azurerm.api_management_backend.withTimeoutsMixin` constructs a mixin object that can be merged into the `api_management_backend`
Terraform resource block to set or update the timeouts field.
...
`azurerm.api_management_backend.withTitle` constructs a mixin object that can be merged into the `api_management_backend`
...
`azurerm.api_management_backend.withTls` constructs a mixin object that can be merged into the `api_management_backend`
...
`azurerm.api_management_backend.withTlsMixin` constructs a mixin object that can be merged into the `api_management_backend`
Terraform resource block to set or update the tls field.
...
`azurerm.api_management_backend.withUrl` constructs a mixin object that can be merged into the `api_management_backend`
