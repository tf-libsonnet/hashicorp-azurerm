...
`azurerm.kusto_eventgrid_data_connection.withBlobStorageEventType` constructs a mixin object that can be merged into the `kusto_eventgrid_data_connection`
...
`azurerm.kusto_eventgrid_data_connection.withClusterName` constructs a mixin object that can be merged into the `kusto_eventgrid_data_connection`
...
`azurerm.kusto_eventgrid_data_connection.withDataFormat` constructs a mixin object that can be merged into the `kusto_eventgrid_data_connection`
...
`azurerm.kusto_eventgrid_data_connection.withDatabaseName` constructs a mixin object that can be merged into the `kusto_eventgrid_data_connection`
...
`azurerm.kusto_eventgrid_data_connection.withDatabaseRoutingType` constructs a mixin object that can be merged into the `kusto_eventgrid_data_connection`
...
`azurerm.kusto_eventgrid_data_connection.withEventgridResourceId` constructs a mixin object that can be merged into the `kusto_eventgrid_data_connection`
...
`azurerm.kusto_eventgrid_data_connection.withEventhubConsumerGroupName` constructs a mixin object that can be merged into the `kusto_eventgrid_data_connection`
...
`azurerm.kusto_eventgrid_data_connection.withEventhubId` constructs a mixin object that can be merged into the `kusto_eventgrid_data_connection`
...
`azurerm.kusto_eventgrid_data_connection.withLocation` constructs a mixin object that can be merged into the `kusto_eventgrid_data_connection`
...
`azurerm.kusto_eventgrid_data_connection.withManagedIdentityResourceId` constructs a mixin object that can be merged into the `kusto_eventgrid_data_connection`
...
`azurerm.kusto_eventgrid_data_connection.withMappingRuleName` constructs a mixin object that can be merged into the `kusto_eventgrid_data_connection`
...
`azurerm.kusto_eventgrid_data_connection.withName` constructs a mixin object that can be merged into the `kusto_eventgrid_data_connection`
...
`azurerm.kusto_eventgrid_data_connection.withResourceGroupName` constructs a mixin object that can be merged into the `kusto_eventgrid_data_connection`
...
`azurerm.kusto_eventgrid_data_connection.withSkipFirstRecord` constructs a mixin object that can be merged into the `kusto_eventgrid_data_connection`
...
`azurerm.kusto_eventgrid_data_connection.withStorageAccountId` constructs a mixin object that can be merged into the `kusto_eventgrid_data_connection`
...
`azurerm.kusto_eventgrid_data_connection.withTableName` constructs a mixin object that can be merged into the `kusto_eventgrid_data_connection`
...
`azurerm.kusto_eventgrid_data_connection.withTimeouts` constructs a mixin object that can be merged into the `kusto_eventgrid_data_connection`
...
`azurerm.kusto_eventgrid_data_connection.withTimeoutsMixin` constructs a mixin object that can be merged into the `kusto_eventgrid_data_connection`
Terraform resource block to set or update the timeouts field.
