...
**Args**:
  ...
  - `aci_connector_linux` (`list[obj]`):  When `null`, the `aci_connector_linux` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.kubernetes_cluster.aci_connector_linux.new](#fn-kubernetes_clusteraci_connector_linuxnew) constructor.
  - `auto_scaler_profile` (`list[obj]`):  When `null`, the `auto_scaler_profile` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.kubernetes_cluster.auto_scaler_profile.new](#fn-kubernetes_clusterauto_scaler_profilenew) constructor.
  - `azure_active_directory_role_based_access_control` (`list[obj]`):  When `null`, the `azure_active_directory_role_based_access_control` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.kubernetes_cluster.azure_active_directory_role_based_access_control.new](#fn-kubernetes_clusterazure_active_directory_role_based_access_controlnew) constructor.
  - `default_node_pool` (`list[obj]`):  When `null`, the `default_node_pool` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.kubernetes_cluster.default_node_pool.new](#fn-kubernetes_clusterdefault_node_poolnew) constructor.
  - `http_proxy_config` (`list[obj]`):  When `null`, the `http_proxy_config` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.kubernetes_cluster.http_proxy_config.new](#fn-kubernetes_clusterhttp_proxy_confignew) constructor.
  - `identity` (`list[obj]`):  When `null`, the `identity` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.kubernetes_cluster.identity.new](#fn-kubernetes_clusteridentitynew) constructor.
  - `ingress_application_gateway` (`list[obj]`):  When `null`, the `ingress_application_gateway` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.kubernetes_cluster.ingress_application_gateway.new](#fn-kubernetes_clusteringress_application_gatewaynew) constructor.
  - `key_vault_secrets_provider` (`list[obj]`):  When `null`, the `key_vault_secrets_provider` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.kubernetes_cluster.key_vault_secrets_provider.new](#fn-kubernetes_clusterkey_vault_secrets_providernew) constructor.
  - `kubelet_identity` (`list[obj]`):  When `null`, the `kubelet_identity` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.kubernetes_cluster.kubelet_identity.new](#fn-kubernetes_clusterkubelet_identitynew) constructor.
  - `linux_profile` (`list[obj]`):  When `null`, the `linux_profile` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.kubernetes_cluster.linux_profile.new](#fn-kubernetes_clusterlinux_profilenew) constructor.
  - `maintenance_window` (`list[obj]`):  When `null`, the `maintenance_window` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.kubernetes_cluster.maintenance_window.new](#fn-kubernetes_clustermaintenance_windownew) constructor.
  - `microsoft_defender` (`list[obj]`):  When `null`, the `microsoft_defender` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.kubernetes_cluster.microsoft_defender.new](#fn-kubernetes_clustermicrosoft_defendernew) constructor.
  - `monitor_metrics` (`list[obj]`):  When `null`, the `monitor_metrics` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.kubernetes_cluster.monitor_metrics.new](#fn-kubernetes_clustermonitor_metricsnew) constructor.
  - `network_profile` (`list[obj]`):  When `null`, the `network_profile` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.kubernetes_cluster.network_profile.new](#fn-kubernetes_clusternetwork_profilenew) constructor.
  - `oms_agent` (`list[obj]`):  When `null`, the `oms_agent` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.kubernetes_cluster.oms_agent.new](#fn-kubernetes_clusteroms_agentnew) constructor.
  - `service_principal` (`list[obj]`):  When `null`, the `service_principal` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.kubernetes_cluster.service_principal.new](#fn-kubernetes_clusterservice_principalnew) constructor.
  - `storage_profile` (`list[obj]`):  When `null`, the `storage_profile` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.kubernetes_cluster.storage_profile.new](#fn-kubernetes_clusterstorage_profilenew) constructor.
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.kubernetes_cluster.timeouts.new](#fn-kubernetes_clustertimeoutsnew) constructor.
  - `web_app_routing` (`list[obj]`):  When `null`, the `web_app_routing` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.kubernetes_cluster.web_app_routing.new](#fn-kubernetes_clusterweb_app_routingnew) constructor.
  - `windows_profile` (`list[obj]`):  When `null`, the `windows_profile` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.kubernetes_cluster.windows_profile.new](#fn-kubernetes_clusterwindows_profilenew) constructor.
  - `workload_autoscaler_profile` (`list[obj]`):  When `null`, the `workload_autoscaler_profile` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.kubernetes_cluster.workload_autoscaler_profile.new](#fn-kubernetes_clusterworkload_autoscaler_profilenew) constructor.
...
Unlike [azurerm.kubernetes_cluster.new](#fn-kubernetes_clusternew), this function will not inject the `resource`
