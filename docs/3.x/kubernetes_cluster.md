...
`azurerm.kubernetes_cluster.withAciConnectorLinux` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withAciConnectorLinuxMixin` constructs a mixin object that can be merged into the `kubernetes_cluster`
Terraform resource block to set or update the aci_connector_linux field.
...
`azurerm.kubernetes_cluster.withApiServerAuthorizedIpRanges` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withAutoScalerProfile` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withAutoScalerProfileMixin` constructs a mixin object that can be merged into the `kubernetes_cluster`
Terraform resource block to set or update the auto_scaler_profile field.
...
`azurerm.kubernetes_cluster.withAutomaticChannelUpgrade` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withAzureActiveDirectoryRoleBasedAccessControl` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withAzureActiveDirectoryRoleBasedAccessControlMixin` constructs a mixin object that can be merged into the `kubernetes_cluster`
Terraform resource block to set or update the azure_active_directory_role_based_access_control field.
...
`azurerm.kubernetes_cluster.withAzurePolicyEnabled` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withDefaultNodePool` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withDefaultNodePoolMixin` constructs a mixin object that can be merged into the `kubernetes_cluster`
Terraform resource block to set or update the default_node_pool field.
...
`azurerm.kubernetes_cluster.withDiskEncryptionSetId` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withDnsPrefix` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withDnsPrefixPrivateCluster` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withEdgeZone` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withEnablePodSecurityPolicy` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withHttpApplicationRoutingEnabled` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withHttpProxyConfig` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withHttpProxyConfigMixin` constructs a mixin object that can be merged into the `kubernetes_cluster`
Terraform resource block to set or update the http_proxy_config field.
...
`azurerm.kubernetes_cluster.withIdentity` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withIdentityMixin` constructs a mixin object that can be merged into the `kubernetes_cluster`
Terraform resource block to set or update the identity field.
...
`azurerm.kubernetes_cluster.withImageCleanerEnabled` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withImageCleanerIntervalHours` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withIngressApplicationGateway` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withIngressApplicationGatewayMixin` constructs a mixin object that can be merged into the `kubernetes_cluster`
Terraform resource block to set or update the ingress_application_gateway field.
...
`azurerm.kubernetes_cluster.withKeyVaultSecretsProvider` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withKeyVaultSecretsProviderMixin` constructs a mixin object that can be merged into the `kubernetes_cluster`
Terraform resource block to set or update the key_vault_secrets_provider field.
...
`azurerm.kubernetes_cluster.withKubeletIdentity` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withKubeletIdentityMixin` constructs a mixin object that can be merged into the `kubernetes_cluster`
Terraform resource block to set or update the kubelet_identity field.
...
`azurerm.kubernetes_cluster.withKubernetesVersion` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withLinuxProfile` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withLinuxProfileMixin` constructs a mixin object that can be merged into the `kubernetes_cluster`
Terraform resource block to set or update the linux_profile field.
...
`azurerm.kubernetes_cluster.withLocalAccountDisabled` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withLocation` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withMaintenanceWindow` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withMaintenanceWindowMixin` constructs a mixin object that can be merged into the `kubernetes_cluster`
Terraform resource block to set or update the maintenance_window field.
...
`azurerm.kubernetes_cluster.withMicrosoftDefender` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withMicrosoftDefenderMixin` constructs a mixin object that can be merged into the `kubernetes_cluster`
Terraform resource block to set or update the microsoft_defender field.
...
`azurerm.kubernetes_cluster.withMonitorMetrics` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withMonitorMetricsMixin` constructs a mixin object that can be merged into the `kubernetes_cluster`
Terraform resource block to set or update the monitor_metrics field.
...
`azurerm.kubernetes_cluster.withName` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withNetworkProfile` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withNetworkProfileMixin` constructs a mixin object that can be merged into the `kubernetes_cluster`
Terraform resource block to set or update the network_profile field.
...
`azurerm.kubernetes_cluster.withNodeResourceGroup` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withOidcIssuerEnabled` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withOmsAgent` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withOmsAgentMixin` constructs a mixin object that can be merged into the `kubernetes_cluster`
Terraform resource block to set or update the oms_agent field.
...
`azurerm.kubernetes_cluster.withOpenServiceMeshEnabled` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withPrivateClusterEnabled` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withPrivateClusterPublicFqdnEnabled` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withPrivateDnsZoneId` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withPublicNetworkAccessEnabled` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withResourceGroupName` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withRoleBasedAccessControlEnabled` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withRunCommandEnabled` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withServicePrincipal` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withServicePrincipalMixin` constructs a mixin object that can be merged into the `kubernetes_cluster`
Terraform resource block to set or update the service_principal field.
...
`azurerm.kubernetes_cluster.withSkuTier` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withStorageProfile` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withStorageProfileMixin` constructs a mixin object that can be merged into the `kubernetes_cluster`
Terraform resource block to set or update the storage_profile field.
...
`azurerm.kubernetes_cluster.withTags` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withTimeouts` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withTimeoutsMixin` constructs a mixin object that can be merged into the `kubernetes_cluster`
Terraform resource block to set or update the timeouts field.
...
`azurerm.kubernetes_cluster.withWebAppRouting` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withWebAppRoutingMixin` constructs a mixin object that can be merged into the `kubernetes_cluster`
Terraform resource block to set or update the web_app_routing field.
...
`azurerm.kubernetes_cluster.withWindowsProfile` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withWindowsProfileMixin` constructs a mixin object that can be merged into the `kubernetes_cluster`
Terraform resource block to set or update the windows_profile field.
...
`azurerm.kubernetes_cluster.withWorkloadAutoscalerProfile` constructs a mixin object that can be merged into the `kubernetes_cluster`
...
`azurerm.kubernetes_cluster.withWorkloadAutoscalerProfileMixin` constructs a mixin object that can be merged into the `kubernetes_cluster`
Terraform resource block to set or update the workload_autoscaler_profile field.
...
`azurerm.kubernetes_cluster.withWorkloadIdentityEnabled` constructs a mixin object that can be merged into the `kubernetes_cluster`
