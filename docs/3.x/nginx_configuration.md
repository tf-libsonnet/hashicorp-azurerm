...
`azurerm.nginx_configuration.withConfigFile` constructs a mixin object that can be merged into the `nginx_configuration`
...
`azurerm.nginx_configuration.withConfigFileMixin` constructs a mixin object that can be merged into the `nginx_configuration`
Terraform resource block to set or update the config_file field.
...
`azurerm.nginx_configuration.withNginxDeploymentId` constructs a mixin object that can be merged into the `nginx_configuration`
...
`azurerm.nginx_configuration.withPackageData` constructs a mixin object that can be merged into the `nginx_configuration`
...
`azurerm.nginx_configuration.withProtectedFile` constructs a mixin object that can be merged into the `nginx_configuration`
...
`azurerm.nginx_configuration.withProtectedFileMixin` constructs a mixin object that can be merged into the `nginx_configuration`
Terraform resource block to set or update the protected_file field.
...
`azurerm.nginx_configuration.withRootFile` constructs a mixin object that can be merged into the `nginx_configuration`
...
`azurerm.nginx_configuration.withTimeouts` constructs a mixin object that can be merged into the `nginx_configuration`
...
`azurerm.nginx_configuration.withTimeoutsMixin` constructs a mixin object that can be merged into the `nginx_configuration`
Terraform resource block to set or update the timeouts field.
