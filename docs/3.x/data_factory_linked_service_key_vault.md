---
permalink: /data_factory_linked_service_key_vault/
---

# data_factory_linked_service_key_vault

`data_factory_linked_service_key_vault` represents the `azurerm_data_factory_linked_service_key_vault` Terraform resource.
...
`azurerm.data_factory_linked_service_key_vault.withAdditionalProperties` constructs a mixin object that can be merged into the `data_factory_linked_service_key_vault`
...
`azurerm.data_factory_linked_service_key_vault.withAnnotations` constructs a mixin object that can be merged into the `data_factory_linked_service_key_vault`
...
`azurerm.data_factory_linked_service_key_vault.withDataFactoryId` constructs a mixin object that can be merged into the `data_factory_linked_service_key_vault`
...
`azurerm.data_factory_linked_service_key_vault.withDescription` constructs a mixin object that can be merged into the `data_factory_linked_service_key_vault`
...
`azurerm.data_factory_linked_service_key_vault.withIntegrationRuntimeName` constructs a mixin object that can be merged into the `data_factory_linked_service_key_vault`
...
`azurerm.data_factory_linked_service_key_vault.withKeyVaultId` constructs a mixin object that can be merged into the `data_factory_linked_service_key_vault`
...
`azurerm.data_factory_linked_service_key_vault.withName` constructs a mixin object that can be merged into the `data_factory_linked_service_key_vault`
...
`azurerm.data_factory_linked_service_key_vault.withParameters` constructs a mixin object that can be merged into the `data_factory_linked_service_key_vault`
...
`azurerm.data_factory_linked_service_key_vault.withTimeouts` constructs a mixin object that can be merged into the `data_factory_linked_service_key_vault`
...
`azurerm.data_factory_linked_service_key_vault.withTimeoutsMixin` constructs a mixin object that can be merged into the `data_factory_linked_service_key_vault`
Terraform resource block to set or update the timeouts field.
