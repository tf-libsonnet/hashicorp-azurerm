...
`azurerm.sql_virtual_network_rule.withIgnoreMissingVnetServiceEndpoint` constructs a mixin object that can be merged into the `sql_virtual_network_rule`
...
`azurerm.sql_virtual_network_rule.withName` constructs a mixin object that can be merged into the `sql_virtual_network_rule`
...
`azurerm.sql_virtual_network_rule.withResourceGroupName` constructs a mixin object that can be merged into the `sql_virtual_network_rule`
...
`azurerm.sql_virtual_network_rule.withServerName` constructs a mixin object that can be merged into the `sql_virtual_network_rule`
...
`azurerm.sql_virtual_network_rule.withSubnetId` constructs a mixin object that can be merged into the `sql_virtual_network_rule`
...
`azurerm.sql_virtual_network_rule.withTimeouts` constructs a mixin object that can be merged into the `sql_virtual_network_rule`
...
`azurerm.sql_virtual_network_rule.withTimeoutsMixin` constructs a mixin object that can be merged into the `sql_virtual_network_rule`
Terraform resource block to set or update the timeouts field.
