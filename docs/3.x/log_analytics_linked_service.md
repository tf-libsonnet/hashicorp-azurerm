...
**Args**:
  ...
  - `read_access_id` (`string`): Set the `read_access_id` field on the resulting resource block. When `null`, the `read_access_id` field will be omitted from the resulting object.
  - `resource_group_name` (`string`): Set the `resource_group_name` field on the resulting resource block.
  - `workspace_id` (`string`): Set the `workspace_id` field on the resulting resource block.
  - `write_access_id` (`string`): Set the `write_access_id` field on the resulting resource block. When `null`, the `write_access_id` field will be omitted from the resulting object.
  - `timeouts` (`obj`): Set the `timeouts` field on the resulting resource block. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.log_analytics_linked_service.timeouts.new](#fn-timeoutsnew) constructor.
...
**Args**:
  - `read_access_id` (`string`): Set the `read_access_id` field on the resulting object. When `null`, the `read_access_id` field will be omitted from the resulting object.
  - `resource_group_name` (`string`): Set the `resource_group_name` field on the resulting object.
  - `workspace_id` (`string`): Set the `workspace_id` field on the resulting object.
  - `write_access_id` (`string`): Set the `write_access_id` field on the resulting object. When `null`, the `write_access_id` field will be omitted from the resulting object.
  - `timeouts` (`obj`): Set the `timeouts` field on the resulting object. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.log_analytics_linked_service.timeouts.new](#fn-timeoutsnew) constructor.
