...
`azurerm.role_assignment.withCondition` constructs a mixin object that can be merged into the `role_assignment`
...
`azurerm.role_assignment.withConditionVersion` constructs a mixin object that can be merged into the `role_assignment`
...
`azurerm.role_assignment.withDelegatedManagedIdentityResourceId` constructs a mixin object that can be merged into the `role_assignment`
...
`azurerm.role_assignment.withDescription` constructs a mixin object that can be merged into the `role_assignment`
...
`azurerm.role_assignment.withName` constructs a mixin object that can be merged into the `role_assignment`
...
`azurerm.role_assignment.withPrincipalId` constructs a mixin object that can be merged into the `role_assignment`
...
`azurerm.role_assignment.withRoleDefinitionId` constructs a mixin object that can be merged into the `role_assignment`
...
`azurerm.role_assignment.withRoleDefinitionName` constructs a mixin object that can be merged into the `role_assignment`
...
`azurerm.role_assignment.withScope` constructs a mixin object that can be merged into the `role_assignment`
...
`azurerm.role_assignment.withSkipServicePrincipalAadCheck` constructs a mixin object that can be merged into the `role_assignment`
...
`azurerm.role_assignment.withTimeouts` constructs a mixin object that can be merged into the `role_assignment`
...
`azurerm.role_assignment.withTimeoutsMixin` constructs a mixin object that can be merged into the `role_assignment`
Terraform resource block to set or update the timeouts field.
