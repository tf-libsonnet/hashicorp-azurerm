...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.role_assignment.timeouts.new](#fn-role_assignmenttimeoutsnew) constructor.
...
Unlike [azurerm.role_assignment.new](#fn-role_assignmentnew), this function will not inject the `resource`
