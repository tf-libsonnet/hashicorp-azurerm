---
permalink: /databricks_workspace_root_dbfs_customer_managed_key/
---

# databricks_workspace_root_dbfs_customer_managed_key

`databricks_workspace_root_dbfs_customer_managed_key` represents the `azurerm_databricks_workspace_root_dbfs_customer_managed_key` Terraform resource.
