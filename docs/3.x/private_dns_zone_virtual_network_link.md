...
**Args**:
  ...
  - `private_dns_zone_name` (`string`): Set the `private_dns_zone_name` field on the resulting resource block.
  - `registration_enabled` (`bool`): Set the `registration_enabled` field on the resulting resource block. When `null`, the `registration_enabled` field will be omitted from the resulting object.
  ...
  - `timeouts` (`obj`): Set the `timeouts` field on the resulting resource block. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.private_dns_zone_virtual_network_link.timeouts.new](#fn-timeoutsnew) constructor.
...
Unlike [azurerm.private_dns_zone_virtual_network_link.new](#fn-new), this function will not inject the `resource`
...
**Args**:
  ...
  - `private_dns_zone_name` (`string`): Set the `private_dns_zone_name` field on the resulting object.
  - `registration_enabled` (`bool`): Set the `registration_enabled` field on the resulting object. When `null`, the `registration_enabled` field will be omitted from the resulting object.
  ...
  - `timeouts` (`obj`): Set the `timeouts` field on the resulting object. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.private_dns_zone_virtual_network_link.timeouts.new](#fn-timeoutsnew) constructor.
...
`azurerm.string.withPrivateDnsZoneName` constructs a mixin object that can be merged into the `string`
...
`azurerm.bool.withRegistrationEnabled` constructs a mixin object that can be merged into the `bool`
