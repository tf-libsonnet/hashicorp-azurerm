...
`azurerm.virtual_network_gateway_connection.withAuthorizationKey` constructs a mixin object that can be merged into the `virtual_network_gateway_connection`
...
`azurerm.virtual_network_gateway_connection.withConnectionMode` constructs a mixin object that can be merged into the `virtual_network_gateway_connection`
...
`azurerm.virtual_network_gateway_connection.withConnectionProtocol` constructs a mixin object that can be merged into the `virtual_network_gateway_connection`
...
`azurerm.virtual_network_gateway_connection.withCustomBgpAddresses` constructs a mixin object that can be merged into the `virtual_network_gateway_connection`
...
`azurerm.virtual_network_gateway_connection.withCustomBgpAddressesMixin` constructs a mixin object that can be merged into the `virtual_network_gateway_connection`
Terraform resource block to set or update the custom_bgp_addresses field.
...
`azurerm.virtual_network_gateway_connection.withDpdTimeoutSeconds` constructs a mixin object that can be merged into the `virtual_network_gateway_connection`
...
`azurerm.virtual_network_gateway_connection.withEgressNatRuleIds` constructs a mixin object that can be merged into the `virtual_network_gateway_connection`
...
`azurerm.virtual_network_gateway_connection.withEnableBgp` constructs a mixin object that can be merged into the `virtual_network_gateway_connection`
...
`azurerm.virtual_network_gateway_connection.withExpressRouteCircuitId` constructs a mixin object that can be merged into the `virtual_network_gateway_connection`
...
`azurerm.virtual_network_gateway_connection.withExpressRouteGatewayBypass` constructs a mixin object that can be merged into the `virtual_network_gateway_connection`
...
`azurerm.virtual_network_gateway_connection.withIngressNatRuleIds` constructs a mixin object that can be merged into the `virtual_network_gateway_connection`
...
`azurerm.virtual_network_gateway_connection.withIpsecPolicy` constructs a mixin object that can be merged into the `virtual_network_gateway_connection`
...
`azurerm.virtual_network_gateway_connection.withIpsecPolicyMixin` constructs a mixin object that can be merged into the `virtual_network_gateway_connection`
Terraform resource block to set or update the ipsec_policy field.
...
`azurerm.virtual_network_gateway_connection.withLocalAzureIpAddressEnabled` constructs a mixin object that can be merged into the `virtual_network_gateway_connection`
...
`azurerm.virtual_network_gateway_connection.withLocalNetworkGatewayId` constructs a mixin object that can be merged into the `virtual_network_gateway_connection`
...
`azurerm.virtual_network_gateway_connection.withLocation` constructs a mixin object that can be merged into the `virtual_network_gateway_connection`
...
`azurerm.virtual_network_gateway_connection.withName` constructs a mixin object that can be merged into the `virtual_network_gateway_connection`
...
`azurerm.virtual_network_gateway_connection.withPeerVirtualNetworkGatewayId` constructs a mixin object that can be merged into the `virtual_network_gateway_connection`
...
`azurerm.virtual_network_gateway_connection.withResourceGroupName` constructs a mixin object that can be merged into the `virtual_network_gateway_connection`
...
`azurerm.virtual_network_gateway_connection.withRoutingWeight` constructs a mixin object that can be merged into the `virtual_network_gateway_connection`
...
`azurerm.virtual_network_gateway_connection.withSharedKey` constructs a mixin object that can be merged into the `virtual_network_gateway_connection`
...
`azurerm.virtual_network_gateway_connection.withTags` constructs a mixin object that can be merged into the `virtual_network_gateway_connection`
...
`azurerm.virtual_network_gateway_connection.withTimeouts` constructs a mixin object that can be merged into the `virtual_network_gateway_connection`
...
`azurerm.virtual_network_gateway_connection.withTimeoutsMixin` constructs a mixin object that can be merged into the `virtual_network_gateway_connection`
Terraform resource block to set or update the timeouts field.
...
`azurerm.virtual_network_gateway_connection.withTrafficSelectorPolicy` constructs a mixin object that can be merged into the `virtual_network_gateway_connection`
...
`azurerm.virtual_network_gateway_connection.withTrafficSelectorPolicyMixin` constructs a mixin object that can be merged into the `virtual_network_gateway_connection`
Terraform resource block to set or update the traffic_selector_policy field.
...
`azurerm.virtual_network_gateway_connection.withType` constructs a mixin object that can be merged into the `virtual_network_gateway_connection`
...
`azurerm.virtual_network_gateway_connection.withUsePolicyBasedTrafficSelectors` constructs a mixin object that can be merged into the `virtual_network_gateway_connection`
...
`azurerm.virtual_network_gateway_connection.withVirtualNetworkGatewayId` constructs a mixin object that can be merged into the `virtual_network_gateway_connection`
