---
permalink: /data_factory_credential_user_managed_identity/
---

# data_factory_credential_user_managed_identity

`data_factory_credential_user_managed_identity` represents the `azurerm_data_factory_credential_user_managed_identity` Terraform resource.
