...
`azurerm.linux_virtual_machine.withAdditionalCapabilities` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withAdditionalCapabilitiesMixin` constructs a mixin object that can be merged into the `linux_virtual_machine`
Terraform resource block to set or update the additional_capabilities field.
...
`azurerm.linux_virtual_machine.withAdminPassword` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withAdminSshKey` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withAdminSshKeyMixin` constructs a mixin object that can be merged into the `linux_virtual_machine`
Terraform resource block to set or update the admin_ssh_key field.
...
`azurerm.linux_virtual_machine.withAdminUsername` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withAllowExtensionOperations` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withAvailabilitySetId` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withBootDiagnostics` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withBootDiagnosticsMixin` constructs a mixin object that can be merged into the `linux_virtual_machine`
Terraform resource block to set or update the boot_diagnostics field.
...
`azurerm.linux_virtual_machine.withCapacityReservationGroupId` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withComputerName` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withCustomData` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withDedicatedHostGroupId` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withDedicatedHostId` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withDisablePasswordAuthentication` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withEdgeZone` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withEncryptionAtHostEnabled` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withEvictionPolicy` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withExtensionsTimeBudget` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withGalleryApplication` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withGalleryApplicationMixin` constructs a mixin object that can be merged into the `linux_virtual_machine`
Terraform resource block to set or update the gallery_application field.
...
`azurerm.linux_virtual_machine.withIdentity` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withIdentityMixin` constructs a mixin object that can be merged into the `linux_virtual_machine`
Terraform resource block to set or update the identity field.
...
`azurerm.linux_virtual_machine.withLicenseType` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withLocation` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withMaxBidPrice` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withName` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withNetworkInterfaceIds` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withOsDisk` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withOsDiskMixin` constructs a mixin object that can be merged into the `linux_virtual_machine`
Terraform resource block to set or update the os_disk field.
...
`azurerm.linux_virtual_machine.withPatchAssessmentMode` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withPatchMode` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withPlan` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withPlanMixin` constructs a mixin object that can be merged into the `linux_virtual_machine`
Terraform resource block to set or update the plan field.
...
`azurerm.linux_virtual_machine.withPlatformFaultDomain` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withPriority` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withProvisionVmAgent` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withProximityPlacementGroupId` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withResourceGroupName` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withSecret` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withSecretMixin` constructs a mixin object that can be merged into the `linux_virtual_machine`
Terraform resource block to set or update the secret field.
...
`azurerm.linux_virtual_machine.withSecureBootEnabled` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withSize` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withSourceImageId` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withSourceImageReference` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withSourceImageReferenceMixin` constructs a mixin object that can be merged into the `linux_virtual_machine`
Terraform resource block to set or update the source_image_reference field.
...
`azurerm.linux_virtual_machine.withTags` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withTerminationNotification` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withTerminationNotificationMixin` constructs a mixin object that can be merged into the `linux_virtual_machine`
Terraform resource block to set or update the termination_notification field.
...
`azurerm.linux_virtual_machine.withTimeouts` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withTimeoutsMixin` constructs a mixin object that can be merged into the `linux_virtual_machine`
Terraform resource block to set or update the timeouts field.
...
`azurerm.linux_virtual_machine.withUserData` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withVirtualMachineScaleSetId` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withVtpmEnabled` constructs a mixin object that can be merged into the `linux_virtual_machine`
...
`azurerm.linux_virtual_machine.withZone` constructs a mixin object that can be merged into the `linux_virtual_machine`
