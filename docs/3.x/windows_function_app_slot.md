...
`azurerm.windows_function_app_slot.withAppSettings` constructs a mixin object that can be merged into the `windows_function_app_slot`
...
`azurerm.windows_function_app_slot.withAuthSettings` constructs a mixin object that can be merged into the `windows_function_app_slot`
...
`azurerm.windows_function_app_slot.withAuthSettingsMixin` constructs a mixin object that can be merged into the `windows_function_app_slot`
Terraform resource block to set or update the auth_settings field.
...
`azurerm.windows_function_app_slot.withBackup` constructs a mixin object that can be merged into the `windows_function_app_slot`
...
`azurerm.windows_function_app_slot.withBackupMixin` constructs a mixin object that can be merged into the `windows_function_app_slot`
Terraform resource block to set or update the backup field.
...
`azurerm.windows_function_app_slot.withBuiltinLoggingEnabled` constructs a mixin object that can be merged into the `windows_function_app_slot`
...
`azurerm.windows_function_app_slot.withClientCertificateEnabled` constructs a mixin object that can be merged into the `windows_function_app_slot`
...
`azurerm.windows_function_app_slot.withClientCertificateExclusionPaths` constructs a mixin object that can be merged into the `windows_function_app_slot`
...
`azurerm.windows_function_app_slot.withClientCertificateMode` constructs a mixin object that can be merged into the `windows_function_app_slot`
...
`azurerm.windows_function_app_slot.withConnectionString` constructs a mixin object that can be merged into the `windows_function_app_slot`
...
`azurerm.windows_function_app_slot.withConnectionStringMixin` constructs a mixin object that can be merged into the `windows_function_app_slot`
Terraform resource block to set or update the connection_string field.
...
`azurerm.windows_function_app_slot.withContentShareForceDisabled` constructs a mixin object that can be merged into the `windows_function_app_slot`
...
`azurerm.windows_function_app_slot.withDailyMemoryTimeQuota` constructs a mixin object that can be merged into the `windows_function_app_slot`
...
`azurerm.windows_function_app_slot.withEnabled` constructs a mixin object that can be merged into the `windows_function_app_slot`
...
`azurerm.windows_function_app_slot.withFunctionAppId` constructs a mixin object that can be merged into the `windows_function_app_slot`
...
`azurerm.windows_function_app_slot.withFunctionsExtensionVersion` constructs a mixin object that can be merged into the `windows_function_app_slot`
...
`azurerm.windows_function_app_slot.withHttpsOnly` constructs a mixin object that can be merged into the `windows_function_app_slot`
...
`azurerm.windows_function_app_slot.withIdentity` constructs a mixin object that can be merged into the `windows_function_app_slot`
...
`azurerm.windows_function_app_slot.withIdentityMixin` constructs a mixin object that can be merged into the `windows_function_app_slot`
Terraform resource block to set or update the identity field.
...
`azurerm.windows_function_app_slot.withKeyVaultReferenceIdentityId` constructs a mixin object that can be merged into the `windows_function_app_slot`
...
`azurerm.windows_function_app_slot.withName` constructs a mixin object that can be merged into the `windows_function_app_slot`
...
`azurerm.windows_function_app_slot.withSiteConfig` constructs a mixin object that can be merged into the `windows_function_app_slot`
...
`azurerm.windows_function_app_slot.withSiteConfigMixin` constructs a mixin object that can be merged into the `windows_function_app_slot`
Terraform resource block to set or update the site_config field.
...
`azurerm.windows_function_app_slot.withStorageAccount` constructs a mixin object that can be merged into the `windows_function_app_slot`
...
`azurerm.windows_function_app_slot.withStorageAccountAccessKey` constructs a mixin object that can be merged into the `windows_function_app_slot`
...
`azurerm.windows_function_app_slot.withStorageAccountMixin` constructs a mixin object that can be merged into the `windows_function_app_slot`
Terraform resource block to set or update the storage_account field.
...
`azurerm.windows_function_app_slot.withStorageAccountName` constructs a mixin object that can be merged into the `windows_function_app_slot`
...
`azurerm.windows_function_app_slot.withStorageKeyVaultSecretId` constructs a mixin object that can be merged into the `windows_function_app_slot`
...
`azurerm.windows_function_app_slot.withStorageUsesManagedIdentity` constructs a mixin object that can be merged into the `windows_function_app_slot`
...
`azurerm.windows_function_app_slot.withTags` constructs a mixin object that can be merged into the `windows_function_app_slot`
...
`azurerm.windows_function_app_slot.withTimeouts` constructs a mixin object that can be merged into the `windows_function_app_slot`
...
`azurerm.windows_function_app_slot.withTimeoutsMixin` constructs a mixin object that can be merged into the `windows_function_app_slot`
Terraform resource block to set or update the timeouts field.
...
`azurerm.windows_function_app_slot.withVirtualNetworkSubnetId` constructs a mixin object that can be merged into the `windows_function_app_slot`
