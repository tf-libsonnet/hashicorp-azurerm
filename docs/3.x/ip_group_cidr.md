---
permalink: /ip_group_cidr/
---

# ip_group_cidr

`ip_group_cidr` represents the `azurerm_ip_group_cidr` Terraform resource.
...
* [`fn withIpGroupId()`](#fn-withipgroupid)
...
`azurerm.string.withIpGroupId` constructs a mixin object that can be merged into the `string`
