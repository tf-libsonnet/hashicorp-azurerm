...
`azurerm.app_service_managed_certificate.withCustomHostnameBindingId` constructs a mixin object that can be merged into the `app_service_managed_certificate`
...
`azurerm.app_service_managed_certificate.withTags` constructs a mixin object that can be merged into the `app_service_managed_certificate`
...
`azurerm.app_service_managed_certificate.withTimeouts` constructs a mixin object that can be merged into the `app_service_managed_certificate`
...
`azurerm.app_service_managed_certificate.withTimeoutsMixin` constructs a mixin object that can be merged into the `app_service_managed_certificate`
Terraform resource block to set or update the timeouts field.
