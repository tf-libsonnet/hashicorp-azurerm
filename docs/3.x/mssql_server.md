...
`azurerm.mssql_server.withAdministratorLogin` constructs a mixin object that can be merged into the `mssql_server`
...
`azurerm.mssql_server.withAdministratorLoginPassword` constructs a mixin object that can be merged into the `mssql_server`
...
`azurerm.mssql_server.withAzureadAdministrator` constructs a mixin object that can be merged into the `mssql_server`
...
`azurerm.mssql_server.withAzureadAdministratorMixin` constructs a mixin object that can be merged into the `mssql_server`
Terraform resource block to set or update the azuread_administrator field.
...
`azurerm.mssql_server.withConnectionPolicy` constructs a mixin object that can be merged into the `mssql_server`
...
`azurerm.mssql_server.withIdentity` constructs a mixin object that can be merged into the `mssql_server`
...
`azurerm.mssql_server.withIdentityMixin` constructs a mixin object that can be merged into the `mssql_server`
Terraform resource block to set or update the identity field.
...
`azurerm.mssql_server.withLocation` constructs a mixin object that can be merged into the `mssql_server`
...
`azurerm.mssql_server.withMinimumTlsVersion` constructs a mixin object that can be merged into the `mssql_server`
...
`azurerm.mssql_server.withName` constructs a mixin object that can be merged into the `mssql_server`
...
`azurerm.mssql_server.withOutboundNetworkRestrictionEnabled` constructs a mixin object that can be merged into the `mssql_server`
...
`azurerm.mssql_server.withPrimaryUserAssignedIdentityId` constructs a mixin object that can be merged into the `mssql_server`
...
`azurerm.mssql_server.withPublicNetworkAccessEnabled` constructs a mixin object that can be merged into the `mssql_server`
...
`azurerm.mssql_server.withResourceGroupName` constructs a mixin object that can be merged into the `mssql_server`
...
`azurerm.mssql_server.withTags` constructs a mixin object that can be merged into the `mssql_server`
...
`azurerm.mssql_server.withTimeouts` constructs a mixin object that can be merged into the `mssql_server`
...
`azurerm.mssql_server.withTimeoutsMixin` constructs a mixin object that can be merged into the `mssql_server`
Terraform resource block to set or update the timeouts field.
...
`azurerm.mssql_server.withVersion` constructs a mixin object that can be merged into the `mssql_server`
