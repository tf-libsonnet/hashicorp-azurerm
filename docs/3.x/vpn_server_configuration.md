...
`azurerm.vpn_server_configuration.withAzureActiveDirectoryAuthentication` constructs a mixin object that can be merged into the `vpn_server_configuration`
...
`azurerm.vpn_server_configuration.withAzureActiveDirectoryAuthenticationMixin` constructs a mixin object that can be merged into the `vpn_server_configuration`
Terraform resource block to set or update the azure_active_directory_authentication field.
...
`azurerm.vpn_server_configuration.withClientRevokedCertificate` constructs a mixin object that can be merged into the `vpn_server_configuration`
...
`azurerm.vpn_server_configuration.withClientRevokedCertificateMixin` constructs a mixin object that can be merged into the `vpn_server_configuration`
Terraform resource block to set or update the client_revoked_certificate field.
...
`azurerm.vpn_server_configuration.withClientRootCertificate` constructs a mixin object that can be merged into the `vpn_server_configuration`
...
`azurerm.vpn_server_configuration.withClientRootCertificateMixin` constructs a mixin object that can be merged into the `vpn_server_configuration`
Terraform resource block to set or update the client_root_certificate field.
...
`azurerm.vpn_server_configuration.withIpsecPolicy` constructs a mixin object that can be merged into the `vpn_server_configuration`
...
`azurerm.vpn_server_configuration.withIpsecPolicyMixin` constructs a mixin object that can be merged into the `vpn_server_configuration`
Terraform resource block to set or update the ipsec_policy field.
...
`azurerm.vpn_server_configuration.withLocation` constructs a mixin object that can be merged into the `vpn_server_configuration`
...
`azurerm.vpn_server_configuration.withName` constructs a mixin object that can be merged into the `vpn_server_configuration`
...
`azurerm.vpn_server_configuration.withRadius` constructs a mixin object that can be merged into the `vpn_server_configuration`
...
`azurerm.vpn_server_configuration.withRadiusMixin` constructs a mixin object that can be merged into the `vpn_server_configuration`
Terraform resource block to set or update the radius field.
...
`azurerm.vpn_server_configuration.withResourceGroupName` constructs a mixin object that can be merged into the `vpn_server_configuration`
...
`azurerm.vpn_server_configuration.withTags` constructs a mixin object that can be merged into the `vpn_server_configuration`
...
`azurerm.vpn_server_configuration.withTimeouts` constructs a mixin object that can be merged into the `vpn_server_configuration`
...
`azurerm.vpn_server_configuration.withTimeoutsMixin` constructs a mixin object that can be merged into the `vpn_server_configuration`
Terraform resource block to set or update the timeouts field.
...
`azurerm.vpn_server_configuration.withVpnAuthenticationTypes` constructs a mixin object that can be merged into the `vpn_server_configuration`
...
`azurerm.vpn_server_configuration.withVpnProtocols` constructs a mixin object that can be merged into the `vpn_server_configuration`
