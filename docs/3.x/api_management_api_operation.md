...
`azurerm.api_management_api_operation.withApiManagementName` constructs a mixin object that can be merged into the `api_management_api_operation`
...
`azurerm.api_management_api_operation.withApiName` constructs a mixin object that can be merged into the `api_management_api_operation`
...
`azurerm.api_management_api_operation.withDescription` constructs a mixin object that can be merged into the `api_management_api_operation`
...
`azurerm.api_management_api_operation.withDisplayName` constructs a mixin object that can be merged into the `api_management_api_operation`
...
`azurerm.api_management_api_operation.withMethod` constructs a mixin object that can be merged into the `api_management_api_operation`
...
`azurerm.api_management_api_operation.withOperationId` constructs a mixin object that can be merged into the `api_management_api_operation`
...
`azurerm.api_management_api_operation.withRequest` constructs a mixin object that can be merged into the `api_management_api_operation`
...
`azurerm.api_management_api_operation.withRequestMixin` constructs a mixin object that can be merged into the `api_management_api_operation`
Terraform resource block to set or update the request field.
...
`azurerm.api_management_api_operation.withResourceGroupName` constructs a mixin object that can be merged into the `api_management_api_operation`
...
`azurerm.api_management_api_operation.withResponse` constructs a mixin object that can be merged into the `api_management_api_operation`
...
`azurerm.api_management_api_operation.withResponseMixin` constructs a mixin object that can be merged into the `api_management_api_operation`
Terraform resource block to set or update the response field.
...
`azurerm.api_management_api_operation.withTemplateParameter` constructs a mixin object that can be merged into the `api_management_api_operation`
...
`azurerm.api_management_api_operation.withTemplateParameterMixin` constructs a mixin object that can be merged into the `api_management_api_operation`
Terraform resource block to set or update the template_parameter field.
...
`azurerm.api_management_api_operation.withTimeouts` constructs a mixin object that can be merged into the `api_management_api_operation`
...
`azurerm.api_management_api_operation.withTimeoutsMixin` constructs a mixin object that can be merged into the `api_management_api_operation`
Terraform resource block to set or update the timeouts field.
...
`azurerm.api_management_api_operation.withUrlTemplate` constructs a mixin object that can be merged into the `api_management_api_operation`
