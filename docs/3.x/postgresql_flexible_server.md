...
`azurerm.postgresql_flexible_server.withAdministratorLogin` constructs a mixin object that can be merged into the `postgresql_flexible_server`
...
`azurerm.postgresql_flexible_server.withAdministratorPassword` constructs a mixin object that can be merged into the `postgresql_flexible_server`
...
`azurerm.postgresql_flexible_server.withAuthentication` constructs a mixin object that can be merged into the `postgresql_flexible_server`
...
`azurerm.postgresql_flexible_server.withAuthenticationMixin` constructs a mixin object that can be merged into the `postgresql_flexible_server`
Terraform resource block to set or update the authentication field.
...
`azurerm.postgresql_flexible_server.withBackupRetentionDays` constructs a mixin object that can be merged into the `postgresql_flexible_server`
...
`azurerm.postgresql_flexible_server.withCreateMode` constructs a mixin object that can be merged into the `postgresql_flexible_server`
...
`azurerm.postgresql_flexible_server.withDelegatedSubnetId` constructs a mixin object that can be merged into the `postgresql_flexible_server`
...
`azurerm.postgresql_flexible_server.withGeoRedundantBackupEnabled` constructs a mixin object that can be merged into the `postgresql_flexible_server`
...
`azurerm.postgresql_flexible_server.withHighAvailability` constructs a mixin object that can be merged into the `postgresql_flexible_server`
...
`azurerm.postgresql_flexible_server.withHighAvailabilityMixin` constructs a mixin object that can be merged into the `postgresql_flexible_server`
Terraform resource block to set or update the high_availability field.
...
`azurerm.postgresql_flexible_server.withLocation` constructs a mixin object that can be merged into the `postgresql_flexible_server`
...
`azurerm.postgresql_flexible_server.withMaintenanceWindow` constructs a mixin object that can be merged into the `postgresql_flexible_server`
...
`azurerm.postgresql_flexible_server.withMaintenanceWindowMixin` constructs a mixin object that can be merged into the `postgresql_flexible_server`
Terraform resource block to set or update the maintenance_window field.
...
`azurerm.postgresql_flexible_server.withName` constructs a mixin object that can be merged into the `postgresql_flexible_server`
...
`azurerm.postgresql_flexible_server.withPointInTimeRestoreTimeInUtc` constructs a mixin object that can be merged into the `postgresql_flexible_server`
...
`azurerm.postgresql_flexible_server.withPrivateDnsZoneId` constructs a mixin object that can be merged into the `postgresql_flexible_server`
...
`azurerm.postgresql_flexible_server.withResourceGroupName` constructs a mixin object that can be merged into the `postgresql_flexible_server`
...
`azurerm.postgresql_flexible_server.withSkuName` constructs a mixin object that can be merged into the `postgresql_flexible_server`
...
`azurerm.postgresql_flexible_server.withSourceServerId` constructs a mixin object that can be merged into the `postgresql_flexible_server`
...
`azurerm.postgresql_flexible_server.withStorageMb` constructs a mixin object that can be merged into the `postgresql_flexible_server`
...
`azurerm.postgresql_flexible_server.withTags` constructs a mixin object that can be merged into the `postgresql_flexible_server`
...
`azurerm.postgresql_flexible_server.withTimeouts` constructs a mixin object that can be merged into the `postgresql_flexible_server`
...
`azurerm.postgresql_flexible_server.withTimeoutsMixin` constructs a mixin object that can be merged into the `postgresql_flexible_server`
Terraform resource block to set or update the timeouts field.
...
`azurerm.postgresql_flexible_server.withVersion` constructs a mixin object that can be merged into the `postgresql_flexible_server`
...
`azurerm.postgresql_flexible_server.withZone` constructs a mixin object that can be merged into the `postgresql_flexible_server`
