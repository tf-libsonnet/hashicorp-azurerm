...
`azurerm.function_app.withAppServicePlanId` constructs a mixin object that can be merged into the `function_app`
...
`azurerm.function_app.withAppSettings` constructs a mixin object that can be merged into the `function_app`
...
`azurerm.function_app.withAuthSettings` constructs a mixin object that can be merged into the `function_app`
...
`azurerm.function_app.withAuthSettingsMixin` constructs a mixin object that can be merged into the `function_app`
Terraform resource block to set or update the auth_settings field.
...
`azurerm.function_app.withClientCertMode` constructs a mixin object that can be merged into the `function_app`
...
`azurerm.function_app.withConnectionString` constructs a mixin object that can be merged into the `function_app`
...
`azurerm.function_app.withConnectionStringMixin` constructs a mixin object that can be merged into the `function_app`
Terraform resource block to set or update the connection_string field.
...
`azurerm.function_app.withDailyMemoryTimeQuota` constructs a mixin object that can be merged into the `function_app`
...
`azurerm.function_app.withEnableBuiltinLogging` constructs a mixin object that can be merged into the `function_app`
...
`azurerm.function_app.withEnabled` constructs a mixin object that can be merged into the `function_app`
...
`azurerm.function_app.withHttpsOnly` constructs a mixin object that can be merged into the `function_app`
...
`azurerm.function_app.withIdentity` constructs a mixin object that can be merged into the `function_app`
...
`azurerm.function_app.withIdentityMixin` constructs a mixin object that can be merged into the `function_app`
Terraform resource block to set or update the identity field.
...
`azurerm.function_app.withKeyVaultReferenceIdentityId` constructs a mixin object that can be merged into the `function_app`
...
`azurerm.function_app.withLocation` constructs a mixin object that can be merged into the `function_app`
...
`azurerm.function_app.withName` constructs a mixin object that can be merged into the `function_app`
...
`azurerm.function_app.withOsType` constructs a mixin object that can be merged into the `function_app`
...
`azurerm.function_app.withResourceGroupName` constructs a mixin object that can be merged into the `function_app`
...
`azurerm.function_app.withSiteConfig` constructs a mixin object that can be merged into the `function_app`
...
`azurerm.function_app.withSiteConfigMixin` constructs a mixin object that can be merged into the `function_app`
Terraform resource block to set or update the site_config field.
...
`azurerm.function_app.withSourceControl` constructs a mixin object that can be merged into the `function_app`
...
`azurerm.function_app.withSourceControlMixin` constructs a mixin object that can be merged into the `function_app`
Terraform resource block to set or update the source_control field.
...
`azurerm.function_app.withStorageAccountAccessKey` constructs a mixin object that can be merged into the `function_app`
...
`azurerm.function_app.withStorageAccountName` constructs a mixin object that can be merged into the `function_app`
...
`azurerm.function_app.withTags` constructs a mixin object that can be merged into the `function_app`
...
`azurerm.function_app.withTimeouts` constructs a mixin object that can be merged into the `function_app`
...
`azurerm.function_app.withTimeoutsMixin` constructs a mixin object that can be merged into the `function_app`
Terraform resource block to set or update the timeouts field.
...
`azurerm.function_app.withVersion` constructs a mixin object that can be merged into the `function_app`
