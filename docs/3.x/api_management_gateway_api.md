...
`azurerm.api_management_gateway_api.withApiId` constructs a mixin object that can be merged into the `api_management_gateway_api`
...
`azurerm.api_management_gateway_api.withGatewayId` constructs a mixin object that can be merged into the `api_management_gateway_api`
...
`azurerm.api_management_gateway_api.withTimeouts` constructs a mixin object that can be merged into the `api_management_gateway_api`
...
`azurerm.api_management_gateway_api.withTimeoutsMixin` constructs a mixin object that can be merged into the `api_management_gateway_api`
Terraform resource block to set or update the timeouts field.
