...
`azurerm.mssql_firewall_rule.withEndIpAddress` constructs a mixin object that can be merged into the `mssql_firewall_rule`
...
`azurerm.mssql_firewall_rule.withName` constructs a mixin object that can be merged into the `mssql_firewall_rule`
...
`azurerm.mssql_firewall_rule.withServerId` constructs a mixin object that can be merged into the `mssql_firewall_rule`
...
`azurerm.mssql_firewall_rule.withStartIpAddress` constructs a mixin object that can be merged into the `mssql_firewall_rule`
...
`azurerm.mssql_firewall_rule.withTimeouts` constructs a mixin object that can be merged into the `mssql_firewall_rule`
...
`azurerm.mssql_firewall_rule.withTimeoutsMixin` constructs a mixin object that can be merged into the `mssql_firewall_rule`
Terraform resource block to set or update the timeouts field.
