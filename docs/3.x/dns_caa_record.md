...
**Args**:
  ...
  - `ttl` (`number`): 
  - `zone_name` (`string`): 
  - `record` (`list[obj]`):  When `null`, the `record` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.dns_caa_record.record.new](#fn-dns_caa_recordrecordnew) constructor.
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.dns_caa_record.timeouts.new](#fn-dns_caa_recordtimeoutsnew) constructor.
...
Unlike [azurerm.dns_caa_record.new](#fn-dns_caa_recordnew), this function will not inject the `resource`
