...
`azurerm.sentinel_alert_rule_scheduled.withAlertDetailsOverride` constructs a mixin object that can be merged into the `sentinel_alert_rule_scheduled`
...
`azurerm.sentinel_alert_rule_scheduled.withAlertDetailsOverrideMixin` constructs a mixin object that can be merged into the `sentinel_alert_rule_scheduled`
Terraform resource block to set or update the alert_details_override field.
...
`azurerm.sentinel_alert_rule_scheduled.withAlertRuleTemplateGuid` constructs a mixin object that can be merged into the `sentinel_alert_rule_scheduled`
...
`azurerm.sentinel_alert_rule_scheduled.withAlertRuleTemplateVersion` constructs a mixin object that can be merged into the `sentinel_alert_rule_scheduled`
...
`azurerm.sentinel_alert_rule_scheduled.withCustomDetails` constructs a mixin object that can be merged into the `sentinel_alert_rule_scheduled`
...
`azurerm.sentinel_alert_rule_scheduled.withDescription` constructs a mixin object that can be merged into the `sentinel_alert_rule_scheduled`
...
`azurerm.sentinel_alert_rule_scheduled.withDisplayName` constructs a mixin object that can be merged into the `sentinel_alert_rule_scheduled`
...
`azurerm.sentinel_alert_rule_scheduled.withEnabled` constructs a mixin object that can be merged into the `sentinel_alert_rule_scheduled`
...
`azurerm.sentinel_alert_rule_scheduled.withEntityMapping` constructs a mixin object that can be merged into the `sentinel_alert_rule_scheduled`
...
`azurerm.sentinel_alert_rule_scheduled.withEntityMappingMixin` constructs a mixin object that can be merged into the `sentinel_alert_rule_scheduled`
Terraform resource block to set or update the entity_mapping field.
...
`azurerm.sentinel_alert_rule_scheduled.withEventGrouping` constructs a mixin object that can be merged into the `sentinel_alert_rule_scheduled`
...
`azurerm.sentinel_alert_rule_scheduled.withEventGroupingMixin` constructs a mixin object that can be merged into the `sentinel_alert_rule_scheduled`
Terraform resource block to set or update the event_grouping field.
...
`azurerm.sentinel_alert_rule_scheduled.withIncidentConfiguration` constructs a mixin object that can be merged into the `sentinel_alert_rule_scheduled`
...
`azurerm.sentinel_alert_rule_scheduled.withIncidentConfigurationMixin` constructs a mixin object that can be merged into the `sentinel_alert_rule_scheduled`
Terraform resource block to set or update the incident_configuration field.
...
`azurerm.sentinel_alert_rule_scheduled.withLogAnalyticsWorkspaceId` constructs a mixin object that can be merged into the `sentinel_alert_rule_scheduled`
...
`azurerm.sentinel_alert_rule_scheduled.withName` constructs a mixin object that can be merged into the `sentinel_alert_rule_scheduled`
...
`azurerm.sentinel_alert_rule_scheduled.withQuery` constructs a mixin object that can be merged into the `sentinel_alert_rule_scheduled`
...
`azurerm.sentinel_alert_rule_scheduled.withQueryFrequency` constructs a mixin object that can be merged into the `sentinel_alert_rule_scheduled`
...
`azurerm.sentinel_alert_rule_scheduled.withQueryPeriod` constructs a mixin object that can be merged into the `sentinel_alert_rule_scheduled`
...
`azurerm.sentinel_alert_rule_scheduled.withSeverity` constructs a mixin object that can be merged into the `sentinel_alert_rule_scheduled`
...
`azurerm.sentinel_alert_rule_scheduled.withSuppressionDuration` constructs a mixin object that can be merged into the `sentinel_alert_rule_scheduled`
...
`azurerm.sentinel_alert_rule_scheduled.withSuppressionEnabled` constructs a mixin object that can be merged into the `sentinel_alert_rule_scheduled`
...
`azurerm.sentinel_alert_rule_scheduled.withTactics` constructs a mixin object that can be merged into the `sentinel_alert_rule_scheduled`
...
`azurerm.sentinel_alert_rule_scheduled.withTechniques` constructs a mixin object that can be merged into the `sentinel_alert_rule_scheduled`
...
`azurerm.sentinel_alert_rule_scheduled.withTimeouts` constructs a mixin object that can be merged into the `sentinel_alert_rule_scheduled`
...
`azurerm.sentinel_alert_rule_scheduled.withTimeoutsMixin` constructs a mixin object that can be merged into the `sentinel_alert_rule_scheduled`
Terraform resource block to set or update the timeouts field.
...
`azurerm.sentinel_alert_rule_scheduled.withTriggerOperator` constructs a mixin object that can be merged into the `sentinel_alert_rule_scheduled`
...
`azurerm.sentinel_alert_rule_scheduled.withTriggerThreshold` constructs a mixin object that can be merged into the `sentinel_alert_rule_scheduled`
