...
`azurerm.bot_channels_registration.withCmkKeyVaultUrl` constructs a mixin object that can be merged into the `bot_channels_registration`
...
`azurerm.bot_channels_registration.withDescription` constructs a mixin object that can be merged into the `bot_channels_registration`
...
`azurerm.bot_channels_registration.withDeveloperAppInsightsApiKey` constructs a mixin object that can be merged into the `bot_channels_registration`
...
`azurerm.bot_channels_registration.withDeveloperAppInsightsApplicationId` constructs a mixin object that can be merged into the `bot_channels_registration`
...
`azurerm.bot_channels_registration.withDeveloperAppInsightsKey` constructs a mixin object that can be merged into the `bot_channels_registration`
...
`azurerm.bot_channels_registration.withDisplayName` constructs a mixin object that can be merged into the `bot_channels_registration`
...
`azurerm.bot_channels_registration.withEndpoint` constructs a mixin object that can be merged into the `bot_channels_registration`
...
`azurerm.bot_channels_registration.withIconUrl` constructs a mixin object that can be merged into the `bot_channels_registration`
...
`azurerm.bot_channels_registration.withIsolatedNetworkEnabled` constructs a mixin object that can be merged into the `bot_channels_registration`
...
`azurerm.bot_channels_registration.withLocation` constructs a mixin object that can be merged into the `bot_channels_registration`
...
`azurerm.bot_channels_registration.withMicrosoftAppId` constructs a mixin object that can be merged into the `bot_channels_registration`
...
`azurerm.bot_channels_registration.withName` constructs a mixin object that can be merged into the `bot_channels_registration`
...
`azurerm.bot_channels_registration.withPublicNetworkAccessEnabled` constructs a mixin object that can be merged into the `bot_channels_registration`
...
`azurerm.bot_channels_registration.withResourceGroupName` constructs a mixin object that can be merged into the `bot_channels_registration`
...
`azurerm.bot_channels_registration.withSku` constructs a mixin object that can be merged into the `bot_channels_registration`
...
`azurerm.bot_channels_registration.withStreamingEndpointEnabled` constructs a mixin object that can be merged into the `bot_channels_registration`
...
`azurerm.bot_channels_registration.withTags` constructs a mixin object that can be merged into the `bot_channels_registration`
...
`azurerm.bot_channels_registration.withTimeouts` constructs a mixin object that can be merged into the `bot_channels_registration`
...
`azurerm.bot_channels_registration.withTimeoutsMixin` constructs a mixin object that can be merged into the `bot_channels_registration`
Terraform resource block to set or update the timeouts field.
