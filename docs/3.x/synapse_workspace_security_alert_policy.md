...
`azurerm.synapse_workspace_security_alert_policy.withDisabledAlerts` constructs a mixin object that can be merged into the `synapse_workspace_security_alert_policy`
...
`azurerm.synapse_workspace_security_alert_policy.withEmailAccountAdminsEnabled` constructs a mixin object that can be merged into the `synapse_workspace_security_alert_policy`
...
`azurerm.synapse_workspace_security_alert_policy.withEmailAddresses` constructs a mixin object that can be merged into the `synapse_workspace_security_alert_policy`
...
`azurerm.synapse_workspace_security_alert_policy.withPolicyState` constructs a mixin object that can be merged into the `synapse_workspace_security_alert_policy`
...
`azurerm.synapse_workspace_security_alert_policy.withRetentionDays` constructs a mixin object that can be merged into the `synapse_workspace_security_alert_policy`
...
`azurerm.synapse_workspace_security_alert_policy.withStorageAccountAccessKey` constructs a mixin object that can be merged into the `synapse_workspace_security_alert_policy`
...
`azurerm.synapse_workspace_security_alert_policy.withStorageEndpoint` constructs a mixin object that can be merged into the `synapse_workspace_security_alert_policy`
...
`azurerm.synapse_workspace_security_alert_policy.withSynapseWorkspaceId` constructs a mixin object that can be merged into the `synapse_workspace_security_alert_policy`
...
`azurerm.synapse_workspace_security_alert_policy.withTimeouts` constructs a mixin object that can be merged into the `synapse_workspace_security_alert_policy`
...
`azurerm.synapse_workspace_security_alert_policy.withTimeoutsMixin` constructs a mixin object that can be merged into the `synapse_workspace_security_alert_policy`
Terraform resource block to set or update the timeouts field.
