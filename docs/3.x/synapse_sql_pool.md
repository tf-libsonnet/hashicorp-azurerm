...
`azurerm.synapse_sql_pool.withCollation` constructs a mixin object that can be merged into the `synapse_sql_pool`
...
`azurerm.synapse_sql_pool.withCreateMode` constructs a mixin object that can be merged into the `synapse_sql_pool`
...
`azurerm.synapse_sql_pool.withDataEncrypted` constructs a mixin object that can be merged into the `synapse_sql_pool`
...
`azurerm.synapse_sql_pool.withName` constructs a mixin object that can be merged into the `synapse_sql_pool`
...
`azurerm.synapse_sql_pool.withRecoveryDatabaseId` constructs a mixin object that can be merged into the `synapse_sql_pool`
...
`azurerm.synapse_sql_pool.withRestore` constructs a mixin object that can be merged into the `synapse_sql_pool`
...
`azurerm.synapse_sql_pool.withRestoreMixin` constructs a mixin object that can be merged into the `synapse_sql_pool`
Terraform resource block to set or update the restore field.
...
`azurerm.synapse_sql_pool.withSkuName` constructs a mixin object that can be merged into the `synapse_sql_pool`
...
`azurerm.synapse_sql_pool.withSynapseWorkspaceId` constructs a mixin object that can be merged into the `synapse_sql_pool`
...
`azurerm.synapse_sql_pool.withTags` constructs a mixin object that can be merged into the `synapse_sql_pool`
...
`azurerm.synapse_sql_pool.withTimeouts` constructs a mixin object that can be merged into the `synapse_sql_pool`
...
`azurerm.synapse_sql_pool.withTimeoutsMixin` constructs a mixin object that can be merged into the `synapse_sql_pool`
Terraform resource block to set or update the timeouts field.
