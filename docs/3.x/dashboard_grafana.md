...
`azurerm.dashboard_grafana.withApiKeyEnabled` constructs a mixin object that can be merged into the `dashboard_grafana`
...
`azurerm.dashboard_grafana.withAutoGeneratedDomainNameLabelScope` constructs a mixin object that can be merged into the `dashboard_grafana`
...
`azurerm.dashboard_grafana.withDeterministicOutboundIpEnabled` constructs a mixin object that can be merged into the `dashboard_grafana`
...
`azurerm.dashboard_grafana.withIdentity` constructs a mixin object that can be merged into the `dashboard_grafana`
...
`azurerm.dashboard_grafana.withIdentityMixin` constructs a mixin object that can be merged into the `dashboard_grafana`
Terraform resource block to set or update the identity field.
...
`azurerm.dashboard_grafana.withLocation` constructs a mixin object that can be merged into the `dashboard_grafana`
...
`azurerm.dashboard_grafana.withName` constructs a mixin object that can be merged into the `dashboard_grafana`
...
`azurerm.dashboard_grafana.withPublicNetworkAccessEnabled` constructs a mixin object that can be merged into the `dashboard_grafana`
...
`azurerm.dashboard_grafana.withResourceGroupName` constructs a mixin object that can be merged into the `dashboard_grafana`
...
`azurerm.dashboard_grafana.withSku` constructs a mixin object that can be merged into the `dashboard_grafana`
...
`azurerm.dashboard_grafana.withTags` constructs a mixin object that can be merged into the `dashboard_grafana`
...
`azurerm.dashboard_grafana.withTimeouts` constructs a mixin object that can be merged into the `dashboard_grafana`
...
`azurerm.dashboard_grafana.withTimeoutsMixin` constructs a mixin object that can be merged into the `dashboard_grafana`
Terraform resource block to set or update the timeouts field.
...
`azurerm.dashboard_grafana.withZoneRedundancyEnabled` constructs a mixin object that can be merged into the `dashboard_grafana`
