...
`azurerm.synapse_sql_pool_workload_classifier.withContext` constructs a mixin object that can be merged into the `synapse_sql_pool_workload_classifier`
...
`azurerm.synapse_sql_pool_workload_classifier.withEndTime` constructs a mixin object that can be merged into the `synapse_sql_pool_workload_classifier`
...
`azurerm.synapse_sql_pool_workload_classifier.withImportance` constructs a mixin object that can be merged into the `synapse_sql_pool_workload_classifier`
...
`azurerm.synapse_sql_pool_workload_classifier.withLabel` constructs a mixin object that can be merged into the `synapse_sql_pool_workload_classifier`
...
`azurerm.synapse_sql_pool_workload_classifier.withMemberName` constructs a mixin object that can be merged into the `synapse_sql_pool_workload_classifier`
...
`azurerm.synapse_sql_pool_workload_classifier.withName` constructs a mixin object that can be merged into the `synapse_sql_pool_workload_classifier`
...
`azurerm.synapse_sql_pool_workload_classifier.withStartTime` constructs a mixin object that can be merged into the `synapse_sql_pool_workload_classifier`
...
`azurerm.synapse_sql_pool_workload_classifier.withTimeouts` constructs a mixin object that can be merged into the `synapse_sql_pool_workload_classifier`
...
`azurerm.synapse_sql_pool_workload_classifier.withTimeoutsMixin` constructs a mixin object that can be merged into the `synapse_sql_pool_workload_classifier`
Terraform resource block to set or update the timeouts field.
...
`azurerm.synapse_sql_pool_workload_classifier.withWorkloadGroupId` constructs a mixin object that can be merged into the `synapse_sql_pool_workload_classifier`
