...
`azurerm.api_management_api_tag.withApiId` constructs a mixin object that can be merged into the `api_management_api_tag`
...
`azurerm.api_management_api_tag.withName` constructs a mixin object that can be merged into the `api_management_api_tag`
...
`azurerm.api_management_api_tag.withTimeouts` constructs a mixin object that can be merged into the `api_management_api_tag`
...
`azurerm.api_management_api_tag.withTimeoutsMixin` constructs a mixin object that can be merged into the `api_management_api_tag`
Terraform resource block to set or update the timeouts field.
