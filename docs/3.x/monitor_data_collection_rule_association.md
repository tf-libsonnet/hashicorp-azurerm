...
`azurerm.monitor_data_collection_rule_association.withName` constructs a mixin object that can be merged into the `monitor_data_collection_rule_association`
