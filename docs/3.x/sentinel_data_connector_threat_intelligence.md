...
`azurerm.sentinel_data_connector_threat_intelligence.withLogAnalyticsWorkspaceId` constructs a mixin object that can be merged into the `sentinel_data_connector_threat_intelligence`
...
`azurerm.sentinel_data_connector_threat_intelligence.withName` constructs a mixin object that can be merged into the `sentinel_data_connector_threat_intelligence`
...
`azurerm.sentinel_data_connector_threat_intelligence.withTenantId` constructs a mixin object that can be merged into the `sentinel_data_connector_threat_intelligence`
...
`azurerm.sentinel_data_connector_threat_intelligence.withTimeouts` constructs a mixin object that can be merged into the `sentinel_data_connector_threat_intelligence`
...
`azurerm.sentinel_data_connector_threat_intelligence.withTimeoutsMixin` constructs a mixin object that can be merged into the `sentinel_data_connector_threat_intelligence`
Terraform resource block to set or update the timeouts field.
