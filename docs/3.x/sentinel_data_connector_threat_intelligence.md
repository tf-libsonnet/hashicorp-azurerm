...
Unlike [azurerm.sentinel_data_connector_threat_intelligence.new](#fn-sentinel_data_connector_threat_intelligencenew), this function will not inject the `resource`
