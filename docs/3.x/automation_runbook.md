...
`azurerm.automation_runbook.withAutomationAccountName` constructs a mixin object that can be merged into the `automation_runbook`
...
`azurerm.automation_runbook.withContent` constructs a mixin object that can be merged into the `automation_runbook`
...
`azurerm.automation_runbook.withDescription` constructs a mixin object that can be merged into the `automation_runbook`
...
`azurerm.automation_runbook.withDraft` constructs a mixin object that can be merged into the `automation_runbook`
...
`azurerm.automation_runbook.withDraftMixin` constructs a mixin object that can be merged into the `automation_runbook`
Terraform resource block to set or update the draft field.
...
`azurerm.automation_runbook.withJobSchedule` constructs a mixin object that can be merged into the `automation_runbook`
...
`azurerm.automation_runbook.withLocation` constructs a mixin object that can be merged into the `automation_runbook`
...
`azurerm.automation_runbook.withLogActivityTraceLevel` constructs a mixin object that can be merged into the `automation_runbook`
...
`azurerm.automation_runbook.withLogProgress` constructs a mixin object that can be merged into the `automation_runbook`
...
`azurerm.automation_runbook.withLogVerbose` constructs a mixin object that can be merged into the `automation_runbook`
...
`azurerm.automation_runbook.withName` constructs a mixin object that can be merged into the `automation_runbook`
...
`azurerm.automation_runbook.withPublishContentLink` constructs a mixin object that can be merged into the `automation_runbook`
...
`azurerm.automation_runbook.withPublishContentLinkMixin` constructs a mixin object that can be merged into the `automation_runbook`
Terraform resource block to set or update the publish_content_link field.
...
`azurerm.automation_runbook.withResourceGroupName` constructs a mixin object that can be merged into the `automation_runbook`
...
`azurerm.automation_runbook.withRunbookType` constructs a mixin object that can be merged into the `automation_runbook`
...
`azurerm.automation_runbook.withTags` constructs a mixin object that can be merged into the `automation_runbook`
...
`azurerm.automation_runbook.withTimeouts` constructs a mixin object that can be merged into the `automation_runbook`
...
`azurerm.automation_runbook.withTimeoutsMixin` constructs a mixin object that can be merged into the `automation_runbook`
Terraform resource block to set or update the timeouts field.
