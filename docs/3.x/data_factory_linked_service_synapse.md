---
permalink: /data_factory_linked_service_synapse/
---

# data_factory_linked_service_synapse

`data_factory_linked_service_synapse` represents the `azurerm_data_factory_linked_service_synapse` Terraform resource.
...
`azurerm.data_factory_linked_service_synapse.withAdditionalProperties` constructs a mixin object that can be merged into the `data_factory_linked_service_synapse`
...
`azurerm.data_factory_linked_service_synapse.withAnnotations` constructs a mixin object that can be merged into the `data_factory_linked_service_synapse`
...
`azurerm.data_factory_linked_service_synapse.withConnectionString` constructs a mixin object that can be merged into the `data_factory_linked_service_synapse`
...
`azurerm.data_factory_linked_service_synapse.withDataFactoryId` constructs a mixin object that can be merged into the `data_factory_linked_service_synapse`
...
`azurerm.data_factory_linked_service_synapse.withDescription` constructs a mixin object that can be merged into the `data_factory_linked_service_synapse`
...
`azurerm.data_factory_linked_service_synapse.withIntegrationRuntimeName` constructs a mixin object that can be merged into the `data_factory_linked_service_synapse`
...
`azurerm.data_factory_linked_service_synapse.withKeyVaultPassword` constructs a mixin object that can be merged into the `data_factory_linked_service_synapse`
...
`azurerm.data_factory_linked_service_synapse.withKeyVaultPasswordMixin` constructs a mixin object that can be merged into the `data_factory_linked_service_synapse`
Terraform resource block to set or update the key_vault_password field.
...
`azurerm.data_factory_linked_service_synapse.withName` constructs a mixin object that can be merged into the `data_factory_linked_service_synapse`
...
`azurerm.data_factory_linked_service_synapse.withParameters` constructs a mixin object that can be merged into the `data_factory_linked_service_synapse`
...
`azurerm.data_factory_linked_service_synapse.withTimeouts` constructs a mixin object that can be merged into the `data_factory_linked_service_synapse`
...
`azurerm.data_factory_linked_service_synapse.withTimeoutsMixin` constructs a mixin object that can be merged into the `data_factory_linked_service_synapse`
Terraform resource block to set or update the timeouts field.
