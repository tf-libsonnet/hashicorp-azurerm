...
`azurerm.log_analytics_datasource_windows_event.withResourceGroupName` constructs a mixin object that can be merged into the `log_analytics_datasource_windows_event`
