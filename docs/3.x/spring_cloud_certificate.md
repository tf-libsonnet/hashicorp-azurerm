...
**Args**:
  ...
  - `service_name` (`string`): 
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.spring_cloud_certificate.timeouts.new](#fn-spring_cloud_certificatetimeoutsnew) constructor.
...
Unlike [azurerm.spring_cloud_certificate.new](#fn-spring_cloud_certificatenew), this function will not inject the `resource`
