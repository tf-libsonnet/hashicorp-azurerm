...
`azurerm.bot_channel_direct_line_speech.withBotName` constructs a mixin object that can be merged into the `bot_channel_direct_line_speech`
...
`azurerm.bot_channel_direct_line_speech.withCognitiveServiceAccessKey` constructs a mixin object that can be merged into the `bot_channel_direct_line_speech`
...
`azurerm.bot_channel_direct_line_speech.withCognitiveServiceLocation` constructs a mixin object that can be merged into the `bot_channel_direct_line_speech`
...
`azurerm.bot_channel_direct_line_speech.withCustomSpeechModelId` constructs a mixin object that can be merged into the `bot_channel_direct_line_speech`
...
`azurerm.bot_channel_direct_line_speech.withCustomVoiceDeploymentId` constructs a mixin object that can be merged into the `bot_channel_direct_line_speech`
...
`azurerm.bot_channel_direct_line_speech.withLocation` constructs a mixin object that can be merged into the `bot_channel_direct_line_speech`
...
`azurerm.bot_channel_direct_line_speech.withResourceGroupName` constructs a mixin object that can be merged into the `bot_channel_direct_line_speech`
...
`azurerm.bot_channel_direct_line_speech.withTimeouts` constructs a mixin object that can be merged into the `bot_channel_direct_line_speech`
...
`azurerm.bot_channel_direct_line_speech.withTimeoutsMixin` constructs a mixin object that can be merged into the `bot_channel_direct_line_speech`
Terraform resource block to set or update the timeouts field.
