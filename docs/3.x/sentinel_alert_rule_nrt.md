...
`azurerm.sentinel_alert_rule_nrt.withAlertDetailsOverride` constructs a mixin object that can be merged into the `sentinel_alert_rule_nrt`
...
`azurerm.sentinel_alert_rule_nrt.withAlertDetailsOverrideMixin` constructs a mixin object that can be merged into the `sentinel_alert_rule_nrt`
Terraform resource block to set or update the alert_details_override field.
...
`azurerm.sentinel_alert_rule_nrt.withAlertRuleTemplateGuid` constructs a mixin object that can be merged into the `sentinel_alert_rule_nrt`
...
`azurerm.sentinel_alert_rule_nrt.withAlertRuleTemplateVersion` constructs a mixin object that can be merged into the `sentinel_alert_rule_nrt`
...
`azurerm.sentinel_alert_rule_nrt.withCustomDetails` constructs a mixin object that can be merged into the `sentinel_alert_rule_nrt`
...
`azurerm.sentinel_alert_rule_nrt.withDescription` constructs a mixin object that can be merged into the `sentinel_alert_rule_nrt`
...
`azurerm.sentinel_alert_rule_nrt.withDisplayName` constructs a mixin object that can be merged into the `sentinel_alert_rule_nrt`
...
`azurerm.sentinel_alert_rule_nrt.withEnabled` constructs a mixin object that can be merged into the `sentinel_alert_rule_nrt`
...
`azurerm.sentinel_alert_rule_nrt.withEntityMapping` constructs a mixin object that can be merged into the `sentinel_alert_rule_nrt`
...
`azurerm.sentinel_alert_rule_nrt.withEntityMappingMixin` constructs a mixin object that can be merged into the `sentinel_alert_rule_nrt`
Terraform resource block to set or update the entity_mapping field.
...
`azurerm.sentinel_alert_rule_nrt.withIncident` constructs a mixin object that can be merged into the `sentinel_alert_rule_nrt`
...
`azurerm.sentinel_alert_rule_nrt.withIncidentMixin` constructs a mixin object that can be merged into the `sentinel_alert_rule_nrt`
Terraform resource block to set or update the incident field.
...
`azurerm.sentinel_alert_rule_nrt.withLogAnalyticsWorkspaceId` constructs a mixin object that can be merged into the `sentinel_alert_rule_nrt`
...
`azurerm.sentinel_alert_rule_nrt.withName` constructs a mixin object that can be merged into the `sentinel_alert_rule_nrt`
...
`azurerm.sentinel_alert_rule_nrt.withQuery` constructs a mixin object that can be merged into the `sentinel_alert_rule_nrt`
...
`azurerm.sentinel_alert_rule_nrt.withSeverity` constructs a mixin object that can be merged into the `sentinel_alert_rule_nrt`
...
`azurerm.sentinel_alert_rule_nrt.withSuppressionDuration` constructs a mixin object that can be merged into the `sentinel_alert_rule_nrt`
...
`azurerm.sentinel_alert_rule_nrt.withSuppressionEnabled` constructs a mixin object that can be merged into the `sentinel_alert_rule_nrt`
...
`azurerm.sentinel_alert_rule_nrt.withTactics` constructs a mixin object that can be merged into the `sentinel_alert_rule_nrt`
...
`azurerm.sentinel_alert_rule_nrt.withTechniques` constructs a mixin object that can be merged into the `sentinel_alert_rule_nrt`
...
`azurerm.sentinel_alert_rule_nrt.withTimeouts` constructs a mixin object that can be merged into the `sentinel_alert_rule_nrt`
...
`azurerm.sentinel_alert_rule_nrt.withTimeoutsMixin` constructs a mixin object that can be merged into the `sentinel_alert_rule_nrt`
Terraform resource block to set or update the timeouts field.
