...
`azurerm.stream_analytics_output_powerbi.withDataset` constructs a mixin object that can be merged into the `stream_analytics_output_powerbi`
...
`azurerm.stream_analytics_output_powerbi.withGroupId` constructs a mixin object that can be merged into the `stream_analytics_output_powerbi`
...
`azurerm.stream_analytics_output_powerbi.withGroupName` constructs a mixin object that can be merged into the `stream_analytics_output_powerbi`
...
`azurerm.stream_analytics_output_powerbi.withName` constructs a mixin object that can be merged into the `stream_analytics_output_powerbi`
...
`azurerm.stream_analytics_output_powerbi.withStreamAnalyticsJobId` constructs a mixin object that can be merged into the `stream_analytics_output_powerbi`
...
`azurerm.stream_analytics_output_powerbi.withTable` constructs a mixin object that can be merged into the `stream_analytics_output_powerbi`
...
`azurerm.stream_analytics_output_powerbi.withTimeouts` constructs a mixin object that can be merged into the `stream_analytics_output_powerbi`
...
`azurerm.stream_analytics_output_powerbi.withTimeoutsMixin` constructs a mixin object that can be merged into the `stream_analytics_output_powerbi`
Terraform resource block to set or update the timeouts field.
...
`azurerm.stream_analytics_output_powerbi.withTokenUserDisplayName` constructs a mixin object that can be merged into the `stream_analytics_output_powerbi`
...
`azurerm.stream_analytics_output_powerbi.withTokenUserPrincipalName` constructs a mixin object that can be merged into the `stream_analytics_output_powerbi`
