...
`azurerm.cosmosdb_gremlin_graph.withAccountName` constructs a mixin object that can be merged into the `cosmosdb_gremlin_graph`
...
`azurerm.cosmosdb_gremlin_graph.withAutoscaleSettings` constructs a mixin object that can be merged into the `cosmosdb_gremlin_graph`
...
`azurerm.cosmosdb_gremlin_graph.withAutoscaleSettingsMixin` constructs a mixin object that can be merged into the `cosmosdb_gremlin_graph`
Terraform resource block to set or update the autoscale_settings field.
...
`azurerm.cosmosdb_gremlin_graph.withConflictResolutionPolicy` constructs a mixin object that can be merged into the `cosmosdb_gremlin_graph`
...
`azurerm.cosmosdb_gremlin_graph.withConflictResolutionPolicyMixin` constructs a mixin object that can be merged into the `cosmosdb_gremlin_graph`
Terraform resource block to set or update the conflict_resolution_policy field.
...
`azurerm.cosmosdb_gremlin_graph.withDatabaseName` constructs a mixin object that can be merged into the `cosmosdb_gremlin_graph`
...
`azurerm.cosmosdb_gremlin_graph.withDefaultTtl` constructs a mixin object that can be merged into the `cosmosdb_gremlin_graph`
...
`azurerm.cosmosdb_gremlin_graph.withIndexPolicy` constructs a mixin object that can be merged into the `cosmosdb_gremlin_graph`
...
`azurerm.cosmosdb_gremlin_graph.withIndexPolicyMixin` constructs a mixin object that can be merged into the `cosmosdb_gremlin_graph`
Terraform resource block to set or update the index_policy field.
...
`azurerm.cosmosdb_gremlin_graph.withName` constructs a mixin object that can be merged into the `cosmosdb_gremlin_graph`
...
`azurerm.cosmosdb_gremlin_graph.withPartitionKeyPath` constructs a mixin object that can be merged into the `cosmosdb_gremlin_graph`
...
`azurerm.cosmosdb_gremlin_graph.withPartitionKeyVersion` constructs a mixin object that can be merged into the `cosmosdb_gremlin_graph`
...
`azurerm.cosmosdb_gremlin_graph.withResourceGroupName` constructs a mixin object that can be merged into the `cosmosdb_gremlin_graph`
...
`azurerm.cosmosdb_gremlin_graph.withThroughput` constructs a mixin object that can be merged into the `cosmosdb_gremlin_graph`
...
`azurerm.cosmosdb_gremlin_graph.withTimeouts` constructs a mixin object that can be merged into the `cosmosdb_gremlin_graph`
...
`azurerm.cosmosdb_gremlin_graph.withTimeoutsMixin` constructs a mixin object that can be merged into the `cosmosdb_gremlin_graph`
Terraform resource block to set or update the timeouts field.
...
`azurerm.cosmosdb_gremlin_graph.withUniqueKey` constructs a mixin object that can be merged into the `cosmosdb_gremlin_graph`
...
`azurerm.cosmosdb_gremlin_graph.withUniqueKeyMixin` constructs a mixin object that can be merged into the `cosmosdb_gremlin_graph`
Terraform resource block to set or update the unique_key field.
