...
`azurerm.string.withDatastoreType` constructs a mixin object that can be merged into the `string`
...
`azurerm.string.withRedundancy` constructs a mixin object that can be merged into the `string`
