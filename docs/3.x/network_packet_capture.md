...
`azurerm.network_packet_capture.withFilter` constructs a mixin object that can be merged into the `network_packet_capture`
...
`azurerm.network_packet_capture.withFilterMixin` constructs a mixin object that can be merged into the `network_packet_capture`
Terraform resource block to set or update the filter field.
...
`azurerm.network_packet_capture.withMaximumBytesPerPacket` constructs a mixin object that can be merged into the `network_packet_capture`
...
`azurerm.network_packet_capture.withMaximumBytesPerSession` constructs a mixin object that can be merged into the `network_packet_capture`
...
`azurerm.network_packet_capture.withMaximumCaptureDuration` constructs a mixin object that can be merged into the `network_packet_capture`
...
`azurerm.network_packet_capture.withName` constructs a mixin object that can be merged into the `network_packet_capture`
...
`azurerm.network_packet_capture.withNetworkWatcherName` constructs a mixin object that can be merged into the `network_packet_capture`
...
`azurerm.network_packet_capture.withResourceGroupName` constructs a mixin object that can be merged into the `network_packet_capture`
...
`azurerm.network_packet_capture.withStorageLocation` constructs a mixin object that can be merged into the `network_packet_capture`
...
`azurerm.network_packet_capture.withStorageLocationMixin` constructs a mixin object that can be merged into the `network_packet_capture`
Terraform resource block to set or update the storage_location field.
...
`azurerm.network_packet_capture.withTargetResourceId` constructs a mixin object that can be merged into the `network_packet_capture`
...
`azurerm.network_packet_capture.withTimeouts` constructs a mixin object that can be merged into the `network_packet_capture`
...
`azurerm.network_packet_capture.withTimeoutsMixin` constructs a mixin object that can be merged into the `network_packet_capture`
Terraform resource block to set or update the timeouts field.
