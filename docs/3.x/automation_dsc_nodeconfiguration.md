...
**Args**:
  ...
  - `timeouts` (`obj`): Set the `timeouts` field on the resulting resource block. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.automation_dsc_nodeconfiguration.timeouts.new](#fn-timeoutsnew) constructor.
...
Unlike [azurerm.automation_dsc_nodeconfiguration.new](#fn-new), this function will not inject the `resource`
...
**Args**:
  ...
  - `timeouts` (`obj`): Set the `timeouts` field on the resulting object. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.automation_dsc_nodeconfiguration.timeouts.new](#fn-timeoutsnew) constructor.
...
`azurerm.string.withContentEmbedded` constructs a mixin object that can be merged into the `string`
