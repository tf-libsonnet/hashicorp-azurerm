...
`azurerm.monitor_scheduled_query_rules_log.withAuthorizedResourceIds` constructs a mixin object that can be merged into the `monitor_scheduled_query_rules_log`
...
`azurerm.monitor_scheduled_query_rules_log.withCriteria` constructs a mixin object that can be merged into the `monitor_scheduled_query_rules_log`
...
`azurerm.monitor_scheduled_query_rules_log.withCriteriaMixin` constructs a mixin object that can be merged into the `monitor_scheduled_query_rules_log`
Terraform resource block to set or update the criteria field.
...
`azurerm.monitor_scheduled_query_rules_log.withDataSourceId` constructs a mixin object that can be merged into the `monitor_scheduled_query_rules_log`
...
`azurerm.monitor_scheduled_query_rules_log.withDescription` constructs a mixin object that can be merged into the `monitor_scheduled_query_rules_log`
...
`azurerm.monitor_scheduled_query_rules_log.withEnabled` constructs a mixin object that can be merged into the `monitor_scheduled_query_rules_log`
...
`azurerm.monitor_scheduled_query_rules_log.withLocation` constructs a mixin object that can be merged into the `monitor_scheduled_query_rules_log`
...
`azurerm.monitor_scheduled_query_rules_log.withTags` constructs a mixin object that can be merged into the `monitor_scheduled_query_rules_log`
