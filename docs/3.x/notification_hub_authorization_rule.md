...
`azurerm.notification_hub_authorization_rule.withListen` constructs a mixin object that can be merged into the `notification_hub_authorization_rule`
...
`azurerm.notification_hub_authorization_rule.withManage` constructs a mixin object that can be merged into the `notification_hub_authorization_rule`
...
`azurerm.notification_hub_authorization_rule.withName` constructs a mixin object that can be merged into the `notification_hub_authorization_rule`
...
`azurerm.notification_hub_authorization_rule.withNamespaceName` constructs a mixin object that can be merged into the `notification_hub_authorization_rule`
...
`azurerm.notification_hub_authorization_rule.withNotificationHubName` constructs a mixin object that can be merged into the `notification_hub_authorization_rule`
...
`azurerm.notification_hub_authorization_rule.withResourceGroupName` constructs a mixin object that can be merged into the `notification_hub_authorization_rule`
...
`azurerm.notification_hub_authorization_rule.withSend` constructs a mixin object that can be merged into the `notification_hub_authorization_rule`
...
`azurerm.notification_hub_authorization_rule.withTimeouts` constructs a mixin object that can be merged into the `notification_hub_authorization_rule`
...
`azurerm.notification_hub_authorization_rule.withTimeoutsMixin` constructs a mixin object that can be merged into the `notification_hub_authorization_rule`
Terraform resource block to set or update the timeouts field.
