...
`azurerm.notification_hub.withApnsCredential` constructs a mixin object that can be merged into the `notification_hub`
...
`azurerm.notification_hub.withApnsCredentialMixin` constructs a mixin object that can be merged into the `notification_hub`
Terraform resource block to set or update the apns_credential field.
...
`azurerm.notification_hub.withGcmCredential` constructs a mixin object that can be merged into the `notification_hub`
...
`azurerm.notification_hub.withGcmCredentialMixin` constructs a mixin object that can be merged into the `notification_hub`
Terraform resource block to set or update the gcm_credential field.
...
`azurerm.notification_hub.withLocation` constructs a mixin object that can be merged into the `notification_hub`
...
`azurerm.notification_hub.withTags` constructs a mixin object that can be merged into the `notification_hub`
