...
`azurerm.automation_watcher.withAutomationAccountId` constructs a mixin object that can be merged into the `automation_watcher`
...
`azurerm.automation_watcher.withDescription` constructs a mixin object that can be merged into the `automation_watcher`
...
`azurerm.automation_watcher.withEtag` constructs a mixin object that can be merged into the `automation_watcher`
...
`azurerm.automation_watcher.withExecutionFrequencyInSeconds` constructs a mixin object that can be merged into the `automation_watcher`
...
`azurerm.automation_watcher.withLocation` constructs a mixin object that can be merged into the `automation_watcher`
...
`azurerm.automation_watcher.withName` constructs a mixin object that can be merged into the `automation_watcher`
...
`azurerm.automation_watcher.withScriptName` constructs a mixin object that can be merged into the `automation_watcher`
...
`azurerm.automation_watcher.withScriptParameters` constructs a mixin object that can be merged into the `automation_watcher`
...
`azurerm.automation_watcher.withScriptRunOn` constructs a mixin object that can be merged into the `automation_watcher`
...
`azurerm.automation_watcher.withTags` constructs a mixin object that can be merged into the `automation_watcher`
...
`azurerm.automation_watcher.withTimeouts` constructs a mixin object that can be merged into the `automation_watcher`
...
`azurerm.automation_watcher.withTimeoutsMixin` constructs a mixin object that can be merged into the `automation_watcher`
Terraform resource block to set or update the timeouts field.
