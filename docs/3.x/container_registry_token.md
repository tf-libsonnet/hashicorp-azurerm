...
`azurerm.container_registry_token.withEnabled` constructs a mixin object that can be merged into the `container_registry_token`
...
`azurerm.container_registry_token.withScopeMapId` constructs a mixin object that can be merged into the `container_registry_token`
