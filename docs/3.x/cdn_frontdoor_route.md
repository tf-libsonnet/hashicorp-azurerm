...
`azurerm.cdn_frontdoor_route.withCache` constructs a mixin object that can be merged into the `cdn_frontdoor_route`
...
`azurerm.cdn_frontdoor_route.withCacheMixin` constructs a mixin object that can be merged into the `cdn_frontdoor_route`
Terraform resource block to set or update the cache field.
...
`azurerm.cdn_frontdoor_route.withCdnFrontdoorCustomDomainIds` constructs a mixin object that can be merged into the `cdn_frontdoor_route`
...
`azurerm.cdn_frontdoor_route.withCdnFrontdoorEndpointId` constructs a mixin object that can be merged into the `cdn_frontdoor_route`
...
`azurerm.cdn_frontdoor_route.withCdnFrontdoorOriginGroupId` constructs a mixin object that can be merged into the `cdn_frontdoor_route`
...
`azurerm.cdn_frontdoor_route.withCdnFrontdoorOriginIds` constructs a mixin object that can be merged into the `cdn_frontdoor_route`
...
`azurerm.cdn_frontdoor_route.withCdnFrontdoorOriginPath` constructs a mixin object that can be merged into the `cdn_frontdoor_route`
...
`azurerm.cdn_frontdoor_route.withCdnFrontdoorRuleSetIds` constructs a mixin object that can be merged into the `cdn_frontdoor_route`
...
`azurerm.cdn_frontdoor_route.withEnabled` constructs a mixin object that can be merged into the `cdn_frontdoor_route`
...
`azurerm.cdn_frontdoor_route.withForwardingProtocol` constructs a mixin object that can be merged into the `cdn_frontdoor_route`
...
`azurerm.cdn_frontdoor_route.withHttpsRedirectEnabled` constructs a mixin object that can be merged into the `cdn_frontdoor_route`
...
`azurerm.cdn_frontdoor_route.withLinkToDefaultDomain` constructs a mixin object that can be merged into the `cdn_frontdoor_route`
...
`azurerm.cdn_frontdoor_route.withName` constructs a mixin object that can be merged into the `cdn_frontdoor_route`
...
`azurerm.cdn_frontdoor_route.withPatternsToMatch` constructs a mixin object that can be merged into the `cdn_frontdoor_route`
...
`azurerm.cdn_frontdoor_route.withSupportedProtocols` constructs a mixin object that can be merged into the `cdn_frontdoor_route`
...
`azurerm.cdn_frontdoor_route.withTimeouts` constructs a mixin object that can be merged into the `cdn_frontdoor_route`
...
`azurerm.cdn_frontdoor_route.withTimeoutsMixin` constructs a mixin object that can be merged into the `cdn_frontdoor_route`
Terraform resource block to set or update the timeouts field.
