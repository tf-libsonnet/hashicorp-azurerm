...
`azurerm.log_analytics_datasource_windows_performance_counter.withCounterName` constructs a mixin object that can be merged into the `log_analytics_datasource_windows_performance_counter`
...
`azurerm.log_analytics_datasource_windows_performance_counter.withInstanceName` constructs a mixin object that can be merged into the `log_analytics_datasource_windows_performance_counter`
...
`azurerm.log_analytics_datasource_windows_performance_counter.withIntervalSeconds` constructs a mixin object that can be merged into the `log_analytics_datasource_windows_performance_counter`
...
`azurerm.log_analytics_datasource_windows_performance_counter.withName` constructs a mixin object that can be merged into the `log_analytics_datasource_windows_performance_counter`
...
`azurerm.log_analytics_datasource_windows_performance_counter.withObjectName` constructs a mixin object that can be merged into the `log_analytics_datasource_windows_performance_counter`
...
`azurerm.log_analytics_datasource_windows_performance_counter.withResourceGroupName` constructs a mixin object that can be merged into the `log_analytics_datasource_windows_performance_counter`
...
`azurerm.log_analytics_datasource_windows_performance_counter.withTimeouts` constructs a mixin object that can be merged into the `log_analytics_datasource_windows_performance_counter`
...
`azurerm.log_analytics_datasource_windows_performance_counter.withTimeoutsMixin` constructs a mixin object that can be merged into the `log_analytics_datasource_windows_performance_counter`
Terraform resource block to set or update the timeouts field.
...
`azurerm.log_analytics_datasource_windows_performance_counter.withWorkspaceName` constructs a mixin object that can be merged into the `log_analytics_datasource_windows_performance_counter`
