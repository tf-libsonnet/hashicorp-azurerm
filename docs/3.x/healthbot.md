...
`healthbot` represents the `azurerm_healthbot` Terraform resource.
...
`azurerm.healthbot.withLocation` constructs a mixin object that can be merged into the `healthbot`
...
`azurerm.healthbot.withName` constructs a mixin object that can be merged into the `healthbot`
...
`azurerm.healthbot.withResourceGroupName` constructs a mixin object that can be merged into the `healthbot`
...
`azurerm.healthbot.withSkuName` constructs a mixin object that can be merged into the `healthbot`
...
`azurerm.healthbot.withTags` constructs a mixin object that can be merged into the `healthbot`
...
`azurerm.healthbot.withTimeouts` constructs a mixin object that can be merged into the `healthbot`
...
`azurerm.healthbot.withTimeoutsMixin` constructs a mixin object that can be merged into the `healthbot`
Terraform resource block to set or update the timeouts field.
