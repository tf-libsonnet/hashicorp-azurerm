...
`azurerm.monitor_log_profile.withCategories` constructs a mixin object that can be merged into the `monitor_log_profile`
...
`azurerm.monitor_log_profile.withLocations` constructs a mixin object that can be merged into the `monitor_log_profile`
...
`azurerm.monitor_log_profile.withName` constructs a mixin object that can be merged into the `monitor_log_profile`
...
`azurerm.monitor_log_profile.withRetentionPolicy` constructs a mixin object that can be merged into the `monitor_log_profile`
...
`azurerm.monitor_log_profile.withRetentionPolicyMixin` constructs a mixin object that can be merged into the `monitor_log_profile`
Terraform resource block to set or update the retention_policy field.
...
`azurerm.monitor_log_profile.withServicebusRuleId` constructs a mixin object that can be merged into the `monitor_log_profile`
...
`azurerm.monitor_log_profile.withStorageAccountId` constructs a mixin object that can be merged into the `monitor_log_profile`
...
`azurerm.monitor_log_profile.withTimeouts` constructs a mixin object that can be merged into the `monitor_log_profile`
...
`azurerm.monitor_log_profile.withTimeoutsMixin` constructs a mixin object that can be merged into the `monitor_log_profile`
Terraform resource block to set or update the timeouts field.
