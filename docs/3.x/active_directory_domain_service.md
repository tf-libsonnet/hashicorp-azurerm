...
`azurerm.active_directory_domain_service.withDomainConfigurationType` constructs a mixin object that can be merged into the `active_directory_domain_service`
...
`azurerm.active_directory_domain_service.withDomainName` constructs a mixin object that can be merged into the `active_directory_domain_service`
...
`azurerm.active_directory_domain_service.withFilteredSyncEnabled` constructs a mixin object that can be merged into the `active_directory_domain_service`
...
`azurerm.active_directory_domain_service.withInitialReplicaSet` constructs a mixin object that can be merged into the `active_directory_domain_service`
...
`azurerm.active_directory_domain_service.withInitialReplicaSetMixin` constructs a mixin object that can be merged into the `active_directory_domain_service`
Terraform resource block to set or update the initial_replica_set field.
...
`azurerm.active_directory_domain_service.withLocation` constructs a mixin object that can be merged into the `active_directory_domain_service`
...
`azurerm.active_directory_domain_service.withName` constructs a mixin object that can be merged into the `active_directory_domain_service`
...
`azurerm.active_directory_domain_service.withNotifications` constructs a mixin object that can be merged into the `active_directory_domain_service`
...
`azurerm.active_directory_domain_service.withNotificationsMixin` constructs a mixin object that can be merged into the `active_directory_domain_service`
Terraform resource block to set or update the notifications field.
...
`azurerm.active_directory_domain_service.withResourceGroupName` constructs a mixin object that can be merged into the `active_directory_domain_service`
...
`azurerm.active_directory_domain_service.withSecureLdap` constructs a mixin object that can be merged into the `active_directory_domain_service`
...
`azurerm.active_directory_domain_service.withSecureLdapMixin` constructs a mixin object that can be merged into the `active_directory_domain_service`
Terraform resource block to set or update the secure_ldap field.
...
`azurerm.active_directory_domain_service.withSecurity` constructs a mixin object that can be merged into the `active_directory_domain_service`
...
`azurerm.active_directory_domain_service.withSecurityMixin` constructs a mixin object that can be merged into the `active_directory_domain_service`
Terraform resource block to set or update the security field.
...
`azurerm.active_directory_domain_service.withSku` constructs a mixin object that can be merged into the `active_directory_domain_service`
...
`azurerm.active_directory_domain_service.withTags` constructs a mixin object that can be merged into the `active_directory_domain_service`
...
`azurerm.active_directory_domain_service.withTimeouts` constructs a mixin object that can be merged into the `active_directory_domain_service`
...
`azurerm.active_directory_domain_service.withTimeoutsMixin` constructs a mixin object that can be merged into the `active_directory_domain_service`
Terraform resource block to set or update the timeouts field.
