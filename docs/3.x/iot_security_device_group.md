...
`azurerm.iot_security_device_group.withAllowRule` constructs a mixin object that can be merged into the `iot_security_device_group`
...
`azurerm.iot_security_device_group.withAllowRuleMixin` constructs a mixin object that can be merged into the `iot_security_device_group`
Terraform resource block to set or update the allow_rule field.
...
`azurerm.iot_security_device_group.withIothubId` constructs a mixin object that can be merged into the `iot_security_device_group`
...
`azurerm.iot_security_device_group.withName` constructs a mixin object that can be merged into the `iot_security_device_group`
...
`azurerm.iot_security_device_group.withRangeRule` constructs a mixin object that can be merged into the `iot_security_device_group`
...
`azurerm.iot_security_device_group.withRangeRuleMixin` constructs a mixin object that can be merged into the `iot_security_device_group`
Terraform resource block to set or update the range_rule field.
...
`azurerm.iot_security_device_group.withTimeouts` constructs a mixin object that can be merged into the `iot_security_device_group`
...
`azurerm.iot_security_device_group.withTimeoutsMixin` constructs a mixin object that can be merged into the `iot_security_device_group`
Terraform resource block to set or update the timeouts field.
