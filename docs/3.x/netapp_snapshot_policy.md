...
`azurerm.netapp_snapshot_policy.withAccountName` constructs a mixin object that can be merged into the `netapp_snapshot_policy`
...
`azurerm.netapp_snapshot_policy.withDailySchedule` constructs a mixin object that can be merged into the `netapp_snapshot_policy`
...
`azurerm.netapp_snapshot_policy.withDailyScheduleMixin` constructs a mixin object that can be merged into the `netapp_snapshot_policy`
Terraform resource block to set or update the daily_schedule field.
...
`azurerm.netapp_snapshot_policy.withEnabled` constructs a mixin object that can be merged into the `netapp_snapshot_policy`
...
`azurerm.netapp_snapshot_policy.withHourlySchedule` constructs a mixin object that can be merged into the `netapp_snapshot_policy`
...
`azurerm.netapp_snapshot_policy.withHourlyScheduleMixin` constructs a mixin object that can be merged into the `netapp_snapshot_policy`
Terraform resource block to set or update the hourly_schedule field.
...
`azurerm.netapp_snapshot_policy.withLocation` constructs a mixin object that can be merged into the `netapp_snapshot_policy`
...
`azurerm.netapp_snapshot_policy.withMonthlySchedule` constructs a mixin object that can be merged into the `netapp_snapshot_policy`
...
`azurerm.netapp_snapshot_policy.withMonthlyScheduleMixin` constructs a mixin object that can be merged into the `netapp_snapshot_policy`
Terraform resource block to set or update the monthly_schedule field.
...
`azurerm.netapp_snapshot_policy.withName` constructs a mixin object that can be merged into the `netapp_snapshot_policy`
...
`azurerm.netapp_snapshot_policy.withResourceGroupName` constructs a mixin object that can be merged into the `netapp_snapshot_policy`
...
`azurerm.netapp_snapshot_policy.withTags` constructs a mixin object that can be merged into the `netapp_snapshot_policy`
...
`azurerm.netapp_snapshot_policy.withTimeouts` constructs a mixin object that can be merged into the `netapp_snapshot_policy`
...
`azurerm.netapp_snapshot_policy.withTimeoutsMixin` constructs a mixin object that can be merged into the `netapp_snapshot_policy`
Terraform resource block to set or update the timeouts field.
...
`azurerm.netapp_snapshot_policy.withWeeklySchedule` constructs a mixin object that can be merged into the `netapp_snapshot_policy`
...
`azurerm.netapp_snapshot_policy.withWeeklyScheduleMixin` constructs a mixin object that can be merged into the `netapp_snapshot_policy`
Terraform resource block to set or update the weekly_schedule field.
