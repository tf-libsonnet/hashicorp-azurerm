...
`azurerm.logz_sub_account.withEnabled` constructs a mixin object that can be merged into the `logz_sub_account`
...
`azurerm.logz_sub_account.withLogzMonitorId` constructs a mixin object that can be merged into the `logz_sub_account`
...
`azurerm.logz_sub_account.withName` constructs a mixin object that can be merged into the `logz_sub_account`
...
`azurerm.logz_sub_account.withTags` constructs a mixin object that can be merged into the `logz_sub_account`
...
`azurerm.logz_sub_account.withTimeouts` constructs a mixin object that can be merged into the `logz_sub_account`
...
`azurerm.logz_sub_account.withTimeoutsMixin` constructs a mixin object that can be merged into the `logz_sub_account`
Terraform resource block to set or update the timeouts field.
...
`azurerm.logz_sub_account.withUser` constructs a mixin object that can be merged into the `logz_sub_account`
...
`azurerm.logz_sub_account.withUserMixin` constructs a mixin object that can be merged into the `logz_sub_account`
Terraform resource block to set or update the user field.
