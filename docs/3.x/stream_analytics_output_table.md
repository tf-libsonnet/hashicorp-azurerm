...
**Args**:
  ...
  - `table` (`string`): 
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.stream_analytics_output_table.timeouts.new](#fn-stream_analytics_output_tabletimeoutsnew) constructor.
...
Unlike [azurerm.stream_analytics_output_table.new](#fn-stream_analytics_output_tablenew), this function will not inject the `resource`
