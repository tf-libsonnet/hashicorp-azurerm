...
`azurerm.security_center_assessment.withAdditionalData` constructs a mixin object that can be merged into the `security_center_assessment`
...
`azurerm.security_center_assessment.withAssessmentPolicyId` constructs a mixin object that can be merged into the `security_center_assessment`
...
`azurerm.security_center_assessment.withStatus` constructs a mixin object that can be merged into the `security_center_assessment`
...
`azurerm.security_center_assessment.withStatusMixin` constructs a mixin object that can be merged into the `security_center_assessment`
Terraform resource block to set or update the status field.
...
`azurerm.security_center_assessment.withTargetResourceId` constructs a mixin object that can be merged into the `security_center_assessment`
...
`azurerm.security_center_assessment.withTimeouts` constructs a mixin object that can be merged into the `security_center_assessment`
...
`azurerm.security_center_assessment.withTimeoutsMixin` constructs a mixin object that can be merged into the `security_center_assessment`
Terraform resource block to set or update the timeouts field.
