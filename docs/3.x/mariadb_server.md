...
**Args**:
  ...
  - `version` (`string`): 
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.mariadb_server.timeouts.new](#fn-mariadb_servertimeoutsnew) constructor.
...
Unlike [azurerm.mariadb_server.new](#fn-mariadb_servernew), this function will not inject the `resource`
