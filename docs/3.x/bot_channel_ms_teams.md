...
`azurerm.bot_channel_ms_teams.withBotName` constructs a mixin object that can be merged into the `bot_channel_ms_teams`
...
`azurerm.bot_channel_ms_teams.withCallingWebHook` constructs a mixin object that can be merged into the `bot_channel_ms_teams`
...
`azurerm.bot_channel_ms_teams.withEnableCalling` constructs a mixin object that can be merged into the `bot_channel_ms_teams`
...
`azurerm.bot_channel_ms_teams.withLocation` constructs a mixin object that can be merged into the `bot_channel_ms_teams`
...
`azurerm.bot_channel_ms_teams.withResourceGroupName` constructs a mixin object that can be merged into the `bot_channel_ms_teams`
...
`azurerm.bot_channel_ms_teams.withTimeouts` constructs a mixin object that can be merged into the `bot_channel_ms_teams`
...
`azurerm.bot_channel_ms_teams.withTimeoutsMixin` constructs a mixin object that can be merged into the `bot_channel_ms_teams`
Terraform resource block to set or update the timeouts field.
