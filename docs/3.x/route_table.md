...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.route_table.timeouts.new](#fn-route_tabletimeoutsnew) constructor.
...
Unlike [azurerm.route_table.new](#fn-route_tablenew), this function will not inject the `resource`
...
`azurerm.bool.withDisableBgpRoutePropagation` constructs a mixin object that can be merged into the `bool`
