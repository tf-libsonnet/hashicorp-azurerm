...
`azurerm.virtual_network_gateway.withActiveActive` constructs a mixin object that can be merged into the `virtual_network_gateway`
...
`azurerm.virtual_network_gateway.withBgpSettings` constructs a mixin object that can be merged into the `virtual_network_gateway`
...
`azurerm.virtual_network_gateway.withBgpSettingsMixin` constructs a mixin object that can be merged into the `virtual_network_gateway`
Terraform resource block to set or update the bgp_settings field.
...
`azurerm.virtual_network_gateway.withCustomRoute` constructs a mixin object that can be merged into the `virtual_network_gateway`
...
`azurerm.virtual_network_gateway.withCustomRouteMixin` constructs a mixin object that can be merged into the `virtual_network_gateway`
Terraform resource block to set or update the custom_route field.
...
`azurerm.virtual_network_gateway.withDefaultLocalNetworkGatewayId` constructs a mixin object that can be merged into the `virtual_network_gateway`
...
`azurerm.virtual_network_gateway.withEdgeZone` constructs a mixin object that can be merged into the `virtual_network_gateway`
...
`azurerm.virtual_network_gateway.withEnableBgp` constructs a mixin object that can be merged into the `virtual_network_gateway`
...
`azurerm.virtual_network_gateway.withGeneration` constructs a mixin object that can be merged into the `virtual_network_gateway`
...
`azurerm.virtual_network_gateway.withIpConfiguration` constructs a mixin object that can be merged into the `virtual_network_gateway`
...
`azurerm.virtual_network_gateway.withIpConfigurationMixin` constructs a mixin object that can be merged into the `virtual_network_gateway`
Terraform resource block to set or update the ip_configuration field.
...
`azurerm.virtual_network_gateway.withLocation` constructs a mixin object that can be merged into the `virtual_network_gateway`
...
`azurerm.virtual_network_gateway.withName` constructs a mixin object that can be merged into the `virtual_network_gateway`
...
`azurerm.virtual_network_gateway.withPrivateIpAddressEnabled` constructs a mixin object that can be merged into the `virtual_network_gateway`
...
`azurerm.virtual_network_gateway.withResourceGroupName` constructs a mixin object that can be merged into the `virtual_network_gateway`
...
`azurerm.virtual_network_gateway.withSku` constructs a mixin object that can be merged into the `virtual_network_gateway`
...
`azurerm.virtual_network_gateway.withTags` constructs a mixin object that can be merged into the `virtual_network_gateway`
...
`azurerm.virtual_network_gateway.withTimeouts` constructs a mixin object that can be merged into the `virtual_network_gateway`
...
`azurerm.virtual_network_gateway.withTimeoutsMixin` constructs a mixin object that can be merged into the `virtual_network_gateway`
Terraform resource block to set or update the timeouts field.
...
`azurerm.virtual_network_gateway.withType` constructs a mixin object that can be merged into the `virtual_network_gateway`
...
`azurerm.virtual_network_gateway.withVpnClientConfiguration` constructs a mixin object that can be merged into the `virtual_network_gateway`
...
`azurerm.virtual_network_gateway.withVpnClientConfigurationMixin` constructs a mixin object that can be merged into the `virtual_network_gateway`
Terraform resource block to set or update the vpn_client_configuration field.
...
`azurerm.virtual_network_gateway.withVpnType` constructs a mixin object that can be merged into the `virtual_network_gateway`
