...
`azurerm.api_management_group_user.withApiManagementName` constructs a mixin object that can be merged into the `api_management_group_user`
...
`azurerm.api_management_group_user.withGroupName` constructs a mixin object that can be merged into the `api_management_group_user`
...
`azurerm.api_management_group_user.withResourceGroupName` constructs a mixin object that can be merged into the `api_management_group_user`
...
`azurerm.api_management_group_user.withTimeouts` constructs a mixin object that can be merged into the `api_management_group_user`
...
`azurerm.api_management_group_user.withTimeoutsMixin` constructs a mixin object that can be merged into the `api_management_group_user`
Terraform resource block to set or update the timeouts field.
...
`azurerm.api_management_group_user.withUserId` constructs a mixin object that can be merged into the `api_management_group_user`
