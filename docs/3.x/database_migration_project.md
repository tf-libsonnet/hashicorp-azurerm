...
`azurerm.string.withSourcePlatform` constructs a mixin object that can be merged into the `string`
...
`azurerm.string.withTargetPlatform` constructs a mixin object that can be merged into the `string`
