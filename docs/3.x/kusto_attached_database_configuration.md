...
`azurerm.kusto_attached_database_configuration.withClusterName` constructs a mixin object that can be merged into the `kusto_attached_database_configuration`
...
`azurerm.kusto_attached_database_configuration.withClusterResourceId` constructs a mixin object that can be merged into the `kusto_attached_database_configuration`
...
`azurerm.kusto_attached_database_configuration.withDatabaseName` constructs a mixin object that can be merged into the `kusto_attached_database_configuration`
...
`azurerm.kusto_attached_database_configuration.withDefaultPrincipalModificationKind` constructs a mixin object that can be merged into the `kusto_attached_database_configuration`
...
`azurerm.kusto_attached_database_configuration.withLocation` constructs a mixin object that can be merged into the `kusto_attached_database_configuration`
...
`azurerm.kusto_attached_database_configuration.withName` constructs a mixin object that can be merged into the `kusto_attached_database_configuration`
...
`azurerm.kusto_attached_database_configuration.withResourceGroupName` constructs a mixin object that can be merged into the `kusto_attached_database_configuration`
...
`azurerm.kusto_attached_database_configuration.withSharing` constructs a mixin object that can be merged into the `kusto_attached_database_configuration`
...
`azurerm.kusto_attached_database_configuration.withSharingMixin` constructs a mixin object that can be merged into the `kusto_attached_database_configuration`
Terraform resource block to set or update the sharing field.
...
`azurerm.kusto_attached_database_configuration.withTimeouts` constructs a mixin object that can be merged into the `kusto_attached_database_configuration`
...
`azurerm.kusto_attached_database_configuration.withTimeoutsMixin` constructs a mixin object that can be merged into the `kusto_attached_database_configuration`
Terraform resource block to set or update the timeouts field.
