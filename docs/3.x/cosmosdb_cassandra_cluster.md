...
`azurerm.cosmosdb_cassandra_cluster.withAuthenticationMethod` constructs a mixin object that can be merged into the `cosmosdb_cassandra_cluster`
...
`azurerm.cosmosdb_cassandra_cluster.withClientCertificatePems` constructs a mixin object that can be merged into the `cosmosdb_cassandra_cluster`
...
`azurerm.cosmosdb_cassandra_cluster.withDefaultAdminPassword` constructs a mixin object that can be merged into the `cosmosdb_cassandra_cluster`
...
`azurerm.cosmosdb_cassandra_cluster.withDelegatedManagementSubnetId` constructs a mixin object that can be merged into the `cosmosdb_cassandra_cluster`
...
`azurerm.cosmosdb_cassandra_cluster.withExternalGossipCertificatePems` constructs a mixin object that can be merged into the `cosmosdb_cassandra_cluster`
...
`azurerm.cosmosdb_cassandra_cluster.withExternalSeedNodeIpAddresses` constructs a mixin object that can be merged into the `cosmosdb_cassandra_cluster`
...
`azurerm.cosmosdb_cassandra_cluster.withHoursBetweenBackups` constructs a mixin object that can be merged into the `cosmosdb_cassandra_cluster`
...
`azurerm.cosmosdb_cassandra_cluster.withIdentity` constructs a mixin object that can be merged into the `cosmosdb_cassandra_cluster`
...
`azurerm.cosmosdb_cassandra_cluster.withIdentityMixin` constructs a mixin object that can be merged into the `cosmosdb_cassandra_cluster`
Terraform resource block to set or update the identity field.
...
`azurerm.cosmosdb_cassandra_cluster.withLocation` constructs a mixin object that can be merged into the `cosmosdb_cassandra_cluster`
...
`azurerm.cosmosdb_cassandra_cluster.withName` constructs a mixin object that can be merged into the `cosmosdb_cassandra_cluster`
...
`azurerm.cosmosdb_cassandra_cluster.withRepairEnabled` constructs a mixin object that can be merged into the `cosmosdb_cassandra_cluster`
...
`azurerm.cosmosdb_cassandra_cluster.withResourceGroupName` constructs a mixin object that can be merged into the `cosmosdb_cassandra_cluster`
...
`azurerm.cosmosdb_cassandra_cluster.withTags` constructs a mixin object that can be merged into the `cosmosdb_cassandra_cluster`
...
`azurerm.cosmosdb_cassandra_cluster.withTimeouts` constructs a mixin object that can be merged into the `cosmosdb_cassandra_cluster`
...
`azurerm.cosmosdb_cassandra_cluster.withTimeoutsMixin` constructs a mixin object that can be merged into the `cosmosdb_cassandra_cluster`
Terraform resource block to set or update the timeouts field.
...
`azurerm.cosmosdb_cassandra_cluster.withVersion` constructs a mixin object that can be merged into the `cosmosdb_cassandra_cluster`
