...
**Args**:
  ...
  - `volume_name` (`string`): 
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.netapp_snapshot.timeouts.new](#fn-netapp_snapshottimeoutsnew) constructor.
...
Unlike [azurerm.netapp_snapshot.new](#fn-netapp_snapshotnew), this function will not inject the `resource`
