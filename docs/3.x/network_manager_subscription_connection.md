---
permalink: /network_manager_subscription_connection/
---

# network_manager_subscription_connection

`network_manager_subscription_connection` represents the `azurerm_network_manager_subscription_connection` Terraform resource.
