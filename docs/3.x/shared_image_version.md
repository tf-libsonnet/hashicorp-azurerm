...
`azurerm.shared_image_version.withBlobUri` constructs a mixin object that can be merged into the `shared_image_version`
...
`azurerm.shared_image_version.withEndOfLifeDate` constructs a mixin object that can be merged into the `shared_image_version`
...
`azurerm.shared_image_version.withExcludeFromLatest` constructs a mixin object that can be merged into the `shared_image_version`
...
`azurerm.shared_image_version.withLocation` constructs a mixin object that can be merged into the `shared_image_version`
...
`azurerm.shared_image_version.withManagedImageId` constructs a mixin object that can be merged into the `shared_image_version`
...
`azurerm.shared_image_version.withOsDiskSnapshotId` constructs a mixin object that can be merged into the `shared_image_version`
...
`azurerm.shared_image_version.withReplicationMode` constructs a mixin object that can be merged into the `shared_image_version`
...
`azurerm.shared_image_version.withStorageAccountId` constructs a mixin object that can be merged into the `shared_image_version`
...
`azurerm.shared_image_version.withTags` constructs a mixin object that can be merged into the `shared_image_version`
...
`azurerm.shared_image_version.withTargetRegion` constructs a mixin object that can be merged into the `shared_image_version`
...
`azurerm.shared_image_version.withTargetRegionMixin` constructs a mixin object that can be merged into the `shared_image_version`
Terraform resource block to set or update the target_region field.
