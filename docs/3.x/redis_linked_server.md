...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.redis_linked_server.timeouts.new](#fn-redis_linked_servertimeoutsnew) constructor.
...
Unlike [azurerm.redis_linked_server.new](#fn-redis_linked_servernew), this function will not inject the `resource`
