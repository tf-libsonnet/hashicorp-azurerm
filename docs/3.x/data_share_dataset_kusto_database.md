...
**Args**:
  ...
  - `name` (`string`): 
  - `share_id` (`string`): 
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.data_share_dataset_kusto_database.timeouts.new](#fn-data_share_dataset_kusto_databasetimeoutsnew) constructor.
...
Unlike [azurerm.data_share_dataset_kusto_database.new](#fn-data_share_dataset_kusto_databasenew), this function will not inject the `resource`
