...
`azurerm.media_streaming_locator.withAlternativeMediaId` constructs a mixin object that can be merged into the `media_streaming_locator`
...
`azurerm.media_streaming_locator.withAssetName` constructs a mixin object that can be merged into the `media_streaming_locator`
...
`azurerm.media_streaming_locator.withContentKey` constructs a mixin object that can be merged into the `media_streaming_locator`
...
`azurerm.media_streaming_locator.withContentKeyMixin` constructs a mixin object that can be merged into the `media_streaming_locator`
Terraform resource block to set or update the content_key field.
...
`azurerm.media_streaming_locator.withDefaultContentKeyPolicyName` constructs a mixin object that can be merged into the `media_streaming_locator`
...
`azurerm.media_streaming_locator.withEndTime` constructs a mixin object that can be merged into the `media_streaming_locator`
...
`azurerm.media_streaming_locator.withMediaServicesAccountName` constructs a mixin object that can be merged into the `media_streaming_locator`
...
`azurerm.media_streaming_locator.withName` constructs a mixin object that can be merged into the `media_streaming_locator`
...
`azurerm.media_streaming_locator.withResourceGroupName` constructs a mixin object that can be merged into the `media_streaming_locator`
...
`azurerm.media_streaming_locator.withStartTime` constructs a mixin object that can be merged into the `media_streaming_locator`
...
`azurerm.media_streaming_locator.withStreamingLocatorId` constructs a mixin object that can be merged into the `media_streaming_locator`
...
`azurerm.media_streaming_locator.withStreamingPolicyName` constructs a mixin object that can be merged into the `media_streaming_locator`
...
`azurerm.media_streaming_locator.withTimeouts` constructs a mixin object that can be merged into the `media_streaming_locator`
...
`azurerm.media_streaming_locator.withTimeoutsMixin` constructs a mixin object that can be merged into the `media_streaming_locator`
Terraform resource block to set or update the timeouts field.
