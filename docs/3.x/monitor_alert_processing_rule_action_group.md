...
`azurerm.monitor_alert_processing_rule_action_group.withAddActionGroupIds` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_action_group`
...
`azurerm.monitor_alert_processing_rule_action_group.withCondition` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_action_group`
...
`azurerm.monitor_alert_processing_rule_action_group.withConditionMixin` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_action_group`
Terraform resource block to set or update the condition field.
...
`azurerm.monitor_alert_processing_rule_action_group.withDescription` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_action_group`
...
`azurerm.monitor_alert_processing_rule_action_group.withEnabled` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_action_group`
...
`azurerm.monitor_alert_processing_rule_action_group.withName` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_action_group`
...
`azurerm.monitor_alert_processing_rule_action_group.withResourceGroupName` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_action_group`
...
`azurerm.monitor_alert_processing_rule_action_group.withSchedule` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_action_group`
...
`azurerm.monitor_alert_processing_rule_action_group.withScheduleMixin` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_action_group`
Terraform resource block to set or update the schedule field.
...
`azurerm.monitor_alert_processing_rule_action_group.withScopes` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_action_group`
...
`azurerm.monitor_alert_processing_rule_action_group.withTags` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_action_group`
...
`azurerm.monitor_alert_processing_rule_action_group.withTimeouts` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_action_group`
...
`azurerm.monitor_alert_processing_rule_action_group.withTimeoutsMixin` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_action_group`
Terraform resource block to set or update the timeouts field.
