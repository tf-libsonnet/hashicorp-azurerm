...
`azurerm.cosmosdb_cassandra_keyspace.withAccountName` constructs a mixin object that can be merged into the `cosmosdb_cassandra_keyspace`
...
`azurerm.cosmosdb_cassandra_keyspace.withAutoscaleSettings` constructs a mixin object that can be merged into the `cosmosdb_cassandra_keyspace`
...
`azurerm.cosmosdb_cassandra_keyspace.withAutoscaleSettingsMixin` constructs a mixin object that can be merged into the `cosmosdb_cassandra_keyspace`
Terraform resource block to set or update the autoscale_settings field.
...
`azurerm.cosmosdb_cassandra_keyspace.withName` constructs a mixin object that can be merged into the `cosmosdb_cassandra_keyspace`
...
`azurerm.cosmosdb_cassandra_keyspace.withResourceGroupName` constructs a mixin object that can be merged into the `cosmosdb_cassandra_keyspace`
...
`azurerm.cosmosdb_cassandra_keyspace.withThroughput` constructs a mixin object that can be merged into the `cosmosdb_cassandra_keyspace`
...
`azurerm.cosmosdb_cassandra_keyspace.withTimeouts` constructs a mixin object that can be merged into the `cosmosdb_cassandra_keyspace`
...
`azurerm.cosmosdb_cassandra_keyspace.withTimeoutsMixin` constructs a mixin object that can be merged into the `cosmosdb_cassandra_keyspace`
Terraform resource block to set or update the timeouts field.
