...
`azurerm.linux_function_app.withAppSettings` constructs a mixin object that can be merged into the `linux_function_app`
...
`azurerm.linux_function_app.withAuthSettings` constructs a mixin object that can be merged into the `linux_function_app`
...
`azurerm.linux_function_app.withAuthSettingsMixin` constructs a mixin object that can be merged into the `linux_function_app`
Terraform resource block to set or update the auth_settings field.
...
`azurerm.linux_function_app.withBackup` constructs a mixin object that can be merged into the `linux_function_app`
...
`azurerm.linux_function_app.withBackupMixin` constructs a mixin object that can be merged into the `linux_function_app`
Terraform resource block to set or update the backup field.
...
`azurerm.linux_function_app.withBuiltinLoggingEnabled` constructs a mixin object that can be merged into the `linux_function_app`
...
`azurerm.linux_function_app.withClientCertificateEnabled` constructs a mixin object that can be merged into the `linux_function_app`
...
`azurerm.linux_function_app.withClientCertificateExclusionPaths` constructs a mixin object that can be merged into the `linux_function_app`
...
`azurerm.linux_function_app.withClientCertificateMode` constructs a mixin object that can be merged into the `linux_function_app`
...
`azurerm.linux_function_app.withConnectionString` constructs a mixin object that can be merged into the `linux_function_app`
...
`azurerm.linux_function_app.withConnectionStringMixin` constructs a mixin object that can be merged into the `linux_function_app`
Terraform resource block to set or update the connection_string field.
...
`azurerm.linux_function_app.withContentShareForceDisabled` constructs a mixin object that can be merged into the `linux_function_app`
...
`azurerm.linux_function_app.withDailyMemoryTimeQuota` constructs a mixin object that can be merged into the `linux_function_app`
...
`azurerm.linux_function_app.withEnabled` constructs a mixin object that can be merged into the `linux_function_app`
...
`azurerm.linux_function_app.withFunctionsExtensionVersion` constructs a mixin object that can be merged into the `linux_function_app`
...
`azurerm.linux_function_app.withHttpsOnly` constructs a mixin object that can be merged into the `linux_function_app`
...
`azurerm.linux_function_app.withIdentity` constructs a mixin object that can be merged into the `linux_function_app`
...
`azurerm.linux_function_app.withIdentityMixin` constructs a mixin object that can be merged into the `linux_function_app`
Terraform resource block to set or update the identity field.
...
`azurerm.linux_function_app.withKeyVaultReferenceIdentityId` constructs a mixin object that can be merged into the `linux_function_app`
...
`azurerm.linux_function_app.withLocation` constructs a mixin object that can be merged into the `linux_function_app`
...
`azurerm.linux_function_app.withName` constructs a mixin object that can be merged into the `linux_function_app`
...
`azurerm.linux_function_app.withResourceGroupName` constructs a mixin object that can be merged into the `linux_function_app`
...
`azurerm.linux_function_app.withServicePlanId` constructs a mixin object that can be merged into the `linux_function_app`
...
`azurerm.linux_function_app.withSiteConfig` constructs a mixin object that can be merged into the `linux_function_app`
...
`azurerm.linux_function_app.withSiteConfigMixin` constructs a mixin object that can be merged into the `linux_function_app`
Terraform resource block to set or update the site_config field.
...
`azurerm.linux_function_app.withStickySettings` constructs a mixin object that can be merged into the `linux_function_app`
...
`azurerm.linux_function_app.withStickySettingsMixin` constructs a mixin object that can be merged into the `linux_function_app`
Terraform resource block to set or update the sticky_settings field.
...
`azurerm.linux_function_app.withStorageAccount` constructs a mixin object that can be merged into the `linux_function_app`
...
`azurerm.linux_function_app.withStorageAccountAccessKey` constructs a mixin object that can be merged into the `linux_function_app`
...
`azurerm.linux_function_app.withStorageAccountMixin` constructs a mixin object that can be merged into the `linux_function_app`
Terraform resource block to set or update the storage_account field.
...
`azurerm.linux_function_app.withStorageAccountName` constructs a mixin object that can be merged into the `linux_function_app`
...
`azurerm.linux_function_app.withStorageKeyVaultSecretId` constructs a mixin object that can be merged into the `linux_function_app`
...
`azurerm.linux_function_app.withStorageUsesManagedIdentity` constructs a mixin object that can be merged into the `linux_function_app`
...
`azurerm.linux_function_app.withTags` constructs a mixin object that can be merged into the `linux_function_app`
...
`azurerm.linux_function_app.withTimeouts` constructs a mixin object that can be merged into the `linux_function_app`
...
`azurerm.linux_function_app.withTimeoutsMixin` constructs a mixin object that can be merged into the `linux_function_app`
Terraform resource block to set or update the timeouts field.
...
`azurerm.linux_function_app.withVirtualNetworkSubnetId` constructs a mixin object that can be merged into the `linux_function_app`
