...
`azurerm.spring_cloud_gateway_route_config.withFilters` constructs a mixin object that can be merged into the `spring_cloud_gateway_route_config`
...
`azurerm.spring_cloud_gateway_route_config.withName` constructs a mixin object that can be merged into the `spring_cloud_gateway_route_config`
...
`azurerm.spring_cloud_gateway_route_config.withOpenApi` constructs a mixin object that can be merged into the `spring_cloud_gateway_route_config`
...
`azurerm.spring_cloud_gateway_route_config.withOpenApiMixin` constructs a mixin object that can be merged into the `spring_cloud_gateway_route_config`
Terraform resource block to set or update the open_api field.
...
`azurerm.spring_cloud_gateway_route_config.withPredicates` constructs a mixin object that can be merged into the `spring_cloud_gateway_route_config`
...
`azurerm.spring_cloud_gateway_route_config.withProtocol` constructs a mixin object that can be merged into the `spring_cloud_gateway_route_config`
...
`azurerm.spring_cloud_gateway_route_config.withRoute` constructs a mixin object that can be merged into the `spring_cloud_gateway_route_config`
...
`azurerm.spring_cloud_gateway_route_config.withRouteMixin` constructs a mixin object that can be merged into the `spring_cloud_gateway_route_config`
Terraform resource block to set or update the route field.
...
`azurerm.spring_cloud_gateway_route_config.withSpringCloudAppId` constructs a mixin object that can be merged into the `spring_cloud_gateway_route_config`
...
`azurerm.spring_cloud_gateway_route_config.withSpringCloudGatewayId` constructs a mixin object that can be merged into the `spring_cloud_gateway_route_config`
...
`azurerm.spring_cloud_gateway_route_config.withSsoValidationEnabled` constructs a mixin object that can be merged into the `spring_cloud_gateway_route_config`
...
`azurerm.spring_cloud_gateway_route_config.withTimeouts` constructs a mixin object that can be merged into the `spring_cloud_gateway_route_config`
...
`azurerm.spring_cloud_gateway_route_config.withTimeoutsMixin` constructs a mixin object that can be merged into the `spring_cloud_gateway_route_config`
Terraform resource block to set or update the timeouts field.
