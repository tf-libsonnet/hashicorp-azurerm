...
`azurerm.media_transform.withDescription` constructs a mixin object that can be merged into the `media_transform`
...
`azurerm.media_transform.withMediaServicesAccountName` constructs a mixin object that can be merged into the `media_transform`
...
`azurerm.media_transform.withName` constructs a mixin object that can be merged into the `media_transform`
...
`azurerm.media_transform.withOutput` constructs a mixin object that can be merged into the `media_transform`
...
`azurerm.media_transform.withOutputMixin` constructs a mixin object that can be merged into the `media_transform`
Terraform resource block to set or update the output field.
...
`azurerm.media_transform.withResourceGroupName` constructs a mixin object that can be merged into the `media_transform`
...
`azurerm.media_transform.withTimeouts` constructs a mixin object that can be merged into the `media_transform`
...
`azurerm.media_transform.withTimeoutsMixin` constructs a mixin object that can be merged into the `media_transform`
Terraform resource block to set or update the timeouts field.
