...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.redis_enterprise_cluster.timeouts.new](#fn-redis_enterprise_clustertimeoutsnew) constructor.
...
Unlike [azurerm.redis_enterprise_cluster.new](#fn-redis_enterprise_clusternew), this function will not inject the `resource`
