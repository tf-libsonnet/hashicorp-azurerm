...
`azurerm.data_factory_linked_service_postgresql.withAdditionalProperties` constructs a mixin object that can be merged into the `data_factory_linked_service_postgresql`
...
`azurerm.data_factory_linked_service_postgresql.withAnnotations` constructs a mixin object that can be merged into the `data_factory_linked_service_postgresql`
...
`azurerm.data_factory_linked_service_postgresql.withConnectionString` constructs a mixin object that can be merged into the `data_factory_linked_service_postgresql`
...
`azurerm.data_factory_linked_service_postgresql.withDataFactoryId` constructs a mixin object that can be merged into the `data_factory_linked_service_postgresql`
...
`azurerm.data_factory_linked_service_postgresql.withDescription` constructs a mixin object that can be merged into the `data_factory_linked_service_postgresql`
...
`azurerm.data_factory_linked_service_postgresql.withIntegrationRuntimeName` constructs a mixin object that can be merged into the `data_factory_linked_service_postgresql`
...
`azurerm.data_factory_linked_service_postgresql.withName` constructs a mixin object that can be merged into the `data_factory_linked_service_postgresql`
...
`azurerm.data_factory_linked_service_postgresql.withParameters` constructs a mixin object that can be merged into the `data_factory_linked_service_postgresql`
...
`azurerm.data_factory_linked_service_postgresql.withTimeouts` constructs a mixin object that can be merged into the `data_factory_linked_service_postgresql`
...
`azurerm.data_factory_linked_service_postgresql.withTimeoutsMixin` constructs a mixin object that can be merged into the `data_factory_linked_service_postgresql`
Terraform resource block to set or update the timeouts field.
