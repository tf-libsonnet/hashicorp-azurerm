...
`azurerm.network_profile.withContainerNetworkInterface` constructs a mixin object that can be merged into the `network_profile`
...
`azurerm.network_profile.withContainerNetworkInterfaceMixin` constructs a mixin object that can be merged into the `network_profile`
Terraform resource block to set or update the container_network_interface field.
...
`azurerm.network_profile.withLocation` constructs a mixin object that can be merged into the `network_profile`
...
`azurerm.network_profile.withName` constructs a mixin object that can be merged into the `network_profile`
...
`azurerm.network_profile.withResourceGroupName` constructs a mixin object that can be merged into the `network_profile`
...
`azurerm.network_profile.withTags` constructs a mixin object that can be merged into the `network_profile`
...
`azurerm.network_profile.withTimeouts` constructs a mixin object that can be merged into the `network_profile`
...
`azurerm.network_profile.withTimeoutsMixin` constructs a mixin object that can be merged into the `network_profile`
Terraform resource block to set or update the timeouts field.
