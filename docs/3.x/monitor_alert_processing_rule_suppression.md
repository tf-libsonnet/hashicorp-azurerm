...
`azurerm.monitor_alert_processing_rule_suppression.withCondition` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_suppression`
...
`azurerm.monitor_alert_processing_rule_suppression.withConditionMixin` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_suppression`
Terraform resource block to set or update the condition field.
...
`azurerm.monitor_alert_processing_rule_suppression.withDescription` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_suppression`
...
`azurerm.monitor_alert_processing_rule_suppression.withEnabled` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_suppression`
...
`azurerm.monitor_alert_processing_rule_suppression.withName` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_suppression`
...
`azurerm.monitor_alert_processing_rule_suppression.withResourceGroupName` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_suppression`
...
`azurerm.monitor_alert_processing_rule_suppression.withSchedule` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_suppression`
...
`azurerm.monitor_alert_processing_rule_suppression.withScheduleMixin` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_suppression`
Terraform resource block to set or update the schedule field.
...
`azurerm.monitor_alert_processing_rule_suppression.withScopes` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_suppression`
...
`azurerm.monitor_alert_processing_rule_suppression.withTags` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_suppression`
...
`azurerm.monitor_alert_processing_rule_suppression.withTimeouts` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_suppression`
...
`azurerm.monitor_alert_processing_rule_suppression.withTimeoutsMixin` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_suppression`
Terraform resource block to set or update the timeouts field.
