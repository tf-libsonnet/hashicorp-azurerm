...
**Args**:
  ...
  - `server_name` (`string`): 
  - `value` (`string`): 
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.mysql_flexible_server_configuration.timeouts.new](#fn-mysql_flexible_server_configurationtimeoutsnew) constructor.
...
Unlike [azurerm.mysql_flexible_server_configuration.new](#fn-mysql_flexible_server_configurationnew), this function will not inject the `resource`
