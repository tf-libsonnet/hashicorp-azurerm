---
permalink: /mysql_flexible_server_active_directory_administrator/
---

# mysql_flexible_server_active_directory_administrator

`mysql_flexible_server_active_directory_administrator` represents the `azurerm_mysql_flexible_server_active_directory_administrator` Terraform resource.
