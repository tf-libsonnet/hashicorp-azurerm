...
`azurerm.key_vault_access_policy.withApplicationId` constructs a mixin object that can be merged into the `key_vault_access_policy`
...
`azurerm.key_vault_access_policy.withCertificatePermissions` constructs a mixin object that can be merged into the `key_vault_access_policy`
...
`azurerm.key_vault_access_policy.withKeyPermissions` constructs a mixin object that can be merged into the `key_vault_access_policy`
...
`azurerm.key_vault_access_policy.withKeyVaultId` constructs a mixin object that can be merged into the `key_vault_access_policy`
...
`azurerm.key_vault_access_policy.withObjectId` constructs a mixin object that can be merged into the `key_vault_access_policy`
...
`azurerm.key_vault_access_policy.withSecretPermissions` constructs a mixin object that can be merged into the `key_vault_access_policy`
...
`azurerm.key_vault_access_policy.withStoragePermissions` constructs a mixin object that can be merged into the `key_vault_access_policy`
...
`azurerm.key_vault_access_policy.withTenantId` constructs a mixin object that can be merged into the `key_vault_access_policy`
...
`azurerm.key_vault_access_policy.withTimeouts` constructs a mixin object that can be merged into the `key_vault_access_policy`
...
`azurerm.key_vault_access_policy.withTimeoutsMixin` constructs a mixin object that can be merged into the `key_vault_access_policy`
Terraform resource block to set or update the timeouts field.
