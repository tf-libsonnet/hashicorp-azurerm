...
`azurerm.stream_analytics_managed_private_endpoint.withSubresourceName` constructs a mixin object that can be merged into the `stream_analytics_managed_private_endpoint`
