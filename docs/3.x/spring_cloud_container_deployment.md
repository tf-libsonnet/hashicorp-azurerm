...
`azurerm.spring_cloud_container_deployment.withAddonJson` constructs a mixin object that can be merged into the `spring_cloud_container_deployment`
...
`azurerm.spring_cloud_container_deployment.withArguments` constructs a mixin object that can be merged into the `spring_cloud_container_deployment`
...
`azurerm.spring_cloud_container_deployment.withCommands` constructs a mixin object that can be merged into the `spring_cloud_container_deployment`
...
`azurerm.spring_cloud_container_deployment.withEnvironmentVariables` constructs a mixin object that can be merged into the `spring_cloud_container_deployment`
...
`azurerm.spring_cloud_container_deployment.withImage` constructs a mixin object that can be merged into the `spring_cloud_container_deployment`
...
`azurerm.spring_cloud_container_deployment.withInstanceCount` constructs a mixin object that can be merged into the `spring_cloud_container_deployment`
...
`azurerm.spring_cloud_container_deployment.withLanguageFramework` constructs a mixin object that can be merged into the `spring_cloud_container_deployment`
...
`azurerm.spring_cloud_container_deployment.withName` constructs a mixin object that can be merged into the `spring_cloud_container_deployment`
...
`azurerm.spring_cloud_container_deployment.withQuota` constructs a mixin object that can be merged into the `spring_cloud_container_deployment`
...
`azurerm.spring_cloud_container_deployment.withQuotaMixin` constructs a mixin object that can be merged into the `spring_cloud_container_deployment`
Terraform resource block to set or update the quota field.
...
`azurerm.spring_cloud_container_deployment.withServer` constructs a mixin object that can be merged into the `spring_cloud_container_deployment`
...
`azurerm.spring_cloud_container_deployment.withSpringCloudAppId` constructs a mixin object that can be merged into the `spring_cloud_container_deployment`
...
`azurerm.spring_cloud_container_deployment.withTimeouts` constructs a mixin object that can be merged into the `spring_cloud_container_deployment`
...
`azurerm.spring_cloud_container_deployment.withTimeoutsMixin` constructs a mixin object that can be merged into the `spring_cloud_container_deployment`
Terraform resource block to set or update the timeouts field.
