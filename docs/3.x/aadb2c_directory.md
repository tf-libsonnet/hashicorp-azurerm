...
`azurerm.aadb2c_directory.withCountryCode` constructs a mixin object that can be merged into the `aadb2c_directory`
...
`azurerm.aadb2c_directory.withDataResidencyLocation` constructs a mixin object that can be merged into the `aadb2c_directory`
...
`azurerm.aadb2c_directory.withDisplayName` constructs a mixin object that can be merged into the `aadb2c_directory`
...
`azurerm.aadb2c_directory.withSkuName` constructs a mixin object that can be merged into the `aadb2c_directory`
...
`azurerm.aadb2c_directory.withTags` constructs a mixin object that can be merged into the `aadb2c_directory`
