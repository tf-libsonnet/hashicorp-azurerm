...
`azurerm.dedicated_hardware_security_module.withLocation` constructs a mixin object that can be merged into the `dedicated_hardware_security_module`
...
`azurerm.dedicated_hardware_security_module.withManagementNetworkProfile` constructs a mixin object that can be merged into the `dedicated_hardware_security_module`
...
`azurerm.dedicated_hardware_security_module.withManagementNetworkProfileMixin` constructs a mixin object that can be merged into the `dedicated_hardware_security_module`
Terraform resource block to set or update the management_network_profile field.
...
`azurerm.dedicated_hardware_security_module.withName` constructs a mixin object that can be merged into the `dedicated_hardware_security_module`
...
`azurerm.dedicated_hardware_security_module.withNetworkProfile` constructs a mixin object that can be merged into the `dedicated_hardware_security_module`
...
`azurerm.dedicated_hardware_security_module.withNetworkProfileMixin` constructs a mixin object that can be merged into the `dedicated_hardware_security_module`
Terraform resource block to set or update the network_profile field.
...
`azurerm.dedicated_hardware_security_module.withResourceGroupName` constructs a mixin object that can be merged into the `dedicated_hardware_security_module`
...
`azurerm.dedicated_hardware_security_module.withSkuName` constructs a mixin object that can be merged into the `dedicated_hardware_security_module`
...
`azurerm.dedicated_hardware_security_module.withStampId` constructs a mixin object that can be merged into the `dedicated_hardware_security_module`
...
`azurerm.dedicated_hardware_security_module.withTags` constructs a mixin object that can be merged into the `dedicated_hardware_security_module`
...
`azurerm.dedicated_hardware_security_module.withTimeouts` constructs a mixin object that can be merged into the `dedicated_hardware_security_module`
...
`azurerm.dedicated_hardware_security_module.withTimeoutsMixin` constructs a mixin object that can be merged into the `dedicated_hardware_security_module`
Terraform resource block to set or update the timeouts field.
...
`azurerm.dedicated_hardware_security_module.withZones` constructs a mixin object that can be merged into the `dedicated_hardware_security_module`
