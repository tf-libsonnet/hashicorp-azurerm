...
`azurerm.iothub_dps_shared_access_policy.withEnrollmentRead` constructs a mixin object that can be merged into the `iothub_dps_shared_access_policy`
...
`azurerm.iothub_dps_shared_access_policy.withEnrollmentWrite` constructs a mixin object that can be merged into the `iothub_dps_shared_access_policy`
...
`azurerm.iothub_dps_shared_access_policy.withRegistrationRead` constructs a mixin object that can be merged into the `iothub_dps_shared_access_policy`
...
`azurerm.iothub_dps_shared_access_policy.withRegistrationWrite` constructs a mixin object that can be merged into the `iothub_dps_shared_access_policy`
...
`azurerm.iothub_dps_shared_access_policy.withServiceConfig` constructs a mixin object that can be merged into the `iothub_dps_shared_access_policy`
