...
`azurerm.nat_gateway.withIdleTimeoutInMinutes` constructs a mixin object that can be merged into the `nat_gateway`
...
`azurerm.nat_gateway.withLocation` constructs a mixin object that can be merged into the `nat_gateway`
...
`azurerm.nat_gateway.withSkuName` constructs a mixin object that can be merged into the `nat_gateway`
...
`azurerm.nat_gateway.withTags` constructs a mixin object that can be merged into the `nat_gateway`
...
`azurerm.nat_gateway.withZones` constructs a mixin object that can be merged into the `nat_gateway`
