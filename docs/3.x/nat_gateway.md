...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.nat_gateway.timeouts.new](#fn-nat_gatewaytimeoutsnew) constructor.
...
Unlike [azurerm.nat_gateway.new](#fn-nat_gatewaynew), this function will not inject the `resource`
