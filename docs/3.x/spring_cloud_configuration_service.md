...
`azurerm.spring_cloud_configuration_service.withName` constructs a mixin object that can be merged into the `spring_cloud_configuration_service`
...
`azurerm.spring_cloud_configuration_service.withRepository` constructs a mixin object that can be merged into the `spring_cloud_configuration_service`
...
`azurerm.spring_cloud_configuration_service.withRepositoryMixin` constructs a mixin object that can be merged into the `spring_cloud_configuration_service`
Terraform resource block to set or update the repository field.
...
`azurerm.spring_cloud_configuration_service.withSpringCloudServiceId` constructs a mixin object that can be merged into the `spring_cloud_configuration_service`
...
`azurerm.spring_cloud_configuration_service.withTimeouts` constructs a mixin object that can be merged into the `spring_cloud_configuration_service`
...
`azurerm.spring_cloud_configuration_service.withTimeoutsMixin` constructs a mixin object that can be merged into the `spring_cloud_configuration_service`
Terraform resource block to set or update the timeouts field.
