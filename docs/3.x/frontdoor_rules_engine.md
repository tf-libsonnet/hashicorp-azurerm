...
`azurerm.frontdoor_rules_engine.withEnabled` constructs a mixin object that can be merged into the `frontdoor_rules_engine`
...
`azurerm.frontdoor_rules_engine.withFrontdoorName` constructs a mixin object that can be merged into the `frontdoor_rules_engine`
...
`azurerm.frontdoor_rules_engine.withName` constructs a mixin object that can be merged into the `frontdoor_rules_engine`
...
`azurerm.frontdoor_rules_engine.withResourceGroupName` constructs a mixin object that can be merged into the `frontdoor_rules_engine`
...
`azurerm.frontdoor_rules_engine.withRule` constructs a mixin object that can be merged into the `frontdoor_rules_engine`
...
`azurerm.frontdoor_rules_engine.withRuleMixin` constructs a mixin object that can be merged into the `frontdoor_rules_engine`
Terraform resource block to set or update the rule field.
...
`azurerm.frontdoor_rules_engine.withTimeouts` constructs a mixin object that can be merged into the `frontdoor_rules_engine`
...
`azurerm.frontdoor_rules_engine.withTimeoutsMixin` constructs a mixin object that can be merged into the `frontdoor_rules_engine`
Terraform resource block to set or update the timeouts field.
