...
`azurerm.traffic_manager_azure_endpoint.withCustomHeader` constructs a mixin object that can be merged into the `traffic_manager_azure_endpoint`
...
`azurerm.traffic_manager_azure_endpoint.withCustomHeaderMixin` constructs a mixin object that can be merged into the `traffic_manager_azure_endpoint`
Terraform resource block to set or update the custom_header field.
...
`azurerm.traffic_manager_azure_endpoint.withEnabled` constructs a mixin object that can be merged into the `traffic_manager_azure_endpoint`
...
`azurerm.traffic_manager_azure_endpoint.withGeoMappings` constructs a mixin object that can be merged into the `traffic_manager_azure_endpoint`
...
`azurerm.traffic_manager_azure_endpoint.withName` constructs a mixin object that can be merged into the `traffic_manager_azure_endpoint`
...
`azurerm.traffic_manager_azure_endpoint.withPriority` constructs a mixin object that can be merged into the `traffic_manager_azure_endpoint`
...
`azurerm.traffic_manager_azure_endpoint.withProfileId` constructs a mixin object that can be merged into the `traffic_manager_azure_endpoint`
...
`azurerm.traffic_manager_azure_endpoint.withSubnet` constructs a mixin object that can be merged into the `traffic_manager_azure_endpoint`
...
`azurerm.traffic_manager_azure_endpoint.withSubnetMixin` constructs a mixin object that can be merged into the `traffic_manager_azure_endpoint`
Terraform resource block to set or update the subnet field.
...
`azurerm.traffic_manager_azure_endpoint.withTargetResourceId` constructs a mixin object that can be merged into the `traffic_manager_azure_endpoint`
...
`azurerm.traffic_manager_azure_endpoint.withTimeouts` constructs a mixin object that can be merged into the `traffic_manager_azure_endpoint`
...
`azurerm.traffic_manager_azure_endpoint.withTimeoutsMixin` constructs a mixin object that can be merged into the `traffic_manager_azure_endpoint`
Terraform resource block to set or update the timeouts field.
...
`azurerm.traffic_manager_azure_endpoint.withWeight` constructs a mixin object that can be merged into the `traffic_manager_azure_endpoint`
