...
`azurerm.app_service.withAppServicePlanId` constructs a mixin object that can be merged into the `app_service`
...
`azurerm.app_service.withAppSettings` constructs a mixin object that can be merged into the `app_service`
...
`azurerm.app_service.withAuthSettings` constructs a mixin object that can be merged into the `app_service`
...
`azurerm.app_service.withAuthSettingsMixin` constructs a mixin object that can be merged into the `app_service`
Terraform resource block to set or update the auth_settings field.
...
`azurerm.app_service.withBackup` constructs a mixin object that can be merged into the `app_service`
...
`azurerm.app_service.withBackupMixin` constructs a mixin object that can be merged into the `app_service`
Terraform resource block to set or update the backup field.
...
`azurerm.app_service.withClientAffinityEnabled` constructs a mixin object that can be merged into the `app_service`
...
`azurerm.app_service.withClientCertEnabled` constructs a mixin object that can be merged into the `app_service`
...
`azurerm.app_service.withClientCertMode` constructs a mixin object that can be merged into the `app_service`
...
`azurerm.app_service.withConnectionString` constructs a mixin object that can be merged into the `app_service`
...
`azurerm.app_service.withConnectionStringMixin` constructs a mixin object that can be merged into the `app_service`
Terraform resource block to set or update the connection_string field.
...
`azurerm.app_service.withEnabled` constructs a mixin object that can be merged into the `app_service`
...
`azurerm.app_service.withHttpsOnly` constructs a mixin object that can be merged into the `app_service`
...
`azurerm.app_service.withIdentity` constructs a mixin object that can be merged into the `app_service`
...
`azurerm.app_service.withIdentityMixin` constructs a mixin object that can be merged into the `app_service`
Terraform resource block to set or update the identity field.
...
`azurerm.app_service.withKeyVaultReferenceIdentityId` constructs a mixin object that can be merged into the `app_service`
...
`azurerm.app_service.withLocation` constructs a mixin object that can be merged into the `app_service`
...
`azurerm.app_service.withLogs` constructs a mixin object that can be merged into the `app_service`
...
`azurerm.app_service.withLogsMixin` constructs a mixin object that can be merged into the `app_service`
Terraform resource block to set or update the logs field.
...
`azurerm.app_service.withName` constructs a mixin object that can be merged into the `app_service`
...
`azurerm.app_service.withResourceGroupName` constructs a mixin object that can be merged into the `app_service`
...
`azurerm.app_service.withSiteConfig` constructs a mixin object that can be merged into the `app_service`
...
`azurerm.app_service.withSiteConfigMixin` constructs a mixin object that can be merged into the `app_service`
Terraform resource block to set or update the site_config field.
...
`azurerm.app_service.withSourceControl` constructs a mixin object that can be merged into the `app_service`
...
`azurerm.app_service.withSourceControlMixin` constructs a mixin object that can be merged into the `app_service`
Terraform resource block to set or update the source_control field.
...
`azurerm.app_service.withStorageAccount` constructs a mixin object that can be merged into the `app_service`
...
`azurerm.app_service.withStorageAccountMixin` constructs a mixin object that can be merged into the `app_service`
Terraform resource block to set or update the storage_account field.
...
`azurerm.app_service.withTags` constructs a mixin object that can be merged into the `app_service`
...
`azurerm.app_service.withTimeouts` constructs a mixin object that can be merged into the `app_service`
...
`azurerm.app_service.withTimeoutsMixin` constructs a mixin object that can be merged into the `app_service`
Terraform resource block to set or update the timeouts field.
