...
`azurerm.stream_analytics_output_function.withApiKey` constructs a mixin object that can be merged into the `stream_analytics_output_function`
...
`azurerm.stream_analytics_output_function.withBatchMaxCount` constructs a mixin object that can be merged into the `stream_analytics_output_function`
...
`azurerm.stream_analytics_output_function.withBatchMaxInBytes` constructs a mixin object that can be merged into the `stream_analytics_output_function`
...
`azurerm.stream_analytics_output_function.withFunctionApp` constructs a mixin object that can be merged into the `stream_analytics_output_function`
...
`azurerm.stream_analytics_output_function.withFunctionName` constructs a mixin object that can be merged into the `stream_analytics_output_function`
...
`azurerm.stream_analytics_output_function.withName` constructs a mixin object that can be merged into the `stream_analytics_output_function`
...
`azurerm.stream_analytics_output_function.withResourceGroupName` constructs a mixin object that can be merged into the `stream_analytics_output_function`
...
`azurerm.stream_analytics_output_function.withStreamAnalyticsJobName` constructs a mixin object that can be merged into the `stream_analytics_output_function`
...
`azurerm.stream_analytics_output_function.withTimeouts` constructs a mixin object that can be merged into the `stream_analytics_output_function`
...
`azurerm.stream_analytics_output_function.withTimeoutsMixin` constructs a mixin object that can be merged into the `stream_analytics_output_function`
Terraform resource block to set or update the timeouts field.
