---
permalink: /network_manager_static_member/
---

# network_manager_static_member

`network_manager_static_member` represents the `azurerm_network_manager_static_member` Terraform resource.
...
* [`fn withNetworkGroupId()`](#fn-withnetworkgroupid)
* [`fn withTargetVirtualNetworkId()`](#fn-withtargetvirtualnetworkid)
...
### fn withNetworkGroupId

```ts
withNetworkGroupId()
```

`azurerm.string.withNetworkGroupId` constructs a mixin object that can be merged into the `string`
...
### fn withTargetVirtualNetworkId

```ts
withTargetVirtualNetworkId()
```

`azurerm.string.withTargetVirtualNetworkId` constructs a mixin object that can be merged into the `string`
