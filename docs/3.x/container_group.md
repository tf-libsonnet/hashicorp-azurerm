...
`azurerm.container_group.withContainer` constructs a mixin object that can be merged into the `container_group`
...
`azurerm.container_group.withContainerMixin` constructs a mixin object that can be merged into the `container_group`
Terraform resource block to set or update the container field.
...
`azurerm.container_group.withDiagnostics` constructs a mixin object that can be merged into the `container_group`
...
`azurerm.container_group.withDiagnosticsMixin` constructs a mixin object that can be merged into the `container_group`
Terraform resource block to set or update the diagnostics field.
...
`azurerm.container_group.withDnsConfig` constructs a mixin object that can be merged into the `container_group`
...
`azurerm.container_group.withDnsConfigMixin` constructs a mixin object that can be merged into the `container_group`
Terraform resource block to set or update the dns_config field.
...
`azurerm.container_group.withDnsNameLabel` constructs a mixin object that can be merged into the `container_group`
...
`azurerm.container_group.withDnsNameLabelReusePolicy` constructs a mixin object that can be merged into the `container_group`
...
`azurerm.container_group.withExposedPort` constructs a mixin object that can be merged into the `container_group`
...
`azurerm.container_group.withIdentity` constructs a mixin object that can be merged into the `container_group`
...
`azurerm.container_group.withIdentityMixin` constructs a mixin object that can be merged into the `container_group`
Terraform resource block to set or update the identity field.
...
`azurerm.container_group.withImageRegistryCredential` constructs a mixin object that can be merged into the `container_group`
...
`azurerm.container_group.withImageRegistryCredentialMixin` constructs a mixin object that can be merged into the `container_group`
Terraform resource block to set or update the image_registry_credential field.
...
`azurerm.container_group.withInitContainer` constructs a mixin object that can be merged into the `container_group`
...
`azurerm.container_group.withInitContainerMixin` constructs a mixin object that can be merged into the `container_group`
Terraform resource block to set or update the init_container field.
...
`azurerm.container_group.withIpAddressType` constructs a mixin object that can be merged into the `container_group`
...
`azurerm.container_group.withKeyVaultKeyId` constructs a mixin object that can be merged into the `container_group`
...
`azurerm.container_group.withLocation` constructs a mixin object that can be merged into the `container_group`
...
`azurerm.container_group.withName` constructs a mixin object that can be merged into the `container_group`
...
`azurerm.container_group.withNetworkProfileId` constructs a mixin object that can be merged into the `container_group`
...
`azurerm.container_group.withOsType` constructs a mixin object that can be merged into the `container_group`
...
`azurerm.container_group.withResourceGroupName` constructs a mixin object that can be merged into the `container_group`
...
`azurerm.container_group.withRestartPolicy` constructs a mixin object that can be merged into the `container_group`
...
`azurerm.container_group.withSubnetIds` constructs a mixin object that can be merged into the `container_group`
...
`azurerm.container_group.withTags` constructs a mixin object that can be merged into the `container_group`
...
`azurerm.container_group.withTimeouts` constructs a mixin object that can be merged into the `container_group`
...
`azurerm.container_group.withTimeoutsMixin` constructs a mixin object that can be merged into the `container_group`
Terraform resource block to set or update the timeouts field.
...
`azurerm.container_group.withZones` constructs a mixin object that can be merged into the `container_group`
