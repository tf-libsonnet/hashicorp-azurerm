...
`azurerm.data_factory_linked_service_sftp.withAdditionalProperties` constructs a mixin object that can be merged into the `data_factory_linked_service_sftp`
...
`azurerm.data_factory_linked_service_sftp.withAnnotations` constructs a mixin object that can be merged into the `data_factory_linked_service_sftp`
...
`azurerm.data_factory_linked_service_sftp.withAuthenticationType` constructs a mixin object that can be merged into the `data_factory_linked_service_sftp`
...
`azurerm.data_factory_linked_service_sftp.withDataFactoryId` constructs a mixin object that can be merged into the `data_factory_linked_service_sftp`
...
`azurerm.data_factory_linked_service_sftp.withDescription` constructs a mixin object that can be merged into the `data_factory_linked_service_sftp`
...
`azurerm.data_factory_linked_service_sftp.withHost` constructs a mixin object that can be merged into the `data_factory_linked_service_sftp`
...
`azurerm.data_factory_linked_service_sftp.withHostKeyFingerprint` constructs a mixin object that can be merged into the `data_factory_linked_service_sftp`
...
`azurerm.data_factory_linked_service_sftp.withIntegrationRuntimeName` constructs a mixin object that can be merged into the `data_factory_linked_service_sftp`
...
`azurerm.data_factory_linked_service_sftp.withName` constructs a mixin object that can be merged into the `data_factory_linked_service_sftp`
...
`azurerm.data_factory_linked_service_sftp.withParameters` constructs a mixin object that can be merged into the `data_factory_linked_service_sftp`
...
`azurerm.data_factory_linked_service_sftp.withPassword` constructs a mixin object that can be merged into the `data_factory_linked_service_sftp`
...
`azurerm.data_factory_linked_service_sftp.withPort` constructs a mixin object that can be merged into the `data_factory_linked_service_sftp`
...
`azurerm.data_factory_linked_service_sftp.withSkipHostKeyValidation` constructs a mixin object that can be merged into the `data_factory_linked_service_sftp`
...
`azurerm.data_factory_linked_service_sftp.withTimeouts` constructs a mixin object that can be merged into the `data_factory_linked_service_sftp`
...
`azurerm.data_factory_linked_service_sftp.withTimeoutsMixin` constructs a mixin object that can be merged into the `data_factory_linked_service_sftp`
Terraform resource block to set or update the timeouts field.
...
`azurerm.data_factory_linked_service_sftp.withUsername` constructs a mixin object that can be merged into the `data_factory_linked_service_sftp`
