...
`azurerm.site_recovery_network_mapping.withName` constructs a mixin object that can be merged into the `site_recovery_network_mapping`
...
`azurerm.site_recovery_network_mapping.withRecoveryVaultName` constructs a mixin object that can be merged into the `site_recovery_network_mapping`
...
`azurerm.site_recovery_network_mapping.withResourceGroupName` constructs a mixin object that can be merged into the `site_recovery_network_mapping`
...
`azurerm.site_recovery_network_mapping.withSourceNetworkId` constructs a mixin object that can be merged into the `site_recovery_network_mapping`
...
`azurerm.site_recovery_network_mapping.withSourceRecoveryFabricName` constructs a mixin object that can be merged into the `site_recovery_network_mapping`
...
`azurerm.site_recovery_network_mapping.withTargetNetworkId` constructs a mixin object that can be merged into the `site_recovery_network_mapping`
...
`azurerm.site_recovery_network_mapping.withTargetRecoveryFabricName` constructs a mixin object that can be merged into the `site_recovery_network_mapping`
...
`azurerm.site_recovery_network_mapping.withTimeouts` constructs a mixin object that can be merged into the `site_recovery_network_mapping`
...
`azurerm.site_recovery_network_mapping.withTimeoutsMixin` constructs a mixin object that can be merged into the `site_recovery_network_mapping`
Terraform resource block to set or update the timeouts field.
