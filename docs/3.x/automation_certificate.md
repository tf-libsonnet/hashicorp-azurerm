...
`azurerm.string.withBase64` constructs a mixin object that can be merged into the `string`
...
`azurerm.bool.withExportable` constructs a mixin object that can be merged into the `bool`
