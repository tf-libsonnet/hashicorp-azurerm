...
`azurerm.spring_cloud_service.withBuildAgentPoolSize` constructs a mixin object that can be merged into the `spring_cloud_service`
...
`azurerm.spring_cloud_service.withConfigServerGitSetting` constructs a mixin object that can be merged into the `spring_cloud_service`
...
`azurerm.spring_cloud_service.withConfigServerGitSettingMixin` constructs a mixin object that can be merged into the `spring_cloud_service`
Terraform resource block to set or update the config_server_git_setting field.
...
`azurerm.spring_cloud_service.withLocation` constructs a mixin object that can be merged into the `spring_cloud_service`
...
`azurerm.spring_cloud_service.withLogStreamPublicEndpointEnabled` constructs a mixin object that can be merged into the `spring_cloud_service`
...
`azurerm.spring_cloud_service.withName` constructs a mixin object that can be merged into the `spring_cloud_service`
...
`azurerm.spring_cloud_service.withNetwork` constructs a mixin object that can be merged into the `spring_cloud_service`
...
`azurerm.spring_cloud_service.withNetworkMixin` constructs a mixin object that can be merged into the `spring_cloud_service`
Terraform resource block to set or update the network field.
...
`azurerm.spring_cloud_service.withResourceGroupName` constructs a mixin object that can be merged into the `spring_cloud_service`
...
`azurerm.spring_cloud_service.withServiceRegistryEnabled` constructs a mixin object that can be merged into the `spring_cloud_service`
...
`azurerm.spring_cloud_service.withSkuName` constructs a mixin object that can be merged into the `spring_cloud_service`
...
`azurerm.spring_cloud_service.withTags` constructs a mixin object that can be merged into the `spring_cloud_service`
...
`azurerm.spring_cloud_service.withTimeouts` constructs a mixin object that can be merged into the `spring_cloud_service`
...
`azurerm.spring_cloud_service.withTimeoutsMixin` constructs a mixin object that can be merged into the `spring_cloud_service`
Terraform resource block to set or update the timeouts field.
...
`azurerm.spring_cloud_service.withTrace` constructs a mixin object that can be merged into the `spring_cloud_service`
...
`azurerm.spring_cloud_service.withTraceMixin` constructs a mixin object that can be merged into the `spring_cloud_service`
Terraform resource block to set or update the trace field.
...
`azurerm.spring_cloud_service.withZoneRedundant` constructs a mixin object that can be merged into the `spring_cloud_service`
