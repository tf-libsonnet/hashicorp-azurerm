...
`azurerm.bot_channel_directline.withBotName` constructs a mixin object that can be merged into the `bot_channel_directline`
...
`azurerm.bot_channel_directline.withLocation` constructs a mixin object that can be merged into the `bot_channel_directline`
...
`azurerm.bot_channel_directline.withResourceGroupName` constructs a mixin object that can be merged into the `bot_channel_directline`
...
`azurerm.bot_channel_directline.withSite` constructs a mixin object that can be merged into the `bot_channel_directline`
...
`azurerm.bot_channel_directline.withSiteMixin` constructs a mixin object that can be merged into the `bot_channel_directline`
Terraform resource block to set or update the site field.
...
`azurerm.bot_channel_directline.withTimeouts` constructs a mixin object that can be merged into the `bot_channel_directline`
...
`azurerm.bot_channel_directline.withTimeoutsMixin` constructs a mixin object that can be merged into the `bot_channel_directline`
Terraform resource block to set or update the timeouts field.
