...
`azurerm.network_connection_monitor.withEndpoint` constructs a mixin object that can be merged into the `network_connection_monitor`
...
`azurerm.network_connection_monitor.withEndpointMixin` constructs a mixin object that can be merged into the `network_connection_monitor`
Terraform resource block to set or update the endpoint field.
...
`azurerm.network_connection_monitor.withLocation` constructs a mixin object that can be merged into the `network_connection_monitor`
...
`azurerm.network_connection_monitor.withName` constructs a mixin object that can be merged into the `network_connection_monitor`
...
`azurerm.network_connection_monitor.withNetworkWatcherId` constructs a mixin object that can be merged into the `network_connection_monitor`
...
`azurerm.network_connection_monitor.withNotes` constructs a mixin object that can be merged into the `network_connection_monitor`
...
`azurerm.network_connection_monitor.withOutputWorkspaceResourceIds` constructs a mixin object that can be merged into the `network_connection_monitor`
...
`azurerm.network_connection_monitor.withTags` constructs a mixin object that can be merged into the `network_connection_monitor`
...
`azurerm.network_connection_monitor.withTestConfiguration` constructs a mixin object that can be merged into the `network_connection_monitor`
...
`azurerm.network_connection_monitor.withTestConfigurationMixin` constructs a mixin object that can be merged into the `network_connection_monitor`
Terraform resource block to set or update the test_configuration field.
...
`azurerm.network_connection_monitor.withTestGroup` constructs a mixin object that can be merged into the `network_connection_monitor`
...
`azurerm.network_connection_monitor.withTestGroupMixin` constructs a mixin object that can be merged into the `network_connection_monitor`
Terraform resource block to set or update the test_group field.
...
`azurerm.network_connection_monitor.withTimeouts` constructs a mixin object that can be merged into the `network_connection_monitor`
...
`azurerm.network_connection_monitor.withTimeoutsMixin` constructs a mixin object that can be merged into the `network_connection_monitor`
Terraform resource block to set or update the timeouts field.
