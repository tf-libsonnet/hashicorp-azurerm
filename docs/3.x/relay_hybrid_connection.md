...
`azurerm.relay_hybrid_connection.withName` constructs a mixin object that can be merged into the `relay_hybrid_connection`
...
`azurerm.relay_hybrid_connection.withRelayNamespaceName` constructs a mixin object that can be merged into the `relay_hybrid_connection`
...
`azurerm.relay_hybrid_connection.withRequiresClientAuthorization` constructs a mixin object that can be merged into the `relay_hybrid_connection`
...
`azurerm.relay_hybrid_connection.withResourceGroupName` constructs a mixin object that can be merged into the `relay_hybrid_connection`
...
`azurerm.relay_hybrid_connection.withTimeouts` constructs a mixin object that can be merged into the `relay_hybrid_connection`
...
`azurerm.relay_hybrid_connection.withTimeoutsMixin` constructs a mixin object that can be merged into the `relay_hybrid_connection`
Terraform resource block to set or update the timeouts field.
...
`azurerm.relay_hybrid_connection.withUserMetadata` constructs a mixin object that can be merged into the `relay_hybrid_connection`
