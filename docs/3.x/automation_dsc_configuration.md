...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.automation_dsc_configuration.timeouts.new](#fn-automation_dsc_configurationtimeoutsnew) constructor.
...
Unlike [azurerm.automation_dsc_configuration.new](#fn-automation_dsc_configurationnew), this function will not inject the `resource`
