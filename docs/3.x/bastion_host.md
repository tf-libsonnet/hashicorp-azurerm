...
`azurerm.bastion_host.withCopyPasteEnabled` constructs a mixin object that can be merged into the `bastion_host`
...
`azurerm.bastion_host.withFileCopyEnabled` constructs a mixin object that can be merged into the `bastion_host`
...
`azurerm.bastion_host.withIpConfiguration` constructs a mixin object that can be merged into the `bastion_host`
...
`azurerm.bastion_host.withIpConfigurationMixin` constructs a mixin object that can be merged into the `bastion_host`
Terraform resource block to set or update the ip_configuration field.
...
`azurerm.bastion_host.withIpConnectEnabled` constructs a mixin object that can be merged into the `bastion_host`
...
`azurerm.bastion_host.withLocation` constructs a mixin object that can be merged into the `bastion_host`
...
`azurerm.bastion_host.withName` constructs a mixin object that can be merged into the `bastion_host`
...
`azurerm.bastion_host.withResourceGroupName` constructs a mixin object that can be merged into the `bastion_host`
...
`azurerm.bastion_host.withScaleUnits` constructs a mixin object that can be merged into the `bastion_host`
...
`azurerm.bastion_host.withShareableLinkEnabled` constructs a mixin object that can be merged into the `bastion_host`
...
`azurerm.bastion_host.withSku` constructs a mixin object that can be merged into the `bastion_host`
...
`azurerm.bastion_host.withTags` constructs a mixin object that can be merged into the `bastion_host`
...
`azurerm.bastion_host.withTimeouts` constructs a mixin object that can be merged into the `bastion_host`
...
`azurerm.bastion_host.withTimeoutsMixin` constructs a mixin object that can be merged into the `bastion_host`
Terraform resource block to set or update the timeouts field.
...
`azurerm.bastion_host.withTunnelingEnabled` constructs a mixin object that can be merged into the `bastion_host`
