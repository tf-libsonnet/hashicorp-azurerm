...
`azurerm.frontdoor_custom_https_configuration.withCustomHttpsConfiguration` constructs a mixin object that can be merged into the `frontdoor_custom_https_configuration`
...
`azurerm.frontdoor_custom_https_configuration.withCustomHttpsConfigurationMixin` constructs a mixin object that can be merged into the `frontdoor_custom_https_configuration`
Terraform resource block to set or update the custom_https_configuration field.
...
`azurerm.frontdoor_custom_https_configuration.withCustomHttpsProvisioningEnabled` constructs a mixin object that can be merged into the `frontdoor_custom_https_configuration`
...
`azurerm.frontdoor_custom_https_configuration.withFrontendEndpointId` constructs a mixin object that can be merged into the `frontdoor_custom_https_configuration`
...
`azurerm.frontdoor_custom_https_configuration.withTimeouts` constructs a mixin object that can be merged into the `frontdoor_custom_https_configuration`
...
`azurerm.frontdoor_custom_https_configuration.withTimeoutsMixin` constructs a mixin object that can be merged into the `frontdoor_custom_https_configuration`
Terraform resource block to set or update the timeouts field.
