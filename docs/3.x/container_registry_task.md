...
`azurerm.container_registry_task.withAgentPoolName` constructs a mixin object that can be merged into the `container_registry_task`
...
`azurerm.container_registry_task.withAgentSetting` constructs a mixin object that can be merged into the `container_registry_task`
...
`azurerm.container_registry_task.withAgentSettingMixin` constructs a mixin object that can be merged into the `container_registry_task`
Terraform resource block to set or update the agent_setting field.
...
`azurerm.container_registry_task.withBaseImageTrigger` constructs a mixin object that can be merged into the `container_registry_task`
...
`azurerm.container_registry_task.withBaseImageTriggerMixin` constructs a mixin object that can be merged into the `container_registry_task`
Terraform resource block to set or update the base_image_trigger field.
...
`azurerm.container_registry_task.withContainerRegistryId` constructs a mixin object that can be merged into the `container_registry_task`
...
`azurerm.container_registry_task.withDockerStep` constructs a mixin object that can be merged into the `container_registry_task`
...
`azurerm.container_registry_task.withDockerStepMixin` constructs a mixin object that can be merged into the `container_registry_task`
Terraform resource block to set or update the docker_step field.
...
`azurerm.container_registry_task.withEnabled` constructs a mixin object that can be merged into the `container_registry_task`
...
`azurerm.container_registry_task.withEncodedStep` constructs a mixin object that can be merged into the `container_registry_task`
...
`azurerm.container_registry_task.withEncodedStepMixin` constructs a mixin object that can be merged into the `container_registry_task`
Terraform resource block to set or update the encoded_step field.
...
`azurerm.container_registry_task.withFileStep` constructs a mixin object that can be merged into the `container_registry_task`
...
`azurerm.container_registry_task.withFileStepMixin` constructs a mixin object that can be merged into the `container_registry_task`
Terraform resource block to set or update the file_step field.
...
`azurerm.container_registry_task.withIdentity` constructs a mixin object that can be merged into the `container_registry_task`
...
`azurerm.container_registry_task.withIdentityMixin` constructs a mixin object that can be merged into the `container_registry_task`
Terraform resource block to set or update the identity field.
...
`azurerm.container_registry_task.withIsSystemTask` constructs a mixin object that can be merged into the `container_registry_task`
...
`azurerm.container_registry_task.withLogTemplate` constructs a mixin object that can be merged into the `container_registry_task`
...
`azurerm.container_registry_task.withName` constructs a mixin object that can be merged into the `container_registry_task`
...
`azurerm.container_registry_task.withPlatform` constructs a mixin object that can be merged into the `container_registry_task`
...
`azurerm.container_registry_task.withPlatformMixin` constructs a mixin object that can be merged into the `container_registry_task`
Terraform resource block to set or update the platform field.
...
`azurerm.container_registry_task.withRegistryCredential` constructs a mixin object that can be merged into the `container_registry_task`
...
`azurerm.container_registry_task.withRegistryCredentialMixin` constructs a mixin object that can be merged into the `container_registry_task`
Terraform resource block to set or update the registry_credential field.
...
`azurerm.container_registry_task.withSourceTrigger` constructs a mixin object that can be merged into the `container_registry_task`
...
`azurerm.container_registry_task.withSourceTriggerMixin` constructs a mixin object that can be merged into the `container_registry_task`
Terraform resource block to set or update the source_trigger field.
...
`azurerm.container_registry_task.withTags` constructs a mixin object that can be merged into the `container_registry_task`
...
`azurerm.container_registry_task.withTimeoutInSeconds` constructs a mixin object that can be merged into the `container_registry_task`
...
`azurerm.container_registry_task.withTimeouts` constructs a mixin object that can be merged into the `container_registry_task`
...
`azurerm.container_registry_task.withTimeoutsMixin` constructs a mixin object that can be merged into the `container_registry_task`
Terraform resource block to set or update the timeouts field.
...
`azurerm.container_registry_task.withTimerTrigger` constructs a mixin object that can be merged into the `container_registry_task`
...
`azurerm.container_registry_task.withTimerTriggerMixin` constructs a mixin object that can be merged into the `container_registry_task`
Terraform resource block to set or update the timer_trigger field.
