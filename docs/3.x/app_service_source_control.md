...
`azurerm.app_service_source_control.withAppId` constructs a mixin object that can be merged into the `app_service_source_control`
...
`azurerm.app_service_source_control.withBranch` constructs a mixin object that can be merged into the `app_service_source_control`
...
`azurerm.app_service_source_control.withGithubActionConfiguration` constructs a mixin object that can be merged into the `app_service_source_control`
...
`azurerm.app_service_source_control.withGithubActionConfigurationMixin` constructs a mixin object that can be merged into the `app_service_source_control`
Terraform resource block to set or update the github_action_configuration field.
...
`azurerm.app_service_source_control.withRepoUrl` constructs a mixin object that can be merged into the `app_service_source_control`
...
`azurerm.app_service_source_control.withRollbackEnabled` constructs a mixin object that can be merged into the `app_service_source_control`
...
`azurerm.app_service_source_control.withTimeouts` constructs a mixin object that can be merged into the `app_service_source_control`
...
`azurerm.app_service_source_control.withTimeoutsMixin` constructs a mixin object that can be merged into the `app_service_source_control`
Terraform resource block to set or update the timeouts field.
...
`azurerm.app_service_source_control.withUseLocalGit` constructs a mixin object that can be merged into the `app_service_source_control`
...
`azurerm.app_service_source_control.withUseManualIntegration` constructs a mixin object that can be merged into the `app_service_source_control`
...
`azurerm.app_service_source_control.withUseMercurial` constructs a mixin object that can be merged into the `app_service_source_control`
