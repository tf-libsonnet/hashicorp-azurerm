...
`azurerm.data_protection_backup_instance_blob_storage.withStorageAccountId` constructs a mixin object that can be merged into the `data_protection_backup_instance_blob_storage`
