...
**Args**:
  ...
  - `vault_id` (`string`): 
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.data_protection_backup_instance_blob_storage.timeouts.new](#fn-data_protection_backup_instance_blob_storagetimeoutsnew) constructor.
...
Unlike [azurerm.data_protection_backup_instance_blob_storage.new](#fn-data_protection_backup_instance_blob_storagenew), this function will not inject the `resource`
