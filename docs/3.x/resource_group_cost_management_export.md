...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.resource_group_cost_management_export.timeouts.new](#fn-timeoutsnew) constructor.
...
Unlike [azurerm.resource_group_cost_management_export.new](#fn-new), this function will not inject the `resource`
