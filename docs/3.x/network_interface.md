...
`azurerm.network_interface.withDnsServers` constructs a mixin object that can be merged into the `network_interface`
...
`azurerm.network_interface.withEdgeZone` constructs a mixin object that can be merged into the `network_interface`
...
`azurerm.network_interface.withEnableAcceleratedNetworking` constructs a mixin object that can be merged into the `network_interface`
...
`azurerm.network_interface.withEnableIpForwarding` constructs a mixin object that can be merged into the `network_interface`
...
`azurerm.network_interface.withInternalDnsNameLabel` constructs a mixin object that can be merged into the `network_interface`
...
`azurerm.network_interface.withIpConfiguration` constructs a mixin object that can be merged into the `network_interface`
...
`azurerm.network_interface.withIpConfigurationMixin` constructs a mixin object that can be merged into the `network_interface`
Terraform resource block to set or update the ip_configuration field.
...
`azurerm.network_interface.withLocation` constructs a mixin object that can be merged into the `network_interface`
...
`azurerm.network_interface.withName` constructs a mixin object that can be merged into the `network_interface`
...
`azurerm.network_interface.withResourceGroupName` constructs a mixin object that can be merged into the `network_interface`
...
`azurerm.network_interface.withTags` constructs a mixin object that can be merged into the `network_interface`
...
`azurerm.network_interface.withTimeouts` constructs a mixin object that can be merged into the `network_interface`
...
`azurerm.network_interface.withTimeoutsMixin` constructs a mixin object that can be merged into the `network_interface`
Terraform resource block to set or update the timeouts field.
