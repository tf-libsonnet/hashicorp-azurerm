...
`azurerm.cdn_frontdoor_origin_group.withCdnFrontdoorProfileId` constructs a mixin object that can be merged into the `cdn_frontdoor_origin_group`
...
`azurerm.cdn_frontdoor_origin_group.withHealthProbe` constructs a mixin object that can be merged into the `cdn_frontdoor_origin_group`
...
`azurerm.cdn_frontdoor_origin_group.withHealthProbeMixin` constructs a mixin object that can be merged into the `cdn_frontdoor_origin_group`
Terraform resource block to set or update the health_probe field.
...
`azurerm.cdn_frontdoor_origin_group.withLoadBalancing` constructs a mixin object that can be merged into the `cdn_frontdoor_origin_group`
...
`azurerm.cdn_frontdoor_origin_group.withLoadBalancingMixin` constructs a mixin object that can be merged into the `cdn_frontdoor_origin_group`
Terraform resource block to set or update the load_balancing field.
...
`azurerm.cdn_frontdoor_origin_group.withRestoreTrafficTimeToHealedOrNewEndpointInMinutes` constructs a mixin object that can be merged into the `cdn_frontdoor_origin_group`
...
`azurerm.cdn_frontdoor_origin_group.withSessionAffinityEnabled` constructs a mixin object that can be merged into the `cdn_frontdoor_origin_group`
