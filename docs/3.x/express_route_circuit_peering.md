...
`azurerm.express_route_circuit_peering.withExpressRouteCircuitName` constructs a mixin object that can be merged into the `express_route_circuit_peering`
...
`azurerm.express_route_circuit_peering.withIpv4Enabled` constructs a mixin object that can be merged into the `express_route_circuit_peering`
...
`azurerm.express_route_circuit_peering.withIpv6` constructs a mixin object that can be merged into the `express_route_circuit_peering`
...
`azurerm.express_route_circuit_peering.withIpv6Mixin` constructs a mixin object that can be merged into the `express_route_circuit_peering`
Terraform resource block to set or update the ipv6 field.
...
`azurerm.express_route_circuit_peering.withMicrosoftPeeringConfig` constructs a mixin object that can be merged into the `express_route_circuit_peering`
...
`azurerm.express_route_circuit_peering.withMicrosoftPeeringConfigMixin` constructs a mixin object that can be merged into the `express_route_circuit_peering`
Terraform resource block to set or update the microsoft_peering_config field.
...
`azurerm.express_route_circuit_peering.withPeerAsn` constructs a mixin object that can be merged into the `express_route_circuit_peering`
...
`azurerm.express_route_circuit_peering.withPeeringType` constructs a mixin object that can be merged into the `express_route_circuit_peering`
...
`azurerm.express_route_circuit_peering.withPrimaryPeerAddressPrefix` constructs a mixin object that can be merged into the `express_route_circuit_peering`
...
`azurerm.express_route_circuit_peering.withResourceGroupName` constructs a mixin object that can be merged into the `express_route_circuit_peering`
...
`azurerm.express_route_circuit_peering.withRouteFilterId` constructs a mixin object that can be merged into the `express_route_circuit_peering`
...
`azurerm.express_route_circuit_peering.withSecondaryPeerAddressPrefix` constructs a mixin object that can be merged into the `express_route_circuit_peering`
...
`azurerm.express_route_circuit_peering.withSharedKey` constructs a mixin object that can be merged into the `express_route_circuit_peering`
...
`azurerm.express_route_circuit_peering.withTimeouts` constructs a mixin object that can be merged into the `express_route_circuit_peering`
...
`azurerm.express_route_circuit_peering.withTimeoutsMixin` constructs a mixin object that can be merged into the `express_route_circuit_peering`
Terraform resource block to set or update the timeouts field.
...
`azurerm.express_route_circuit_peering.withVlanId` constructs a mixin object that can be merged into the `express_route_circuit_peering`
