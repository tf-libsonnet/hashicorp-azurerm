---
permalink: /billing_account_cost_management_export/
---

# billing_account_cost_management_export

`billing_account_cost_management_export` represents the `azurerm_billing_account_cost_management_export` Terraform resource.
...
`azurerm.string.withBillingAccountId` constructs a mixin object that can be merged into the `string`
