...
`azurerm.data_factory_trigger_schedule.withActivated` constructs a mixin object that can be merged into the `data_factory_trigger_schedule`
...
`azurerm.data_factory_trigger_schedule.withAnnotations` constructs a mixin object that can be merged into the `data_factory_trigger_schedule`
...
`azurerm.data_factory_trigger_schedule.withDataFactoryId` constructs a mixin object that can be merged into the `data_factory_trigger_schedule`
...
`azurerm.data_factory_trigger_schedule.withDescription` constructs a mixin object that can be merged into the `data_factory_trigger_schedule`
...
`azurerm.data_factory_trigger_schedule.withEndTime` constructs a mixin object that can be merged into the `data_factory_trigger_schedule`
...
`azurerm.data_factory_trigger_schedule.withFrequency` constructs a mixin object that can be merged into the `data_factory_trigger_schedule`
...
`azurerm.data_factory_trigger_schedule.withInterval` constructs a mixin object that can be merged into the `data_factory_trigger_schedule`
...
`azurerm.data_factory_trigger_schedule.withName` constructs a mixin object that can be merged into the `data_factory_trigger_schedule`
...
`azurerm.data_factory_trigger_schedule.withPipeline` constructs a mixin object that can be merged into the `data_factory_trigger_schedule`
...
`azurerm.data_factory_trigger_schedule.withPipelineMixin` constructs a mixin object that can be merged into the `data_factory_trigger_schedule`
Terraform resource block to set or update the pipeline field.
...
`azurerm.data_factory_trigger_schedule.withPipelineName` constructs a mixin object that can be merged into the `data_factory_trigger_schedule`
...
`azurerm.data_factory_trigger_schedule.withPipelineParameters` constructs a mixin object that can be merged into the `data_factory_trigger_schedule`
...
`azurerm.data_factory_trigger_schedule.withSchedule` constructs a mixin object that can be merged into the `data_factory_trigger_schedule`
...
`azurerm.data_factory_trigger_schedule.withScheduleMixin` constructs a mixin object that can be merged into the `data_factory_trigger_schedule`
Terraform resource block to set or update the schedule field.
...
`azurerm.data_factory_trigger_schedule.withStartTime` constructs a mixin object that can be merged into the `data_factory_trigger_schedule`
...
`azurerm.data_factory_trigger_schedule.withTimeZone` constructs a mixin object that can be merged into the `data_factory_trigger_schedule`
...
`azurerm.data_factory_trigger_schedule.withTimeouts` constructs a mixin object that can be merged into the `data_factory_trigger_schedule`
...
`azurerm.data_factory_trigger_schedule.withTimeoutsMixin` constructs a mixin object that can be merged into the `data_factory_trigger_schedule`
Terraform resource block to set or update the timeouts field.
