...
`azurerm.api_management_tag.withApiManagementId` constructs a mixin object that can be merged into the `api_management_tag`
...
`azurerm.api_management_tag.withDisplayName` constructs a mixin object that can be merged into the `api_management_tag`
...
`azurerm.api_management_tag.withName` constructs a mixin object that can be merged into the `api_management_tag`
...
`azurerm.api_management_tag.withTimeouts` constructs a mixin object that can be merged into the `api_management_tag`
...
`azurerm.api_management_tag.withTimeoutsMixin` constructs a mixin object that can be merged into the `api_management_tag`
Terraform resource block to set or update the timeouts field.
