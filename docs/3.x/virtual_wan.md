...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.virtual_wan.timeouts.new](#fn-virtual_wantimeoutsnew) constructor.
...
Unlike [azurerm.virtual_wan.new](#fn-virtual_wannew), this function will not inject the `resource`
