...
`azurerm.management_group_policy_assignment.overrides.new` constructs a new object with attributes and blocks configured for the `overrides`
Terraform sub block.
...
`azurerm.management_group_policy_assignment.overrides.selectors.new` constructs a new object with attributes and blocks configured for the `selectors`
Terraform sub block.
...
`azurerm.management_group_policy_assignment.resource_selectors.new` constructs a new object with attributes and blocks configured for the `resource_selectors`
Terraform sub block.
...
**Args**:
  ...
  - `selectors` (`list[obj]`): Set the `selectors` field on the resulting object. When `null`, the `selectors` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.management_group_policy_assignment.resource_selectors.selectors.new](#fn-resource_selectorsselectorsnew) constructor.
...
`azurerm.management_group_policy_assignment.resource_selectors.selectors.new` constructs a new object with attributes and blocks configured for the `selectors`
Terraform sub block.
