...
`azurerm.resource_group_policy_exemption.withDescription` constructs a mixin object that can be merged into the `resource_group_policy_exemption`
...
`azurerm.resource_group_policy_exemption.withDisplayName` constructs a mixin object that can be merged into the `resource_group_policy_exemption`
...
`azurerm.resource_group_policy_exemption.withExemptionCategory` constructs a mixin object that can be merged into the `resource_group_policy_exemption`
...
`azurerm.resource_group_policy_exemption.withExpiresOn` constructs a mixin object that can be merged into the `resource_group_policy_exemption`
...
`azurerm.resource_group_policy_exemption.withMetadata` constructs a mixin object that can be merged into the `resource_group_policy_exemption`
...
`azurerm.resource_group_policy_exemption.withName` constructs a mixin object that can be merged into the `resource_group_policy_exemption`
...
`azurerm.resource_group_policy_exemption.withPolicyAssignmentId` constructs a mixin object that can be merged into the `resource_group_policy_exemption`
...
`azurerm.resource_group_policy_exemption.withPolicyDefinitionReferenceIds` constructs a mixin object that can be merged into the `resource_group_policy_exemption`
...
`azurerm.resource_group_policy_exemption.withResourceGroupId` constructs a mixin object that can be merged into the `resource_group_policy_exemption`
...
`azurerm.resource_group_policy_exemption.withTimeouts` constructs a mixin object that can be merged into the `resource_group_policy_exemption`
...
`azurerm.resource_group_policy_exemption.withTimeoutsMixin` constructs a mixin object that can be merged into the `resource_group_policy_exemption`
Terraform resource block to set or update the timeouts field.
