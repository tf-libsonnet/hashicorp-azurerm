...
`azurerm.stream_analytics_output_blob.withAuthenticationMode` constructs a mixin object that can be merged into the `stream_analytics_output_blob`
...
`azurerm.stream_analytics_output_blob.withBatchMaxWaitTime` constructs a mixin object that can be merged into the `stream_analytics_output_blob`
...
`azurerm.stream_analytics_output_blob.withBatchMinRows` constructs a mixin object that can be merged into the `stream_analytics_output_blob`
...
`azurerm.stream_analytics_output_blob.withDateFormat` constructs a mixin object that can be merged into the `stream_analytics_output_blob`
...
`azurerm.stream_analytics_output_blob.withName` constructs a mixin object that can be merged into the `stream_analytics_output_blob`
...
`azurerm.stream_analytics_output_blob.withPathPattern` constructs a mixin object that can be merged into the `stream_analytics_output_blob`
...
`azurerm.stream_analytics_output_blob.withResourceGroupName` constructs a mixin object that can be merged into the `stream_analytics_output_blob`
...
`azurerm.stream_analytics_output_blob.withSerialization` constructs a mixin object that can be merged into the `stream_analytics_output_blob`
...
`azurerm.stream_analytics_output_blob.withSerializationMixin` constructs a mixin object that can be merged into the `stream_analytics_output_blob`
Terraform resource block to set or update the serialization field.
...
`azurerm.stream_analytics_output_blob.withStorageAccountKey` constructs a mixin object that can be merged into the `stream_analytics_output_blob`
...
`azurerm.stream_analytics_output_blob.withStorageAccountName` constructs a mixin object that can be merged into the `stream_analytics_output_blob`
...
`azurerm.stream_analytics_output_blob.withStorageContainerName` constructs a mixin object that can be merged into the `stream_analytics_output_blob`
...
`azurerm.stream_analytics_output_blob.withStreamAnalyticsJobName` constructs a mixin object that can be merged into the `stream_analytics_output_blob`
...
`azurerm.stream_analytics_output_blob.withTimeFormat` constructs a mixin object that can be merged into the `stream_analytics_output_blob`
...
`azurerm.stream_analytics_output_blob.withTimeouts` constructs a mixin object that can be merged into the `stream_analytics_output_blob`
...
`azurerm.stream_analytics_output_blob.withTimeoutsMixin` constructs a mixin object that can be merged into the `stream_analytics_output_blob`
Terraform resource block to set or update the timeouts field.
