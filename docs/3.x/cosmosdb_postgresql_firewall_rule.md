---
permalink: /cosmosdb_postgresql_firewall_rule/
---

# cosmosdb_postgresql_firewall_rule

`cosmosdb_postgresql_firewall_rule` represents the `azurerm_cosmosdb_postgresql_firewall_rule` Terraform resource.
