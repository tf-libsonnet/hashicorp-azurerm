...
`azurerm.lb_rule.withBackendAddressPoolIds` constructs a mixin object that can be merged into the `lb_rule`
...
`azurerm.lb_rule.withBackendPort` constructs a mixin object that can be merged into the `lb_rule`
...
`azurerm.lb_rule.withDisableOutboundSnat` constructs a mixin object that can be merged into the `lb_rule`
...
`azurerm.lb_rule.withEnableFloatingIp` constructs a mixin object that can be merged into the `lb_rule`
...
`azurerm.lb_rule.withEnableTcpReset` constructs a mixin object that can be merged into the `lb_rule`
...
`azurerm.lb_rule.withFrontendIpConfigurationName` constructs a mixin object that can be merged into the `lb_rule`
...
`azurerm.lb_rule.withFrontendPort` constructs a mixin object that can be merged into the `lb_rule`
...
`azurerm.lb_rule.withIdleTimeoutInMinutes` constructs a mixin object that can be merged into the `lb_rule`
...
`azurerm.lb_rule.withLoadDistribution` constructs a mixin object that can be merged into the `lb_rule`
...
`azurerm.lb_rule.withLoadbalancerId` constructs a mixin object that can be merged into the `lb_rule`
...
`azurerm.lb_rule.withName` constructs a mixin object that can be merged into the `lb_rule`
...
`azurerm.lb_rule.withProbeId` constructs a mixin object that can be merged into the `lb_rule`
...
`azurerm.lb_rule.withProtocol` constructs a mixin object that can be merged into the `lb_rule`
...
`azurerm.lb_rule.withTimeouts` constructs a mixin object that can be merged into the `lb_rule`
...
`azurerm.lb_rule.withTimeoutsMixin` constructs a mixin object that can be merged into the `lb_rule`
Terraform resource block to set or update the timeouts field.
