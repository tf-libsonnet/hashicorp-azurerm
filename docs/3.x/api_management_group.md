...
`azurerm.api_management_group.withDescription` constructs a mixin object that can be merged into the `api_management_group`
...
`azurerm.api_management_group.withDisplayName` constructs a mixin object that can be merged into the `api_management_group`
...
`azurerm.api_management_group.withExternalId` constructs a mixin object that can be merged into the `api_management_group`
...
`azurerm.api_management_group.withType` constructs a mixin object that can be merged into the `api_management_group`
