...
`azurerm.api_management.withAdditionalLocation` constructs a mixin object that can be merged into the `api_management`
...
`azurerm.api_management.withAdditionalLocationMixin` constructs a mixin object that can be merged into the `api_management`
Terraform resource block to set or update the additional_location field.
...
`azurerm.api_management.withCertificate` constructs a mixin object that can be merged into the `api_management`
...
`azurerm.api_management.withCertificateMixin` constructs a mixin object that can be merged into the `api_management`
Terraform resource block to set or update the certificate field.
...
`azurerm.api_management.withClientCertificateEnabled` constructs a mixin object that can be merged into the `api_management`
...
`azurerm.api_management.withGatewayDisabled` constructs a mixin object that can be merged into the `api_management`
...
`azurerm.api_management.withHostnameConfiguration` constructs a mixin object that can be merged into the `api_management`
...
`azurerm.api_management.withHostnameConfigurationMixin` constructs a mixin object that can be merged into the `api_management`
Terraform resource block to set or update the hostname_configuration field.
...
`azurerm.api_management.withIdentity` constructs a mixin object that can be merged into the `api_management`
...
`azurerm.api_management.withIdentityMixin` constructs a mixin object that can be merged into the `api_management`
Terraform resource block to set or update the identity field.
...
`azurerm.api_management.withLocation` constructs a mixin object that can be merged into the `api_management`
...
`azurerm.api_management.withMinApiVersion` constructs a mixin object that can be merged into the `api_management`
...
`azurerm.api_management.withName` constructs a mixin object that can be merged into the `api_management`
...
`azurerm.api_management.withNotificationSenderEmail` constructs a mixin object that can be merged into the `api_management`
...
`azurerm.api_management.withPolicy` constructs a mixin object that can be merged into the `api_management`
...
`azurerm.api_management.withProtocols` constructs a mixin object that can be merged into the `api_management`
...
`azurerm.api_management.withProtocolsMixin` constructs a mixin object that can be merged into the `api_management`
Terraform resource block to set or update the protocols field.
...
`azurerm.api_management.withPublicIpAddressId` constructs a mixin object that can be merged into the `api_management`
...
`azurerm.api_management.withPublicNetworkAccessEnabled` constructs a mixin object that can be merged into the `api_management`
...
`azurerm.api_management.withPublisherEmail` constructs a mixin object that can be merged into the `api_management`
...
`azurerm.api_management.withPublisherName` constructs a mixin object that can be merged into the `api_management`
...
`azurerm.api_management.withResourceGroupName` constructs a mixin object that can be merged into the `api_management`
...
`azurerm.api_management.withSecurity` constructs a mixin object that can be merged into the `api_management`
...
`azurerm.api_management.withSecurityMixin` constructs a mixin object that can be merged into the `api_management`
Terraform resource block to set or update the security field.
...
`azurerm.api_management.withSignIn` constructs a mixin object that can be merged into the `api_management`
...
`azurerm.api_management.withSignInMixin` constructs a mixin object that can be merged into the `api_management`
Terraform resource block to set or update the sign_in field.
...
`azurerm.api_management.withSignUp` constructs a mixin object that can be merged into the `api_management`
...
`azurerm.api_management.withSignUpMixin` constructs a mixin object that can be merged into the `api_management`
Terraform resource block to set or update the sign_up field.
...
`azurerm.api_management.withSkuName` constructs a mixin object that can be merged into the `api_management`
...
`azurerm.api_management.withTags` constructs a mixin object that can be merged into the `api_management`
...
`azurerm.api_management.withTenantAccess` constructs a mixin object that can be merged into the `api_management`
...
`azurerm.api_management.withTenantAccessMixin` constructs a mixin object that can be merged into the `api_management`
Terraform resource block to set or update the tenant_access field.
...
`azurerm.api_management.withTimeouts` constructs a mixin object that can be merged into the `api_management`
...
`azurerm.api_management.withTimeoutsMixin` constructs a mixin object that can be merged into the `api_management`
Terraform resource block to set or update the timeouts field.
...
`azurerm.api_management.withVirtualNetworkConfiguration` constructs a mixin object that can be merged into the `api_management`
...
`azurerm.api_management.withVirtualNetworkConfigurationMixin` constructs a mixin object that can be merged into the `api_management`
Terraform resource block to set or update the virtual_network_configuration field.
...
`azurerm.api_management.withVirtualNetworkType` constructs a mixin object that can be merged into the `api_management`
...
`azurerm.api_management.withZones` constructs a mixin object that can be merged into the `api_management`
