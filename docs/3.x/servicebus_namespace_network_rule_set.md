...
`azurerm.servicebus_namespace_network_rule_set.withPublicNetworkAccessEnabled` constructs a mixin object that can be merged into the `servicebus_namespace_network_rule_set`
