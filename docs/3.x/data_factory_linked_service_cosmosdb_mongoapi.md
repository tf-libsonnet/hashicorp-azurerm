...
**Args**:
  ...
  - `server_version_is_32_or_higher` (`bool`): Set the `server_version_is_32_or_higher` field on the resulting resource block. When `null`, the `server_version_is_32_or_higher` field will be omitted from the resulting object.
  - `timeouts` (`obj`): Set the `timeouts` field on the resulting resource block. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.data_factory_linked_service_cosmosdb_mongoapi.timeouts.new](#fn-timeoutsnew) constructor.
...
Unlike [azurerm.data_factory_linked_service_cosmosdb_mongoapi.new](#fn-new), this function will not inject the `resource`
...
**Args**:
  ...
  - `server_version_is_32_or_higher` (`bool`): Set the `server_version_is_32_or_higher` field on the resulting object. When `null`, the `server_version_is_32_or_higher` field will be omitted from the resulting object.
...
`azurerm.bool.withServerVersionIs32OrHigher` constructs a mixin object that can be merged into the `bool`
