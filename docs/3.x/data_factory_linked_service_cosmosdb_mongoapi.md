...
`azurerm.data_factory_linked_service_cosmosdb_mongoapi.withAnnotations` constructs a mixin object that can be merged into the `data_factory_linked_service_cosmosdb_mongoapi`
