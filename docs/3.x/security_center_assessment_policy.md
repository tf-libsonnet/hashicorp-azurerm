...
`azurerm.security_center_assessment_policy.withCategories` constructs a mixin object that can be merged into the `security_center_assessment_policy`
...
`azurerm.security_center_assessment_policy.withDescription` constructs a mixin object that can be merged into the `security_center_assessment_policy`
...
`azurerm.security_center_assessment_policy.withDisplayName` constructs a mixin object that can be merged into the `security_center_assessment_policy`
...
`azurerm.security_center_assessment_policy.withImplementationEffort` constructs a mixin object that can be merged into the `security_center_assessment_policy`
...
`azurerm.security_center_assessment_policy.withRemediationDescription` constructs a mixin object that can be merged into the `security_center_assessment_policy`
...
`azurerm.security_center_assessment_policy.withSeverity` constructs a mixin object that can be merged into the `security_center_assessment_policy`
...
`azurerm.security_center_assessment_policy.withThreats` constructs a mixin object that can be merged into the `security_center_assessment_policy`
...
`azurerm.security_center_assessment_policy.withTimeouts` constructs a mixin object that can be merged into the `security_center_assessment_policy`
...
`azurerm.security_center_assessment_policy.withTimeoutsMixin` constructs a mixin object that can be merged into the `security_center_assessment_policy`
Terraform resource block to set or update the timeouts field.
...
`azurerm.security_center_assessment_policy.withUserImpact` constructs a mixin object that can be merged into the `security_center_assessment_policy`
