...
`azurerm.log_analytics_solution.withLocation` constructs a mixin object that can be merged into the `log_analytics_solution`
...
`azurerm.log_analytics_solution.withPlan` constructs a mixin object that can be merged into the `log_analytics_solution`
...
`azurerm.log_analytics_solution.withPlanMixin` constructs a mixin object that can be merged into the `log_analytics_solution`
Terraform resource block to set or update the plan field.
...
`azurerm.log_analytics_solution.withResourceGroupName` constructs a mixin object that can be merged into the `log_analytics_solution`
...
`azurerm.log_analytics_solution.withSolutionName` constructs a mixin object that can be merged into the `log_analytics_solution`
...
`azurerm.log_analytics_solution.withTags` constructs a mixin object that can be merged into the `log_analytics_solution`
...
`azurerm.log_analytics_solution.withTimeouts` constructs a mixin object that can be merged into the `log_analytics_solution`
...
`azurerm.log_analytics_solution.withTimeoutsMixin` constructs a mixin object that can be merged into the `log_analytics_solution`
Terraform resource block to set or update the timeouts field.
...
`azurerm.log_analytics_solution.withWorkspaceName` constructs a mixin object that can be merged into the `log_analytics_solution`
...
`azurerm.log_analytics_solution.withWorkspaceResourceId` constructs a mixin object that can be merged into the `log_analytics_solution`
