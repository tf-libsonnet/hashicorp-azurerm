---
permalink: /signalr_service_custom_certificate/
---

# signalr_service_custom_certificate

`signalr_service_custom_certificate` represents the `azurerm_signalr_service_custom_certificate` Terraform resource.
