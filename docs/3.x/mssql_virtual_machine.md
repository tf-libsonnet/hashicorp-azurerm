...
`azurerm.mssql_virtual_machine.withAssessment` constructs a mixin object that can be merged into the `mssql_virtual_machine`
...
`azurerm.mssql_virtual_machine.withAssessmentMixin` constructs a mixin object that can be merged into the `mssql_virtual_machine`
Terraform resource block to set or update the assessment field.
...
`azurerm.mssql_virtual_machine.withAutoBackup` constructs a mixin object that can be merged into the `mssql_virtual_machine`
...
`azurerm.mssql_virtual_machine.withAutoBackupMixin` constructs a mixin object that can be merged into the `mssql_virtual_machine`
Terraform resource block to set or update the auto_backup field.
...
`azurerm.mssql_virtual_machine.withAutoPatching` constructs a mixin object that can be merged into the `mssql_virtual_machine`
...
`azurerm.mssql_virtual_machine.withAutoPatchingMixin` constructs a mixin object that can be merged into the `mssql_virtual_machine`
Terraform resource block to set or update the auto_patching field.
...
`azurerm.mssql_virtual_machine.withKeyVaultCredential` constructs a mixin object that can be merged into the `mssql_virtual_machine`
...
`azurerm.mssql_virtual_machine.withKeyVaultCredentialMixin` constructs a mixin object that can be merged into the `mssql_virtual_machine`
Terraform resource block to set or update the key_vault_credential field.
...
`azurerm.mssql_virtual_machine.withRServicesEnabled` constructs a mixin object that can be merged into the `mssql_virtual_machine`
...
`azurerm.mssql_virtual_machine.withSqlConnectivityPort` constructs a mixin object that can be merged into the `mssql_virtual_machine`
...
`azurerm.mssql_virtual_machine.withSqlConnectivityType` constructs a mixin object that can be merged into the `mssql_virtual_machine`
...
`azurerm.mssql_virtual_machine.withSqlConnectivityUpdatePassword` constructs a mixin object that can be merged into the `mssql_virtual_machine`
...
`azurerm.mssql_virtual_machine.withSqlConnectivityUpdateUsername` constructs a mixin object that can be merged into the `mssql_virtual_machine`
...
`azurerm.mssql_virtual_machine.withSqlInstance` constructs a mixin object that can be merged into the `mssql_virtual_machine`
...
`azurerm.mssql_virtual_machine.withSqlInstanceMixin` constructs a mixin object that can be merged into the `mssql_virtual_machine`
Terraform resource block to set or update the sql_instance field.
...
`azurerm.mssql_virtual_machine.withSqlLicenseType` constructs a mixin object that can be merged into the `mssql_virtual_machine`
...
`azurerm.mssql_virtual_machine.withStorageConfiguration` constructs a mixin object that can be merged into the `mssql_virtual_machine`
...
`azurerm.mssql_virtual_machine.withStorageConfigurationMixin` constructs a mixin object that can be merged into the `mssql_virtual_machine`
Terraform resource block to set or update the storage_configuration field.
...
`azurerm.mssql_virtual_machine.withTags` constructs a mixin object that can be merged into the `mssql_virtual_machine`
...
`azurerm.mssql_virtual_machine.withTimeouts` constructs a mixin object that can be merged into the `mssql_virtual_machine`
...
`azurerm.mssql_virtual_machine.withTimeoutsMixin` constructs a mixin object that can be merged into the `mssql_virtual_machine`
Terraform resource block to set or update the timeouts field.
...
`azurerm.mssql_virtual_machine.withVirtualMachineId` constructs a mixin object that can be merged into the `mssql_virtual_machine`
