...
`azurerm.sentinel_data_connector_microsoft_cloud_app_security.withName` constructs a mixin object that can be merged into the `sentinel_data_connector_microsoft_cloud_app_security`
