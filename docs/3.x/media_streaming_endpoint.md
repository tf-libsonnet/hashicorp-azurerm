...
`azurerm.media_streaming_endpoint.withAccessControl` constructs a mixin object that can be merged into the `media_streaming_endpoint`
...
`azurerm.media_streaming_endpoint.withAccessControlMixin` constructs a mixin object that can be merged into the `media_streaming_endpoint`
Terraform resource block to set or update the access_control field.
...
`azurerm.media_streaming_endpoint.withAutoStartEnabled` constructs a mixin object that can be merged into the `media_streaming_endpoint`
...
`azurerm.media_streaming_endpoint.withCdnEnabled` constructs a mixin object that can be merged into the `media_streaming_endpoint`
...
`azurerm.media_streaming_endpoint.withCdnProfile` constructs a mixin object that can be merged into the `media_streaming_endpoint`
...
`azurerm.media_streaming_endpoint.withCdnProvider` constructs a mixin object that can be merged into the `media_streaming_endpoint`
...
`azurerm.media_streaming_endpoint.withCrossSiteAccessPolicy` constructs a mixin object that can be merged into the `media_streaming_endpoint`
...
`azurerm.media_streaming_endpoint.withCrossSiteAccessPolicyMixin` constructs a mixin object that can be merged into the `media_streaming_endpoint`
Terraform resource block to set or update the cross_site_access_policy field.
...
`azurerm.media_streaming_endpoint.withCustomHostNames` constructs a mixin object that can be merged into the `media_streaming_endpoint`
...
`azurerm.media_streaming_endpoint.withDescription` constructs a mixin object that can be merged into the `media_streaming_endpoint`
...
`azurerm.media_streaming_endpoint.withLocation` constructs a mixin object that can be merged into the `media_streaming_endpoint`
...
`azurerm.media_streaming_endpoint.withMaxCacheAgeSeconds` constructs a mixin object that can be merged into the `media_streaming_endpoint`
...
`azurerm.media_streaming_endpoint.withMediaServicesAccountName` constructs a mixin object that can be merged into the `media_streaming_endpoint`
...
`azurerm.media_streaming_endpoint.withName` constructs a mixin object that can be merged into the `media_streaming_endpoint`
...
`azurerm.media_streaming_endpoint.withResourceGroupName` constructs a mixin object that can be merged into the `media_streaming_endpoint`
...
`azurerm.media_streaming_endpoint.withScaleUnits` constructs a mixin object that can be merged into the `media_streaming_endpoint`
...
`azurerm.media_streaming_endpoint.withTags` constructs a mixin object that can be merged into the `media_streaming_endpoint`
...
`azurerm.media_streaming_endpoint.withTimeouts` constructs a mixin object that can be merged into the `media_streaming_endpoint`
...
`azurerm.media_streaming_endpoint.withTimeoutsMixin` constructs a mixin object that can be merged into the `media_streaming_endpoint`
Terraform resource block to set or update the timeouts field.
