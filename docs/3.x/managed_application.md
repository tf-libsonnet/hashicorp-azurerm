...
`azurerm.managed_application.withApplicationDefinitionId` constructs a mixin object that can be merged into the `managed_application`
...
`azurerm.managed_application.withKind` constructs a mixin object that can be merged into the `managed_application`
...
`azurerm.managed_application.withLocation` constructs a mixin object that can be merged into the `managed_application`
...
`azurerm.managed_application.withManagedResourceGroupName` constructs a mixin object that can be merged into the `managed_application`
...
`azurerm.managed_application.withName` constructs a mixin object that can be merged into the `managed_application`
...
`azurerm.managed_application.withParameterValues` constructs a mixin object that can be merged into the `managed_application`
...
`azurerm.managed_application.withParameters` constructs a mixin object that can be merged into the `managed_application`
...
`azurerm.managed_application.withPlan` constructs a mixin object that can be merged into the `managed_application`
...
`azurerm.managed_application.withPlanMixin` constructs a mixin object that can be merged into the `managed_application`
Terraform resource block to set or update the plan field.
...
`azurerm.managed_application.withResourceGroupName` constructs a mixin object that can be merged into the `managed_application`
...
`azurerm.managed_application.withTags` constructs a mixin object that can be merged into the `managed_application`
...
`azurerm.managed_application.withTimeouts` constructs a mixin object that can be merged into the `managed_application`
...
`azurerm.managed_application.withTimeoutsMixin` constructs a mixin object that can be merged into the `managed_application`
Terraform resource block to set or update the timeouts field.
