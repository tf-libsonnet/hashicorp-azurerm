...
`azurerm.api_management_api_operation_policy.withResourceGroupName` constructs a mixin object that can be merged into the `api_management_api_operation_policy`
