...
`azurerm.iothub_endpoint_storage_container.withAuthenticationType` constructs a mixin object that can be merged into the `iothub_endpoint_storage_container`
...
`azurerm.iothub_endpoint_storage_container.withBatchFrequencyInSeconds` constructs a mixin object that can be merged into the `iothub_endpoint_storage_container`
...
`azurerm.iothub_endpoint_storage_container.withConnectionString` constructs a mixin object that can be merged into the `iothub_endpoint_storage_container`
...
`azurerm.iothub_endpoint_storage_container.withContainerName` constructs a mixin object that can be merged into the `iothub_endpoint_storage_container`
...
`azurerm.iothub_endpoint_storage_container.withEncoding` constructs a mixin object that can be merged into the `iothub_endpoint_storage_container`
...
`azurerm.iothub_endpoint_storage_container.withEndpointUri` constructs a mixin object that can be merged into the `iothub_endpoint_storage_container`
...
`azurerm.iothub_endpoint_storage_container.withFileNameFormat` constructs a mixin object that can be merged into the `iothub_endpoint_storage_container`
...
`azurerm.iothub_endpoint_storage_container.withIdentityId` constructs a mixin object that can be merged into the `iothub_endpoint_storage_container`
...
`azurerm.iothub_endpoint_storage_container.withIothubId` constructs a mixin object that can be merged into the `iothub_endpoint_storage_container`
...
`azurerm.iothub_endpoint_storage_container.withMaxChunkSizeInBytes` constructs a mixin object that can be merged into the `iothub_endpoint_storage_container`
...
`azurerm.iothub_endpoint_storage_container.withName` constructs a mixin object that can be merged into the `iothub_endpoint_storage_container`
...
`azurerm.iothub_endpoint_storage_container.withResourceGroupName` constructs a mixin object that can be merged into the `iothub_endpoint_storage_container`
...
`azurerm.iothub_endpoint_storage_container.withTimeouts` constructs a mixin object that can be merged into the `iothub_endpoint_storage_container`
...
`azurerm.iothub_endpoint_storage_container.withTimeoutsMixin` constructs a mixin object that can be merged into the `iothub_endpoint_storage_container`
Terraform resource block to set or update the timeouts field.
