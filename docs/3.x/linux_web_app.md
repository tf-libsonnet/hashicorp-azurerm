...
`azurerm.linux_web_app.withAppSettings` constructs a mixin object that can be merged into the `linux_web_app`
...
`azurerm.linux_web_app.withAuthSettings` constructs a mixin object that can be merged into the `linux_web_app`
...
`azurerm.linux_web_app.withAuthSettingsMixin` constructs a mixin object that can be merged into the `linux_web_app`
Terraform resource block to set or update the auth_settings field.
...
`azurerm.linux_web_app.withBackup` constructs a mixin object that can be merged into the `linux_web_app`
...
`azurerm.linux_web_app.withBackupMixin` constructs a mixin object that can be merged into the `linux_web_app`
Terraform resource block to set or update the backup field.
...
`azurerm.linux_web_app.withClientAffinityEnabled` constructs a mixin object that can be merged into the `linux_web_app`
...
`azurerm.linux_web_app.withClientCertificateEnabled` constructs a mixin object that can be merged into the `linux_web_app`
...
`azurerm.linux_web_app.withClientCertificateExclusionPaths` constructs a mixin object that can be merged into the `linux_web_app`
...
`azurerm.linux_web_app.withClientCertificateMode` constructs a mixin object that can be merged into the `linux_web_app`
...
`azurerm.linux_web_app.withConnectionString` constructs a mixin object that can be merged into the `linux_web_app`
...
`azurerm.linux_web_app.withConnectionStringMixin` constructs a mixin object that can be merged into the `linux_web_app`
Terraform resource block to set or update the connection_string field.
...
`azurerm.linux_web_app.withEnabled` constructs a mixin object that can be merged into the `linux_web_app`
...
`azurerm.linux_web_app.withHttpsOnly` constructs a mixin object that can be merged into the `linux_web_app`
...
`azurerm.linux_web_app.withIdentity` constructs a mixin object that can be merged into the `linux_web_app`
...
`azurerm.linux_web_app.withIdentityMixin` constructs a mixin object that can be merged into the `linux_web_app`
Terraform resource block to set or update the identity field.
...
`azurerm.linux_web_app.withKeyVaultReferenceIdentityId` constructs a mixin object that can be merged into the `linux_web_app`
...
`azurerm.linux_web_app.withLocation` constructs a mixin object that can be merged into the `linux_web_app`
...
`azurerm.linux_web_app.withLogs` constructs a mixin object that can be merged into the `linux_web_app`
...
`azurerm.linux_web_app.withLogsMixin` constructs a mixin object that can be merged into the `linux_web_app`
Terraform resource block to set or update the logs field.
...
`azurerm.linux_web_app.withName` constructs a mixin object that can be merged into the `linux_web_app`
...
`azurerm.linux_web_app.withResourceGroupName` constructs a mixin object that can be merged into the `linux_web_app`
...
`azurerm.linux_web_app.withServicePlanId` constructs a mixin object that can be merged into the `linux_web_app`
...
`azurerm.linux_web_app.withSiteConfig` constructs a mixin object that can be merged into the `linux_web_app`
...
`azurerm.linux_web_app.withSiteConfigMixin` constructs a mixin object that can be merged into the `linux_web_app`
Terraform resource block to set or update the site_config field.
...
`azurerm.linux_web_app.withStickySettings` constructs a mixin object that can be merged into the `linux_web_app`
...
`azurerm.linux_web_app.withStickySettingsMixin` constructs a mixin object that can be merged into the `linux_web_app`
Terraform resource block to set or update the sticky_settings field.
...
`azurerm.linux_web_app.withStorageAccount` constructs a mixin object that can be merged into the `linux_web_app`
...
`azurerm.linux_web_app.withStorageAccountMixin` constructs a mixin object that can be merged into the `linux_web_app`
Terraform resource block to set or update the storage_account field.
...
`azurerm.linux_web_app.withTags` constructs a mixin object that can be merged into the `linux_web_app`
...
`azurerm.linux_web_app.withTimeouts` constructs a mixin object that can be merged into the `linux_web_app`
...
`azurerm.linux_web_app.withTimeoutsMixin` constructs a mixin object that can be merged into the `linux_web_app`
Terraform resource block to set or update the timeouts field.
...
`azurerm.linux_web_app.withVirtualNetworkSubnetId` constructs a mixin object that can be merged into the `linux_web_app`
...
`azurerm.linux_web_app.withZipDeployFile` constructs a mixin object that can be merged into the `linux_web_app`
