---
permalink: /linux_web_app/
---

# linux_web_app

`linux_web_app` represents the `azurerm_linux_web_app` Terraform resource.
...
**Args**:
  ...
  - `active_directory` (`list[obj]`):  When `null`, the `active_directory` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app.auth_settings.active_directory.new](#fn-active_directorynew) constructor.
  - `facebook` (`list[obj]`):  When `null`, the `facebook` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app.auth_settings.facebook.new](#fn-facebooknew) constructor.
  - `github` (`list[obj]`):  When `null`, the `github` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app.auth_settings.github.new](#fn-githubnew) constructor.
  - `google` (`list[obj]`):  When `null`, the `google` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app.auth_settings.google.new](#fn-googlenew) constructor.
  - `microsoft` (`list[obj]`):  When `null`, the `microsoft` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app.auth_settings.microsoft.new](#fn-microsoftnew) constructor.
  - `twitter` (`list[obj]`):  When `null`, the `twitter` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app.auth_settings.twitter.new](#fn-twitternew) constructor.
...
**Args**:
  ...
  - `schedule` (`list[obj]`):  When `null`, the `schedule` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app.backup.schedule.new](#fn-schedulenew) constructor.
...
**Args**:
  ...
  - `application_logs` (`list[obj]`):  When `null`, the `application_logs` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app.logs.application_logs.new](#fn-application_logsnew) constructor.
  - `http_logs` (`list[obj]`):  When `null`, the `http_logs` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app.logs.http_logs.new](#fn-http_logsnew) constructor.
...
**Args**:
  ...
  - `azure_blob_storage` (`list[obj]`):  When `null`, the `azure_blob_storage` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app.logs.application_logs.azure_blob_storage.new](#fn-logsazure_blob_storagenew) constructor.
...
**Args**:
  - `azure_blob_storage` (`list[obj]`):  When `null`, the `azure_blob_storage` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app.logs.http_logs.azure_blob_storage.new](#fn-logsazure_blob_storagenew) constructor.
  - `file_system` (`list[obj]`):  When `null`, the `file_system` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app.logs.http_logs.file_system.new](#fn-logsfile_systemnew) constructor.
...
**Args**:
  ...
  - `application_stack` (`list[obj]`):  When `null`, the `application_stack` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app.site_config.application_stack.new](#fn-application_stacknew) constructor.
  - `auto_heal_setting` (`list[obj]`):  When `null`, the `auto_heal_setting` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app.site_config.auto_heal_setting.new](#fn-auto_heal_settingnew) constructor.
  - `cors` (`list[obj]`):  When `null`, the `cors` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app.site_config.cors.new](#fn-corsnew) constructor.
...
**Args**:
  - `action` (`list[obj]`):  When `null`, the `action` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app.site_config.auto_heal_setting.action.new](#fn-site_configactionnew) constructor.
  - `trigger` (`list[obj]`):  When `null`, the `trigger` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app.site_config.auto_heal_setting.trigger.new](#fn-site_configtriggernew) constructor.
...
**Args**:
  - `requests` (`list[obj]`):  When `null`, the `requests` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app.site_config.auto_heal_setting.trigger.requests.new](#fn-site_configauto_heal_settingrequestsnew) constructor.
  - `slow_request` (`list[obj]`):  When `null`, the `slow_request` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app.site_config.auto_heal_setting.trigger.slow_request.new](#fn-site_configauto_heal_settingslow_requestnew) constructor.
  - `status_code` (`list[obj]`):  When `null`, the `status_code` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app.site_config.auto_heal_setting.trigger.status_code.new](#fn-site_configauto_heal_settingstatus_codenew) constructor.
