...
`azurerm.automation_variable_datetime.withDescription` constructs a mixin object that can be merged into the `automation_variable_datetime`
...
`azurerm.automation_variable_datetime.withEncrypted` constructs a mixin object that can be merged into the `automation_variable_datetime`
...
`azurerm.automation_variable_datetime.withValue` constructs a mixin object that can be merged into the `automation_variable_datetime`
