...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.automation_variable_datetime.timeouts.new](#fn-automation_variable_datetimetimeoutsnew) constructor.
...
Unlike [azurerm.automation_variable_datetime.new](#fn-automation_variable_datetimenew), this function will not inject the `resource`
