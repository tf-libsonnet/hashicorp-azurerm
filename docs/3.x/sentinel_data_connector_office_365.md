...
`azurerm.sentinel_data_connector_office_365.withExchangeEnabled` constructs a mixin object that can be merged into the `sentinel_data_connector_office_365`
...
`azurerm.sentinel_data_connector_office_365.withLogAnalyticsWorkspaceId` constructs a mixin object that can be merged into the `sentinel_data_connector_office_365`
...
`azurerm.sentinel_data_connector_office_365.withName` constructs a mixin object that can be merged into the `sentinel_data_connector_office_365`
...
`azurerm.sentinel_data_connector_office_365.withSharepointEnabled` constructs a mixin object that can be merged into the `sentinel_data_connector_office_365`
...
`azurerm.sentinel_data_connector_office_365.withTeamsEnabled` constructs a mixin object that can be merged into the `sentinel_data_connector_office_365`
...
`azurerm.sentinel_data_connector_office_365.withTenantId` constructs a mixin object that can be merged into the `sentinel_data_connector_office_365`
...
`azurerm.sentinel_data_connector_office_365.withTimeouts` constructs a mixin object that can be merged into the `sentinel_data_connector_office_365`
...
`azurerm.sentinel_data_connector_office_365.withTimeoutsMixin` constructs a mixin object that can be merged into the `sentinel_data_connector_office_365`
Terraform resource block to set or update the timeouts field.
