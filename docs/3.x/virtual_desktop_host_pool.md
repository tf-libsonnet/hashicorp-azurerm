...
`azurerm.virtual_desktop_host_pool.withCustomRdpProperties` constructs a mixin object that can be merged into the `virtual_desktop_host_pool`
...
`azurerm.virtual_desktop_host_pool.withDescription` constructs a mixin object that can be merged into the `virtual_desktop_host_pool`
...
`azurerm.virtual_desktop_host_pool.withFriendlyName` constructs a mixin object that can be merged into the `virtual_desktop_host_pool`
...
`azurerm.virtual_desktop_host_pool.withLoadBalancerType` constructs a mixin object that can be merged into the `virtual_desktop_host_pool`
...
`azurerm.virtual_desktop_host_pool.withLocation` constructs a mixin object that can be merged into the `virtual_desktop_host_pool`
...
`azurerm.virtual_desktop_host_pool.withMaximumSessionsAllowed` constructs a mixin object that can be merged into the `virtual_desktop_host_pool`
...
`azurerm.virtual_desktop_host_pool.withName` constructs a mixin object that can be merged into the `virtual_desktop_host_pool`
...
`azurerm.virtual_desktop_host_pool.withPersonalDesktopAssignmentType` constructs a mixin object that can be merged into the `virtual_desktop_host_pool`
...
`azurerm.virtual_desktop_host_pool.withPreferredAppGroupType` constructs a mixin object that can be merged into the `virtual_desktop_host_pool`
...
`azurerm.virtual_desktop_host_pool.withResourceGroupName` constructs a mixin object that can be merged into the `virtual_desktop_host_pool`
...
`azurerm.virtual_desktop_host_pool.withScheduledAgentUpdates` constructs a mixin object that can be merged into the `virtual_desktop_host_pool`
...
`azurerm.virtual_desktop_host_pool.withScheduledAgentUpdatesMixin` constructs a mixin object that can be merged into the `virtual_desktop_host_pool`
Terraform resource block to set or update the scheduled_agent_updates field.
...
`azurerm.virtual_desktop_host_pool.withStartVmOnConnect` constructs a mixin object that can be merged into the `virtual_desktop_host_pool`
...
`azurerm.virtual_desktop_host_pool.withTags` constructs a mixin object that can be merged into the `virtual_desktop_host_pool`
...
`azurerm.virtual_desktop_host_pool.withTimeouts` constructs a mixin object that can be merged into the `virtual_desktop_host_pool`
...
`azurerm.virtual_desktop_host_pool.withTimeoutsMixin` constructs a mixin object that can be merged into the `virtual_desktop_host_pool`
Terraform resource block to set or update the timeouts field.
...
`azurerm.virtual_desktop_host_pool.withType` constructs a mixin object that can be merged into the `virtual_desktop_host_pool`
...
`azurerm.virtual_desktop_host_pool.withValidateEnvironment` constructs a mixin object that can be merged into the `virtual_desktop_host_pool`
