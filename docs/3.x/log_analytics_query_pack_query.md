...
`azurerm.log_analytics_query_pack_query.withAdditionalSettingsJson` constructs a mixin object that can be merged into the `log_analytics_query_pack_query`
...
`azurerm.log_analytics_query_pack_query.withBody` constructs a mixin object that can be merged into the `log_analytics_query_pack_query`
...
`azurerm.log_analytics_query_pack_query.withCategories` constructs a mixin object that can be merged into the `log_analytics_query_pack_query`
...
`azurerm.log_analytics_query_pack_query.withDescription` constructs a mixin object that can be merged into the `log_analytics_query_pack_query`
...
`azurerm.log_analytics_query_pack_query.withDisplayName` constructs a mixin object that can be merged into the `log_analytics_query_pack_query`
...
`azurerm.log_analytics_query_pack_query.withName` constructs a mixin object that can be merged into the `log_analytics_query_pack_query`
...
`azurerm.log_analytics_query_pack_query.withQueryPackId` constructs a mixin object that can be merged into the `log_analytics_query_pack_query`
...
`azurerm.log_analytics_query_pack_query.withResourceTypes` constructs a mixin object that can be merged into the `log_analytics_query_pack_query`
...
`azurerm.log_analytics_query_pack_query.withSolutions` constructs a mixin object that can be merged into the `log_analytics_query_pack_query`
...
`azurerm.log_analytics_query_pack_query.withTags` constructs a mixin object that can be merged into the `log_analytics_query_pack_query`
...
`azurerm.log_analytics_query_pack_query.withTimeouts` constructs a mixin object that can be merged into the `log_analytics_query_pack_query`
...
`azurerm.log_analytics_query_pack_query.withTimeoutsMixin` constructs a mixin object that can be merged into the `log_analytics_query_pack_query`
Terraform resource block to set or update the timeouts field.
