...
`azurerm.app_service_slot_custom_hostname_binding.withAppServiceSlotId` constructs a mixin object that can be merged into the `app_service_slot_custom_hostname_binding`
...
`azurerm.app_service_slot_custom_hostname_binding.withHostname` constructs a mixin object that can be merged into the `app_service_slot_custom_hostname_binding`
...
`azurerm.app_service_slot_custom_hostname_binding.withSslState` constructs a mixin object that can be merged into the `app_service_slot_custom_hostname_binding`
...
`azurerm.app_service_slot_custom_hostname_binding.withThumbprint` constructs a mixin object that can be merged into the `app_service_slot_custom_hostname_binding`
...
`azurerm.app_service_slot_custom_hostname_binding.withTimeouts` constructs a mixin object that can be merged into the `app_service_slot_custom_hostname_binding`
...
`azurerm.app_service_slot_custom_hostname_binding.withTimeoutsMixin` constructs a mixin object that can be merged into the `app_service_slot_custom_hostname_binding`
Terraform resource block to set or update the timeouts field.
