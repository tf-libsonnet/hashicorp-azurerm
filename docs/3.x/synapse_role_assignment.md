...
`azurerm.synapse_role_assignment.withPrincipalId` constructs a mixin object that can be merged into the `synapse_role_assignment`
...
`azurerm.synapse_role_assignment.withRoleName` constructs a mixin object that can be merged into the `synapse_role_assignment`
...
`azurerm.synapse_role_assignment.withSynapseSparkPoolId` constructs a mixin object that can be merged into the `synapse_role_assignment`
...
`azurerm.synapse_role_assignment.withSynapseWorkspaceId` constructs a mixin object that can be merged into the `synapse_role_assignment`
...
`azurerm.synapse_role_assignment.withTimeouts` constructs a mixin object that can be merged into the `synapse_role_assignment`
...
`azurerm.synapse_role_assignment.withTimeoutsMixin` constructs a mixin object that can be merged into the `synapse_role_assignment`
Terraform resource block to set or update the timeouts field.
