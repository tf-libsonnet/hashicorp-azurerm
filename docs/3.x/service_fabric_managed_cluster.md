...
`azurerm.service_fabric_managed_cluster.withAuthentication` constructs a mixin object that can be merged into the `service_fabric_managed_cluster`
...
`azurerm.service_fabric_managed_cluster.withAuthenticationMixin` constructs a mixin object that can be merged into the `service_fabric_managed_cluster`
Terraform resource block to set or update the authentication field.
...
`azurerm.service_fabric_managed_cluster.withBackupServiceEnabled` constructs a mixin object that can be merged into the `service_fabric_managed_cluster`
...
`azurerm.service_fabric_managed_cluster.withClientConnectionPort` constructs a mixin object that can be merged into the `service_fabric_managed_cluster`
...
`azurerm.service_fabric_managed_cluster.withCustomFabricSetting` constructs a mixin object that can be merged into the `service_fabric_managed_cluster`
...
`azurerm.service_fabric_managed_cluster.withCustomFabricSettingMixin` constructs a mixin object that can be merged into the `service_fabric_managed_cluster`
Terraform resource block to set or update the custom_fabric_setting field.
...
`azurerm.service_fabric_managed_cluster.withDnsName` constructs a mixin object that can be merged into the `service_fabric_managed_cluster`
...
`azurerm.service_fabric_managed_cluster.withDnsServiceEnabled` constructs a mixin object that can be merged into the `service_fabric_managed_cluster`
...
`azurerm.service_fabric_managed_cluster.withHttpGatewayPort` constructs a mixin object that can be merged into the `service_fabric_managed_cluster`
...
`azurerm.service_fabric_managed_cluster.withLbRule` constructs a mixin object that can be merged into the `service_fabric_managed_cluster`
...
`azurerm.service_fabric_managed_cluster.withLbRuleMixin` constructs a mixin object that can be merged into the `service_fabric_managed_cluster`
Terraform resource block to set or update the lb_rule field.
...
`azurerm.service_fabric_managed_cluster.withLocation` constructs a mixin object that can be merged into the `service_fabric_managed_cluster`
...
`azurerm.service_fabric_managed_cluster.withName` constructs a mixin object that can be merged into the `service_fabric_managed_cluster`
...
`azurerm.service_fabric_managed_cluster.withNodeType` constructs a mixin object that can be merged into the `service_fabric_managed_cluster`
...
`azurerm.service_fabric_managed_cluster.withNodeTypeMixin` constructs a mixin object that can be merged into the `service_fabric_managed_cluster`
Terraform resource block to set or update the node_type field.
...
`azurerm.service_fabric_managed_cluster.withPassword` constructs a mixin object that can be merged into the `service_fabric_managed_cluster`
...
`azurerm.service_fabric_managed_cluster.withResourceGroupName` constructs a mixin object that can be merged into the `service_fabric_managed_cluster`
...
`azurerm.service_fabric_managed_cluster.withSku` constructs a mixin object that can be merged into the `service_fabric_managed_cluster`
...
`azurerm.service_fabric_managed_cluster.withTags` constructs a mixin object that can be merged into the `service_fabric_managed_cluster`
...
`azurerm.service_fabric_managed_cluster.withTimeouts` constructs a mixin object that can be merged into the `service_fabric_managed_cluster`
...
`azurerm.service_fabric_managed_cluster.withTimeoutsMixin` constructs a mixin object that can be merged into the `service_fabric_managed_cluster`
Terraform resource block to set or update the timeouts field.
...
`azurerm.service_fabric_managed_cluster.withUpgradeWave` constructs a mixin object that can be merged into the `service_fabric_managed_cluster`
...
`azurerm.service_fabric_managed_cluster.withUsername` constructs a mixin object that can be merged into the `service_fabric_managed_cluster`
