...
`azurerm.virtual_desktop_workspace_application_group_association.withApplicationGroupId` constructs a mixin object that can be merged into the `virtual_desktop_workspace_application_group_association`
...
`azurerm.virtual_desktop_workspace_application_group_association.withTimeouts` constructs a mixin object that can be merged into the `virtual_desktop_workspace_application_group_association`
...
`azurerm.virtual_desktop_workspace_application_group_association.withTimeoutsMixin` constructs a mixin object that can be merged into the `virtual_desktop_workspace_application_group_association`
Terraform resource block to set or update the timeouts field.
...
`azurerm.virtual_desktop_workspace_application_group_association.withWorkspaceId` constructs a mixin object that can be merged into the `virtual_desktop_workspace_application_group_association`
