...
`azurerm.digital_twins_endpoint_eventgrid.withDeadLetterStorageSecret` constructs a mixin object that can be merged into the `digital_twins_endpoint_eventgrid`
...
`azurerm.digital_twins_endpoint_eventgrid.withDigitalTwinsId` constructs a mixin object that can be merged into the `digital_twins_endpoint_eventgrid`
...
`azurerm.digital_twins_endpoint_eventgrid.withEventgridTopicEndpoint` constructs a mixin object that can be merged into the `digital_twins_endpoint_eventgrid`
...
`azurerm.digital_twins_endpoint_eventgrid.withEventgridTopicPrimaryAccessKey` constructs a mixin object that can be merged into the `digital_twins_endpoint_eventgrid`
...
`azurerm.digital_twins_endpoint_eventgrid.withEventgridTopicSecondaryAccessKey` constructs a mixin object that can be merged into the `digital_twins_endpoint_eventgrid`
...
`azurerm.digital_twins_endpoint_eventgrid.withName` constructs a mixin object that can be merged into the `digital_twins_endpoint_eventgrid`
...
`azurerm.digital_twins_endpoint_eventgrid.withTimeouts` constructs a mixin object that can be merged into the `digital_twins_endpoint_eventgrid`
...
`azurerm.digital_twins_endpoint_eventgrid.withTimeoutsMixin` constructs a mixin object that can be merged into the `digital_twins_endpoint_eventgrid`
Terraform resource block to set or update the timeouts field.
