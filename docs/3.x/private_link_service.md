...
`azurerm.private_link_service.withAutoApprovalSubscriptionIds` constructs a mixin object that can be merged into the `private_link_service`
...
`azurerm.private_link_service.withEnableProxyProtocol` constructs a mixin object that can be merged into the `private_link_service`
...
`azurerm.private_link_service.withFqdns` constructs a mixin object that can be merged into the `private_link_service`
...
`azurerm.private_link_service.withLoadBalancerFrontendIpConfigurationIds` constructs a mixin object that can be merged into the `private_link_service`
...
`azurerm.private_link_service.withLocation` constructs a mixin object that can be merged into the `private_link_service`
...
`azurerm.private_link_service.withNatIpConfiguration` constructs a mixin object that can be merged into the `private_link_service`
...
`azurerm.private_link_service.withNatIpConfigurationMixin` constructs a mixin object that can be merged into the `private_link_service`
Terraform resource block to set or update the nat_ip_configuration field.
...
`azurerm.private_link_service.withTags` constructs a mixin object that can be merged into the `private_link_service`
...
`azurerm.private_link_service.withVisibilitySubscriptionIds` constructs a mixin object that can be merged into the `private_link_service`
