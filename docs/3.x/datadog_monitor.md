...
`azurerm.datadog_monitor.withDatadogOrganization` constructs a mixin object that can be merged into the `datadog_monitor`
...
`azurerm.datadog_monitor.withDatadogOrganizationMixin` constructs a mixin object that can be merged into the `datadog_monitor`
Terraform resource block to set or update the datadog_organization field.
...
`azurerm.datadog_monitor.withIdentity` constructs a mixin object that can be merged into the `datadog_monitor`
...
`azurerm.datadog_monitor.withIdentityMixin` constructs a mixin object that can be merged into the `datadog_monitor`
Terraform resource block to set or update the identity field.
...
`azurerm.datadog_monitor.withLocation` constructs a mixin object that can be merged into the `datadog_monitor`
...
`azurerm.datadog_monitor.withMonitoringEnabled` constructs a mixin object that can be merged into the `datadog_monitor`
...
`azurerm.datadog_monitor.withName` constructs a mixin object that can be merged into the `datadog_monitor`
...
`azurerm.datadog_monitor.withResourceGroupName` constructs a mixin object that can be merged into the `datadog_monitor`
...
`azurerm.datadog_monitor.withSkuName` constructs a mixin object that can be merged into the `datadog_monitor`
...
`azurerm.datadog_monitor.withTags` constructs a mixin object that can be merged into the `datadog_monitor`
...
`azurerm.datadog_monitor.withTimeouts` constructs a mixin object that can be merged into the `datadog_monitor`
...
`azurerm.datadog_monitor.withTimeoutsMixin` constructs a mixin object that can be merged into the `datadog_monitor`
Terraform resource block to set or update the timeouts field.
...
`azurerm.datadog_monitor.withUser` constructs a mixin object that can be merged into the `datadog_monitor`
...
`azurerm.datadog_monitor.withUserMixin` constructs a mixin object that can be merged into the `datadog_monitor`
Terraform resource block to set or update the user field.
