...
`azurerm.eventgrid_domain.withAutoCreateTopicWithFirstSubscription` constructs a mixin object that can be merged into the `eventgrid_domain`
...
`azurerm.eventgrid_domain.withAutoDeleteTopicWithLastSubscription` constructs a mixin object that can be merged into the `eventgrid_domain`
...
`azurerm.eventgrid_domain.withIdentity` constructs a mixin object that can be merged into the `eventgrid_domain`
...
`azurerm.eventgrid_domain.withIdentityMixin` constructs a mixin object that can be merged into the `eventgrid_domain`
Terraform resource block to set or update the identity field.
...
`azurerm.eventgrid_domain.withInputMappingDefaultValues` constructs a mixin object that can be merged into the `eventgrid_domain`
...
`azurerm.eventgrid_domain.withInputMappingDefaultValuesMixin` constructs a mixin object that can be merged into the `eventgrid_domain`
Terraform resource block to set or update the input_mapping_default_values field.
...
`azurerm.eventgrid_domain.withInputMappingFields` constructs a mixin object that can be merged into the `eventgrid_domain`
...
`azurerm.eventgrid_domain.withInputMappingFieldsMixin` constructs a mixin object that can be merged into the `eventgrid_domain`
Terraform resource block to set or update the input_mapping_fields field.
...
`azurerm.eventgrid_domain.withInputSchema` constructs a mixin object that can be merged into the `eventgrid_domain`
...
`azurerm.eventgrid_domain.withLocalAuthEnabled` constructs a mixin object that can be merged into the `eventgrid_domain`
...
`azurerm.eventgrid_domain.withLocation` constructs a mixin object that can be merged into the `eventgrid_domain`
...
`azurerm.eventgrid_domain.withResourceGroupName` constructs a mixin object that can be merged into the `eventgrid_domain`
