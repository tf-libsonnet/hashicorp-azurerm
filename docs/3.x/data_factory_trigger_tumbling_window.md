...
`azurerm.data_factory_trigger_tumbling_window.withActivated` constructs a mixin object that can be merged into the `data_factory_trigger_tumbling_window`
...
`azurerm.data_factory_trigger_tumbling_window.withAdditionalProperties` constructs a mixin object that can be merged into the `data_factory_trigger_tumbling_window`
...
`azurerm.data_factory_trigger_tumbling_window.withAnnotations` constructs a mixin object that can be merged into the `data_factory_trigger_tumbling_window`
...
`azurerm.data_factory_trigger_tumbling_window.withDataFactoryId` constructs a mixin object that can be merged into the `data_factory_trigger_tumbling_window`
...
`azurerm.data_factory_trigger_tumbling_window.withDelay` constructs a mixin object that can be merged into the `data_factory_trigger_tumbling_window`
...
`azurerm.data_factory_trigger_tumbling_window.withDescription` constructs a mixin object that can be merged into the `data_factory_trigger_tumbling_window`
...
`azurerm.data_factory_trigger_tumbling_window.withEndTime` constructs a mixin object that can be merged into the `data_factory_trigger_tumbling_window`
...
`azurerm.data_factory_trigger_tumbling_window.withFrequency` constructs a mixin object that can be merged into the `data_factory_trigger_tumbling_window`
...
`azurerm.data_factory_trigger_tumbling_window.withInterval` constructs a mixin object that can be merged into the `data_factory_trigger_tumbling_window`
...
`azurerm.data_factory_trigger_tumbling_window.withMaxConcurrency` constructs a mixin object that can be merged into the `data_factory_trigger_tumbling_window`
...
`azurerm.data_factory_trigger_tumbling_window.withName` constructs a mixin object that can be merged into the `data_factory_trigger_tumbling_window`
...
`azurerm.data_factory_trigger_tumbling_window.withPipeline` constructs a mixin object that can be merged into the `data_factory_trigger_tumbling_window`
...
`azurerm.data_factory_trigger_tumbling_window.withPipelineMixin` constructs a mixin object that can be merged into the `data_factory_trigger_tumbling_window`
Terraform resource block to set or update the pipeline field.
...
`azurerm.data_factory_trigger_tumbling_window.withRetry` constructs a mixin object that can be merged into the `data_factory_trigger_tumbling_window`
...
`azurerm.data_factory_trigger_tumbling_window.withRetryMixin` constructs a mixin object that can be merged into the `data_factory_trigger_tumbling_window`
Terraform resource block to set or update the retry field.
...
`azurerm.data_factory_trigger_tumbling_window.withStartTime` constructs a mixin object that can be merged into the `data_factory_trigger_tumbling_window`
...
`azurerm.data_factory_trigger_tumbling_window.withTimeouts` constructs a mixin object that can be merged into the `data_factory_trigger_tumbling_window`
...
`azurerm.data_factory_trigger_tumbling_window.withTimeoutsMixin` constructs a mixin object that can be merged into the `data_factory_trigger_tumbling_window`
Terraform resource block to set or update the timeouts field.
...
`azurerm.data_factory_trigger_tumbling_window.withTriggerDependency` constructs a mixin object that can be merged into the `data_factory_trigger_tumbling_window`
...
`azurerm.data_factory_trigger_tumbling_window.withTriggerDependencyMixin` constructs a mixin object that can be merged into the `data_factory_trigger_tumbling_window`
Terraform resource block to set or update the trigger_dependency field.
