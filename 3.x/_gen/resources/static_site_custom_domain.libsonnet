...
{
  '#':: d.pkg(name='static_site_custom_domain', url='', help='`static_site_custom_domain` represents the `azurerm_static_site_custom_domain` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withDomainName':: d.fn(help='`azurerm.static_site_custom_domain.withDomainName` constructs a mixin object that can be merged into the `static_site_custom_domain`\nTerraform resource block to set or update the domain_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `domain_name` field.\n', args=[]),
  ...
  '#withStaticSiteId':: d.fn(help='`azurerm.static_site_custom_domain.withStaticSiteId` constructs a mixin object that can be merged into the `static_site_custom_domain`\nTerraform resource block to set or update the static_site_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `static_site_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.static_site_custom_domain.withTimeouts` constructs a mixin object that can be merged into the `static_site_custom_domain`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.static_site_custom_domain.withTimeoutsMixin` constructs a mixin object that can be merged into the `static_site_custom_domain`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.static_site_custom_domain.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withValidationType':: d.fn(help='`azurerm.static_site_custom_domain.withValidationType` constructs a mixin object that can be merged into the `static_site_custom_domain`\nTerraform resource block to set or update the validation_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `validation_type` field.\n', args=[]),
