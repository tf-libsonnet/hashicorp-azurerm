...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withName':: d.fn(help='`azurerm.spring_cloud_application_live_view.withName` constructs a mixin object that can be merged into the `spring_cloud_application_live_view`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withSpringCloudServiceId':: d.fn(help='`azurerm.spring_cloud_application_live_view.withSpringCloudServiceId` constructs a mixin object that can be merged into the `spring_cloud_application_live_view`\nTerraform resource block to set or update the spring_cloud_service_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `spring_cloud_service_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.spring_cloud_application_live_view.withTimeouts` constructs a mixin object that can be merged into the `spring_cloud_application_live_view`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.spring_cloud_application_live_view.withTimeoutsMixin` constructs a mixin object that can be merged into the `spring_cloud_application_live_view`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.spring_cloud_application_live_view.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
