...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withApplyToDevice':: d.fn(help='`azurerm.iotcentral_application_network_rule_set.withApplyToDevice` constructs a mixin object that can be merged into the `iotcentral_application_network_rule_set`\nTerraform resource block to set or update the apply_to_device field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `apply_to_device` field.\n', args=[]),
  ...
  '#withDefaultAction':: d.fn(help='`azurerm.iotcentral_application_network_rule_set.withDefaultAction` constructs a mixin object that can be merged into the `iotcentral_application_network_rule_set`\nTerraform resource block to set or update the default_action field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `default_action` field.\n', args=[]),
  ...
  '#withIotcentralApplicationId':: d.fn(help='`azurerm.iotcentral_application_network_rule_set.withIotcentralApplicationId` constructs a mixin object that can be merged into the `iotcentral_application_network_rule_set`\nTerraform resource block to set or update the iotcentral_application_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `iotcentral_application_id` field.\n', args=[]),
  ...
  '#withIpRule':: d.fn(help='`azurerm.iotcentral_application_network_rule_set.withIpRule` constructs a mixin object that can be merged into the `iotcentral_application_network_rule_set`\nTerraform resource block to set or update the ip_rule field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ip_rule` field.\n', args=[]),
  ...
  '#withIpRuleMixin':: d.fn(help='`azurerm.iotcentral_application_network_rule_set.withIpRuleMixin` constructs a mixin object that can be merged into the `iotcentral_application_network_rule_set`\nTerraform resource block to set or update the ip_rule field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.iotcentral_application_network_rule_set.withIpRule](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ip_rule` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.iotcentral_application_network_rule_set.withTimeouts` constructs a mixin object that can be merged into the `iotcentral_application_network_rule_set`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.iotcentral_application_network_rule_set.withTimeoutsMixin` constructs a mixin object that can be merged into the `iotcentral_application_network_rule_set`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.iotcentral_application_network_rule_set.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
