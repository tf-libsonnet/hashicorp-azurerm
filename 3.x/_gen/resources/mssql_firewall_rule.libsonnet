...
{
  '#':: d.pkg(name='mssql_firewall_rule', url='', help='`mssql_firewall_rule` represents the `azurerm_mssql_firewall_rule` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withEndIpAddress':: d.fn(help='`azurerm.mssql_firewall_rule.withEndIpAddress` constructs a mixin object that can be merged into the `mssql_firewall_rule`\nTerraform resource block to set or update the end_ip_address field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `end_ip_address` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.mssql_firewall_rule.withName` constructs a mixin object that can be merged into the `mssql_firewall_rule`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withServerId':: d.fn(help='`azurerm.mssql_firewall_rule.withServerId` constructs a mixin object that can be merged into the `mssql_firewall_rule`\nTerraform resource block to set or update the server_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `server_id` field.\n', args=[]),
  ...
  '#withStartIpAddress':: d.fn(help='`azurerm.mssql_firewall_rule.withStartIpAddress` constructs a mixin object that can be merged into the `mssql_firewall_rule`\nTerraform resource block to set or update the start_ip_address field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `start_ip_address` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.mssql_firewall_rule.withTimeouts` constructs a mixin object that can be merged into the `mssql_firewall_rule`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.mssql_firewall_rule.withTimeoutsMixin` constructs a mixin object that can be merged into the `mssql_firewall_rule`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.mssql_firewall_rule.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
