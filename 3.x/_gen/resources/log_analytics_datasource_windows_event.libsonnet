...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withEventLogName':: d.fn(help='`azurerm.log_analytics_datasource_windows_event.withEventLogName` constructs a mixin object that can be merged into the `log_analytics_datasource_windows_event`\nTerraform resource block to set or update the event_log_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `event_log_name` field.\n', args=[]),
  ...
  '#withEventTypes':: d.fn(help='`azurerm.log_analytics_datasource_windows_event.withEventTypes` constructs a mixin object that can be merged into the `log_analytics_datasource_windows_event`\nTerraform resource block to set or update the event_types field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `event_types` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.log_analytics_datasource_windows_event.withName` constructs a mixin object that can be merged into the `log_analytics_datasource_windows_event`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.log_analytics_datasource_windows_event.withResourceGroupName` constructs a mixin object that can be merged into the `log_analytics_datasource_windows_event`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.log_analytics_datasource_windows_event.withTimeouts` constructs a mixin object that can be merged into the `log_analytics_datasource_windows_event`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.log_analytics_datasource_windows_event.withTimeoutsMixin` constructs a mixin object that can be merged into the `log_analytics_datasource_windows_event`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.log_analytics_datasource_windows_event.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withWorkspaceName':: d.fn(help='`azurerm.log_analytics_datasource_windows_event.withWorkspaceName` constructs a mixin object that can be merged into the `log_analytics_datasource_windows_event`\nTerraform resource block to set or update the workspace_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `workspace_name` field.\n', args=[]),
