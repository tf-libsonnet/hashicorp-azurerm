...
{
  '#':: d.pkg(name='palo_alto_next_generation_firewall_virtual_network_local_rulestack', url='', help='`palo_alto_next_generation_firewall_virtual_network_local_rulestack` represents the `azurerm_palo_alto_next_generation_firewall_virtual_network_local_rulestack` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  destination_nat:: {
    backend_config:: {
