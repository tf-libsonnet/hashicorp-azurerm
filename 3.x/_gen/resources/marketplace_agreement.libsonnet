...
{
  '#':: d.pkg(name='marketplace_agreement', url='', help='`marketplace_agreement` represents the `azurerm_marketplace_agreement` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withOffer':: d.fn(help='`azurerm.marketplace_agreement.withOffer` constructs a mixin object that can be merged into the `marketplace_agreement`\nTerraform resource block to set or update the offer field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `offer` field.\n', args=[]),
  ...
  '#withPlan':: d.fn(help='`azurerm.marketplace_agreement.withPlan` constructs a mixin object that can be merged into the `marketplace_agreement`\nTerraform resource block to set or update the plan field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `plan` field.\n', args=[]),
  ...
  '#withPublisher':: d.fn(help='`azurerm.marketplace_agreement.withPublisher` constructs a mixin object that can be merged into the `marketplace_agreement`\nTerraform resource block to set or update the publisher field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `publisher` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.marketplace_agreement.withTimeouts` constructs a mixin object that can be merged into the `marketplace_agreement`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.marketplace_agreement.withTimeoutsMixin` constructs a mixin object that can be merged into the `marketplace_agreement`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.marketplace_agreement.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
