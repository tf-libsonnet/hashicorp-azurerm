...
{
  '#':: d.pkg(name='web_app_active_slot', url='', help='`web_app_active_slot` represents the `azurerm_web_app_active_slot` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withOverwriteNetworkConfig':: d.fn(help='`azurerm.web_app_active_slot.withOverwriteNetworkConfig` constructs a mixin object that can be merged into the `web_app_active_slot`\nTerraform resource block to set or update the overwrite_network_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `overwrite_network_config` field.\n', args=[]),
  ...
  '#withSlotId':: d.fn(help='`azurerm.web_app_active_slot.withSlotId` constructs a mixin object that can be merged into the `web_app_active_slot`\nTerraform resource block to set or update the slot_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `slot_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.web_app_active_slot.withTimeouts` constructs a mixin object that can be merged into the `web_app_active_slot`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.web_app_active_slot.withTimeoutsMixin` constructs a mixin object that can be merged into the `web_app_active_slot`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.web_app_active_slot.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
