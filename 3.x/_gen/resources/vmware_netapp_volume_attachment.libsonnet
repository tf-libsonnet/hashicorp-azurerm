...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withName':: d.fn(help='`azurerm.vmware_netapp_volume_attachment.withName` constructs a mixin object that can be merged into the `vmware_netapp_volume_attachment`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withNetappVolumeId':: d.fn(help='`azurerm.vmware_netapp_volume_attachment.withNetappVolumeId` constructs a mixin object that can be merged into the `vmware_netapp_volume_attachment`\nTerraform resource block to set or update the netapp_volume_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `netapp_volume_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.vmware_netapp_volume_attachment.withTimeouts` constructs a mixin object that can be merged into the `vmware_netapp_volume_attachment`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.vmware_netapp_volume_attachment.withTimeoutsMixin` constructs a mixin object that can be merged into the `vmware_netapp_volume_attachment`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.vmware_netapp_volume_attachment.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withVmwareClusterId':: d.fn(help='`azurerm.vmware_netapp_volume_attachment.withVmwareClusterId` constructs a mixin object that can be merged into the `vmware_netapp_volume_attachment`\nTerraform resource block to set or update the vmware_cluster_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vmware_cluster_id` field.\n', args=[]),
