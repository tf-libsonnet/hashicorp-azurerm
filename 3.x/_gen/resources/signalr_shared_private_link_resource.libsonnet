...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withName':: d.fn(help='`azurerm.signalr_shared_private_link_resource.withName` constructs a mixin object that can be merged into the `signalr_shared_private_link_resource`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withRequestMessage':: d.fn(help='`azurerm.signalr_shared_private_link_resource.withRequestMessage` constructs a mixin object that can be merged into the `signalr_shared_private_link_resource`\nTerraform resource block to set or update the request_message field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `request_message` field.\n', args=[]),
  ...
  '#withSignalrServiceId':: d.fn(help='`azurerm.signalr_shared_private_link_resource.withSignalrServiceId` constructs a mixin object that can be merged into the `signalr_shared_private_link_resource`\nTerraform resource block to set or update the signalr_service_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `signalr_service_id` field.\n', args=[]),
  ...
  '#withSubResourceName':: d.fn(help='`azurerm.signalr_shared_private_link_resource.withSubResourceName` constructs a mixin object that can be merged into the `signalr_shared_private_link_resource`\nTerraform resource block to set or update the sub_resource_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `sub_resource_name` field.\n', args=[]),
  ...
  '#withTargetResourceId':: d.fn(help='`azurerm.signalr_shared_private_link_resource.withTargetResourceId` constructs a mixin object that can be merged into the `signalr_shared_private_link_resource`\nTerraform resource block to set or update the target_resource_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target_resource_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.signalr_shared_private_link_resource.withTimeouts` constructs a mixin object that can be merged into the `signalr_shared_private_link_resource`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.signalr_shared_private_link_resource.withTimeoutsMixin` constructs a mixin object that can be merged into the `signalr_shared_private_link_resource`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.signalr_shared_private_link_resource.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
