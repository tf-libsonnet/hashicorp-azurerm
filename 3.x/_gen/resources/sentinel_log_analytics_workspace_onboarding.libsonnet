...
{
  '#':: d.pkg(name='sentinel_log_analytics_workspace_onboarding', url='', help='`sentinel_log_analytics_workspace_onboarding` represents the `azurerm_sentinel_log_analytics_workspace_onboarding` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
