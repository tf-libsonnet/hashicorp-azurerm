...
{
  '#':: d.pkg(name='arc_kubernetes_flux_configuration', url='', help='`arc_kubernetes_flux_configuration` represents the `azurerm_arc_kubernetes_flux_configuration` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  blob_storage:: {
