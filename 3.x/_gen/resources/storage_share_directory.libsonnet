...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withMetadata':: d.fn(help='`azurerm.storage_share_directory.withMetadata` constructs a mixin object that can be merged into the `storage_share_directory`\nTerraform resource block to set or update the metadata field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `metadata` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.storage_share_directory.withName` constructs a mixin object that can be merged into the `storage_share_directory`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withShareName':: d.fn(help='`azurerm.storage_share_directory.withShareName` constructs a mixin object that can be merged into the `storage_share_directory`\nTerraform resource block to set or update the share_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `share_name` field.\n', args=[]),
  ...
  '#withStorageAccountName':: d.fn(help='`azurerm.storage_share_directory.withStorageAccountName` constructs a mixin object that can be merged into the `storage_share_directory`\nTerraform resource block to set or update the storage_account_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `storage_account_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.storage_share_directory.withTimeouts` constructs a mixin object that can be merged into the `storage_share_directory`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.storage_share_directory.withTimeoutsMixin` constructs a mixin object that can be merged into the `storage_share_directory`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.storage_share_directory.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
