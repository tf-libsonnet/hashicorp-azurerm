...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withGrafanaMajorVersion':: d.fn(help='`azurerm.string.withGrafanaMajorVersion` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the grafana_major_version field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `grafana_major_version` field.\n', args=[]),
  withGrafanaMajorVersion(resourceLabel, value): {
    resource+: {
      azurerm_dashboard_grafana+: {
        [resourceLabel]+: {
          grafana_major_version: value,
        },
      },
    },
  },
