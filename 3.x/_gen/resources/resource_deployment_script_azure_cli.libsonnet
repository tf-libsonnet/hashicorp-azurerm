...
{
  '#':: d.pkg(name='resource_deployment_script_azure_cli', url='', help='`resource_deployment_script_azure_cli` represents the `azurerm_resource_deployment_script_azure_cli` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  container:: {
