...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withName':: d.fn(help='`azurerm.eventhub_namespace_disaster_recovery_config.withName` constructs a mixin object that can be merged into the `eventhub_namespace_disaster_recovery_config`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withNamespaceName':: d.fn(help='`azurerm.eventhub_namespace_disaster_recovery_config.withNamespaceName` constructs a mixin object that can be merged into the `eventhub_namespace_disaster_recovery_config`\nTerraform resource block to set or update the namespace_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `namespace_name` field.\n', args=[]),
  ...
  '#withPartnerNamespaceId':: d.fn(help='`azurerm.eventhub_namespace_disaster_recovery_config.withPartnerNamespaceId` constructs a mixin object that can be merged into the `eventhub_namespace_disaster_recovery_config`\nTerraform resource block to set or update the partner_namespace_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `partner_namespace_id` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.eventhub_namespace_disaster_recovery_config.withResourceGroupName` constructs a mixin object that can be merged into the `eventhub_namespace_disaster_recovery_config`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.eventhub_namespace_disaster_recovery_config.withTimeouts` constructs a mixin object that can be merged into the `eventhub_namespace_disaster_recovery_config`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.eventhub_namespace_disaster_recovery_config.withTimeoutsMixin` constructs a mixin object that can be merged into the `eventhub_namespace_disaster_recovery_config`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.eventhub_namespace_disaster_recovery_config.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
