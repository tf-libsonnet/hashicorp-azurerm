...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withLogzMonitorId':: d.fn(help='`azurerm.logz_tag_rule.withLogzMonitorId` constructs a mixin object that can be merged into the `logz_tag_rule`\nTerraform resource block to set or update the logz_monitor_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `logz_monitor_id` field.\n', args=[]),
  ...
  '#withSendAadLogs':: d.fn(help='`azurerm.logz_tag_rule.withSendAadLogs` constructs a mixin object that can be merged into the `logz_tag_rule`\nTerraform resource block to set or update the send_aad_logs field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `send_aad_logs` field.\n', args=[]),
  ...
  '#withSendActivityLogs':: d.fn(help='`azurerm.logz_tag_rule.withSendActivityLogs` constructs a mixin object that can be merged into the `logz_tag_rule`\nTerraform resource block to set or update the send_activity_logs field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `send_activity_logs` field.\n', args=[]),
  ...
  '#withSendSubscriptionLogs':: d.fn(help='`azurerm.logz_tag_rule.withSendSubscriptionLogs` constructs a mixin object that can be merged into the `logz_tag_rule`\nTerraform resource block to set or update the send_subscription_logs field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `send_subscription_logs` field.\n', args=[]),
  ...
  '#withTagFilter':: d.fn(help='`azurerm.logz_tag_rule.withTagFilter` constructs a mixin object that can be merged into the `logz_tag_rule`\nTerraform resource block to set or update the tag_filter field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tag_filter` field.\n', args=[]),
  ...
  '#withTagFilterMixin':: d.fn(help='`azurerm.logz_tag_rule.withTagFilterMixin` constructs a mixin object that can be merged into the `logz_tag_rule`\nTerraform resource block to set or update the tag_filter field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.logz_tag_rule.withTagFilter](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tag_filter` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.logz_tag_rule.withTimeouts` constructs a mixin object that can be merged into the `logz_tag_rule`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.logz_tag_rule.withTimeoutsMixin` constructs a mixin object that can be merged into the `logz_tag_rule`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.logz_tag_rule.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
