...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withRules':: d.fn(help='`azurerm.storage_blob_inventory_policy.withRules` constructs a mixin object that can be merged into the `storage_blob_inventory_policy`\nTerraform resource block to set or update the rules field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `rules` field.\n', args=[]),
  ...
  '#withRulesMixin':: d.fn(help='`azurerm.storage_blob_inventory_policy.withRulesMixin` constructs a mixin object that can be merged into the `storage_blob_inventory_policy`\nTerraform resource block to set or update the rules field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.storage_blob_inventory_policy.withRules](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `rules` field.\n', args=[]),
  ...
  '#withStorageAccountId':: d.fn(help='`azurerm.storage_blob_inventory_policy.withStorageAccountId` constructs a mixin object that can be merged into the `storage_blob_inventory_policy`\nTerraform resource block to set or update the storage_account_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `storage_account_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.storage_blob_inventory_policy.withTimeouts` constructs a mixin object that can be merged into the `storage_blob_inventory_policy`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.storage_blob_inventory_policy.withTimeoutsMixin` constructs a mixin object that can be merged into the `storage_blob_inventory_policy`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.storage_blob_inventory_policy.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
