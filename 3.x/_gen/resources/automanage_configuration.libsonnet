...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withLogAnalyticsEnabled':: d.fn(help='`azurerm.bool.withLogAnalyticsEnabled` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the log_analytics_enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `log_analytics_enabled` field.\n', args=[]),
  withLogAnalyticsEnabled(resourceLabel, value): {
    resource+: {
      azurerm_automanage_configuration+: {
        [resourceLabel]+: {
          log_analytics_enabled: value,
        },
      },
    },
  },
