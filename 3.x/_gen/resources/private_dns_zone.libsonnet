...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withSoaRecord':: d.fn(help='`azurerm.private_dns_zone.withSoaRecord` constructs a mixin object that can be merged into the `private_dns_zone`\nTerraform resource block to set or update the soa_record field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `soa_record` field.\n', args=[]),
  ...
  '#withSoaRecordMixin':: d.fn(help='`azurerm.private_dns_zone.withSoaRecordMixin` constructs a mixin object that can be merged into the `private_dns_zone`\nTerraform resource block to set or update the soa_record field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.private_dns_zone.withSoaRecord](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `soa_record` field.\n', args=[]),
