...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  new(
    ...
    boot_recovery_group=null,
    failover_recovery_group=null,
    recovery_group=null,
    shutdown_recovery_group=null,
    timeouts=null,
    _meta={}
  ):: tf.withResource(
  ...
  '#withBootRecoveryGroup':: d.fn(help='`azurerm.list[obj].withBootRecoveryGroup` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the boot_recovery_group field.\n\nThis function will replace the array with the passed in `value`. If you wish to instead append the\npassed in value to the existing array, use the [azurerm.list[obj].withBootRecoveryGroupMixin](TODO) function.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `boot_recovery_group` field.\n', args=[]),
  withBootRecoveryGroup(resourceLabel, value): {
    resource+: {
      azurerm_site_recovery_replication_recovery_plan+: {
        [resourceLabel]+: {
          boot_recovery_group: value,
        },
      },
    },
  },
  '#withBootRecoveryGroupMixin':: d.fn(help='`azurerm.list[obj].withBootRecoveryGroupMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the boot_recovery_group field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.list[obj].withBootRecoveryGroup](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `boot_recovery_group` field.\n', args=[]),
  withBootRecoveryGroupMixin(resourceLabel, value): {
    resource+: {
      azurerm_site_recovery_replication_recovery_plan+: {
        [resourceLabel]+: {
          boot_recovery_group+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
  '#withFailoverRecoveryGroup':: d.fn(help='`azurerm.list[obj].withFailoverRecoveryGroup` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the failover_recovery_group field.\n\nThis function will replace the array with the passed in `value`. If you wish to instead append the\npassed in value to the existing array, use the [azurerm.list[obj].withFailoverRecoveryGroupMixin](TODO) function.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `failover_recovery_group` field.\n', args=[]),
  withFailoverRecoveryGroup(resourceLabel, value): {
    resource+: {
      azurerm_site_recovery_replication_recovery_plan+: {
        [resourceLabel]+: {
          failover_recovery_group: value,
        },
      },
    },
  },
  '#withFailoverRecoveryGroupMixin':: d.fn(help='`azurerm.list[obj].withFailoverRecoveryGroupMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the failover_recovery_group field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.list[obj].withFailoverRecoveryGroup](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `failover_recovery_group` field.\n', args=[]),
  withFailoverRecoveryGroupMixin(resourceLabel, value): {
    resource+: {
      azurerm_site_recovery_replication_recovery_plan+: {
        [resourceLabel]+: {
          failover_recovery_group+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
  ...
  '#withShutdownRecoveryGroup':: d.fn(help='`azurerm.list[obj].withShutdownRecoveryGroup` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the shutdown_recovery_group field.\n\nThis function will replace the array with the passed in `value`. If you wish to instead append the\npassed in value to the existing array, use the [azurerm.list[obj].withShutdownRecoveryGroupMixin](TODO) function.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `shutdown_recovery_group` field.\n', args=[]),
  withShutdownRecoveryGroup(resourceLabel, value): {
    resource+: {
      azurerm_site_recovery_replication_recovery_plan+: {
        [resourceLabel]+: {
          shutdown_recovery_group: value,
        },
      },
    },
  },
  '#withShutdownRecoveryGroupMixin':: d.fn(help='`azurerm.list[obj].withShutdownRecoveryGroupMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the shutdown_recovery_group field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.list[obj].withShutdownRecoveryGroup](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `shutdown_recovery_group` field.\n', args=[]),
  withShutdownRecoveryGroupMixin(resourceLabel, value): {
    resource+: {
      azurerm_site_recovery_replication_recovery_plan+: {
        [resourceLabel]+: {
          shutdown_recovery_group+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
