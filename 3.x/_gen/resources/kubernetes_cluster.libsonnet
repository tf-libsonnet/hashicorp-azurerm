...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withSupportPlan':: d.fn(help='`azurerm.string.withSupportPlan` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the support_plan field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `support_plan` field.\n', args=[]),
  withSupportPlan(resourceLabel, value): {
    resource+: {
      azurerm_kubernetes_cluster+: {
        [resourceLabel]+: {
          support_plan: value,
