...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAllowedVmSizes':: d.fn(help='`azurerm.list.withAllowedVmSizes` constructs a mixin object that can be merged into the `list`\nTerraform resource block to set or update the allowed_vm_sizes field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list`): The value to set for the `allowed_vm_sizes` field.\n', args=[]),
  withAllowedVmSizes(resourceLabel, value): {
    resource+: {
      azurerm_proximity_placement_group+: {
        [resourceLabel]+: {
          allowed_vm_sizes: value,
        },
      },
    },
  },
