...
{
  '#':: d.pkg(name='virtual_network_dns_servers', url='', help='`virtual_network_dns_servers` represents the `azurerm_virtual_network_dns_servers` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withDnsServers':: d.fn(help='`azurerm.virtual_network_dns_servers.withDnsServers` constructs a mixin object that can be merged into the `virtual_network_dns_servers`\nTerraform resource block to set or update the dns_servers field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `dns_servers` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.virtual_network_dns_servers.withTimeouts` constructs a mixin object that can be merged into the `virtual_network_dns_servers`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.virtual_network_dns_servers.withTimeoutsMixin` constructs a mixin object that can be merged into the `virtual_network_dns_servers`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.virtual_network_dns_servers.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withVirtualNetworkId':: d.fn(help='`azurerm.virtual_network_dns_servers.withVirtualNetworkId` constructs a mixin object that can be merged into the `virtual_network_dns_servers`\nTerraform resource block to set or update the virtual_network_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `virtual_network_id` field.\n', args=[]),
