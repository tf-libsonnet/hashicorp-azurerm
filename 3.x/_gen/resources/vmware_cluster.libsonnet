...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withClusterNodeCount':: d.fn(help='`azurerm.vmware_cluster.withClusterNodeCount` constructs a mixin object that can be merged into the `vmware_cluster`\nTerraform resource block to set or update the cluster_node_count field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cluster_node_count` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.vmware_cluster.withName` constructs a mixin object that can be merged into the `vmware_cluster`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withSkuName':: d.fn(help='`azurerm.vmware_cluster.withSkuName` constructs a mixin object that can be merged into the `vmware_cluster`\nTerraform resource block to set or update the sku_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `sku_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.vmware_cluster.withTimeouts` constructs a mixin object that can be merged into the `vmware_cluster`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.vmware_cluster.withTimeoutsMixin` constructs a mixin object that can be merged into the `vmware_cluster`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.vmware_cluster.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withVmwareCloudId':: d.fn(help='`azurerm.vmware_cluster.withVmwareCloudId` constructs a mixin object that can be merged into the `vmware_cluster`\nTerraform resource block to set or update the vmware_cloud_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vmware_cloud_id` field.\n', args=[]),
