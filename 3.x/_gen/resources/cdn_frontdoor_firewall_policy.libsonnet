...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  new(
    ...
    managed_rule=null,
    redirect_url=null,
    request_body_check_enabled=null,
    tags=null,
    timeouts=null,
    _meta={}
  ):: tf.withResource(
  ...
  '#withRequestBodyCheckEnabled':: d.fn(help='`azurerm.bool.withRequestBodyCheckEnabled` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the request_body_check_enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `request_body_check_enabled` field.\n', args=[]),
  withRequestBodyCheckEnabled(resourceLabel, value): {
    resource+: {
      azurerm_cdn_frontdoor_firewall_policy+: {
        [resourceLabel]+: {
          request_body_check_enabled: value,
        },
      },
    },
  },
