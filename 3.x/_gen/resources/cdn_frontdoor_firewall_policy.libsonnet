...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  managed_rule:: {
    ...
    '#new':: d.fn(help='\n`azurerm.cdn_frontdoor_firewall_policy.managed_rule.new` constructs a new object with attributes and blocks configured for the `managed_rule`\nTerraform sub block.\n\n\n\n**Args**:\n  - `action` (`string`): \n  - `type` (`string`): \n  - `version` (`string`): \n  - `exclusion` (`list[obj]`):  When `null`, the `exclusion` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.cdn_frontdoor_firewall_policy.managed_rule.exclusion.new](#fn-managed_ruleexclusionnew) constructor.\n  - `override` (`list[obj]`):  When `null`, the `override` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.cdn_frontdoor_firewall_policy.managed_rule.override.new](#fn-managed_ruleoverridenew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `managed_rule` sub block.\n', args=[]),
    new(
      action,
      type,
      version,
    ...
    override:: {
      ...
      '#new':: d.fn(help='\n`azurerm.cdn_frontdoor_firewall_policy.managed_rule.override.new` constructs a new object with attributes and blocks configured for the `override`\nTerraform sub block.\n\n\n\n**Args**:\n  - `rule_group_name` (`string`): \n  - `exclusion` (`list[obj]`):  When `null`, the `exclusion` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.cdn_frontdoor_firewall_policy.managed_rule.override.exclusion.new](#fn-managed_rulemanaged_ruleexclusionnew) constructor.\n  - `rule` (`list[obj]`):  When `null`, the `rule` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.cdn_frontdoor_firewall_policy.managed_rule.override.rule.new](#fn-managed_rulemanaged_rulerulenew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `override` sub block.\n', args=[]),
      new(
        rule_group_name,
        exclusion=null,
        rule=null
