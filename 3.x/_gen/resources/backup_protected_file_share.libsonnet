...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBackupPolicyId':: d.fn(help='`azurerm.backup_protected_file_share.withBackupPolicyId` constructs a mixin object that can be merged into the `backup_protected_file_share`\nTerraform resource block to set or update the backup_policy_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `backup_policy_id` field.\n', args=[]),
  ...
  '#withRecoveryVaultName':: d.fn(help='`azurerm.backup_protected_file_share.withRecoveryVaultName` constructs a mixin object that can be merged into the `backup_protected_file_share`\nTerraform resource block to set or update the recovery_vault_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `recovery_vault_name` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.backup_protected_file_share.withResourceGroupName` constructs a mixin object that can be merged into the `backup_protected_file_share`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withSourceFileShareName':: d.fn(help='`azurerm.backup_protected_file_share.withSourceFileShareName` constructs a mixin object that can be merged into the `backup_protected_file_share`\nTerraform resource block to set or update the source_file_share_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `source_file_share_name` field.\n', args=[]),
  ...
  '#withSourceStorageAccountId':: d.fn(help='`azurerm.backup_protected_file_share.withSourceStorageAccountId` constructs a mixin object that can be merged into the `backup_protected_file_share`\nTerraform resource block to set or update the source_storage_account_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `source_storage_account_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.backup_protected_file_share.withTimeouts` constructs a mixin object that can be merged into the `backup_protected_file_share`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.backup_protected_file_share.withTimeoutsMixin` constructs a mixin object that can be merged into the `backup_protected_file_share`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.backup_protected_file_share.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
