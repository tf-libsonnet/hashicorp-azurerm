...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withApiOperationId':: d.fn(help='`azurerm.api_management_api_operation_tag.withApiOperationId` constructs a mixin object that can be merged into the `api_management_api_operation_tag`\nTerraform resource block to set or update the api_operation_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `api_operation_id` field.\n', args=[]),
  ...
  '#withDisplayName':: d.fn(help='`azurerm.api_management_api_operation_tag.withDisplayName` constructs a mixin object that can be merged into the `api_management_api_operation_tag`\nTerraform resource block to set or update the display_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `display_name` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.api_management_api_operation_tag.withName` constructs a mixin object that can be merged into the `api_management_api_operation_tag`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.api_management_api_operation_tag.withTimeouts` constructs a mixin object that can be merged into the `api_management_api_operation_tag`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.api_management_api_operation_tag.withTimeoutsMixin` constructs a mixin object that can be merged into the `api_management_api_operation_tag`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.api_management_api_operation_tag.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
