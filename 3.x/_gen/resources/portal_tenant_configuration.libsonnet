...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withPrivateMarkdownStorageEnforced':: d.fn(help='`azurerm.portal_tenant_configuration.withPrivateMarkdownStorageEnforced` constructs a mixin object that can be merged into the `portal_tenant_configuration`\nTerraform resource block to set or update the private_markdown_storage_enforced field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `private_markdown_storage_enforced` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.portal_tenant_configuration.withTimeouts` constructs a mixin object that can be merged into the `portal_tenant_configuration`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.portal_tenant_configuration.withTimeoutsMixin` constructs a mixin object that can be merged into the `portal_tenant_configuration`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.portal_tenant_configuration.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
