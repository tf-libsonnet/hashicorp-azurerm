...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withKeyVaultKeyId':: d.fn(help='`azurerm.databricks_workspace_customer_managed_key.withKeyVaultKeyId` constructs a mixin object that can be merged into the `databricks_workspace_customer_managed_key`\nTerraform resource block to set or update the key_vault_key_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `key_vault_key_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.databricks_workspace_customer_managed_key.withTimeouts` constructs a mixin object that can be merged into the `databricks_workspace_customer_managed_key`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.databricks_workspace_customer_managed_key.withTimeoutsMixin` constructs a mixin object that can be merged into the `databricks_workspace_customer_managed_key`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.databricks_workspace_customer_managed_key.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withWorkspaceId':: d.fn(help='`azurerm.databricks_workspace_customer_managed_key.withWorkspaceId` constructs a mixin object that can be merged into the `databricks_workspace_customer_managed_key`\nTerraform resource block to set or update the workspace_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `workspace_id` field.\n', args=[]),
