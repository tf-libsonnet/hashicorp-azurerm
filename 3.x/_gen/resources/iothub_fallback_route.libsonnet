...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCondition':: d.fn(help='`azurerm.iothub_fallback_route.withCondition` constructs a mixin object that can be merged into the `iothub_fallback_route`\nTerraform resource block to set or update the condition field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `condition` field.\n', args=[]),
  ...
  '#withEnabled':: d.fn(help='`azurerm.iothub_fallback_route.withEnabled` constructs a mixin object that can be merged into the `iothub_fallback_route`\nTerraform resource block to set or update the enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enabled` field.\n', args=[]),
  ...
  '#withEndpointNames':: d.fn(help='`azurerm.iothub_fallback_route.withEndpointNames` constructs a mixin object that can be merged into the `iothub_fallback_route`\nTerraform resource block to set or update the endpoint_names field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `endpoint_names` field.\n', args=[]),
  ...
  '#withIothubName':: d.fn(help='`azurerm.iothub_fallback_route.withIothubName` constructs a mixin object that can be merged into the `iothub_fallback_route`\nTerraform resource block to set or update the iothub_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `iothub_name` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.iothub_fallback_route.withResourceGroupName` constructs a mixin object that can be merged into the `iothub_fallback_route`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withSource':: d.fn(help='`azurerm.iothub_fallback_route.withSource` constructs a mixin object that can be merged into the `iothub_fallback_route`\nTerraform resource block to set or update the source field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `source` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.iothub_fallback_route.withTimeouts` constructs a mixin object that can be merged into the `iothub_fallback_route`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.iothub_fallback_route.withTimeoutsMixin` constructs a mixin object that can be merged into the `iothub_fallback_route`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.iothub_fallback_route.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
