...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAdditionalEmailRecipients':: d.fn(help='`azurerm.application_insights_smart_detection_rule.withAdditionalEmailRecipients` constructs a mixin object that can be merged into the `application_insights_smart_detection_rule`\nTerraform resource block to set or update the additional_email_recipients field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `additional_email_recipients` field.\n', args=[]),
  ...
  '#withApplicationInsightsId':: d.fn(help='`azurerm.application_insights_smart_detection_rule.withApplicationInsightsId` constructs a mixin object that can be merged into the `application_insights_smart_detection_rule`\nTerraform resource block to set or update the application_insights_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `application_insights_id` field.\n', args=[]),
  ...
  '#withEnabled':: d.fn(help='`azurerm.application_insights_smart_detection_rule.withEnabled` constructs a mixin object that can be merged into the `application_insights_smart_detection_rule`\nTerraform resource block to set or update the enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enabled` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.application_insights_smart_detection_rule.withName` constructs a mixin object that can be merged into the `application_insights_smart_detection_rule`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withSendEmailsToSubscriptionOwners':: d.fn(help='`azurerm.application_insights_smart_detection_rule.withSendEmailsToSubscriptionOwners` constructs a mixin object that can be merged into the `application_insights_smart_detection_rule`\nTerraform resource block to set or update the send_emails_to_subscription_owners field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `send_emails_to_subscription_owners` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.application_insights_smart_detection_rule.withTimeouts` constructs a mixin object that can be merged into the `application_insights_smart_detection_rule`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.application_insights_smart_detection_rule.withTimeoutsMixin` constructs a mixin object that can be merged into the `application_insights_smart_detection_rule`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.application_insights_smart_detection_rule.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
