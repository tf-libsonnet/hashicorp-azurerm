...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withLogin':: d.fn(help='`azurerm.mysql_active_directory_administrator.withLogin` constructs a mixin object that can be merged into the `mysql_active_directory_administrator`\nTerraform resource block to set or update the login field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `login` field.\n', args=[]),
  ...
  '#withObjectId':: d.fn(help='`azurerm.mysql_active_directory_administrator.withObjectId` constructs a mixin object that can be merged into the `mysql_active_directory_administrator`\nTerraform resource block to set or update the object_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `object_id` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.mysql_active_directory_administrator.withResourceGroupName` constructs a mixin object that can be merged into the `mysql_active_directory_administrator`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withServerName':: d.fn(help='`azurerm.mysql_active_directory_administrator.withServerName` constructs a mixin object that can be merged into the `mysql_active_directory_administrator`\nTerraform resource block to set or update the server_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `server_name` field.\n', args=[]),
  ...
  '#withTenantId':: d.fn(help='`azurerm.mysql_active_directory_administrator.withTenantId` constructs a mixin object that can be merged into the `mysql_active_directory_administrator`\nTerraform resource block to set or update the tenant_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tenant_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.mysql_active_directory_administrator.withTimeouts` constructs a mixin object that can be merged into the `mysql_active_directory_administrator`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.mysql_active_directory_administrator.withTimeoutsMixin` constructs a mixin object that can be merged into the `mysql_active_directory_administrator`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.mysql_active_directory_administrator.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
