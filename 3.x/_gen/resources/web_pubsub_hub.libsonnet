...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAnonymousConnectionsEnabled':: d.fn(help='`azurerm.web_pubsub_hub.withAnonymousConnectionsEnabled` constructs a mixin object that can be merged into the `web_pubsub_hub`\nTerraform resource block to set or update the anonymous_connections_enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `anonymous_connections_enabled` field.\n', args=[]),
  ...
  '#withEventHandler':: d.fn(help='`azurerm.web_pubsub_hub.withEventHandler` constructs a mixin object that can be merged into the `web_pubsub_hub`\nTerraform resource block to set or update the event_handler field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `event_handler` field.\n', args=[]),
  ...
  '#withEventHandlerMixin':: d.fn(help='`azurerm.web_pubsub_hub.withEventHandlerMixin` constructs a mixin object that can be merged into the `web_pubsub_hub`\nTerraform resource block to set or update the event_handler field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.web_pubsub_hub.withEventHandler](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `event_handler` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.web_pubsub_hub.withName` constructs a mixin object that can be merged into the `web_pubsub_hub`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.web_pubsub_hub.withTimeouts` constructs a mixin object that can be merged into the `web_pubsub_hub`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.web_pubsub_hub.withTimeoutsMixin` constructs a mixin object that can be merged into the `web_pubsub_hub`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.web_pubsub_hub.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withWebPubsubId':: d.fn(help='`azurerm.web_pubsub_hub.withWebPubsubId` constructs a mixin object that can be merged into the `web_pubsub_hub`\nTerraform resource block to set or update the web_pubsub_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `web_pubsub_id` field.\n', args=[]),
