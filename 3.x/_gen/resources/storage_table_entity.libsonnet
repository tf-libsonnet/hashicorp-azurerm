...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withEntity':: d.fn(help='`azurerm.storage_table_entity.withEntity` constructs a mixin object that can be merged into the `storage_table_entity`\nTerraform resource block to set or update the entity field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `entity` field.\n', args=[]),
  ...
  '#withPartitionKey':: d.fn(help='`azurerm.storage_table_entity.withPartitionKey` constructs a mixin object that can be merged into the `storage_table_entity`\nTerraform resource block to set or update the partition_key field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `partition_key` field.\n', args=[]),
  ...
  '#withRowKey':: d.fn(help='`azurerm.storage_table_entity.withRowKey` constructs a mixin object that can be merged into the `storage_table_entity`\nTerraform resource block to set or update the row_key field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `row_key` field.\n', args=[]),
  ...
  '#withStorageAccountName':: d.fn(help='`azurerm.storage_table_entity.withStorageAccountName` constructs a mixin object that can be merged into the `storage_table_entity`\nTerraform resource block to set or update the storage_account_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `storage_account_name` field.\n', args=[]),
  ...
  '#withTableName':: d.fn(help='`azurerm.storage_table_entity.withTableName` constructs a mixin object that can be merged into the `storage_table_entity`\nTerraform resource block to set or update the table_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `table_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.storage_table_entity.withTimeouts` constructs a mixin object that can be merged into the `storage_table_entity`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.storage_table_entity.withTimeoutsMixin` constructs a mixin object that can be merged into the `storage_table_entity`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.storage_table_entity.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
