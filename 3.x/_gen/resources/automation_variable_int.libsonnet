...
{
  '#':: d.pkg(name='automation_variable_int', url='', help='`automation_variable_int` represents the `azurerm_automation_variable_int` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withDescription':: d.fn(help='`azurerm.automation_variable_int.withDescription` constructs a mixin object that can be merged into the `automation_variable_int`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withEncrypted':: d.fn(help='`azurerm.automation_variable_int.withEncrypted` constructs a mixin object that can be merged into the `automation_variable_int`\nTerraform resource block to set or update the encrypted field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `encrypted` field.\n', args=[]),
  ...
  '#withValue':: d.fn(help='`azurerm.automation_variable_int.withValue` constructs a mixin object that can be merged into the `automation_variable_int`\nTerraform resource block to set or update the value field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `value` field.\n', args=[]),
