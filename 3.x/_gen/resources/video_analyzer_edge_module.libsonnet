...
{
  '#':: d.pkg(name='video_analyzer_edge_module', url='', help='`video_analyzer_edge_module` represents the `azurerm_video_analyzer_edge_module` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withName':: d.fn(help='`azurerm.video_analyzer_edge_module.withName` constructs a mixin object that can be merged into the `video_analyzer_edge_module`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.video_analyzer_edge_module.withResourceGroupName` constructs a mixin object that can be merged into the `video_analyzer_edge_module`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.video_analyzer_edge_module.withTimeouts` constructs a mixin object that can be merged into the `video_analyzer_edge_module`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.video_analyzer_edge_module.withTimeoutsMixin` constructs a mixin object that can be merged into the `video_analyzer_edge_module`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.video_analyzer_edge_module.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withVideoAnalyzerName':: d.fn(help='`azurerm.video_analyzer_edge_module.withVideoAnalyzerName` constructs a mixin object that can be merged into the `video_analyzer_edge_module`\nTerraform resource block to set or update the video_analyzer_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `video_analyzer_name` field.\n', args=[]),
