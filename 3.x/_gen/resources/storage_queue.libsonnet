...
{
  '#':: d.pkg(name='storage_queue', url='', help='`storage_queue` represents the `azurerm_storage_queue` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withMetadata':: d.fn(help='`azurerm.storage_queue.withMetadata` constructs a mixin object that can be merged into the `storage_queue`\nTerraform resource block to set or update the metadata field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `metadata` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.storage_queue.withName` constructs a mixin object that can be merged into the `storage_queue`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withStorageAccountName':: d.fn(help='`azurerm.storage_queue.withStorageAccountName` constructs a mixin object that can be merged into the `storage_queue`\nTerraform resource block to set or update the storage_account_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `storage_account_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.storage_queue.withTimeouts` constructs a mixin object that can be merged into the `storage_queue`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.storage_queue.withTimeoutsMixin` constructs a mixin object that can be merged into the `storage_queue`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.storage_queue.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
