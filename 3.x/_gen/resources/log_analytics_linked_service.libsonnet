...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withReadAccessId':: d.fn(help='`azurerm.log_analytics_linked_service.withReadAccessId` constructs a mixin object that can be merged into the `log_analytics_linked_service`\nTerraform resource block to set or update the read_access_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `read_access_id` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.log_analytics_linked_service.withResourceGroupName` constructs a mixin object that can be merged into the `log_analytics_linked_service`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.log_analytics_linked_service.withTimeouts` constructs a mixin object that can be merged into the `log_analytics_linked_service`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.log_analytics_linked_service.withTimeoutsMixin` constructs a mixin object that can be merged into the `log_analytics_linked_service`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.log_analytics_linked_service.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withWorkspaceId':: d.fn(help='`azurerm.log_analytics_linked_service.withWorkspaceId` constructs a mixin object that can be merged into the `log_analytics_linked_service`\nTerraform resource block to set or update the workspace_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `workspace_id` field.\n', args=[]),
  ...
  '#withWriteAccessId':: d.fn(help='`azurerm.log_analytics_linked_service.withWriteAccessId` constructs a mixin object that can be merged into the `log_analytics_linked_service`\nTerraform resource block to set or update the write_access_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `write_access_id` field.\n', args=[]),
