...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withRewindWindowDuration':: d.fn(help='`azurerm.string.withRewindWindowDuration` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the rewind_window_duration field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `rewind_window_duration` field.\n', args=[]),
  withRewindWindowDuration(resourceLabel, value): {
    resource+: {
      azurerm_media_live_event_output+: {
        [resourceLabel]+: {
          rewind_window_duration: value,
        },
      },
    },
  },
