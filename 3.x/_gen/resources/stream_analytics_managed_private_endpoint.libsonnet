...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withName':: d.fn(help='`azurerm.stream_analytics_managed_private_endpoint.withName` constructs a mixin object that can be merged into the `stream_analytics_managed_private_endpoint`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.stream_analytics_managed_private_endpoint.withResourceGroupName` constructs a mixin object that can be merged into the `stream_analytics_managed_private_endpoint`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withStreamAnalyticsClusterName':: d.fn(help='`azurerm.stream_analytics_managed_private_endpoint.withStreamAnalyticsClusterName` constructs a mixin object that can be merged into the `stream_analytics_managed_private_endpoint`\nTerraform resource block to set or update the stream_analytics_cluster_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `stream_analytics_cluster_name` field.\n', args=[]),
  ...
  '#withSubresourceName':: d.fn(help='`azurerm.stream_analytics_managed_private_endpoint.withSubresourceName` constructs a mixin object that can be merged into the `stream_analytics_managed_private_endpoint`\nTerraform resource block to set or update the subresource_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `subresource_name` field.\n', args=[]),
  ...
  '#withTargetResourceId':: d.fn(help='`azurerm.stream_analytics_managed_private_endpoint.withTargetResourceId` constructs a mixin object that can be merged into the `stream_analytics_managed_private_endpoint`\nTerraform resource block to set or update the target_resource_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target_resource_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.stream_analytics_managed_private_endpoint.withTimeouts` constructs a mixin object that can be merged into the `stream_analytics_managed_private_endpoint`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.stream_analytics_managed_private_endpoint.withTimeoutsMixin` constructs a mixin object that can be merged into the `stream_analytics_managed_private_endpoint`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.stream_analytics_managed_private_endpoint.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
