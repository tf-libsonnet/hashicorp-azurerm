...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDomainServiceId':: d.fn(help='`azurerm.active_directory_domain_service_replica_set.withDomainServiceId` constructs a mixin object that can be merged into the `active_directory_domain_service_replica_set`\nTerraform resource block to set or update the domain_service_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `domain_service_id` field.\n', args=[]),
  ...
  '#withLocation':: d.fn(help='`azurerm.active_directory_domain_service_replica_set.withLocation` constructs a mixin object that can be merged into the `active_directory_domain_service_replica_set`\nTerraform resource block to set or update the location field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `location` field.\n', args=[]),
  ...
  '#withSubnetId':: d.fn(help='`azurerm.active_directory_domain_service_replica_set.withSubnetId` constructs a mixin object that can be merged into the `active_directory_domain_service_replica_set`\nTerraform resource block to set or update the subnet_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `subnet_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.active_directory_domain_service_replica_set.withTimeouts` constructs a mixin object that can be merged into the `active_directory_domain_service_replica_set`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.active_directory_domain_service_replica_set.withTimeoutsMixin` constructs a mixin object that can be merged into the `active_directory_domain_service_replica_set`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.active_directory_domain_service_replica_set.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
