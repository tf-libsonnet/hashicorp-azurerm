...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCharset':: d.fn(help='`azurerm.mysql_flexible_database.withCharset` constructs a mixin object that can be merged into the `mysql_flexible_database`\nTerraform resource block to set or update the charset field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `charset` field.\n', args=[]),
  ...
  '#withCollation':: d.fn(help='`azurerm.mysql_flexible_database.withCollation` constructs a mixin object that can be merged into the `mysql_flexible_database`\nTerraform resource block to set or update the collation field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `collation` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.mysql_flexible_database.withName` constructs a mixin object that can be merged into the `mysql_flexible_database`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.mysql_flexible_database.withResourceGroupName` constructs a mixin object that can be merged into the `mysql_flexible_database`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withServerName':: d.fn(help='`azurerm.mysql_flexible_database.withServerName` constructs a mixin object that can be merged into the `mysql_flexible_database`\nTerraform resource block to set or update the server_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `server_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.mysql_flexible_database.withTimeouts` constructs a mixin object that can be merged into the `mysql_flexible_database`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.mysql_flexible_database.withTimeoutsMixin` constructs a mixin object that can be merged into the `mysql_flexible_database`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.mysql_flexible_database.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
