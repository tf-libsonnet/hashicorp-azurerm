...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withWorkloadProfileName':: d.fn(help='`azurerm.string.withWorkloadProfileName` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the workload_profile_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `workload_profile_name` field.\n', args=[]),
  withWorkloadProfileName(resourceLabel, value): {
    resource+: {
      azurerm_container_app+: {
        [resourceLabel]+: {
