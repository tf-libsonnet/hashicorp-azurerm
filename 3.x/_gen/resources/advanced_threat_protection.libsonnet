...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withEnabled':: d.fn(help='`azurerm.advanced_threat_protection.withEnabled` constructs a mixin object that can be merged into the `advanced_threat_protection`\nTerraform resource block to set or update the enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enabled` field.\n', args=[]),
  ...
  '#withTargetResourceId':: d.fn(help='`azurerm.advanced_threat_protection.withTargetResourceId` constructs a mixin object that can be merged into the `advanced_threat_protection`\nTerraform resource block to set or update the target_resource_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target_resource_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.advanced_threat_protection.withTimeouts` constructs a mixin object that can be merged into the `advanced_threat_protection`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.advanced_threat_protection.withTimeoutsMixin` constructs a mixin object that can be merged into the `advanced_threat_protection`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.advanced_threat_protection.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
