...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withNatGatewayId':: d.fn(help='`azurerm.nat_gateway_public_ip_association.withNatGatewayId` constructs a mixin object that can be merged into the `nat_gateway_public_ip_association`\nTerraform resource block to set or update the nat_gateway_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `nat_gateway_id` field.\n', args=[]),
  ...
  '#withPublicIpAddressId':: d.fn(help='`azurerm.nat_gateway_public_ip_association.withPublicIpAddressId` constructs a mixin object that can be merged into the `nat_gateway_public_ip_association`\nTerraform resource block to set or update the public_ip_address_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `public_ip_address_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.nat_gateway_public_ip_association.withTimeouts` constructs a mixin object that can be merged into the `nat_gateway_public_ip_association`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.nat_gateway_public_ip_association.withTimeoutsMixin` constructs a mixin object that can be merged into the `nat_gateway_public_ip_association`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.nat_gateway_public_ip_association.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
