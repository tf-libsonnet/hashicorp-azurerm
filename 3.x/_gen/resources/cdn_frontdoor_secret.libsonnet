...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCdnFrontdoorProfileId':: d.fn(help='`azurerm.cdn_frontdoor_secret.withCdnFrontdoorProfileId` constructs a mixin object that can be merged into the `cdn_frontdoor_secret`\nTerraform resource block to set or update the cdn_frontdoor_profile_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cdn_frontdoor_profile_id` field.\n', args=[]),
  ...
  '#withSecret':: d.fn(help='`azurerm.cdn_frontdoor_secret.withSecret` constructs a mixin object that can be merged into the `cdn_frontdoor_secret`\nTerraform resource block to set or update the secret field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `secret` field.\n', args=[]),
  ...
  '#withSecretMixin':: d.fn(help='`azurerm.cdn_frontdoor_secret.withSecretMixin` constructs a mixin object that can be merged into the `cdn_frontdoor_secret`\nTerraform resource block to set or update the secret field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.cdn_frontdoor_secret.withSecret](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `secret` field.\n', args=[]),
