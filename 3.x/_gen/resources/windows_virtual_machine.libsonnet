...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBypassPlatformSafetyChecksOnUserScheduleEnabled':: d.fn(help='`azurerm.bool.withBypassPlatformSafetyChecksOnUserScheduleEnabled` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the bypass_platform_safety_checks_on_user_schedule_enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `bypass_platform_safety_checks_on_user_schedule_enabled` field.\n', args=[]),
  withBypassPlatformSafetyChecksOnUserScheduleEnabled(resourceLabel, value): {
    resource+: {
      azurerm_windows_virtual_machine+: {
        [resourceLabel]+: {
          bypass_platform_safety_checks_on_user_schedule_enabled: value,
        },
      },
    },
  },
  ...
  '#withRebootSetting':: d.fn(help='`azurerm.string.withRebootSetting` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the reboot_setting field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `reboot_setting` field.\n', args=[]),
  withRebootSetting(resourceLabel, value): {
    resource+: {
      azurerm_windows_virtual_machine+: {
        [resourceLabel]+: {
          reboot_setting: value,
        },
      },
    },
  },
