...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDescription':: d.fn(help='`azurerm.automation_variable_string.withDescription` constructs a mixin object that can be merged into the `automation_variable_string`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withEncrypted':: d.fn(help='`azurerm.automation_variable_string.withEncrypted` constructs a mixin object that can be merged into the `automation_variable_string`\nTerraform resource block to set or update the encrypted field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `encrypted` field.\n', args=[]),
  ...
  '#withValue':: d.fn(help='`azurerm.automation_variable_string.withValue` constructs a mixin object that can be merged into the `automation_variable_string`\nTerraform resource block to set or update the value field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `value` field.\n', args=[]),
