...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBotName':: d.fn(help='`azurerm.bot_channel_web_chat.withBotName` constructs a mixin object that can be merged into the `bot_channel_web_chat`\nTerraform resource block to set or update the bot_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `bot_name` field.\n', args=[]),
  ...
  '#withLocation':: d.fn(help='`azurerm.bot_channel_web_chat.withLocation` constructs a mixin object that can be merged into the `bot_channel_web_chat`\nTerraform resource block to set or update the location field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `location` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.bot_channel_web_chat.withResourceGroupName` constructs a mixin object that can be merged into the `bot_channel_web_chat`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withSiteNames':: d.fn(help='`azurerm.bot_channel_web_chat.withSiteNames` constructs a mixin object that can be merged into the `bot_channel_web_chat`\nTerraform resource block to set or update the site_names field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `site_names` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.bot_channel_web_chat.withTimeouts` constructs a mixin object that can be merged into the `bot_channel_web_chat`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.bot_channel_web_chat.withTimeoutsMixin` constructs a mixin object that can be merged into the `bot_channel_web_chat`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.bot_channel_web_chat.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
