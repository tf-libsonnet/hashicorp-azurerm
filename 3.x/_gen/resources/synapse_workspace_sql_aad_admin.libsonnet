...
{
  '#':: d.pkg(name='synapse_workspace_sql_aad_admin', url='', help='`synapse_workspace_sql_aad_admin` represents the `azurerm_synapse_workspace_sql_aad_admin` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withLogin':: d.fn(help='`azurerm.synapse_workspace_sql_aad_admin.withLogin` constructs a mixin object that can be merged into the `synapse_workspace_sql_aad_admin`\nTerraform resource block to set or update the login field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `login` field.\n', args=[]),
  ...
  '#withObjectId':: d.fn(help='`azurerm.synapse_workspace_sql_aad_admin.withObjectId` constructs a mixin object that can be merged into the `synapse_workspace_sql_aad_admin`\nTerraform resource block to set or update the object_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `object_id` field.\n', args=[]),
  ...
  '#withSynapseWorkspaceId':: d.fn(help='`azurerm.synapse_workspace_sql_aad_admin.withSynapseWorkspaceId` constructs a mixin object that can be merged into the `synapse_workspace_sql_aad_admin`\nTerraform resource block to set or update the synapse_workspace_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `synapse_workspace_id` field.\n', args=[]),
  ...
  '#withTenantId':: d.fn(help='`azurerm.synapse_workspace_sql_aad_admin.withTenantId` constructs a mixin object that can be merged into the `synapse_workspace_sql_aad_admin`\nTerraform resource block to set or update the tenant_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tenant_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.synapse_workspace_sql_aad_admin.withTimeouts` constructs a mixin object that can be merged into the `synapse_workspace_sql_aad_admin`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.synapse_workspace_sql_aad_admin.withTimeoutsMixin` constructs a mixin object that can be merged into the `synapse_workspace_sql_aad_admin`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.synapse_workspace_sql_aad_admin.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
