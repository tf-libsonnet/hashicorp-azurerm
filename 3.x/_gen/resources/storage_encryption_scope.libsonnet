...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withInfrastructureEncryptionRequired':: d.fn(help='`azurerm.storage_encryption_scope.withInfrastructureEncryptionRequired` constructs a mixin object that can be merged into the `storage_encryption_scope`\nTerraform resource block to set or update the infrastructure_encryption_required field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `infrastructure_encryption_required` field.\n', args=[]),
  ...
  '#withKeyVaultKeyId':: d.fn(help='`azurerm.storage_encryption_scope.withKeyVaultKeyId` constructs a mixin object that can be merged into the `storage_encryption_scope`\nTerraform resource block to set or update the key_vault_key_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `key_vault_key_id` field.\n', args=[]),
  ...
  '#withSource':: d.fn(help='`azurerm.storage_encryption_scope.withSource` constructs a mixin object that can be merged into the `storage_encryption_scope`\nTerraform resource block to set or update the source field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `source` field.\n', args=[]),
