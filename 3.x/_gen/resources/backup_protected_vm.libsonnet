...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withProtectionState':: d.fn(help='`azurerm.string.withProtectionState` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the protection_state field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `protection_state` field.\n', args=[]),
  withProtectionState(resourceLabel, value): {
    resource+: {
      azurerm_backup_protected_vm+: {
        [resourceLabel]+: {
