...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withKustoDatabaseId':: d.fn(help='`azurerm.data_share_dataset_kusto_database.withKustoDatabaseId` constructs a mixin object that can be merged into the `data_share_dataset_kusto_database`\nTerraform resource block to set or update the kusto_database_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `kusto_database_id` field.\n', args=[]),
