...
{
  '#':: d.pkg(name='private_endpoint_application_security_group_association', url='', help='`private_endpoint_application_security_group_association` represents the `azurerm_private_endpoint_application_security_group_association` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  new(
    ...
    label=resourceLabel,
    attrs=self.newAttrs(application_security_group_id=application_security_group_id, private_endpoint_id=private_endpoint_id, timeouts=timeouts),
    _meta=_meta
  ),
  ...
  withPrivateEndpointId(resourceLabel, value): {
    resource+: {
      azurerm_private_endpoint_application_security_group_association+: {
        [resourceLabel]+: {
