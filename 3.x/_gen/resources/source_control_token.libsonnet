...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withTimeouts':: d.fn(help='`azurerm.source_control_token.withTimeouts` constructs a mixin object that can be merged into the `source_control_token`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.source_control_token.withTimeoutsMixin` constructs a mixin object that can be merged into the `source_control_token`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.source_control_token.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withToken':: d.fn(help='`azurerm.source_control_token.withToken` constructs a mixin object that can be merged into the `source_control_token`\nTerraform resource block to set or update the token field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `token` field.\n', args=[]),
  ...
  '#withTokenSecret':: d.fn(help='`azurerm.source_control_token.withTokenSecret` constructs a mixin object that can be merged into the `source_control_token`\nTerraform resource block to set or update the token_secret field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `token_secret` field.\n', args=[]),
  ...
  '#withType':: d.fn(help='`azurerm.source_control_token.withType` constructs a mixin object that can be merged into the `source_control_token`\nTerraform resource block to set or update the type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `type` field.\n', args=[]),
