...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDatadogMonitorId':: d.fn(help='`azurerm.datadog_monitor_sso_configuration.withDatadogMonitorId` constructs a mixin object that can be merged into the `datadog_monitor_sso_configuration`\nTerraform resource block to set or update the datadog_monitor_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `datadog_monitor_id` field.\n', args=[]),
  ...
  '#withEnterpriseApplicationId':: d.fn(help='`azurerm.datadog_monitor_sso_configuration.withEnterpriseApplicationId` constructs a mixin object that can be merged into the `datadog_monitor_sso_configuration`\nTerraform resource block to set or update the enterprise_application_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enterprise_application_id` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.datadog_monitor_sso_configuration.withName` constructs a mixin object that can be merged into the `datadog_monitor_sso_configuration`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withSingleSignOnEnabled':: d.fn(help='`azurerm.datadog_monitor_sso_configuration.withSingleSignOnEnabled` constructs a mixin object that can be merged into the `datadog_monitor_sso_configuration`\nTerraform resource block to set or update the single_sign_on_enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `single_sign_on_enabled` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.datadog_monitor_sso_configuration.withTimeouts` constructs a mixin object that can be merged into the `datadog_monitor_sso_configuration`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.datadog_monitor_sso_configuration.withTimeoutsMixin` constructs a mixin object that can be merged into the `datadog_monitor_sso_configuration`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.datadog_monitor_sso_configuration.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
