...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withEventhubNamespaceId':: d.fn(help='`azurerm.eventhub_namespace_customer_managed_key.withEventhubNamespaceId` constructs a mixin object that can be merged into the `eventhub_namespace_customer_managed_key`\nTerraform resource block to set or update the eventhub_namespace_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `eventhub_namespace_id` field.\n', args=[]),
  ...
  '#withKeyVaultKeyIds':: d.fn(help='`azurerm.eventhub_namespace_customer_managed_key.withKeyVaultKeyIds` constructs a mixin object that can be merged into the `eventhub_namespace_customer_managed_key`\nTerraform resource block to set or update the key_vault_key_ids field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `key_vault_key_ids` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.eventhub_namespace_customer_managed_key.withTimeouts` constructs a mixin object that can be merged into the `eventhub_namespace_customer_managed_key`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.eventhub_namespace_customer_managed_key.withTimeoutsMixin` constructs a mixin object that can be merged into the `eventhub_namespace_customer_managed_key`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.eventhub_namespace_customer_managed_key.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
