...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBackendAddressIpConfigurationId':: d.fn(help='`azurerm.lb_backend_address_pool_address.withBackendAddressIpConfigurationId` constructs a mixin object that can be merged into the `lb_backend_address_pool_address`\nTerraform resource block to set or update the backend_address_ip_configuration_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `backend_address_ip_configuration_id` field.\n', args=[]),
  ...
  '#withBackendAddressPoolId':: d.fn(help='`azurerm.lb_backend_address_pool_address.withBackendAddressPoolId` constructs a mixin object that can be merged into the `lb_backend_address_pool_address`\nTerraform resource block to set or update the backend_address_pool_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `backend_address_pool_id` field.\n', args=[]),
  ...
  '#withIpAddress':: d.fn(help='`azurerm.lb_backend_address_pool_address.withIpAddress` constructs a mixin object that can be merged into the `lb_backend_address_pool_address`\nTerraform resource block to set or update the ip_address field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ip_address` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.lb_backend_address_pool_address.withName` constructs a mixin object that can be merged into the `lb_backend_address_pool_address`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.lb_backend_address_pool_address.withTimeouts` constructs a mixin object that can be merged into the `lb_backend_address_pool_address`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.lb_backend_address_pool_address.withTimeoutsMixin` constructs a mixin object that can be merged into the `lb_backend_address_pool_address`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.lb_backend_address_pool_address.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withVirtualNetworkId':: d.fn(help='`azurerm.lb_backend_address_pool_address.withVirtualNetworkId` constructs a mixin object that can be merged into the `lb_backend_address_pool_address`\nTerraform resource block to set or update the virtual_network_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `virtual_network_id` field.\n', args=[]),
