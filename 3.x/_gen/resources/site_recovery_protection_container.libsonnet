...
{
  '#':: d.pkg(name='site_recovery_protection_container', url='', help='`site_recovery_protection_container` represents the `azurerm_site_recovery_protection_container` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
