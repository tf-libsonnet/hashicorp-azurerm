...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#new':: d.fn(help="\n`azurerm.virtual_desktop_scaling_plan.new` injects a new `azurerm_virtual_desktop_scaling_plan` Terraform `resource`\nblock into the root module document.\n\nAdditionally, this inserts a private function into the `_ref` attribute that generates references to attributes of the\nresource. For example, if you added a new instance to the root using:\n\n    # arguments omitted for brevity\n    azurerm.virtual_desktop_scaling_plan.new('some_id')\n\nYou can get the reference to the `id` field of the created `azurerm.virtual_desktop_scaling_plan` using the reference:\n\n    $._ref.azurerm_virtual_desktop_scaling_plan.some_id.get('id')\n\nThis is the same as directly entering `\"${ azurerm_virtual_desktop_scaling_plan.some_id.id }\"` as the value.\n\nNOTE: if you are chaining multiple resources together in a merge operation, you may not be able to use `super`, `self`,\nor `$` to refer to the root object. Instead, make an explicit outer object using `local`.\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block.\n  - `description` (`string`):  When `null`, the `description` field will be omitted from the resulting object.\n  - `exclusion_tag` (`string`):  When `null`, the `exclusion_tag` field will be omitted from the resulting object.\n  - `friendly_name` (`string`):  When `null`, the `friendly_name` field will be omitted from the resulting object.\n  - `location` (`string`): \n  - `name` (`string`): \n  - `resource_group_name` (`string`): \n  - `tags` (`obj`):  When `null`, the `tags` field will be omitted from the resulting object.\n  - `time_zone` (`string`): \n  - `host_pool` (`list[obj]`):  When `null`, the `host_pool` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.virtual_desktop_scaling_plan.host_pool.new](#fn-virtualdesktopscalingplanhostpoolnew) constructor.\n  - `schedule` (`list[obj]`):  When `null`, the `schedule` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.virtual_desktop_scaling_plan.schedule.new](#fn-virtualdesktopscalingplanschedulenew) constructor.\n  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.virtual_desktop_scaling_plan.timeouts.new](#fn-virtualdesktopscalingplantimeoutsnew) constructor.\n\n**Returns**:\n- A mixin object that injects the new resource into the root Terraform configuration.\n", args=[]),
  new(
    resourceLabel,
    location,
    name,
  ...
  '#withDescription':: d.fn(help='`azurerm.virtual_desktop_scaling_plan.withDescription` constructs a mixin object that can be merged into the `virtual_desktop_scaling_plan`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withExclusionTag':: d.fn(help='`azurerm.virtual_desktop_scaling_plan.withExclusionTag` constructs a mixin object that can be merged into the `virtual_desktop_scaling_plan`\nTerraform resource block to set or update the exclusion_tag field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `exclusion_tag` field.\n', args=[]),
  ...
  '#withFriendlyName':: d.fn(help='`azurerm.virtual_desktop_scaling_plan.withFriendlyName` constructs a mixin object that can be merged into the `virtual_desktop_scaling_plan`\nTerraform resource block to set or update the friendly_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `friendly_name` field.\n', args=[]),
  ...
  '#withHostPool':: d.fn(help='`azurerm.virtual_desktop_scaling_plan.withHostPool` constructs a mixin object that can be merged into the `virtual_desktop_scaling_plan`\nTerraform resource block to set or update the host_pool field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `host_pool` field.\n', args=[]),
  ...
  '#withHostPoolMixin':: d.fn(help='`azurerm.virtual_desktop_scaling_plan.withHostPoolMixin` constructs a mixin object that can be merged into the `virtual_desktop_scaling_plan`\nTerraform resource block to set or update the host_pool field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.virtual_desktop_scaling_plan.withHostPool](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `host_pool` field.\n', args=[]),
  ...
  '#withLocation':: d.fn(help='`azurerm.virtual_desktop_scaling_plan.withLocation` constructs a mixin object that can be merged into the `virtual_desktop_scaling_plan`\nTerraform resource block to set or update the location field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `location` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.virtual_desktop_scaling_plan.withName` constructs a mixin object that can be merged into the `virtual_desktop_scaling_plan`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.virtual_desktop_scaling_plan.withResourceGroupName` constructs a mixin object that can be merged into the `virtual_desktop_scaling_plan`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withSchedule':: d.fn(help='`azurerm.virtual_desktop_scaling_plan.withSchedule` constructs a mixin object that can be merged into the `virtual_desktop_scaling_plan`\nTerraform resource block to set or update the schedule field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `schedule` field.\n', args=[]),
  ...
  '#withScheduleMixin':: d.fn(help='`azurerm.virtual_desktop_scaling_plan.withScheduleMixin` constructs a mixin object that can be merged into the `virtual_desktop_scaling_plan`\nTerraform resource block to set or update the schedule field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.virtual_desktop_scaling_plan.withSchedule](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `schedule` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`azurerm.virtual_desktop_scaling_plan.withTags` constructs a mixin object that can be merged into the `virtual_desktop_scaling_plan`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTimeZone':: d.fn(help='`azurerm.virtual_desktop_scaling_plan.withTimeZone` constructs a mixin object that can be merged into the `virtual_desktop_scaling_plan`\nTerraform resource block to set or update the time_zone field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `time_zone` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.virtual_desktop_scaling_plan.withTimeouts` constructs a mixin object that can be merged into the `virtual_desktop_scaling_plan`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.virtual_desktop_scaling_plan.withTimeoutsMixin` constructs a mixin object that can be merged into the `virtual_desktop_scaling_plan`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.virtual_desktop_scaling_plan.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
