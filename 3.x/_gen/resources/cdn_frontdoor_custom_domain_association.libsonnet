...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCdnFrontdoorCustomDomainId':: d.fn(help='`azurerm.cdn_frontdoor_custom_domain_association.withCdnFrontdoorCustomDomainId` constructs a mixin object that can be merged into the `cdn_frontdoor_custom_domain_association`\nTerraform resource block to set or update the cdn_frontdoor_custom_domain_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cdn_frontdoor_custom_domain_id` field.\n', args=[]),
  ...
  '#withCdnFrontdoorRouteIds':: d.fn(help='`azurerm.cdn_frontdoor_custom_domain_association.withCdnFrontdoorRouteIds` constructs a mixin object that can be merged into the `cdn_frontdoor_custom_domain_association`\nTerraform resource block to set or update the cdn_frontdoor_route_ids field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cdn_frontdoor_route_ids` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.cdn_frontdoor_custom_domain_association.withTimeouts` constructs a mixin object that can be merged into the `cdn_frontdoor_custom_domain_association`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.cdn_frontdoor_custom_domain_association.withTimeoutsMixin` constructs a mixin object that can be merged into the `cdn_frontdoor_custom_domain_association`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.cdn_frontdoor_custom_domain_association.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
