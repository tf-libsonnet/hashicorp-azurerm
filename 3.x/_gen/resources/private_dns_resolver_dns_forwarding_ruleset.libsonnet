...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withPrivateDnsResolverOutboundEndpointIds':: d.fn(help='`azurerm.list.withPrivateDnsResolverOutboundEndpointIds` constructs a mixin object that can be merged into the `list`\nTerraform resource block to set or update the private_dns_resolver_outbound_endpoint_ids field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list`): The value to set for the `private_dns_resolver_outbound_endpoint_ids` field.\n', args=[]),
