...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCertificateName':: d.fn(help='`azurerm.spring_cloud_custom_domain.withCertificateName` constructs a mixin object that can be merged into the `spring_cloud_custom_domain`\nTerraform resource block to set or update the certificate_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `certificate_name` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.spring_cloud_custom_domain.withName` constructs a mixin object that can be merged into the `spring_cloud_custom_domain`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withSpringCloudAppId':: d.fn(help='`azurerm.spring_cloud_custom_domain.withSpringCloudAppId` constructs a mixin object that can be merged into the `spring_cloud_custom_domain`\nTerraform resource block to set or update the spring_cloud_app_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `spring_cloud_app_id` field.\n', args=[]),
  ...
  '#withThumbprint':: d.fn(help='`azurerm.spring_cloud_custom_domain.withThumbprint` constructs a mixin object that can be merged into the `spring_cloud_custom_domain`\nTerraform resource block to set or update the thumbprint field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `thumbprint` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.spring_cloud_custom_domain.withTimeouts` constructs a mixin object that can be merged into the `spring_cloud_custom_domain`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.spring_cloud_custom_domain.withTimeoutsMixin` constructs a mixin object that can be merged into the `spring_cloud_custom_domain`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.spring_cloud_custom_domain.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
