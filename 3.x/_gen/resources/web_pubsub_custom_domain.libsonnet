...
{
  '#':: d.pkg(name='web_pubsub_custom_domain', url='', help='`web_pubsub_custom_domain` represents the `azurerm_web_pubsub_custom_domain` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withWebPubsubCustomCertificateId':: d.fn(help='`azurerm.string.withWebPubsubCustomCertificateId` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the web_pubsub_custom_certificate_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `web_pubsub_custom_certificate_id` field.\n', args=[]),
  withWebPubsubCustomCertificateId(resourceLabel, value): {
    resource+: {
      azurerm_web_pubsub_custom_domain+: {
        [resourceLabel]+: {
          web_pubsub_custom_certificate_id: value,
        },
      },
    },
  },
