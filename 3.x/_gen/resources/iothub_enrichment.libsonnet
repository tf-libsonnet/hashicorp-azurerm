...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withEndpointNames':: d.fn(help='`azurerm.iothub_enrichment.withEndpointNames` constructs a mixin object that can be merged into the `iothub_enrichment`\nTerraform resource block to set or update the endpoint_names field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `endpoint_names` field.\n', args=[]),
  ...
  '#withIothubName':: d.fn(help='`azurerm.iothub_enrichment.withIothubName` constructs a mixin object that can be merged into the `iothub_enrichment`\nTerraform resource block to set or update the iothub_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `iothub_name` field.\n', args=[]),
  ...
  '#withKey':: d.fn(help='`azurerm.iothub_enrichment.withKey` constructs a mixin object that can be merged into the `iothub_enrichment`\nTerraform resource block to set or update the key field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `key` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.iothub_enrichment.withResourceGroupName` constructs a mixin object that can be merged into the `iothub_enrichment`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.iothub_enrichment.withTimeouts` constructs a mixin object that can be merged into the `iothub_enrichment`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.iothub_enrichment.withTimeoutsMixin` constructs a mixin object that can be merged into the `iothub_enrichment`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.iothub_enrichment.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withValue':: d.fn(help='`azurerm.iothub_enrichment.withValue` constructs a mixin object that can be merged into the `iothub_enrichment`\nTerraform resource block to set or update the value field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `value` field.\n', args=[]),
