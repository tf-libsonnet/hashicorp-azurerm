...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withListen':: d.fn(help='`azurerm.servicebus_queue_authorization_rule.withListen` constructs a mixin object that can be merged into the `servicebus_queue_authorization_rule`\nTerraform resource block to set or update the listen field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `listen` field.\n', args=[]),
  ...
  '#withManage':: d.fn(help='`azurerm.servicebus_queue_authorization_rule.withManage` constructs a mixin object that can be merged into the `servicebus_queue_authorization_rule`\nTerraform resource block to set or update the manage field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `manage` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.servicebus_queue_authorization_rule.withName` constructs a mixin object that can be merged into the `servicebus_queue_authorization_rule`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withQueueId':: d.fn(help='`azurerm.servicebus_queue_authorization_rule.withQueueId` constructs a mixin object that can be merged into the `servicebus_queue_authorization_rule`\nTerraform resource block to set or update the queue_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `queue_id` field.\n', args=[]),
  ...
  '#withSend':: d.fn(help='`azurerm.servicebus_queue_authorization_rule.withSend` constructs a mixin object that can be merged into the `servicebus_queue_authorization_rule`\nTerraform resource block to set or update the send field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `send` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.servicebus_queue_authorization_rule.withTimeouts` constructs a mixin object that can be merged into the `servicebus_queue_authorization_rule`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.servicebus_queue_authorization_rule.withTimeoutsMixin` constructs a mixin object that can be merged into the `servicebus_queue_authorization_rule`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.servicebus_queue_authorization_rule.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
