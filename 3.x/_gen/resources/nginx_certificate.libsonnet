...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCertificateVirtualPath':: d.fn(help='`azurerm.nginx_certificate.withCertificateVirtualPath` constructs a mixin object that can be merged into the `nginx_certificate`\nTerraform resource block to set or update the certificate_virtual_path field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `certificate_virtual_path` field.\n', args=[]),
  ...
  '#withKeyVaultSecretId':: d.fn(help='`azurerm.nginx_certificate.withKeyVaultSecretId` constructs a mixin object that can be merged into the `nginx_certificate`\nTerraform resource block to set or update the key_vault_secret_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `key_vault_secret_id` field.\n', args=[]),
  ...
  '#withKeyVirtualPath':: d.fn(help='`azurerm.nginx_certificate.withKeyVirtualPath` constructs a mixin object that can be merged into the `nginx_certificate`\nTerraform resource block to set or update the key_virtual_path field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `key_virtual_path` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.nginx_certificate.withName` constructs a mixin object that can be merged into the `nginx_certificate`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withNginxDeploymentId':: d.fn(help='`azurerm.nginx_certificate.withNginxDeploymentId` constructs a mixin object that can be merged into the `nginx_certificate`\nTerraform resource block to set or update the nginx_deployment_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `nginx_deployment_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.nginx_certificate.withTimeouts` constructs a mixin object that can be merged into the `nginx_certificate`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.nginx_certificate.withTimeoutsMixin` constructs a mixin object that can be merged into the `nginx_certificate`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.nginx_certificate.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
