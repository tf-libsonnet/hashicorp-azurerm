...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDiskPoolId':: d.fn(help='`azurerm.disk_pool_managed_disk_attachment.withDiskPoolId` constructs a mixin object that can be merged into the `disk_pool_managed_disk_attachment`\nTerraform resource block to set or update the disk_pool_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `disk_pool_id` field.\n', args=[]),
  ...
  '#withManagedDiskId':: d.fn(help='`azurerm.disk_pool_managed_disk_attachment.withManagedDiskId` constructs a mixin object that can be merged into the `disk_pool_managed_disk_attachment`\nTerraform resource block to set or update the managed_disk_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `managed_disk_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.disk_pool_managed_disk_attachment.withTimeouts` constructs a mixin object that can be merged into the `disk_pool_managed_disk_attachment`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.disk_pool_managed_disk_attachment.withTimeoutsMixin` constructs a mixin object that can be merged into the `disk_pool_managed_disk_attachment`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.disk_pool_managed_disk_attachment.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
