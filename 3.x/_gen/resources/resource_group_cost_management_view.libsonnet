...
{
  '#':: d.pkg(name='resource_group_cost_management_view', url='', help='`resource_group_cost_management_view` represents the `azurerm_resource_group_cost_management_view` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  dataset:: {
    aggregation:: {
