...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withContainer':: d.fn(help='`azurerm.media_asset.withContainer` constructs a mixin object that can be merged into the `media_asset`\nTerraform resource block to set or update the container field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `container` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`azurerm.media_asset.withDescription` constructs a mixin object that can be merged into the `media_asset`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withMediaServicesAccountName':: d.fn(help='`azurerm.media_asset.withMediaServicesAccountName` constructs a mixin object that can be merged into the `media_asset`\nTerraform resource block to set or update the media_services_account_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `media_services_account_name` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.media_asset.withName` constructs a mixin object that can be merged into the `media_asset`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.media_asset.withResourceGroupName` constructs a mixin object that can be merged into the `media_asset`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withStorageAccountName':: d.fn(help='`azurerm.media_asset.withStorageAccountName` constructs a mixin object that can be merged into the `media_asset`\nTerraform resource block to set or update the storage_account_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `storage_account_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.media_asset.withTimeouts` constructs a mixin object that can be merged into the `media_asset`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.media_asset.withTimeoutsMixin` constructs a mixin object that can be merged into the `media_asset`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.media_asset.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
