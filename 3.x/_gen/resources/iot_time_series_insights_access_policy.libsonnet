...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDescription':: d.fn(help='`azurerm.iot_time_series_insights_access_policy.withDescription` constructs a mixin object that can be merged into the `iot_time_series_insights_access_policy`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.iot_time_series_insights_access_policy.withName` constructs a mixin object that can be merged into the `iot_time_series_insights_access_policy`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withPrincipalObjectId':: d.fn(help='`azurerm.iot_time_series_insights_access_policy.withPrincipalObjectId` constructs a mixin object that can be merged into the `iot_time_series_insights_access_policy`\nTerraform resource block to set or update the principal_object_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `principal_object_id` field.\n', args=[]),
  ...
  '#withRoles':: d.fn(help='`azurerm.iot_time_series_insights_access_policy.withRoles` constructs a mixin object that can be merged into the `iot_time_series_insights_access_policy`\nTerraform resource block to set or update the roles field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `roles` field.\n', args=[]),
  ...
  '#withTimeSeriesInsightsEnvironmentId':: d.fn(help='`azurerm.iot_time_series_insights_access_policy.withTimeSeriesInsightsEnvironmentId` constructs a mixin object that can be merged into the `iot_time_series_insights_access_policy`\nTerraform resource block to set or update the time_series_insights_environment_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `time_series_insights_environment_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.iot_time_series_insights_access_policy.withTimeouts` constructs a mixin object that can be merged into the `iot_time_series_insights_access_policy`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.iot_time_series_insights_access_policy.withTimeoutsMixin` constructs a mixin object that can be merged into the `iot_time_series_insights_access_policy`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.iot_time_series_insights_access_policy.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
