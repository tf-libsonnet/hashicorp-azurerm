...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  new(
    ...
    label=resourceLabel,
    attrs=self.newAttrs(name=name, private_cloud_id=private_cloud_id, timeouts=timeouts),
    _meta=_meta
  ),
  '#newAttrs':: d.fn(help='\n`azurerm.vmware_express_route_authorization.newAttrs` constructs a new object with attributes and blocks configured for the `vmware_express_route_authorization`\nTerraform resource.\n\nUnlike [azurerm.vmware_express_route_authorization.new](#fn-new), this function will not inject the `resource`\nblock into the root Terraform document. Instead, this must be passed in as the `attrs` argument for the\n[tf.withResource](https://github.com/tf-libsonnet/core/tree/main/docs#fn-withresource) function to build a complete block.\n\nThis is most useful when you need to preprocess the attributes with functions, conditional, or looping logic prior to\ninjecting into a complete block.\n\n**Args**:\n  - `name` (`string`): Set the `name` field on the resulting object.\n  - `private_cloud_id` (`string`): Set the `private_cloud_id` field on the resulting object.\n  - `timeouts` (`obj`): Set the `timeouts` field on the resulting object. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.vmware_express_route_authorization.timeouts.new](#fn-timeoutsnew) constructor.\n\n**Returns**:\n  - An attribute object that can be used with [tf.withResource](https://github.com/tf-libsonnet/core/tree/main/docs#fn-withresource) to construct a new `vmware_express_route_authorization` resource into the root Terraform configuration.\n', args=[]),
  newAttrs(
    name,
    private_cloud_id,
    timeouts=null
  ...
  '#withPrivateCloudId':: d.fn(help='`azurerm.string.withPrivateCloudId` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the private_cloud_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `private_cloud_id` field.\n', args=[]),
