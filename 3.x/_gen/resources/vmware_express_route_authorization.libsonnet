...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withName':: d.fn(help='`azurerm.vmware_express_route_authorization.withName` constructs a mixin object that can be merged into the `vmware_express_route_authorization`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withPrivateCloudId':: d.fn(help='`azurerm.vmware_express_route_authorization.withPrivateCloudId` constructs a mixin object that can be merged into the `vmware_express_route_authorization`\nTerraform resource block to set or update the private_cloud_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `private_cloud_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.vmware_express_route_authorization.withTimeouts` constructs a mixin object that can be merged into the `vmware_express_route_authorization`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.vmware_express_route_authorization.withTimeoutsMixin` constructs a mixin object that can be merged into the `vmware_express_route_authorization`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.vmware_express_route_authorization.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
