...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAllowedCopyScope':: d.fn(help='`azurerm.string.withAllowedCopyScope` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the allowed_copy_scope field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `allowed_copy_scope` field.\n', args=[]),
  withAllowedCopyScope(resourceLabel, value): {
    resource+: {
      azurerm_storage_account+: {
        [resourceLabel]+: {
          allowed_copy_scope: value,
        },
      },
    },
  },
