...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withFileShareName':: d.fn(help='`azurerm.storage_sync_cloud_endpoint.withFileShareName` constructs a mixin object that can be merged into the `storage_sync_cloud_endpoint`\nTerraform resource block to set or update the file_share_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `file_share_name` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.storage_sync_cloud_endpoint.withName` constructs a mixin object that can be merged into the `storage_sync_cloud_endpoint`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withStorageAccountId':: d.fn(help='`azurerm.storage_sync_cloud_endpoint.withStorageAccountId` constructs a mixin object that can be merged into the `storage_sync_cloud_endpoint`\nTerraform resource block to set or update the storage_account_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `storage_account_id` field.\n', args=[]),
  ...
  '#withStorageAccountTenantId':: d.fn(help='`azurerm.storage_sync_cloud_endpoint.withStorageAccountTenantId` constructs a mixin object that can be merged into the `storage_sync_cloud_endpoint`\nTerraform resource block to set or update the storage_account_tenant_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `storage_account_tenant_id` field.\n', args=[]),
  ...
  '#withStorageSyncGroupId':: d.fn(help='`azurerm.storage_sync_cloud_endpoint.withStorageSyncGroupId` constructs a mixin object that can be merged into the `storage_sync_cloud_endpoint`\nTerraform resource block to set or update the storage_sync_group_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `storage_sync_group_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.storage_sync_cloud_endpoint.withTimeouts` constructs a mixin object that can be merged into the `storage_sync_cloud_endpoint`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.storage_sync_cloud_endpoint.withTimeoutsMixin` constructs a mixin object that can be merged into the `storage_sync_cloud_endpoint`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.storage_sync_cloud_endpoint.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
