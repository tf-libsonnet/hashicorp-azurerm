...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withPrefixList':: d.fn(help='`azurerm.list.withPrefixList` constructs a mixin object that can be merged into the `list`\nTerraform resource block to set or update the prefix_list field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list`): The value to set for the `prefix_list` field.\n', args=[]),
  withPrefixList(resourceLabel, value): {
    resource+: {
      azurerm_palo_alto_local_rulestack_prefix_list+: {
        [resourceLabel]+: {
          prefix_list: value,
