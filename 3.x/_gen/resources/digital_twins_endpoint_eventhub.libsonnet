...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDeadLetterStorageSecret':: d.fn(help='`azurerm.digital_twins_endpoint_eventhub.withDeadLetterStorageSecret` constructs a mixin object that can be merged into the `digital_twins_endpoint_eventhub`\nTerraform resource block to set or update the dead_letter_storage_secret field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `dead_letter_storage_secret` field.\n', args=[]),
  ...
  '#withDigitalTwinsId':: d.fn(help='`azurerm.digital_twins_endpoint_eventhub.withDigitalTwinsId` constructs a mixin object that can be merged into the `digital_twins_endpoint_eventhub`\nTerraform resource block to set or update the digital_twins_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `digital_twins_id` field.\n', args=[]),
  ...
  '#withEventhubPrimaryConnectionString':: d.fn(help='`azurerm.digital_twins_endpoint_eventhub.withEventhubPrimaryConnectionString` constructs a mixin object that can be merged into the `digital_twins_endpoint_eventhub`\nTerraform resource block to set or update the eventhub_primary_connection_string field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `eventhub_primary_connection_string` field.\n', args=[]),
  ...
  '#withEventhubSecondaryConnectionString':: d.fn(help='`azurerm.digital_twins_endpoint_eventhub.withEventhubSecondaryConnectionString` constructs a mixin object that can be merged into the `digital_twins_endpoint_eventhub`\nTerraform resource block to set or update the eventhub_secondary_connection_string field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `eventhub_secondary_connection_string` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.digital_twins_endpoint_eventhub.withName` constructs a mixin object that can be merged into the `digital_twins_endpoint_eventhub`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.digital_twins_endpoint_eventhub.withTimeouts` constructs a mixin object that can be merged into the `digital_twins_endpoint_eventhub`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.digital_twins_endpoint_eventhub.withTimeoutsMixin` constructs a mixin object that can be merged into the `digital_twins_endpoint_eventhub`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.digital_twins_endpoint_eventhub.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
