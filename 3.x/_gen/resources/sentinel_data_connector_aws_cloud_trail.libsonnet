...
{
  '#':: d.pkg(name='sentinel_data_connector_aws_cloud_trail', url='', help='`sentinel_data_connector_aws_cloud_trail` represents the `azurerm_sentinel_data_connector_aws_cloud_trail` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withAwsRoleArn':: d.fn(help='`azurerm.sentinel_data_connector_aws_cloud_trail.withAwsRoleArn` constructs a mixin object that can be merged into the `sentinel_data_connector_aws_cloud_trail`\nTerraform resource block to set or update the aws_role_arn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `aws_role_arn` field.\n', args=[]),
  ...
  '#withLogAnalyticsWorkspaceId':: d.fn(help='`azurerm.sentinel_data_connector_aws_cloud_trail.withLogAnalyticsWorkspaceId` constructs a mixin object that can be merged into the `sentinel_data_connector_aws_cloud_trail`\nTerraform resource block to set or update the log_analytics_workspace_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `log_analytics_workspace_id` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.sentinel_data_connector_aws_cloud_trail.withName` constructs a mixin object that can be merged into the `sentinel_data_connector_aws_cloud_trail`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.sentinel_data_connector_aws_cloud_trail.withTimeouts` constructs a mixin object that can be merged into the `sentinel_data_connector_aws_cloud_trail`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.sentinel_data_connector_aws_cloud_trail.withTimeoutsMixin` constructs a mixin object that can be merged into the `sentinel_data_connector_aws_cloud_trail`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.sentinel_data_connector_aws_cloud_trail.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
