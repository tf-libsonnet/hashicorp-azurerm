...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withLinkedRedisCacheId':: d.fn(help='`azurerm.redis_linked_server.withLinkedRedisCacheId` constructs a mixin object that can be merged into the `redis_linked_server`\nTerraform resource block to set or update the linked_redis_cache_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `linked_redis_cache_id` field.\n', args=[]),
  ...
  '#withLinkedRedisCacheLocation':: d.fn(help='`azurerm.redis_linked_server.withLinkedRedisCacheLocation` constructs a mixin object that can be merged into the `redis_linked_server`\nTerraform resource block to set or update the linked_redis_cache_location field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `linked_redis_cache_location` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.redis_linked_server.withResourceGroupName` constructs a mixin object that can be merged into the `redis_linked_server`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withServerRole':: d.fn(help='`azurerm.redis_linked_server.withServerRole` constructs a mixin object that can be merged into the `redis_linked_server`\nTerraform resource block to set or update the server_role field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `server_role` field.\n', args=[]),
  ...
  '#withTargetRedisCacheName':: d.fn(help='`azurerm.redis_linked_server.withTargetRedisCacheName` constructs a mixin object that can be merged into the `redis_linked_server`\nTerraform resource block to set or update the target_redis_cache_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target_redis_cache_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.redis_linked_server.withTimeouts` constructs a mixin object that can be merged into the `redis_linked_server`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.redis_linked_server.withTimeoutsMixin` constructs a mixin object that can be merged into the `redis_linked_server`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.redis_linked_server.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
