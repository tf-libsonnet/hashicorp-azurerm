...
{
  '#':: d.pkg(name='netapp_account_encryption', url='', help='`netapp_account_encryption` represents the `azurerm_netapp_account_encryption` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  withNetappAccountId(resourceLabel, value): {
    resource+: {
      azurerm_netapp_account_encryption+: {
        [resourceLabel]+: {
  ...
  withSystemAssignedIdentityPrincipalId(resourceLabel, value): {
    resource+: {
      azurerm_netapp_account_encryption+: {
        [resourceLabel]+: {
