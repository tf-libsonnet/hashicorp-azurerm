...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAppServiceName':: d.fn(help='`azurerm.app_service_active_slot.withAppServiceName` constructs a mixin object that can be merged into the `app_service_active_slot`\nTerraform resource block to set or update the app_service_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `app_service_name` field.\n', args=[]),
  ...
  '#withAppServiceSlotName':: d.fn(help='`azurerm.app_service_active_slot.withAppServiceSlotName` constructs a mixin object that can be merged into the `app_service_active_slot`\nTerraform resource block to set or update the app_service_slot_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `app_service_slot_name` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.app_service_active_slot.withResourceGroupName` constructs a mixin object that can be merged into the `app_service_active_slot`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.app_service_active_slot.withTimeouts` constructs a mixin object that can be merged into the `app_service_active_slot`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.app_service_active_slot.withTimeoutsMixin` constructs a mixin object that can be merged into the `app_service_active_slot`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.app_service_active_slot.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
