...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  new(
    ...
    https_only=null,
    instance_count=null,
    local_response_cache_per_instance=null,
    local_response_cache_per_route=null,
  ...
  '#withLocalResponseCachePerInstance':: d.fn(help='`azurerm.list[obj].withLocalResponseCachePerInstance` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the local_response_cache_per_instance field.\n\nThis function will replace the array with the passed in `value`. If you wish to instead append the\npassed in value to the existing array, use the [azurerm.list[obj].withLocalResponseCachePerInstanceMixin](TODO) function.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `local_response_cache_per_instance` field.\n', args=[]),
  withLocalResponseCachePerInstance(resourceLabel, value): {
    resource+: {
      azurerm_spring_cloud_gateway+: {
        [resourceLabel]+: {
          local_response_cache_per_instance: value,
        },
      },
    },
  },
  '#withLocalResponseCachePerInstanceMixin':: d.fn(help='`azurerm.list[obj].withLocalResponseCachePerInstanceMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the local_response_cache_per_instance field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.list[obj].withLocalResponseCachePerInstance](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `local_response_cache_per_instance` field.\n', args=[]),
  withLocalResponseCachePerInstanceMixin(resourceLabel, value): {
    resource+: {
      azurerm_spring_cloud_gateway+: {
        [resourceLabel]+: {
          local_response_cache_per_instance+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
  '#withLocalResponseCachePerRoute':: d.fn(help='`azurerm.list[obj].withLocalResponseCachePerRoute` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the local_response_cache_per_route field.\n\nThis function will replace the array with the passed in `value`. If you wish to instead append the\npassed in value to the existing array, use the [azurerm.list[obj].withLocalResponseCachePerRouteMixin](TODO) function.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `local_response_cache_per_route` field.\n', args=[]),
  withLocalResponseCachePerRoute(resourceLabel, value): {
    resource+: {
      azurerm_spring_cloud_gateway+: {
        [resourceLabel]+: {
          local_response_cache_per_route: value,
        },
      },
    },
  },
  '#withLocalResponseCachePerRouteMixin':: d.fn(help='`azurerm.list[obj].withLocalResponseCachePerRouteMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the local_response_cache_per_route field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.list[obj].withLocalResponseCachePerRoute](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `local_response_cache_per_route` field.\n', args=[]),
  withLocalResponseCachePerRouteMixin(resourceLabel, value): {
    resource+: {
      azurerm_spring_cloud_gateway+: {
        [resourceLabel]+: {
          local_response_cache_per_route+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
