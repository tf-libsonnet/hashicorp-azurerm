...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDatabaseCredentialKeyVaultSecretId':: d.fn(help='`azurerm.string.withDatabaseCredentialKeyVaultSecretId` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the database_credential_key_vault_secret_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `database_credential_key_vault_secret_id` field.\n', args=[]),
