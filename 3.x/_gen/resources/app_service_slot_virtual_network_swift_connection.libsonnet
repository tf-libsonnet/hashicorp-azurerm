...
{
  '#':: d.pkg(name='app_service_slot_virtual_network_swift_connection', url='', help='`app_service_slot_virtual_network_swift_connection` represents the `azurerm_app_service_slot_virtual_network_swift_connection` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withAppServiceId':: d.fn(help='`azurerm.app_service_slot_virtual_network_swift_connection.withAppServiceId` constructs a mixin object that can be merged into the `app_service_slot_virtual_network_swift_connection`\nTerraform resource block to set or update the app_service_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `app_service_id` field.\n', args=[]),
  ...
  '#withSlotName':: d.fn(help='`azurerm.app_service_slot_virtual_network_swift_connection.withSlotName` constructs a mixin object that can be merged into the `app_service_slot_virtual_network_swift_connection`\nTerraform resource block to set or update the slot_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `slot_name` field.\n', args=[]),
  ...
  '#withSubnetId':: d.fn(help='`azurerm.app_service_slot_virtual_network_swift_connection.withSubnetId` constructs a mixin object that can be merged into the `app_service_slot_virtual_network_swift_connection`\nTerraform resource block to set or update the subnet_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `subnet_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.app_service_slot_virtual_network_swift_connection.withTimeouts` constructs a mixin object that can be merged into the `app_service_slot_virtual_network_swift_connection`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.app_service_slot_virtual_network_swift_connection.withTimeoutsMixin` constructs a mixin object that can be merged into the `app_service_slot_virtual_network_swift_connection`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.app_service_slot_virtual_network_swift_connection.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
