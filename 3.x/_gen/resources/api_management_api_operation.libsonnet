...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#new':: d.fn(help="\n`azurerm.api_management_api_operation.new` injects a new `azurerm_api_management_api_operation` Terraform `resource`\nblock into the root module document.\n\nAdditionally, this inserts a private function into the `_ref` attribute that generates references to attributes of the\nresource. For example, if you added a new instance to the root using:\n\n    # arguments omitted for brevity\n    azurerm.api_management_api_operation.new('some_id')\n\nYou can get the reference to the `id` field of the created `azurerm.api_management_api_operation` using the reference:\n\n    $._ref.azurerm_api_management_api_operation.some_id.get('id')\n\nThis is the same as directly entering `\"${ azurerm_api_management_api_operation.some_id.id }\"` as the value.\n\nNOTE: if you are chaining multiple resources together in a merge operation, you may not be able to use `super`, `self`,\nor `$` to refer to the root object. Instead, make an explicit outer object using `local`.\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block.\n  - `api_management_name` (`string`): \n  - `api_name` (`string`): \n  - `description` (`string`):  When `null`, the `description` field will be omitted from the resulting object.\n  - `display_name` (`string`): \n  - `method` (`string`): \n  - `operation_id` (`string`): \n  - `resource_group_name` (`string`): \n  - `url_template` (`string`): \n  - `request` (`list[obj]`):  When `null`, the `request` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management_api_operation.request.new](#fn-apimanagementapioperationrequestnew) constructor.\n  - `response` (`list[obj]`):  When `null`, the `response` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management_api_operation.response.new](#fn-apimanagementapioperationresponsenew) constructor.\n  - `template_parameter` (`list[obj]`):  When `null`, the `template_parameter` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management_api_operation.template_parameter.new](#fn-apimanagementapioperationtemplateparameternew) constructor.\n  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management_api_operation.timeouts.new](#fn-apimanagementapioperationtimeoutsnew) constructor.\n\n**Returns**:\n- A mixin object that injects the new resource into the root Terraform configuration.\n", args=[]),
  new(
    resourceLabel,
    api_management_name,
    api_name,
  ...
  request:: {
    ...
    query_parameter:: {
      ...
      '#new':: d.fn(help='\n`azurerm.api_management_api_operation.request.query_parameter.new` constructs a new object with attributes and blocks configured for the `query_parameter`\nTerraform sub block.\n\n\n\n**Args**:\n  - `default_value` (`string`):  When `null`, the `default_value` field will be omitted from the resulting object.\n  - `description` (`string`):  When `null`, the `description` field will be omitted from the resulting object.\n  - `name` (`string`): \n  - `required` (`bool`): \n  - `schema_id` (`string`):  When `null`, the `schema_id` field will be omitted from the resulting object.\n  - `type` (`string`): \n  - `type_name` (`string`):  When `null`, the `type_name` field will be omitted from the resulting object.\n  - `values` (`list`):  When `null`, the `values` field will be omitted from the resulting object.\n  - `example` (`list[obj]`):  When `null`, the `example` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management_api_operation.request.query_parameter.example.new](#fn-queryparameterexamplenew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `query_parameter` sub block.\n', args=[]),
      new(
        name,
        required,
        type,
    ...
    representation:: {
      ...
      form_parameter:: {
        ...
        '#new':: d.fn(help='\n`azurerm.api_management_api_operation.request.representation.form_parameter.new` constructs a new object with attributes and blocks configured for the `form_parameter`\nTerraform sub block.\n\n\n\n**Args**:\n  - `default_value` (`string`):  When `null`, the `default_value` field will be omitted from the resulting object.\n  - `description` (`string`):  When `null`, the `description` field will be omitted from the resulting object.\n  - `name` (`string`): \n  - `required` (`bool`): \n  - `schema_id` (`string`):  When `null`, the `schema_id` field will be omitted from the resulting object.\n  - `type` (`string`): \n  - `type_name` (`string`):  When `null`, the `type_name` field will be omitted from the resulting object.\n  - `values` (`list`):  When `null`, the `values` field will be omitted from the resulting object.\n  - `example` (`list[obj]`):  When `null`, the `example` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management_api_operation.request.representation.form_parameter.example.new](#fn-formparameterexamplenew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `form_parameter` sub block.\n', args=[]),
        new(
          name,
          required,
          type,
  ...
  response:: {
    ...
    representation:: {
      ...
      form_parameter:: {
        ...
        '#new':: d.fn(help='\n`azurerm.api_management_api_operation.response.representation.form_parameter.new` constructs a new object with attributes and blocks configured for the `form_parameter`\nTerraform sub block.\n\n\n\n**Args**:\n  - `default_value` (`string`):  When `null`, the `default_value` field will be omitted from the resulting object.\n  - `description` (`string`):  When `null`, the `description` field will be omitted from the resulting object.\n  - `name` (`string`): \n  - `required` (`bool`): \n  - `schema_id` (`string`):  When `null`, the `schema_id` field will be omitted from the resulting object.\n  - `type` (`string`): \n  - `type_name` (`string`):  When `null`, the `type_name` field will be omitted from the resulting object.\n  - `values` (`list`):  When `null`, the `values` field will be omitted from the resulting object.\n  - `example` (`list[obj]`):  When `null`, the `example` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management_api_operation.response.representation.form_parameter.example.new](#fn-formparameterexamplenew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `form_parameter` sub block.\n', args=[]),
        new(
          name,
          required,
          type,
  ...
  template_parameter:: {
    ...
    '#new':: d.fn(help='\n`azurerm.api_management_api_operation.template_parameter.new` constructs a new object with attributes and blocks configured for the `template_parameter`\nTerraform sub block.\n\n\n\n**Args**:\n  - `default_value` (`string`):  When `null`, the `default_value` field will be omitted from the resulting object.\n  - `description` (`string`):  When `null`, the `description` field will be omitted from the resulting object.\n  - `name` (`string`): \n  - `required` (`bool`): \n  - `schema_id` (`string`):  When `null`, the `schema_id` field will be omitted from the resulting object.\n  - `type` (`string`): \n  - `type_name` (`string`):  When `null`, the `type_name` field will be omitted from the resulting object.\n  - `values` (`list`):  When `null`, the `values` field will be omitted from the resulting object.\n  - `example` (`list[obj]`):  When `null`, the `example` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management_api_operation.template_parameter.example.new](#fn-templateparameterexamplenew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `template_parameter` sub block.\n', args=[]),
    new(
      name,
      required,
      type,
  ...
  '#withApiManagementName':: d.fn(help='`azurerm.api_management_api_operation.withApiManagementName` constructs a mixin object that can be merged into the `api_management_api_operation`\nTerraform resource block to set or update the api_management_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `api_management_name` field.\n', args=[]),
  ...
  '#withApiName':: d.fn(help='`azurerm.api_management_api_operation.withApiName` constructs a mixin object that can be merged into the `api_management_api_operation`\nTerraform resource block to set or update the api_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `api_name` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`azurerm.api_management_api_operation.withDescription` constructs a mixin object that can be merged into the `api_management_api_operation`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withDisplayName':: d.fn(help='`azurerm.api_management_api_operation.withDisplayName` constructs a mixin object that can be merged into the `api_management_api_operation`\nTerraform resource block to set or update the display_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `display_name` field.\n', args=[]),
  ...
  '#withMethod':: d.fn(help='`azurerm.api_management_api_operation.withMethod` constructs a mixin object that can be merged into the `api_management_api_operation`\nTerraform resource block to set or update the method field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `method` field.\n', args=[]),
  ...
  '#withOperationId':: d.fn(help='`azurerm.api_management_api_operation.withOperationId` constructs a mixin object that can be merged into the `api_management_api_operation`\nTerraform resource block to set or update the operation_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `operation_id` field.\n', args=[]),
  ...
  '#withRequest':: d.fn(help='`azurerm.api_management_api_operation.withRequest` constructs a mixin object that can be merged into the `api_management_api_operation`\nTerraform resource block to set or update the request field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `request` field.\n', args=[]),
  ...
  '#withRequestMixin':: d.fn(help='`azurerm.api_management_api_operation.withRequestMixin` constructs a mixin object that can be merged into the `api_management_api_operation`\nTerraform resource block to set or update the request field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.api_management_api_operation.withRequest](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `request` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.api_management_api_operation.withResourceGroupName` constructs a mixin object that can be merged into the `api_management_api_operation`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withResponse':: d.fn(help='`azurerm.api_management_api_operation.withResponse` constructs a mixin object that can be merged into the `api_management_api_operation`\nTerraform resource block to set or update the response field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `response` field.\n', args=[]),
  ...
  '#withResponseMixin':: d.fn(help='`azurerm.api_management_api_operation.withResponseMixin` constructs a mixin object that can be merged into the `api_management_api_operation`\nTerraform resource block to set or update the response field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.api_management_api_operation.withResponse](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `response` field.\n', args=[]),
  ...
  '#withTemplateParameter':: d.fn(help='`azurerm.api_management_api_operation.withTemplateParameter` constructs a mixin object that can be merged into the `api_management_api_operation`\nTerraform resource block to set or update the template_parameter field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `template_parameter` field.\n', args=[]),
  ...
  '#withTemplateParameterMixin':: d.fn(help='`azurerm.api_management_api_operation.withTemplateParameterMixin` constructs a mixin object that can be merged into the `api_management_api_operation`\nTerraform resource block to set or update the template_parameter field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.api_management_api_operation.withTemplateParameter](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `template_parameter` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.api_management_api_operation.withTimeouts` constructs a mixin object that can be merged into the `api_management_api_operation`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.api_management_api_operation.withTimeoutsMixin` constructs a mixin object that can be merged into the `api_management_api_operation`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.api_management_api_operation.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withUrlTemplate':: d.fn(help='`azurerm.api_management_api_operation.withUrlTemplate` constructs a mixin object that can be merged into the `api_management_api_operation`\nTerraform resource block to set or update the url_template field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `url_template` field.\n', args=[]),
