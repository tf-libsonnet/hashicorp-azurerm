...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAlertsEnabled':: d.fn(help='`azurerm.sentinel_data_connector_microsoft_cloud_app_security.withAlertsEnabled` constructs a mixin object that can be merged into the `sentinel_data_connector_microsoft_cloud_app_security`\nTerraform resource block to set or update the alerts_enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `alerts_enabled` field.\n', args=[]),
  ...
  '#withDiscoveryLogsEnabled':: d.fn(help='`azurerm.sentinel_data_connector_microsoft_cloud_app_security.withDiscoveryLogsEnabled` constructs a mixin object that can be merged into the `sentinel_data_connector_microsoft_cloud_app_security`\nTerraform resource block to set or update the discovery_logs_enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `discovery_logs_enabled` field.\n', args=[]),
  ...
  '#withLogAnalyticsWorkspaceId':: d.fn(help='`azurerm.sentinel_data_connector_microsoft_cloud_app_security.withLogAnalyticsWorkspaceId` constructs a mixin object that can be merged into the `sentinel_data_connector_microsoft_cloud_app_security`\nTerraform resource block to set or update the log_analytics_workspace_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `log_analytics_workspace_id` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.sentinel_data_connector_microsoft_cloud_app_security.withName` constructs a mixin object that can be merged into the `sentinel_data_connector_microsoft_cloud_app_security`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTenantId':: d.fn(help='`azurerm.sentinel_data_connector_microsoft_cloud_app_security.withTenantId` constructs a mixin object that can be merged into the `sentinel_data_connector_microsoft_cloud_app_security`\nTerraform resource block to set or update the tenant_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tenant_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.sentinel_data_connector_microsoft_cloud_app_security.withTimeouts` constructs a mixin object that can be merged into the `sentinel_data_connector_microsoft_cloud_app_security`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.sentinel_data_connector_microsoft_cloud_app_security.withTimeoutsMixin` constructs a mixin object that can be merged into the `sentinel_data_connector_microsoft_cloud_app_security`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.sentinel_data_connector_microsoft_cloud_app_security.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
