...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDomainServiceId':: d.fn(help='`azurerm.active_directory_domain_service_trust.withDomainServiceId` constructs a mixin object that can be merged into the `active_directory_domain_service_trust`\nTerraform resource block to set or update the domain_service_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `domain_service_id` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.active_directory_domain_service_trust.withName` constructs a mixin object that can be merged into the `active_directory_domain_service_trust`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withPassword':: d.fn(help='`azurerm.active_directory_domain_service_trust.withPassword` constructs a mixin object that can be merged into the `active_directory_domain_service_trust`\nTerraform resource block to set or update the password field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `password` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.active_directory_domain_service_trust.withTimeouts` constructs a mixin object that can be merged into the `active_directory_domain_service_trust`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.active_directory_domain_service_trust.withTimeoutsMixin` constructs a mixin object that can be merged into the `active_directory_domain_service_trust`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.active_directory_domain_service_trust.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTrustedDomainDnsIps':: d.fn(help='`azurerm.active_directory_domain_service_trust.withTrustedDomainDnsIps` constructs a mixin object that can be merged into the `active_directory_domain_service_trust`\nTerraform resource block to set or update the trusted_domain_dns_ips field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `trusted_domain_dns_ips` field.\n', args=[]),
  ...
  '#withTrustedDomainFqdn':: d.fn(help='`azurerm.active_directory_domain_service_trust.withTrustedDomainFqdn` constructs a mixin object that can be merged into the `active_directory_domain_service_trust`\nTerraform resource block to set or update the trusted_domain_fqdn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `trusted_domain_fqdn` field.\n', args=[]),
