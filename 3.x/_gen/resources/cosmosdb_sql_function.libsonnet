...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBody':: d.fn(help='`azurerm.cosmosdb_sql_function.withBody` constructs a mixin object that can be merged into the `cosmosdb_sql_function`\nTerraform resource block to set or update the body field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `body` field.\n', args=[]),
  ...
  '#withContainerId':: d.fn(help='`azurerm.cosmosdb_sql_function.withContainerId` constructs a mixin object that can be merged into the `cosmosdb_sql_function`\nTerraform resource block to set or update the container_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `container_id` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.cosmosdb_sql_function.withName` constructs a mixin object that can be merged into the `cosmosdb_sql_function`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.cosmosdb_sql_function.withTimeouts` constructs a mixin object that can be merged into the `cosmosdb_sql_function`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.cosmosdb_sql_function.withTimeoutsMixin` constructs a mixin object that can be merged into the `cosmosdb_sql_function`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.cosmosdb_sql_function.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
