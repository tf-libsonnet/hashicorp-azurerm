...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withName':: d.fn(help='`azurerm.sentinel_watchlist_item.withName` constructs a mixin object that can be merged into the `sentinel_watchlist_item`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withProperties':: d.fn(help='`azurerm.sentinel_watchlist_item.withProperties` constructs a mixin object that can be merged into the `sentinel_watchlist_item`\nTerraform resource block to set or update the properties field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `properties` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.sentinel_watchlist_item.withTimeouts` constructs a mixin object that can be merged into the `sentinel_watchlist_item`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.sentinel_watchlist_item.withTimeoutsMixin` constructs a mixin object that can be merged into the `sentinel_watchlist_item`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.sentinel_watchlist_item.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withWatchlistId':: d.fn(help='`azurerm.sentinel_watchlist_item.withWatchlistId` constructs a mixin object that can be merged into the `sentinel_watchlist_item`\nTerraform resource block to set or update the watchlist_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `watchlist_id` field.\n', args=[]),
