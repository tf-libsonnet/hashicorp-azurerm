...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withStorageFileshareId':: d.fn(help='`azurerm.string.withStorageFileshareId` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the storage_fileshare_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `storage_fileshare_id` field.\n', args=[]),
  withStorageFileshareId(resourceLabel, value): {
    resource+: {
      azurerm_machine_learning_datastore_fileshare+: {
        [resourceLabel]+: {
          storage_fileshare_id: value,
        },
      },
    },
  },
