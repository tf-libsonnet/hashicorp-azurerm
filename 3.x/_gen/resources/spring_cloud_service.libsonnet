...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withManagedEnvironmentId':: d.fn(help='`azurerm.string.withManagedEnvironmentId` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the managed_environment_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `managed_environment_id` field.\n', args=[]),
  withManagedEnvironmentId(resourceLabel, value): {
    resource+: {
      azurerm_spring_cloud_service+: {
        [resourceLabel]+: {
          managed_environment_id: value,
        },
      },
    },
  },
