...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  new(
    ...
    spring_cloud_app_id,
    addon_json=null,
    application_performance_monitoring_ids=null,
  ...
  '#withApplicationPerformanceMonitoringIds':: d.fn(help='`azurerm.list.withApplicationPerformanceMonitoringIds` constructs a mixin object that can be merged into the `list`\nTerraform resource block to set or update the application_performance_monitoring_ids field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list`): The value to set for the `application_performance_monitoring_ids` field.\n', args=[]),
  withApplicationPerformanceMonitoringIds(resourceLabel, value): {
    resource+: {
      azurerm_spring_cloud_build_deployment+: {
        [resourceLabel]+: {
          application_performance_monitoring_ids: value,
        },
      },
    },
  },
