...
{
  '#':: d.pkg(name='databricks_virtual_network_peering', url='', help='`databricks_virtual_network_peering` represents the `azurerm_databricks_virtual_network_peering` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withRemoteAddressSpacePrefixes':: d.fn(help='`azurerm.list.withRemoteAddressSpacePrefixes` constructs a mixin object that can be merged into the `list`\nTerraform resource block to set or update the remote_address_space_prefixes field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list`): The value to set for the `remote_address_space_prefixes` field.\n', args=[]),
  withRemoteAddressSpacePrefixes(resourceLabel, value): {
    resource+: {
      azurerm_databricks_virtual_network_peering+: {
        [resourceLabel]+: {
          remote_address_space_prefixes: value,
        },
      },
    },
  },
