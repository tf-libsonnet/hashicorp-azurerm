...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  backend_request:: {
    data_masking:: {
      ...
      '#new':: d.fn(help='\n`azurerm.api_management_diagnostic.backend_request.data_masking.new` constructs a new object with attributes and blocks configured for the `data_masking`\nTerraform sub block.\n\n\n\n**Args**:\n  - `headers` (`list[obj]`):  When `null`, the `headers` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management_diagnostic.backend_request.data_masking.headers.new](#fn-datamaskingheadersnew) constructor.\n  - `query_params` (`list[obj]`):  When `null`, the `query_params` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management_diagnostic.backend_request.data_masking.query_params.new](#fn-datamaskingqueryparamsnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `data_masking` sub block.\n', args=[]),
      new(
        headers=null,
        query_params=null
      ):: std.prune(a={
  ...
  backend_response:: {
    data_masking:: {
      ...
      '#new':: d.fn(help='\n`azurerm.api_management_diagnostic.backend_response.data_masking.new` constructs a new object with attributes and blocks configured for the `data_masking`\nTerraform sub block.\n\n\n\n**Args**:\n  - `headers` (`list[obj]`):  When `null`, the `headers` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management_diagnostic.backend_response.data_masking.headers.new](#fn-datamaskingheadersnew) constructor.\n  - `query_params` (`list[obj]`):  When `null`, the `query_params` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management_diagnostic.backend_response.data_masking.query_params.new](#fn-datamaskingqueryparamsnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `data_masking` sub block.\n', args=[]),
      new(
        headers=null,
        query_params=null
      ):: std.prune(a={
    ...
    '#new':: d.fn(help='\n`azurerm.api_management_diagnostic.backend_response.new` constructs a new object with attributes and blocks configured for the `backend_response`\nTerraform sub block.\n\n\n\n**Args**:\n  - `body_bytes` (`number`):  When `null`, the `body_bytes` field will be omitted from the resulting object.\n  - `headers_to_log` (`list`):  When `null`, the `headers_to_log` field will be omitted from the resulting object.\n  - `data_masking` (`list[obj]`):  When `null`, the `data_masking` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management_diagnostic.backend_response.data_masking.new](#fn-backendresponsedatamaskingnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `backend_response` sub block.\n', args=[]),
    new(
      body_bytes=null,
      data_masking=null,
      headers_to_log=null
  ...
  frontend_request:: {
    data_masking:: {
      ...
      '#new':: d.fn(help='\n`azurerm.api_management_diagnostic.frontend_request.data_masking.new` constructs a new object with attributes and blocks configured for the `data_masking`\nTerraform sub block.\n\n\n\n**Args**:\n  - `headers` (`list[obj]`):  When `null`, the `headers` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management_diagnostic.frontend_request.data_masking.headers.new](#fn-datamaskingheadersnew) constructor.\n  - `query_params` (`list[obj]`):  When `null`, the `query_params` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management_diagnostic.frontend_request.data_masking.query_params.new](#fn-datamaskingqueryparamsnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `data_masking` sub block.\n', args=[]),
      new(
        headers=null,
        query_params=null
      ):: std.prune(a={
    ...
    '#new':: d.fn(help='\n`azurerm.api_management_diagnostic.frontend_request.new` constructs a new object with attributes and blocks configured for the `frontend_request`\nTerraform sub block.\n\n\n\n**Args**:\n  - `body_bytes` (`number`):  When `null`, the `body_bytes` field will be omitted from the resulting object.\n  - `headers_to_log` (`list`):  When `null`, the `headers_to_log` field will be omitted from the resulting object.\n  - `data_masking` (`list[obj]`):  When `null`, the `data_masking` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management_diagnostic.frontend_request.data_masking.new](#fn-frontendrequestdatamaskingnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `frontend_request` sub block.\n', args=[]),
    new(
      body_bytes=null,
      data_masking=null,
      headers_to_log=null
  ...
  frontend_response:: {
    data_masking:: {
      ...
      '#new':: d.fn(help='\n`azurerm.api_management_diagnostic.frontend_response.data_masking.new` constructs a new object with attributes and blocks configured for the `data_masking`\nTerraform sub block.\n\n\n\n**Args**:\n  - `headers` (`list[obj]`):  When `null`, the `headers` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management_diagnostic.frontend_response.data_masking.headers.new](#fn-datamaskingheadersnew) constructor.\n  - `query_params` (`list[obj]`):  When `null`, the `query_params` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management_diagnostic.frontend_response.data_masking.query_params.new](#fn-datamaskingqueryparamsnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `data_masking` sub block.\n', args=[]),
      new(
        headers=null,
        query_params=null
      ):: std.prune(a={
    ...
    '#new':: d.fn(help='\n`azurerm.api_management_diagnostic.frontend_response.new` constructs a new object with attributes and blocks configured for the `frontend_response`\nTerraform sub block.\n\n\n\n**Args**:\n  - `body_bytes` (`number`):  When `null`, the `body_bytes` field will be omitted from the resulting object.\n  - `headers_to_log` (`list`):  When `null`, the `headers_to_log` field will be omitted from the resulting object.\n  - `data_masking` (`list[obj]`):  When `null`, the `data_masking` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management_diagnostic.frontend_response.data_masking.new](#fn-frontendresponsedatamaskingnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `frontend_response` sub block.\n', args=[]),
    new(
      body_bytes=null,
      data_masking=null,
      headers_to_log=null
  ...
  '#withAlwaysLogErrors':: d.fn(help='`azurerm.api_management_diagnostic.withAlwaysLogErrors` constructs a mixin object that can be merged into the `api_management_diagnostic`\nTerraform resource block to set or update the always_log_errors field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `always_log_errors` field.\n', args=[]),
  ...
  '#withApiManagementLoggerId':: d.fn(help='`azurerm.api_management_diagnostic.withApiManagementLoggerId` constructs a mixin object that can be merged into the `api_management_diagnostic`\nTerraform resource block to set or update the api_management_logger_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `api_management_logger_id` field.\n', args=[]),
  ...
  '#withApiManagementName':: d.fn(help='`azurerm.api_management_diagnostic.withApiManagementName` constructs a mixin object that can be merged into the `api_management_diagnostic`\nTerraform resource block to set or update the api_management_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `api_management_name` field.\n', args=[]),
  ...
  '#withBackendRequest':: d.fn(help='`azurerm.api_management_diagnostic.withBackendRequest` constructs a mixin object that can be merged into the `api_management_diagnostic`\nTerraform resource block to set or update the backend_request field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `backend_request` field.\n', args=[]),
  ...
  '#withBackendRequestMixin':: d.fn(help='`azurerm.api_management_diagnostic.withBackendRequestMixin` constructs a mixin object that can be merged into the `api_management_diagnostic`\nTerraform resource block to set or update the backend_request field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.api_management_diagnostic.withBackendRequest](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `backend_request` field.\n', args=[]),
  ...
  '#withBackendResponse':: d.fn(help='`azurerm.api_management_diagnostic.withBackendResponse` constructs a mixin object that can be merged into the `api_management_diagnostic`\nTerraform resource block to set or update the backend_response field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `backend_response` field.\n', args=[]),
  ...
  '#withBackendResponseMixin':: d.fn(help='`azurerm.api_management_diagnostic.withBackendResponseMixin` constructs a mixin object that can be merged into the `api_management_diagnostic`\nTerraform resource block to set or update the backend_response field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.api_management_diagnostic.withBackendResponse](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `backend_response` field.\n', args=[]),
  ...
  '#withFrontendRequest':: d.fn(help='`azurerm.api_management_diagnostic.withFrontendRequest` constructs a mixin object that can be merged into the `api_management_diagnostic`\nTerraform resource block to set or update the frontend_request field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `frontend_request` field.\n', args=[]),
  ...
  '#withFrontendRequestMixin':: d.fn(help='`azurerm.api_management_diagnostic.withFrontendRequestMixin` constructs a mixin object that can be merged into the `api_management_diagnostic`\nTerraform resource block to set or update the frontend_request field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.api_management_diagnostic.withFrontendRequest](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `frontend_request` field.\n', args=[]),
  ...
  '#withFrontendResponse':: d.fn(help='`azurerm.api_management_diagnostic.withFrontendResponse` constructs a mixin object that can be merged into the `api_management_diagnostic`\nTerraform resource block to set or update the frontend_response field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `frontend_response` field.\n', args=[]),
  ...
  '#withFrontendResponseMixin':: d.fn(help='`azurerm.api_management_diagnostic.withFrontendResponseMixin` constructs a mixin object that can be merged into the `api_management_diagnostic`\nTerraform resource block to set or update the frontend_response field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.api_management_diagnostic.withFrontendResponse](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `frontend_response` field.\n', args=[]),
  ...
  '#withHttpCorrelationProtocol':: d.fn(help='`azurerm.api_management_diagnostic.withHttpCorrelationProtocol` constructs a mixin object that can be merged into the `api_management_diagnostic`\nTerraform resource block to set or update the http_correlation_protocol field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `http_correlation_protocol` field.\n', args=[]),
  ...
  '#withIdentifier':: d.fn(help='`azurerm.api_management_diagnostic.withIdentifier` constructs a mixin object that can be merged into the `api_management_diagnostic`\nTerraform resource block to set or update the identifier field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `identifier` field.\n', args=[]),
  ...
  '#withLogClientIp':: d.fn(help='`azurerm.api_management_diagnostic.withLogClientIp` constructs a mixin object that can be merged into the `api_management_diagnostic`\nTerraform resource block to set or update the log_client_ip field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `log_client_ip` field.\n', args=[]),
  ...
  '#withOperationNameFormat':: d.fn(help='`azurerm.api_management_diagnostic.withOperationNameFormat` constructs a mixin object that can be merged into the `api_management_diagnostic`\nTerraform resource block to set or update the operation_name_format field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `operation_name_format` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.api_management_diagnostic.withResourceGroupName` constructs a mixin object that can be merged into the `api_management_diagnostic`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withSamplingPercentage':: d.fn(help='`azurerm.api_management_diagnostic.withSamplingPercentage` constructs a mixin object that can be merged into the `api_management_diagnostic`\nTerraform resource block to set or update the sampling_percentage field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `sampling_percentage` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.api_management_diagnostic.withTimeouts` constructs a mixin object that can be merged into the `api_management_diagnostic`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.api_management_diagnostic.withTimeoutsMixin` constructs a mixin object that can be merged into the `api_management_diagnostic`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.api_management_diagnostic.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withVerbosity':: d.fn(help='`azurerm.api_management_diagnostic.withVerbosity` constructs a mixin object that can be merged into the `api_management_diagnostic`\nTerraform resource block to set or update the verbosity field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `verbosity` field.\n', args=[]),
