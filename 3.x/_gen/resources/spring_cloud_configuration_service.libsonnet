...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withName':: d.fn(help='`azurerm.spring_cloud_configuration_service.withName` constructs a mixin object that can be merged into the `spring_cloud_configuration_service`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withRepository':: d.fn(help='`azurerm.spring_cloud_configuration_service.withRepository` constructs a mixin object that can be merged into the `spring_cloud_configuration_service`\nTerraform resource block to set or update the repository field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `repository` field.\n', args=[]),
  ...
  '#withRepositoryMixin':: d.fn(help='`azurerm.spring_cloud_configuration_service.withRepositoryMixin` constructs a mixin object that can be merged into the `spring_cloud_configuration_service`\nTerraform resource block to set or update the repository field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.spring_cloud_configuration_service.withRepository](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `repository` field.\n', args=[]),
  ...
  '#withSpringCloudServiceId':: d.fn(help='`azurerm.spring_cloud_configuration_service.withSpringCloudServiceId` constructs a mixin object that can be merged into the `spring_cloud_configuration_service`\nTerraform resource block to set or update the spring_cloud_service_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `spring_cloud_service_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.spring_cloud_configuration_service.withTimeouts` constructs a mixin object that can be merged into the `spring_cloud_configuration_service`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.spring_cloud_configuration_service.withTimeoutsMixin` constructs a mixin object that can be merged into the `spring_cloud_configuration_service`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.spring_cloud_configuration_service.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
