...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#new':: d.fn(help="\n`azurerm.data_factory_data_flow.new` injects a new `azurerm_data_factory_data_flow` Terraform `resource`\nblock into the root module document.\n\nAdditionally, this inserts a private function into the `_ref` attribute that generates references to attributes of the\nresource. For example, if you added a new instance to the root using:\n\n    # arguments omitted for brevity\n    azurerm.data_factory_data_flow.new('some_id')\n\nYou can get the reference to the `id` field of the created `azurerm.data_factory_data_flow` using the reference:\n\n    $._ref.azurerm_data_factory_data_flow.some_id.get('id')\n\nThis is the same as directly entering `\"${ azurerm_data_factory_data_flow.some_id.id }\"` as the value.\n\nNOTE: if you are chaining multiple resources together in a merge operation, you may not be able to use `super`, `self`,\nor `$` to refer to the root object. Instead, make an explicit outer object using `local`.\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block.\n  - `annotations` (`list`):  When `null`, the `annotations` field will be omitted from the resulting object.\n  - `data_factory_id` (`string`): \n  - `description` (`string`):  When `null`, the `description` field will be omitted from the resulting object.\n  - `folder` (`string`):  When `null`, the `folder` field will be omitted from the resulting object.\n  - `name` (`string`): \n  - `script` (`string`):  When `null`, the `script` field will be omitted from the resulting object.\n  - `script_lines` (`list`):  When `null`, the `script_lines` field will be omitted from the resulting object.\n  - `sink` (`list[obj]`):  When `null`, the `sink` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.data_factory_data_flow.sink.new](#fn-datafactorydataflowsinknew) constructor.\n  - `source` (`list[obj]`):  When `null`, the `source` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.data_factory_data_flow.source.new](#fn-datafactorydataflowsourcenew) constructor.\n  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.data_factory_data_flow.timeouts.new](#fn-datafactorydataflowtimeoutsnew) constructor.\n  - `transformation` (`list[obj]`):  When `null`, the `transformation` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.data_factory_data_flow.transformation.new](#fn-datafactorydataflowtransformationnew) constructor.\n\n**Returns**:\n- A mixin object that injects the new resource into the root Terraform configuration.\n", args=[]),
  new(
    resourceLabel,
    data_factory_id,
    name,
  ...
  '#withAnnotations':: d.fn(help='`azurerm.data_factory_data_flow.withAnnotations` constructs a mixin object that can be merged into the `data_factory_data_flow`\nTerraform resource block to set or update the annotations field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `annotations` field.\n', args=[]),
  ...
  '#withDataFactoryId':: d.fn(help='`azurerm.data_factory_data_flow.withDataFactoryId` constructs a mixin object that can be merged into the `data_factory_data_flow`\nTerraform resource block to set or update the data_factory_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `data_factory_id` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`azurerm.data_factory_data_flow.withDescription` constructs a mixin object that can be merged into the `data_factory_data_flow`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withFolder':: d.fn(help='`azurerm.data_factory_data_flow.withFolder` constructs a mixin object that can be merged into the `data_factory_data_flow`\nTerraform resource block to set or update the folder field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `folder` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.data_factory_data_flow.withName` constructs a mixin object that can be merged into the `data_factory_data_flow`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withScript':: d.fn(help='`azurerm.data_factory_data_flow.withScript` constructs a mixin object that can be merged into the `data_factory_data_flow`\nTerraform resource block to set or update the script field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `script` field.\n', args=[]),
  ...
  '#withScriptLines':: d.fn(help='`azurerm.data_factory_data_flow.withScriptLines` constructs a mixin object that can be merged into the `data_factory_data_flow`\nTerraform resource block to set or update the script_lines field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `script_lines` field.\n', args=[]),
  ...
  '#withSink':: d.fn(help='`azurerm.data_factory_data_flow.withSink` constructs a mixin object that can be merged into the `data_factory_data_flow`\nTerraform resource block to set or update the sink field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `sink` field.\n', args=[]),
  ...
  '#withSinkMixin':: d.fn(help='`azurerm.data_factory_data_flow.withSinkMixin` constructs a mixin object that can be merged into the `data_factory_data_flow`\nTerraform resource block to set or update the sink field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.data_factory_data_flow.withSink](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `sink` field.\n', args=[]),
  ...
  '#withSource':: d.fn(help='`azurerm.data_factory_data_flow.withSource` constructs a mixin object that can be merged into the `data_factory_data_flow`\nTerraform resource block to set or update the source field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `source` field.\n', args=[]),
  ...
  '#withSourceMixin':: d.fn(help='`azurerm.data_factory_data_flow.withSourceMixin` constructs a mixin object that can be merged into the `data_factory_data_flow`\nTerraform resource block to set or update the source field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.data_factory_data_flow.withSource](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `source` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.data_factory_data_flow.withTimeouts` constructs a mixin object that can be merged into the `data_factory_data_flow`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.data_factory_data_flow.withTimeoutsMixin` constructs a mixin object that can be merged into the `data_factory_data_flow`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.data_factory_data_flow.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTransformation':: d.fn(help='`azurerm.data_factory_data_flow.withTransformation` constructs a mixin object that can be merged into the `data_factory_data_flow`\nTerraform resource block to set or update the transformation field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `transformation` field.\n', args=[]),
  ...
  '#withTransformationMixin':: d.fn(help='`azurerm.data_factory_data_flow.withTransformationMixin` constructs a mixin object that can be merged into the `data_factory_data_flow`\nTerraform resource block to set or update the transformation field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.data_factory_data_flow.withTransformation](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `transformation` field.\n', args=[]),
