...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAutoRotationEnabled':: d.fn(help='`azurerm.mssql_server_transparent_data_encryption.withAutoRotationEnabled` constructs a mixin object that can be merged into the `mssql_server_transparent_data_encryption`\nTerraform resource block to set or update the auto_rotation_enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `auto_rotation_enabled` field.\n', args=[]),
  ...
  '#withKeyVaultKeyId':: d.fn(help='`azurerm.mssql_server_transparent_data_encryption.withKeyVaultKeyId` constructs a mixin object that can be merged into the `mssql_server_transparent_data_encryption`\nTerraform resource block to set or update the key_vault_key_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `key_vault_key_id` field.\n', args=[]),
  ...
  '#withServerId':: d.fn(help='`azurerm.mssql_server_transparent_data_encryption.withServerId` constructs a mixin object that can be merged into the `mssql_server_transparent_data_encryption`\nTerraform resource block to set or update the server_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `server_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.mssql_server_transparent_data_encryption.withTimeouts` constructs a mixin object that can be merged into the `mssql_server_transparent_data_encryption`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.mssql_server_transparent_data_encryption.withTimeoutsMixin` constructs a mixin object that can be merged into the `mssql_server_transparent_data_encryption`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.mssql_server_transparent_data_encryption.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
