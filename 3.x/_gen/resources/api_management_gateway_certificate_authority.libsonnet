...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withApiManagementId':: d.fn(help='`azurerm.api_management_gateway_certificate_authority.withApiManagementId` constructs a mixin object that can be merged into the `api_management_gateway_certificate_authority`\nTerraform resource block to set or update the api_management_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `api_management_id` field.\n', args=[]),
  ...
  '#withCertificateName':: d.fn(help='`azurerm.api_management_gateway_certificate_authority.withCertificateName` constructs a mixin object that can be merged into the `api_management_gateway_certificate_authority`\nTerraform resource block to set or update the certificate_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `certificate_name` field.\n', args=[]),
  ...
  '#withGatewayName':: d.fn(help='`azurerm.api_management_gateway_certificate_authority.withGatewayName` constructs a mixin object that can be merged into the `api_management_gateway_certificate_authority`\nTerraform resource block to set or update the gateway_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `gateway_name` field.\n', args=[]),
  ...
  '#withIsTrusted':: d.fn(help='`azurerm.api_management_gateway_certificate_authority.withIsTrusted` constructs a mixin object that can be merged into the `api_management_gateway_certificate_authority`\nTerraform resource block to set or update the is_trusted field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `is_trusted` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.api_management_gateway_certificate_authority.withTimeouts` constructs a mixin object that can be merged into the `api_management_gateway_certificate_authority`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.api_management_gateway_certificate_authority.withTimeoutsMixin` constructs a mixin object that can be merged into the `api_management_gateway_certificate_authority`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.api_management_gateway_certificate_authority.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
