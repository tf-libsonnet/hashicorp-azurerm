...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withApplicationInsightsId':: d.fn(help='`azurerm.application_insights_api_key.withApplicationInsightsId` constructs a mixin object that can be merged into the `application_insights_api_key`\nTerraform resource block to set or update the application_insights_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `application_insights_id` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.application_insights_api_key.withName` constructs a mixin object that can be merged into the `application_insights_api_key`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withReadPermissions':: d.fn(help='`azurerm.application_insights_api_key.withReadPermissions` constructs a mixin object that can be merged into the `application_insights_api_key`\nTerraform resource block to set or update the read_permissions field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `read_permissions` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.application_insights_api_key.withTimeouts` constructs a mixin object that can be merged into the `application_insights_api_key`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.application_insights_api_key.withTimeoutsMixin` constructs a mixin object that can be merged into the `application_insights_api_key`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.application_insights_api_key.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withWritePermissions':: d.fn(help='`azurerm.application_insights_api_key.withWritePermissions` constructs a mixin object that can be merged into the `application_insights_api_key`\nTerraform resource block to set or update the write_permissions field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `write_permissions` field.\n', args=[]),
