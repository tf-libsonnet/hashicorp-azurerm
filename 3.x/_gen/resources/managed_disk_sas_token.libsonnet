...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAccessLevel':: d.fn(help='`azurerm.managed_disk_sas_token.withAccessLevel` constructs a mixin object that can be merged into the `managed_disk_sas_token`\nTerraform resource block to set or update the access_level field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `access_level` field.\n', args=[]),
  ...
  '#withDurationInSeconds':: d.fn(help='`azurerm.managed_disk_sas_token.withDurationInSeconds` constructs a mixin object that can be merged into the `managed_disk_sas_token`\nTerraform resource block to set or update the duration_in_seconds field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `duration_in_seconds` field.\n', args=[]),
  ...
  '#withManagedDiskId':: d.fn(help='`azurerm.managed_disk_sas_token.withManagedDiskId` constructs a mixin object that can be merged into the `managed_disk_sas_token`\nTerraform resource block to set or update the managed_disk_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `managed_disk_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.managed_disk_sas_token.withTimeouts` constructs a mixin object that can be merged into the `managed_disk_sas_token`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.managed_disk_sas_token.withTimeoutsMixin` constructs a mixin object that can be merged into the `managed_disk_sas_token`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.managed_disk_sas_token.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
