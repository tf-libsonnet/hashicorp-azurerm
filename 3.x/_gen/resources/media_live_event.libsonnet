...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withStreamOptions':: d.fn(help='`azurerm.list.withStreamOptions` constructs a mixin object that can be merged into the `list`\nTerraform resource block to set or update the stream_options field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list`): The value to set for the `stream_options` field.\n', args=[]),
  withStreamOptions(resourceLabel, value): {
    resource+: {
      azurerm_media_live_event+: {
        [resourceLabel]+: {
