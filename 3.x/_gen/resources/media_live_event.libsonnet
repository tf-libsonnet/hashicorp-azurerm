...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#new':: d.fn(help="\n`azurerm.media_live_event.new` injects a new `azurerm_media_live_event` Terraform `resource`\nblock into the root module document.\n\nAdditionally, this inserts a private function into the `_ref` attribute that generates references to attributes of the\nresource. For example, if you added a new instance to the root using:\n\n    # arguments omitted for brevity\n    azurerm.media_live_event.new('some_id')\n\nYou can get the reference to the `id` field of the created `azurerm.media_live_event` using the reference:\n\n    $._ref.azurerm_media_live_event.some_id.get('id')\n\nThis is the same as directly entering `\"${ azurerm_media_live_event.some_id.id }\"` as the value.\n\nNOTE: if you are chaining multiple resources together in a merge operation, you may not be able to use `super`, `self`,\nor `$` to refer to the root object. Instead, make an explicit outer object using `local`.\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block.\n  - `auto_start_enabled` (`bool`):  When `null`, the `auto_start_enabled` field will be omitted from the resulting object.\n  - `description` (`string`):  When `null`, the `description` field will be omitted from the resulting object.\n  - `hostname_prefix` (`string`):  When `null`, the `hostname_prefix` field will be omitted from the resulting object.\n  - `location` (`string`): \n  - `media_services_account_name` (`string`): \n  - `name` (`string`): \n  - `resource_group_name` (`string`): \n  - `tags` (`obj`):  When `null`, the `tags` field will be omitted from the resulting object.\n  - `transcription_languages` (`list`):  When `null`, the `transcription_languages` field will be omitted from the resulting object.\n  - `use_static_hostname` (`bool`):  When `null`, the `use_static_hostname` field will be omitted from the resulting object.\n  - `cross_site_access_policy` (`list[obj]`):  When `null`, the `cross_site_access_policy` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.media_live_event.cross_site_access_policy.new](#fn-medialiveeventcrosssiteaccesspolicynew) constructor.\n  - `encoding` (`list[obj]`):  When `null`, the `encoding` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.media_live_event.encoding.new](#fn-medialiveeventencodingnew) constructor.\n  - `input` (`list[obj]`):  When `null`, the `input` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.media_live_event.input.new](#fn-medialiveeventinputnew) constructor.\n  - `preview` (`list[obj]`):  When `null`, the `preview` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.media_live_event.preview.new](#fn-medialiveeventpreviewnew) constructor.\n  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.media_live_event.timeouts.new](#fn-medialiveeventtimeoutsnew) constructor.\n\n**Returns**:\n- A mixin object that injects the new resource into the root Terraform configuration.\n", args=[]),
  new(
    resourceLabel,
    location,
  ...
  '#withAutoStartEnabled':: d.fn(help='`azurerm.media_live_event.withAutoStartEnabled` constructs a mixin object that can be merged into the `media_live_event`\nTerraform resource block to set or update the auto_start_enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `auto_start_enabled` field.\n', args=[]),
  ...
  '#withCrossSiteAccessPolicy':: d.fn(help='`azurerm.media_live_event.withCrossSiteAccessPolicy` constructs a mixin object that can be merged into the `media_live_event`\nTerraform resource block to set or update the cross_site_access_policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cross_site_access_policy` field.\n', args=[]),
  ...
  '#withCrossSiteAccessPolicyMixin':: d.fn(help='`azurerm.media_live_event.withCrossSiteAccessPolicyMixin` constructs a mixin object that can be merged into the `media_live_event`\nTerraform resource block to set or update the cross_site_access_policy field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.media_live_event.withCrossSiteAccessPolicy](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cross_site_access_policy` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`azurerm.media_live_event.withDescription` constructs a mixin object that can be merged into the `media_live_event`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withEncoding':: d.fn(help='`azurerm.media_live_event.withEncoding` constructs a mixin object that can be merged into the `media_live_event`\nTerraform resource block to set or update the encoding field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `encoding` field.\n', args=[]),
  ...
  '#withEncodingMixin':: d.fn(help='`azurerm.media_live_event.withEncodingMixin` constructs a mixin object that can be merged into the `media_live_event`\nTerraform resource block to set or update the encoding field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.media_live_event.withEncoding](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `encoding` field.\n', args=[]),
  ...
  '#withHostnamePrefix':: d.fn(help='`azurerm.media_live_event.withHostnamePrefix` constructs a mixin object that can be merged into the `media_live_event`\nTerraform resource block to set or update the hostname_prefix field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `hostname_prefix` field.\n', args=[]),
  ...
  '#withInput':: d.fn(help='`azurerm.media_live_event.withInput` constructs a mixin object that can be merged into the `media_live_event`\nTerraform resource block to set or update the input field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `input` field.\n', args=[]),
  ...
  '#withInputMixin':: d.fn(help='`azurerm.media_live_event.withInputMixin` constructs a mixin object that can be merged into the `media_live_event`\nTerraform resource block to set or update the input field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.media_live_event.withInput](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `input` field.\n', args=[]),
  ...
  '#withLocation':: d.fn(help='`azurerm.media_live_event.withLocation` constructs a mixin object that can be merged into the `media_live_event`\nTerraform resource block to set or update the location field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `location` field.\n', args=[]),
  ...
  '#withMediaServicesAccountName':: d.fn(help='`azurerm.media_live_event.withMediaServicesAccountName` constructs a mixin object that can be merged into the `media_live_event`\nTerraform resource block to set or update the media_services_account_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `media_services_account_name` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.media_live_event.withName` constructs a mixin object that can be merged into the `media_live_event`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withPreview':: d.fn(help='`azurerm.media_live_event.withPreview` constructs a mixin object that can be merged into the `media_live_event`\nTerraform resource block to set or update the preview field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `preview` field.\n', args=[]),
  ...
  '#withPreviewMixin':: d.fn(help='`azurerm.media_live_event.withPreviewMixin` constructs a mixin object that can be merged into the `media_live_event`\nTerraform resource block to set or update the preview field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.media_live_event.withPreview](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `preview` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.media_live_event.withResourceGroupName` constructs a mixin object that can be merged into the `media_live_event`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`azurerm.media_live_event.withTags` constructs a mixin object that can be merged into the `media_live_event`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.media_live_event.withTimeouts` constructs a mixin object that can be merged into the `media_live_event`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.media_live_event.withTimeoutsMixin` constructs a mixin object that can be merged into the `media_live_event`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.media_live_event.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTranscriptionLanguages':: d.fn(help='`azurerm.media_live_event.withTranscriptionLanguages` constructs a mixin object that can be merged into the `media_live_event`\nTerraform resource block to set or update the transcription_languages field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `transcription_languages` field.\n', args=[]),
  ...
  '#withUseStaticHostname':: d.fn(help='`azurerm.media_live_event.withUseStaticHostname` constructs a mixin object that can be merged into the `media_live_event`\nTerraform resource block to set or update the use_static_hostname field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `use_static_hostname` field.\n', args=[]),
