...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAutomationAccountName':: d.fn(help='`azurerm.automation_hybrid_runbook_worker_group.withAutomationAccountName` constructs a mixin object that can be merged into the `automation_hybrid_runbook_worker_group`\nTerraform resource block to set or update the automation_account_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `automation_account_name` field.\n', args=[]),
  ...
  '#withCredentialName':: d.fn(help='`azurerm.automation_hybrid_runbook_worker_group.withCredentialName` constructs a mixin object that can be merged into the `automation_hybrid_runbook_worker_group`\nTerraform resource block to set or update the credential_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `credential_name` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.automation_hybrid_runbook_worker_group.withName` constructs a mixin object that can be merged into the `automation_hybrid_runbook_worker_group`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.automation_hybrid_runbook_worker_group.withResourceGroupName` constructs a mixin object that can be merged into the `automation_hybrid_runbook_worker_group`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.automation_hybrid_runbook_worker_group.withTimeouts` constructs a mixin object that can be merged into the `automation_hybrid_runbook_worker_group`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.automation_hybrid_runbook_worker_group.withTimeoutsMixin` constructs a mixin object that can be merged into the `automation_hybrid_runbook_worker_group`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.automation_hybrid_runbook_worker_group.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
