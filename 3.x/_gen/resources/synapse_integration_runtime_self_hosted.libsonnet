...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDescription':: d.fn(help='`azurerm.synapse_integration_runtime_self_hosted.withDescription` constructs a mixin object that can be merged into the `synapse_integration_runtime_self_hosted`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.synapse_integration_runtime_self_hosted.withName` constructs a mixin object that can be merged into the `synapse_integration_runtime_self_hosted`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withSynapseWorkspaceId':: d.fn(help='`azurerm.synapse_integration_runtime_self_hosted.withSynapseWorkspaceId` constructs a mixin object that can be merged into the `synapse_integration_runtime_self_hosted`\nTerraform resource block to set or update the synapse_workspace_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `synapse_workspace_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.synapse_integration_runtime_self_hosted.withTimeouts` constructs a mixin object that can be merged into the `synapse_integration_runtime_self_hosted`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.synapse_integration_runtime_self_hosted.withTimeoutsMixin` constructs a mixin object that can be merged into the `synapse_integration_runtime_self_hosted`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.synapse_integration_runtime_self_hosted.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
