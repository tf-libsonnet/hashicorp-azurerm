...
{
  '#':: d.pkg(name='network_interface_application_security_group_association', url='', help='`network_interface_application_security_group_association` represents the `azurerm_network_interface_application_security_group_association` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  new(
    ...
    label=resourceLabel,
    attrs=self.newAttrs(application_security_group_id=application_security_group_id, network_interface_id=network_interface_id, timeouts=timeouts),
    _meta=_meta
  ),
  ...
  '#withApplicationSecurityGroupId':: d.fn(help='`azurerm.network_interface_application_security_group_association.withApplicationSecurityGroupId` constructs a mixin object that can be merged into the `network_interface_application_security_group_association`\nTerraform resource block to set or update the application_security_group_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `application_security_group_id` field.\n', args=[]),
  ...
  '#withNetworkInterfaceId':: d.fn(help='`azurerm.network_interface_application_security_group_association.withNetworkInterfaceId` constructs a mixin object that can be merged into the `network_interface_application_security_group_association`\nTerraform resource block to set or update the network_interface_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `network_interface_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.network_interface_application_security_group_association.withTimeouts` constructs a mixin object that can be merged into the `network_interface_application_security_group_association`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.network_interface_application_security_group_association.withTimeoutsMixin` constructs a mixin object that can be merged into the `network_interface_application_security_group_association`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.network_interface_application_security_group_association.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
