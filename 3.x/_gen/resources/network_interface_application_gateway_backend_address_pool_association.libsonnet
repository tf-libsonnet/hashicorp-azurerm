...
{
  '#':: d.pkg(name='network_interface_application_gateway_backend_address_pool_association', url='', help='`network_interface_application_gateway_backend_address_pool_association` represents the `azurerm_network_interface_application_gateway_backend_address_pool_association` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withBackendAddressPoolId':: d.fn(help='`azurerm.network_interface_application_gateway_backend_address_pool_association.withBackendAddressPoolId` constructs a mixin object that can be merged into the `network_interface_application_gateway_backend_address_pool_association`\nTerraform resource block to set or update the backend_address_pool_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `backend_address_pool_id` field.\n', args=[]),
  ...
  '#withIpConfigurationName':: d.fn(help='`azurerm.network_interface_application_gateway_backend_address_pool_association.withIpConfigurationName` constructs a mixin object that can be merged into the `network_interface_application_gateway_backend_address_pool_association`\nTerraform resource block to set or update the ip_configuration_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ip_configuration_name` field.\n', args=[]),
  ...
  '#withNetworkInterfaceId':: d.fn(help='`azurerm.network_interface_application_gateway_backend_address_pool_association.withNetworkInterfaceId` constructs a mixin object that can be merged into the `network_interface_application_gateway_backend_address_pool_association`\nTerraform resource block to set or update the network_interface_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `network_interface_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.network_interface_application_gateway_backend_address_pool_association.withTimeouts` constructs a mixin object that can be merged into the `network_interface_application_gateway_backend_address_pool_association`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.network_interface_application_gateway_backend_address_pool_association.withTimeoutsMixin` constructs a mixin object that can be merged into the `network_interface_application_gateway_backend_address_pool_association`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.network_interface_application_gateway_backend_address_pool_association.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
