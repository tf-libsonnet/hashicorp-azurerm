...
{
  '#':: d.pkg(name='mysql_server_key', url='', help='`mysql_server_key` represents the `azurerm_mysql_server_key` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withKeyVaultKeyId':: d.fn(help='`azurerm.mysql_server_key.withKeyVaultKeyId` constructs a mixin object that can be merged into the `mysql_server_key`\nTerraform resource block to set or update the key_vault_key_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `key_vault_key_id` field.\n', args=[]),
  ...
  '#withServerId':: d.fn(help='`azurerm.mysql_server_key.withServerId` constructs a mixin object that can be merged into the `mysql_server_key`\nTerraform resource block to set or update the server_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `server_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.mysql_server_key.withTimeouts` constructs a mixin object that can be merged into the `mysql_server_key`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.mysql_server_key.withTimeoutsMixin` constructs a mixin object that can be merged into the `mysql_server_key`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.mysql_server_key.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
