...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDynamicFilenameEnabled':: d.fn(help='`azurerm.bool.withDynamicFilenameEnabled` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the dynamic_filename_enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `dynamic_filename_enabled` field.\n', args=[]),
  ...
  '#withDynamicPathEnabled':: d.fn(help='`azurerm.bool.withDynamicPathEnabled` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the dynamic_path_enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `dynamic_path_enabled` field.\n', args=[]),
