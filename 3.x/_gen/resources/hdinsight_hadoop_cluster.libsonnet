...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  metastores:: {
    ...
    '#new':: d.fn(help='\n`azurerm.hdinsight_hadoop_cluster.metastores.new` constructs a new object with attributes and blocks configured for the `metastores`\nTerraform sub block.\n\n\n\n**Args**:\n  - `ambari` (`list[obj]`):  When `null`, the `ambari` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.hdinsight_hadoop_cluster.metastores.ambari.new](#fn-metastoresambarinew) constructor.\n  - `hive` (`list[obj]`):  When `null`, the `hive` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.hdinsight_hadoop_cluster.metastores.hive.new](#fn-metastoreshivenew) constructor.\n  - `oozie` (`list[obj]`):  When `null`, the `oozie` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.hdinsight_hadoop_cluster.metastores.oozie.new](#fn-metastoresoozienew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `metastores` sub block.\n', args=[]),
    new(
      ambari=null,
      hive=null,
      oozie=null
  ...
  '#new':: d.fn(help="\n`azurerm.hdinsight_hadoop_cluster.new` injects a new `azurerm_hdinsight_hadoop_cluster` Terraform `resource`\nblock into the root module document.\n\nAdditionally, this inserts a private function into the `_ref` attribute that generates references to attributes of the\nresource. For example, if you added a new instance to the root using:\n\n    # arguments omitted for brevity\n    azurerm.hdinsight_hadoop_cluster.new('some_id')\n\nYou can get the reference to the `id` field of the created `azurerm.hdinsight_hadoop_cluster` using the reference:\n\n    $._ref.azurerm_hdinsight_hadoop_cluster.some_id.get('id')\n\nThis is the same as directly entering `\"${ azurerm_hdinsight_hadoop_cluster.some_id.id }\"` as the value.\n\nNOTE: if you are chaining multiple resources together in a merge operation, you may not be able to use `super`, `self`,\nor `$` to refer to the root object. Instead, make an explicit outer object using `local`.\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block.\n  - `cluster_version` (`string`): \n  - `location` (`string`): \n  - `name` (`string`): \n  - `resource_group_name` (`string`): \n  - `tags` (`obj`):  When `null`, the `tags` field will be omitted from the resulting object.\n  - `tier` (`string`): \n  - `tls_min_version` (`string`):  When `null`, the `tls_min_version` field will be omitted from the resulting object.\n  - `component_version` (`list[obj]`):  When `null`, the `component_version` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.hdinsight_hadoop_cluster.component_version.new](#fn-hdinsighthadoopclustercomponentversionnew) constructor.\n  - `compute_isolation` (`list[obj]`):  When `null`, the `compute_isolation` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.hdinsight_hadoop_cluster.compute_isolation.new](#fn-hdinsighthadoopclustercomputeisolationnew) constructor.\n  - `disk_encryption` (`list[obj]`):  When `null`, the `disk_encryption` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.hdinsight_hadoop_cluster.disk_encryption.new](#fn-hdinsighthadoopclusterdiskencryptionnew) constructor.\n  - `extension` (`list[obj]`):  When `null`, the `extension` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.hdinsight_hadoop_cluster.extension.new](#fn-hdinsighthadoopclusterextensionnew) constructor.\n  - `gateway` (`list[obj]`):  When `null`, the `gateway` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.hdinsight_hadoop_cluster.gateway.new](#fn-hdinsighthadoopclustergatewaynew) constructor.\n  - `metastores` (`list[obj]`):  When `null`, the `metastores` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.hdinsight_hadoop_cluster.metastores.new](#fn-hdinsighthadoopclustermetastoresnew) constructor.\n  - `monitor` (`list[obj]`):  When `null`, the `monitor` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.hdinsight_hadoop_cluster.monitor.new](#fn-hdinsighthadoopclustermonitornew) constructor.\n  - `network` (`list[obj]`):  When `null`, the `network` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.hdinsight_hadoop_cluster.network.new](#fn-hdinsighthadoopclusternetworknew) constructor.\n  - `roles` (`list[obj]`):  When `null`, the `roles` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.hdinsight_hadoop_cluster.roles.new](#fn-hdinsighthadoopclusterrolesnew) constructor.\n  - `security_profile` (`list[obj]`):  When `null`, the `security_profile` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.hdinsight_hadoop_cluster.security_profile.new](#fn-hdinsighthadoopclustersecurityprofilenew) constructor.\n  - `storage_account` (`list[obj]`):  When `null`, the `storage_account` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.hdinsight_hadoop_cluster.storage_account.new](#fn-hdinsighthadoopclusterstorageaccountnew) constructor.\n  - `storage_account_gen2` (`list[obj]`):  When `null`, the `storage_account_gen2` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.hdinsight_hadoop_cluster.storage_account_gen2.new](#fn-hdinsighthadoopclusterstorageaccountgen2new) constructor.\n  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.hdinsight_hadoop_cluster.timeouts.new](#fn-hdinsighthadoopclustertimeoutsnew) constructor.\n\n**Returns**:\n- A mixin object that injects the new resource into the root Terraform configuration.\n", args=[]),
  new(
    resourceLabel,
    cluster_version,
    location,
  ...
  roles:: {
    ...
    '#new':: d.fn(help='\n`azurerm.hdinsight_hadoop_cluster.roles.new` constructs a new object with attributes and blocks configured for the `roles`\nTerraform sub block.\n\n\n\n**Args**:\n  - `edge_node` (`list[obj]`):  When `null`, the `edge_node` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.hdinsight_hadoop_cluster.roles.edge_node.new](#fn-rolesedgenodenew) constructor.\n  - `head_node` (`list[obj]`):  When `null`, the `head_node` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.hdinsight_hadoop_cluster.roles.head_node.new](#fn-rolesheadnodenew) constructor.\n  - `worker_node` (`list[obj]`):  When `null`, the `worker_node` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.hdinsight_hadoop_cluster.roles.worker_node.new](#fn-rolesworkernodenew) constructor.\n  - `zookeeper_node` (`list[obj]`):  When `null`, the `zookeeper_node` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.hdinsight_hadoop_cluster.roles.zookeeper_node.new](#fn-roleszookeepernodenew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `roles` sub block.\n', args=[]),
    new(
      edge_node=null,
      head_node=null,
      worker_node=null,
    ...
    worker_node:: {
      autoscale:: {
        ...
        '#new':: d.fn(help='\n`azurerm.hdinsight_hadoop_cluster.roles.worker_node.autoscale.new` constructs a new object with attributes and blocks configured for the `autoscale`\nTerraform sub block.\n\n\n\n**Args**:\n  - `capacity` (`list[obj]`):  When `null`, the `capacity` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.hdinsight_hadoop_cluster.roles.worker_node.autoscale.capacity.new](#fn-autoscalecapacitynew) constructor.\n  - `recurrence` (`list[obj]`):  When `null`, the `recurrence` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.hdinsight_hadoop_cluster.roles.worker_node.autoscale.recurrence.new](#fn-autoscalerecurrencenew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `autoscale` sub block.\n', args=[]),
        new(
          capacity=null,
          recurrence=null
        ):: std.prune(a={
        ...
        recurrence:: {
          '#new':: d.fn(help='\n`azurerm.hdinsight_hadoop_cluster.roles.worker_node.autoscale.recurrence.new` constructs a new object with attributes and blocks configured for the `recurrence`\nTerraform sub block.\n\n\n\n**Args**:\n  - `timezone` (`string`): \n  - `schedule` (`list[obj]`):  When `null`, the `schedule` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.hdinsight_hadoop_cluster.roles.worker_node.autoscale.recurrence.schedule.new](#fn-recurrenceschedulenew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `recurrence` sub block.\n', args=[]),
          new(
            timezone,
            schedule=null
          ):: std.prune(a={
      ...
      '#new':: d.fn(help='\n`azurerm.hdinsight_hadoop_cluster.roles.worker_node.new` constructs a new object with attributes and blocks configured for the `worker_node`\nTerraform sub block.\n\n\n\n**Args**:\n  - `password` (`string`):  When `null`, the `password` field will be omitted from the resulting object.\n  - `ssh_keys` (`list`):  When `null`, the `ssh_keys` field will be omitted from the resulting object.\n  - `subnet_id` (`string`):  When `null`, the `subnet_id` field will be omitted from the resulting object.\n  - `target_instance_count` (`number`): \n  - `username` (`string`): \n  - `virtual_network_id` (`string`):  When `null`, the `virtual_network_id` field will be omitted from the resulting object.\n  - `vm_size` (`string`): \n  - `autoscale` (`list[obj]`):  When `null`, the `autoscale` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.hdinsight_hadoop_cluster.roles.worker_node.autoscale.new](#fn-workernodeautoscalenew) constructor.\n  - `script_actions` (`list[obj]`):  When `null`, the `script_actions` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.hdinsight_hadoop_cluster.roles.worker_node.script_actions.new](#fn-workernodescriptactionsnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `worker_node` sub block.\n', args=[]),
      new(
        target_instance_count,
        username,
        vm_size,
  ...
  '#withClusterVersion':: d.fn(help='`azurerm.hdinsight_hadoop_cluster.withClusterVersion` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`\nTerraform resource block to set or update the cluster_version field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cluster_version` field.\n', args=[]),
  ...
  '#withComponentVersion':: d.fn(help='`azurerm.hdinsight_hadoop_cluster.withComponentVersion` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`\nTerraform resource block to set or update the component_version field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `component_version` field.\n', args=[]),
  ...
  '#withComponentVersionMixin':: d.fn(help='`azurerm.hdinsight_hadoop_cluster.withComponentVersionMixin` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`\nTerraform resource block to set or update the component_version field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.hdinsight_hadoop_cluster.withComponentVersion](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `component_version` field.\n', args=[]),
  ...
  '#withComputeIsolation':: d.fn(help='`azurerm.hdinsight_hadoop_cluster.withComputeIsolation` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`\nTerraform resource block to set or update the compute_isolation field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `compute_isolation` field.\n', args=[]),
  ...
  '#withComputeIsolationMixin':: d.fn(help='`azurerm.hdinsight_hadoop_cluster.withComputeIsolationMixin` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`\nTerraform resource block to set or update the compute_isolation field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.hdinsight_hadoop_cluster.withComputeIsolation](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `compute_isolation` field.\n', args=[]),
  ...
  '#withDiskEncryption':: d.fn(help='`azurerm.hdinsight_hadoop_cluster.withDiskEncryption` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`\nTerraform resource block to set or update the disk_encryption field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `disk_encryption` field.\n', args=[]),
  ...
  '#withDiskEncryptionMixin':: d.fn(help='`azurerm.hdinsight_hadoop_cluster.withDiskEncryptionMixin` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`\nTerraform resource block to set or update the disk_encryption field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.hdinsight_hadoop_cluster.withDiskEncryption](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `disk_encryption` field.\n', args=[]),
  ...
  '#withExtension':: d.fn(help='`azurerm.hdinsight_hadoop_cluster.withExtension` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`\nTerraform resource block to set or update the extension field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `extension` field.\n', args=[]),
  ...
  '#withExtensionMixin':: d.fn(help='`azurerm.hdinsight_hadoop_cluster.withExtensionMixin` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`\nTerraform resource block to set or update the extension field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.hdinsight_hadoop_cluster.withExtension](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `extension` field.\n', args=[]),
  ...
  '#withGateway':: d.fn(help='`azurerm.hdinsight_hadoop_cluster.withGateway` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`\nTerraform resource block to set or update the gateway field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `gateway` field.\n', args=[]),
  ...
  '#withGatewayMixin':: d.fn(help='`azurerm.hdinsight_hadoop_cluster.withGatewayMixin` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`\nTerraform resource block to set or update the gateway field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.hdinsight_hadoop_cluster.withGateway](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `gateway` field.\n', args=[]),
  ...
  '#withLocation':: d.fn(help='`azurerm.hdinsight_hadoop_cluster.withLocation` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`\nTerraform resource block to set or update the location field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `location` field.\n', args=[]),
  ...
  '#withMetastores':: d.fn(help='`azurerm.hdinsight_hadoop_cluster.withMetastores` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`\nTerraform resource block to set or update the metastores field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `metastores` field.\n', args=[]),
  ...
  '#withMetastoresMixin':: d.fn(help='`azurerm.hdinsight_hadoop_cluster.withMetastoresMixin` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`\nTerraform resource block to set or update the metastores field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.hdinsight_hadoop_cluster.withMetastores](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `metastores` field.\n', args=[]),
  ...
  '#withMonitor':: d.fn(help='`azurerm.hdinsight_hadoop_cluster.withMonitor` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`\nTerraform resource block to set or update the monitor field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `monitor` field.\n', args=[]),
  ...
  '#withMonitorMixin':: d.fn(help='`azurerm.hdinsight_hadoop_cluster.withMonitorMixin` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`\nTerraform resource block to set or update the monitor field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.hdinsight_hadoop_cluster.withMonitor](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `monitor` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.hdinsight_hadoop_cluster.withName` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withNetwork':: d.fn(help='`azurerm.hdinsight_hadoop_cluster.withNetwork` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`\nTerraform resource block to set or update the network field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `network` field.\n', args=[]),
  ...
  '#withNetworkMixin':: d.fn(help='`azurerm.hdinsight_hadoop_cluster.withNetworkMixin` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`\nTerraform resource block to set or update the network field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.hdinsight_hadoop_cluster.withNetwork](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `network` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.hdinsight_hadoop_cluster.withResourceGroupName` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withRoles':: d.fn(help='`azurerm.hdinsight_hadoop_cluster.withRoles` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`\nTerraform resource block to set or update the roles field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `roles` field.\n', args=[]),
  ...
  '#withRolesMixin':: d.fn(help='`azurerm.hdinsight_hadoop_cluster.withRolesMixin` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`\nTerraform resource block to set or update the roles field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.hdinsight_hadoop_cluster.withRoles](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `roles` field.\n', args=[]),
  ...
  '#withSecurityProfile':: d.fn(help='`azurerm.hdinsight_hadoop_cluster.withSecurityProfile` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`\nTerraform resource block to set or update the security_profile field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `security_profile` field.\n', args=[]),
  ...
  '#withSecurityProfileMixin':: d.fn(help='`azurerm.hdinsight_hadoop_cluster.withSecurityProfileMixin` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`\nTerraform resource block to set or update the security_profile field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.hdinsight_hadoop_cluster.withSecurityProfile](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `security_profile` field.\n', args=[]),
  ...
  '#withStorageAccount':: d.fn(help='`azurerm.hdinsight_hadoop_cluster.withStorageAccount` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`\nTerraform resource block to set or update the storage_account field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `storage_account` field.\n', args=[]),
  ...
  '#withStorageAccountGen2':: d.fn(help='`azurerm.hdinsight_hadoop_cluster.withStorageAccountGen2` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`\nTerraform resource block to set or update the storage_account_gen2 field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `storage_account_gen2` field.\n', args=[]),
  ...
  '#withStorageAccountGen2Mixin':: d.fn(help='`azurerm.hdinsight_hadoop_cluster.withStorageAccountGen2Mixin` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`\nTerraform resource block to set or update the storage_account_gen2 field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.hdinsight_hadoop_cluster.withStorageAccountGen2](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `storage_account_gen2` field.\n', args=[]),
  ...
  '#withStorageAccountMixin':: d.fn(help='`azurerm.hdinsight_hadoop_cluster.withStorageAccountMixin` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`\nTerraform resource block to set or update the storage_account field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.hdinsight_hadoop_cluster.withStorageAccount](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `storage_account` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`azurerm.hdinsight_hadoop_cluster.withTags` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTier':: d.fn(help='`azurerm.hdinsight_hadoop_cluster.withTier` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`\nTerraform resource block to set or update the tier field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tier` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.hdinsight_hadoop_cluster.withTimeouts` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.hdinsight_hadoop_cluster.withTimeoutsMixin` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.hdinsight_hadoop_cluster.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTlsMinVersion':: d.fn(help='`azurerm.hdinsight_hadoop_cluster.withTlsMinVersion` constructs a mixin object that can be merged into the `hdinsight_hadoop_cluster`\nTerraform resource block to set or update the tls_min_version field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tls_min_version` field.\n', args=[]),
