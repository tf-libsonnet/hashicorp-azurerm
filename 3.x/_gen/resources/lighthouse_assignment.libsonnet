...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withLighthouseDefinitionId':: d.fn(help='`azurerm.lighthouse_assignment.withLighthouseDefinitionId` constructs a mixin object that can be merged into the `lighthouse_assignment`\nTerraform resource block to set or update the lighthouse_definition_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `lighthouse_definition_id` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.lighthouse_assignment.withName` constructs a mixin object that can be merged into the `lighthouse_assignment`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withScope':: d.fn(help='`azurerm.lighthouse_assignment.withScope` constructs a mixin object that can be merged into the `lighthouse_assignment`\nTerraform resource block to set or update the scope field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `scope` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.lighthouse_assignment.withTimeouts` constructs a mixin object that can be merged into the `lighthouse_assignment`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.lighthouse_assignment.withTimeoutsMixin` constructs a mixin object that can be merged into the `lighthouse_assignment`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.lighthouse_assignment.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
