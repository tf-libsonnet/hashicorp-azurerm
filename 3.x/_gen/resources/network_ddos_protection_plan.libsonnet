...
{
  '#':: d.pkg(name='network_ddos_protection_plan', url='', help='`network_ddos_protection_plan` represents the `azurerm_network_ddos_protection_plan` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withLocation':: d.fn(help='`azurerm.network_ddos_protection_plan.withLocation` constructs a mixin object that can be merged into the `network_ddos_protection_plan`\nTerraform resource block to set or update the location field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `location` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.network_ddos_protection_plan.withName` constructs a mixin object that can be merged into the `network_ddos_protection_plan`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.network_ddos_protection_plan.withResourceGroupName` constructs a mixin object that can be merged into the `network_ddos_protection_plan`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`azurerm.network_ddos_protection_plan.withTags` constructs a mixin object that can be merged into the `network_ddos_protection_plan`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.network_ddos_protection_plan.withTimeouts` constructs a mixin object that can be merged into the `network_ddos_protection_plan`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.network_ddos_protection_plan.withTimeoutsMixin` constructs a mixin object that can be merged into the `network_ddos_protection_plan`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.network_ddos_protection_plan.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
