...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  delegation:: {
    '#new':: d.fn(help='\n`azurerm.subnet.delegation.new` constructs a new object with attributes and blocks configured for the `delegation`\nTerraform sub block.\n\n\n\n**Args**:\n  - `name` (`string`): \n  - `service_delegation` (`list[obj]`):  When `null`, the `service_delegation` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.subnet.delegation.service_delegation.new](#fn-subnetservice_delegationnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `delegation` sub block.\n', args=[]),
    new(
      name,
