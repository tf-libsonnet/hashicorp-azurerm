...
{
  '#':: d.pkg(name='cosmosdb_sql_role_assignment', url='', help='`cosmosdb_sql_role_assignment` represents the `azurerm_cosmosdb_sql_role_assignment` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withAccountName':: d.fn(help='`azurerm.cosmosdb_sql_role_assignment.withAccountName` constructs a mixin object that can be merged into the `cosmosdb_sql_role_assignment`\nTerraform resource block to set or update the account_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `account_name` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.cosmosdb_sql_role_assignment.withName` constructs a mixin object that can be merged into the `cosmosdb_sql_role_assignment`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withPrincipalId':: d.fn(help='`azurerm.cosmosdb_sql_role_assignment.withPrincipalId` constructs a mixin object that can be merged into the `cosmosdb_sql_role_assignment`\nTerraform resource block to set or update the principal_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `principal_id` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.cosmosdb_sql_role_assignment.withResourceGroupName` constructs a mixin object that can be merged into the `cosmosdb_sql_role_assignment`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withRoleDefinitionId':: d.fn(help='`azurerm.cosmosdb_sql_role_assignment.withRoleDefinitionId` constructs a mixin object that can be merged into the `cosmosdb_sql_role_assignment`\nTerraform resource block to set or update the role_definition_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `role_definition_id` field.\n', args=[]),
  ...
  '#withScope':: d.fn(help='`azurerm.cosmosdb_sql_role_assignment.withScope` constructs a mixin object that can be merged into the `cosmosdb_sql_role_assignment`\nTerraform resource block to set or update the scope field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `scope` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.cosmosdb_sql_role_assignment.withTimeouts` constructs a mixin object that can be merged into the `cosmosdb_sql_role_assignment`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.cosmosdb_sql_role_assignment.withTimeoutsMixin` constructs a mixin object that can be merged into the `cosmosdb_sql_role_assignment`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.cosmosdb_sql_role_assignment.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
