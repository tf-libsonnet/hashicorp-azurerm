...
{
  '#':: d.pkg(name='data_protection_backup_policy_blob_storage', url='', help='`data_protection_backup_policy_blob_storage` represents the `azurerm_data_protection_backup_policy_blob_storage` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withName':: d.fn(help='`azurerm.data_protection_backup_policy_blob_storage.withName` constructs a mixin object that can be merged into the `data_protection_backup_policy_blob_storage`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withRetentionDuration':: d.fn(help='`azurerm.data_protection_backup_policy_blob_storage.withRetentionDuration` constructs a mixin object that can be merged into the `data_protection_backup_policy_blob_storage`\nTerraform resource block to set or update the retention_duration field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `retention_duration` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.data_protection_backup_policy_blob_storage.withTimeouts` constructs a mixin object that can be merged into the `data_protection_backup_policy_blob_storage`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.data_protection_backup_policy_blob_storage.withTimeoutsMixin` constructs a mixin object that can be merged into the `data_protection_backup_policy_blob_storage`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.data_protection_backup_policy_blob_storage.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withVaultId':: d.fn(help='`azurerm.data_protection_backup_policy_blob_storage.withVaultId` constructs a mixin object that can be merged into the `data_protection_backup_policy_blob_storage`\nTerraform resource block to set or update the vault_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vault_id` field.\n', args=[]),
