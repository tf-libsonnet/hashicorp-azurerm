...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  index_policy:: {
    composite_index:: {
      ...
      '#new':: d.fn(help='\n`azurerm.cosmosdb_gremlin_graph.index_policy.composite_index.new` constructs a new object with attributes and blocks configured for the `composite_index`\nTerraform sub block.\n\n\n\n**Args**:\n  - `index` (`list[obj]`):  When `null`, the `index` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.cosmosdb_gremlin_graph.index_policy.composite_index.index.new](#fn-index_policyindexnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `composite_index` sub block.\n', args=[]),
      new(
        index=null
      ):: std.prune(a={
        index: index,
    ...
    '#new':: d.fn(help='\n`azurerm.cosmosdb_gremlin_graph.index_policy.new` constructs a new object with attributes and blocks configured for the `index_policy`\nTerraform sub block.\n\n\n\n**Args**:\n  - `automatic` (`bool`):  When `null`, the `automatic` field will be omitted from the resulting object.\n  - `excluded_paths` (`list`):  When `null`, the `excluded_paths` field will be omitted from the resulting object.\n  - `included_paths` (`list`):  When `null`, the `included_paths` field will be omitted from the resulting object.\n  - `indexing_mode` (`string`): \n  - `composite_index` (`list[obj]`):  When `null`, the `composite_index` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.cosmosdb_gremlin_graph.index_policy.composite_index.new](#fn-composite_indexnew) constructor.\n  - `spatial_index` (`list[obj]`):  When `null`, the `spatial_index` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.cosmosdb_gremlin_graph.index_policy.spatial_index.new](#fn-spatial_indexnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `index_policy` sub block.\n', args=[]),
    new(
      indexing_mode,
      automatic=null,
