...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withApiManagementId':: d.fn(help='`azurerm.api_management_notification_recipient_email.withApiManagementId` constructs a mixin object that can be merged into the `api_management_notification_recipient_email`\nTerraform resource block to set or update the api_management_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `api_management_id` field.\n', args=[]),
  ...
  '#withEmail':: d.fn(help='`azurerm.api_management_notification_recipient_email.withEmail` constructs a mixin object that can be merged into the `api_management_notification_recipient_email`\nTerraform resource block to set or update the email field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `email` field.\n', args=[]),
  ...
  '#withNotificationType':: d.fn(help='`azurerm.api_management_notification_recipient_email.withNotificationType` constructs a mixin object that can be merged into the `api_management_notification_recipient_email`\nTerraform resource block to set or update the notification_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `notification_type` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.api_management_notification_recipient_email.withTimeouts` constructs a mixin object that can be merged into the `api_management_notification_recipient_email`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.api_management_notification_recipient_email.withTimeoutsMixin` constructs a mixin object that can be merged into the `api_management_notification_recipient_email`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.api_management_notification_recipient_email.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
