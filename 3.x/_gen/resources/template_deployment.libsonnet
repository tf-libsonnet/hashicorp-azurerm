...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDeploymentMode':: d.fn(help='`azurerm.template_deployment.withDeploymentMode` constructs a mixin object that can be merged into the `template_deployment`\nTerraform resource block to set or update the deployment_mode field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `deployment_mode` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.template_deployment.withName` constructs a mixin object that can be merged into the `template_deployment`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withParameters':: d.fn(help='`azurerm.template_deployment.withParameters` constructs a mixin object that can be merged into the `template_deployment`\nTerraform resource block to set or update the parameters field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `parameters` field.\n', args=[]),
  ...
  '#withParametersBody':: d.fn(help='`azurerm.template_deployment.withParametersBody` constructs a mixin object that can be merged into the `template_deployment`\nTerraform resource block to set or update the parameters_body field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `parameters_body` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.template_deployment.withResourceGroupName` constructs a mixin object that can be merged into the `template_deployment`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withTemplateBody':: d.fn(help='`azurerm.template_deployment.withTemplateBody` constructs a mixin object that can be merged into the `template_deployment`\nTerraform resource block to set or update the template_body field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `template_body` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.template_deployment.withTimeouts` constructs a mixin object that can be merged into the `template_deployment`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.template_deployment.withTimeoutsMixin` constructs a mixin object that can be merged into the `template_deployment`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.template_deployment.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
