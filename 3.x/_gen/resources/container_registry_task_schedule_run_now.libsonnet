...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withContainerRegistryTaskId':: d.fn(help='`azurerm.container_registry_task_schedule_run_now.withContainerRegistryTaskId` constructs a mixin object that can be merged into the `container_registry_task_schedule_run_now`\nTerraform resource block to set or update the container_registry_task_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `container_registry_task_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.container_registry_task_schedule_run_now.withTimeouts` constructs a mixin object that can be merged into the `container_registry_task_schedule_run_now`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.container_registry_task_schedule_run_now.withTimeoutsMixin` constructs a mixin object that can be merged into the `container_registry_task_schedule_run_now`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.container_registry_task_schedule_run_now.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
