...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBotName':: d.fn(help='`azurerm.bot_channel_email.withBotName` constructs a mixin object that can be merged into the `bot_channel_email`\nTerraform resource block to set or update the bot_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `bot_name` field.\n', args=[]),
  ...
  '#withEmailAddress':: d.fn(help='`azurerm.bot_channel_email.withEmailAddress` constructs a mixin object that can be merged into the `bot_channel_email`\nTerraform resource block to set or update the email_address field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `email_address` field.\n', args=[]),
  ...
  '#withEmailPassword':: d.fn(help='`azurerm.bot_channel_email.withEmailPassword` constructs a mixin object that can be merged into the `bot_channel_email`\nTerraform resource block to set or update the email_password field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `email_password` field.\n', args=[]),
  ...
  '#withLocation':: d.fn(help='`azurerm.bot_channel_email.withLocation` constructs a mixin object that can be merged into the `bot_channel_email`\nTerraform resource block to set or update the location field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `location` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.bot_channel_email.withResourceGroupName` constructs a mixin object that can be merged into the `bot_channel_email`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.bot_channel_email.withTimeouts` constructs a mixin object that can be merged into the `bot_channel_email`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.bot_channel_email.withTimeoutsMixin` constructs a mixin object that can be merged into the `bot_channel_email`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.bot_channel_email.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
