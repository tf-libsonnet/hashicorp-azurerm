...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAutomationAccountName':: d.fn(help='`azurerm.automation_module.withAutomationAccountName` constructs a mixin object that can be merged into the `automation_module`\nTerraform resource block to set or update the automation_account_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `automation_account_name` field.\n', args=[]),
  ...
  '#withModuleLink':: d.fn(help='`azurerm.automation_module.withModuleLink` constructs a mixin object that can be merged into the `automation_module`\nTerraform resource block to set or update the module_link field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `module_link` field.\n', args=[]),
  ...
  '#withModuleLinkMixin':: d.fn(help='`azurerm.automation_module.withModuleLinkMixin` constructs a mixin object that can be merged into the `automation_module`\nTerraform resource block to set or update the module_link field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.automation_module.withModuleLink](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `module_link` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.automation_module.withName` constructs a mixin object that can be merged into the `automation_module`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.automation_module.withResourceGroupName` constructs a mixin object that can be merged into the `automation_module`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.automation_module.withTimeouts` constructs a mixin object that can be merged into the `automation_module`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.automation_module.withTimeoutsMixin` constructs a mixin object that can be merged into the `automation_module`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.automation_module.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
