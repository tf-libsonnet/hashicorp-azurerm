...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCertificateContent':: d.fn(help='`azurerm.spring_cloud_certificate.withCertificateContent` constructs a mixin object that can be merged into the `spring_cloud_certificate`\nTerraform resource block to set or update the certificate_content field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `certificate_content` field.\n', args=[]),
  ...
  '#withKeyVaultCertificateId':: d.fn(help='`azurerm.spring_cloud_certificate.withKeyVaultCertificateId` constructs a mixin object that can be merged into the `spring_cloud_certificate`\nTerraform resource block to set or update the key_vault_certificate_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `key_vault_certificate_id` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.spring_cloud_certificate.withName` constructs a mixin object that can be merged into the `spring_cloud_certificate`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.spring_cloud_certificate.withResourceGroupName` constructs a mixin object that can be merged into the `spring_cloud_certificate`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withServiceName':: d.fn(help='`azurerm.spring_cloud_certificate.withServiceName` constructs a mixin object that can be merged into the `spring_cloud_certificate`\nTerraform resource block to set or update the service_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.spring_cloud_certificate.withTimeouts` constructs a mixin object that can be merged into the `spring_cloud_certificate`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.spring_cloud_certificate.withTimeoutsMixin` constructs a mixin object that can be merged into the `spring_cloud_certificate`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.spring_cloud_certificate.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
