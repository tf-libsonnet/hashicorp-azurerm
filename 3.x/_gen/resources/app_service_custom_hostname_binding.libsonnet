...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAppServiceName':: d.fn(help='`azurerm.app_service_custom_hostname_binding.withAppServiceName` constructs a mixin object that can be merged into the `app_service_custom_hostname_binding`\nTerraform resource block to set or update the app_service_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `app_service_name` field.\n', args=[]),
  ...
  '#withHostname':: d.fn(help='`azurerm.app_service_custom_hostname_binding.withHostname` constructs a mixin object that can be merged into the `app_service_custom_hostname_binding`\nTerraform resource block to set or update the hostname field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `hostname` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.app_service_custom_hostname_binding.withResourceGroupName` constructs a mixin object that can be merged into the `app_service_custom_hostname_binding`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withSslState':: d.fn(help='`azurerm.app_service_custom_hostname_binding.withSslState` constructs a mixin object that can be merged into the `app_service_custom_hostname_binding`\nTerraform resource block to set or update the ssl_state field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ssl_state` field.\n', args=[]),
  ...
  '#withThumbprint':: d.fn(help='`azurerm.app_service_custom_hostname_binding.withThumbprint` constructs a mixin object that can be merged into the `app_service_custom_hostname_binding`\nTerraform resource block to set or update the thumbprint field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `thumbprint` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.app_service_custom_hostname_binding.withTimeouts` constructs a mixin object that can be merged into the `app_service_custom_hostname_binding`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.app_service_custom_hostname_binding.withTimeoutsMixin` constructs a mixin object that can be merged into the `app_service_custom_hostname_binding`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.app_service_custom_hostname_binding.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
