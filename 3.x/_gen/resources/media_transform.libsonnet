...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDescription':: d.fn(help='`azurerm.media_transform.withDescription` constructs a mixin object that can be merged into the `media_transform`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withMediaServicesAccountName':: d.fn(help='`azurerm.media_transform.withMediaServicesAccountName` constructs a mixin object that can be merged into the `media_transform`\nTerraform resource block to set or update the media_services_account_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `media_services_account_name` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.media_transform.withName` constructs a mixin object that can be merged into the `media_transform`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withOutput':: d.fn(help='`azurerm.media_transform.withOutput` constructs a mixin object that can be merged into the `media_transform`\nTerraform resource block to set or update the output field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `output` field.\n', args=[]),
  ...
  '#withOutputMixin':: d.fn(help='`azurerm.media_transform.withOutputMixin` constructs a mixin object that can be merged into the `media_transform`\nTerraform resource block to set or update the output field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.media_transform.withOutput](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `output` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.media_transform.withResourceGroupName` constructs a mixin object that can be merged into the `media_transform`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.media_transform.withTimeouts` constructs a mixin object that can be merged into the `media_transform`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.media_transform.withTimeoutsMixin` constructs a mixin object that can be merged into the `media_transform`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.media_transform.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
