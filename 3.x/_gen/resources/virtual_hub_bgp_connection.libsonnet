...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withName':: d.fn(help='`azurerm.virtual_hub_bgp_connection.withName` constructs a mixin object that can be merged into the `virtual_hub_bgp_connection`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withPeerAsn':: d.fn(help='`azurerm.virtual_hub_bgp_connection.withPeerAsn` constructs a mixin object that can be merged into the `virtual_hub_bgp_connection`\nTerraform resource block to set or update the peer_asn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `peer_asn` field.\n', args=[]),
  ...
  '#withPeerIp':: d.fn(help='`azurerm.virtual_hub_bgp_connection.withPeerIp` constructs a mixin object that can be merged into the `virtual_hub_bgp_connection`\nTerraform resource block to set or update the peer_ip field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `peer_ip` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.virtual_hub_bgp_connection.withTimeouts` constructs a mixin object that can be merged into the `virtual_hub_bgp_connection`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.virtual_hub_bgp_connection.withTimeoutsMixin` constructs a mixin object that can be merged into the `virtual_hub_bgp_connection`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.virtual_hub_bgp_connection.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withVirtualHubId':: d.fn(help='`azurerm.virtual_hub_bgp_connection.withVirtualHubId` constructs a mixin object that can be merged into the `virtual_hub_bgp_connection`\nTerraform resource block to set or update the virtual_hub_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `virtual_hub_id` field.\n', args=[]),
  ...
  '#withVirtualNetworkConnectionId':: d.fn(help='`azurerm.virtual_hub_bgp_connection.withVirtualNetworkConnectionId` constructs a mixin object that can be merged into the `virtual_hub_bgp_connection`\nTerraform resource block to set or update the virtual_network_connection_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `virtual_network_connection_id` field.\n', args=[]),
