...
{
  '#':: d.pkg(name='iothub_certificate', url='', help='`iothub_certificate` represents the `azurerm_iothub_certificate` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withCertificateContent':: d.fn(help='`azurerm.iothub_certificate.withCertificateContent` constructs a mixin object that can be merged into the `iothub_certificate`\nTerraform resource block to set or update the certificate_content field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `certificate_content` field.\n', args=[]),
  ...
  '#withIothubName':: d.fn(help='`azurerm.iothub_certificate.withIothubName` constructs a mixin object that can be merged into the `iothub_certificate`\nTerraform resource block to set or update the iothub_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `iothub_name` field.\n', args=[]),
  ...
  '#withIsVerified':: d.fn(help='`azurerm.iothub_certificate.withIsVerified` constructs a mixin object that can be merged into the `iothub_certificate`\nTerraform resource block to set or update the is_verified field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `is_verified` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.iothub_certificate.withName` constructs a mixin object that can be merged into the `iothub_certificate`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.iothub_certificate.withResourceGroupName` constructs a mixin object that can be merged into the `iothub_certificate`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.iothub_certificate.withTimeouts` constructs a mixin object that can be merged into the `iothub_certificate`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.iothub_certificate.withTimeoutsMixin` constructs a mixin object that can be merged into the `iothub_certificate`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.iothub_certificate.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
