...
{
  '#':: d.pkg(name='function_app', url='', help='`function_app` represents the `azurerm_function_app` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  auth_settings:: {
    active_directory:: {
    ...
    '#new':: d.fn(help='\n`azurerm.function_app.auth_settings.new` constructs a new object with attributes and blocks configured for the `auth_settings`\nTerraform sub block.\n\n\n\n**Args**:\n  - `additional_login_params` (`obj`):  When `null`, the `additional_login_params` field will be omitted from the resulting object.\n  - `allowed_external_redirect_urls` (`list`):  When `null`, the `allowed_external_redirect_urls` field will be omitted from the resulting object.\n  - `default_provider` (`string`):  When `null`, the `default_provider` field will be omitted from the resulting object.\n  - `enabled` (`bool`): \n  - `issuer` (`string`):  When `null`, the `issuer` field will be omitted from the resulting object.\n  - `runtime_version` (`string`):  When `null`, the `runtime_version` field will be omitted from the resulting object.\n  - `token_refresh_extension_hours` (`number`):  When `null`, the `token_refresh_extension_hours` field will be omitted from the resulting object.\n  - `token_store_enabled` (`bool`):  When `null`, the `token_store_enabled` field will be omitted from the resulting object.\n  - `unauthenticated_client_action` (`string`):  When `null`, the `unauthenticated_client_action` field will be omitted from the resulting object.\n  - `active_directory` (`list[obj]`):  When `null`, the `active_directory` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.function_app.auth_settings.active_directory.new](#fn-authsettingsactivedirectorynew) constructor.\n  - `facebook` (`list[obj]`):  When `null`, the `facebook` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.function_app.auth_settings.facebook.new](#fn-authsettingsfacebooknew) constructor.\n  - `google` (`list[obj]`):  When `null`, the `google` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.function_app.auth_settings.google.new](#fn-authsettingsgooglenew) constructor.\n  - `microsoft` (`list[obj]`):  When `null`, the `microsoft` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.function_app.auth_settings.microsoft.new](#fn-authsettingsmicrosoftnew) constructor.\n  - `twitter` (`list[obj]`):  When `null`, the `twitter` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.function_app.auth_settings.twitter.new](#fn-authsettingstwitternew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `auth_settings` sub block.\n', args=[]),
    new(
      enabled,
  ...
  '#new':: d.fn(help="\n`azurerm.function_app.new` injects a new `azurerm_function_app` Terraform `resource`\nblock into the root module document.\n\nAdditionally, this inserts a private function into the `_ref` attribute that generates references to attributes of the\nresource. For example, if you added a new instance to the root using:\n\n    # arguments omitted for brevity\n    azurerm.function_app.new('some_id')\n\nYou can get the reference to the `id` field of the created `azurerm.function_app` using the reference:\n\n    $._ref.azurerm_function_app.some_id.get('id')\n\nThis is the same as directly entering `\"${ azurerm_function_app.some_id.id }\"` as the value.\n\nNOTE: if you are chaining multiple resources together in a merge operation, you may not be able to use `super`, `self`,\nor `$` to refer to the root object. Instead, make an explicit outer object using `local`.\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block.\n  - `app_service_plan_id` (`string`): \n  - `app_settings` (`obj`):  When `null`, the `app_settings` field will be omitted from the resulting object.\n  - `client_cert_mode` (`string`):  When `null`, the `client_cert_mode` field will be omitted from the resulting object.\n  - `daily_memory_time_quota` (`number`):  When `null`, the `daily_memory_time_quota` field will be omitted from the resulting object.\n  - `enable_builtin_logging` (`bool`):  When `null`, the `enable_builtin_logging` field will be omitted from the resulting object.\n  - `enabled` (`bool`):  When `null`, the `enabled` field will be omitted from the resulting object.\n  - `https_only` (`bool`):  When `null`, the `https_only` field will be omitted from the resulting object.\n  - `key_vault_reference_identity_id` (`string`):  When `null`, the `key_vault_reference_identity_id` field will be omitted from the resulting object.\n  - `location` (`string`): \n  - `name` (`string`): \n  - `os_type` (`string`):  When `null`, the `os_type` field will be omitted from the resulting object.\n  - `resource_group_name` (`string`): \n  - `storage_account_access_key` (`string`): \n  - `storage_account_name` (`string`): \n  - `tags` (`obj`):  When `null`, the `tags` field will be omitted from the resulting object.\n  - `version` (`string`):  When `null`, the `version` field will be omitted from the resulting object.\n  - `auth_settings` (`list[obj]`):  When `null`, the `auth_settings` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.function_app.auth_settings.new](#fn-functionappauthsettingsnew) constructor.\n  - `connection_string` (`list[obj]`):  When `null`, the `connection_string` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.function_app.connection_string.new](#fn-functionappconnectionstringnew) constructor.\n  - `identity` (`list[obj]`):  When `null`, the `identity` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.function_app.identity.new](#fn-functionappidentitynew) constructor.\n  - `site_config` (`list[obj]`):  When `null`, the `site_config` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.function_app.site_config.new](#fn-functionappsiteconfignew) constructor.\n  - `source_control` (`list[obj]`):  When `null`, the `source_control` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.function_app.source_control.new](#fn-functionappsourcecontrolnew) constructor.\n  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.function_app.timeouts.new](#fn-functionapptimeoutsnew) constructor.\n\n**Returns**:\n- A mixin object that injects the new resource into the root Terraform configuration.\n", args=[]),
  new(
    resourceLabel,
    app_service_plan_id,
    location,
  ...
  '#withAppSettings':: d.fn(help='`azurerm.function_app.withAppSettings` constructs a mixin object that can be merged into the `function_app`\nTerraform resource block to set or update the app_settings field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `app_settings` field.\n', args=[]),
  ...
  '#withAuthSettings':: d.fn(help='`azurerm.function_app.withAuthSettings` constructs a mixin object that can be merged into the `function_app`\nTerraform resource block to set or update the auth_settings field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `auth_settings` field.\n', args=[]),
  ...
  '#withAuthSettingsMixin':: d.fn(help='`azurerm.function_app.withAuthSettingsMixin` constructs a mixin object that can be merged into the `function_app`\nTerraform resource block to set or update the auth_settings field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.function_app.withAuthSettings](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `auth_settings` field.\n', args=[]),
  ...
  '#withClientCertMode':: d.fn(help='`azurerm.function_app.withClientCertMode` constructs a mixin object that can be merged into the `function_app`\nTerraform resource block to set or update the client_cert_mode field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `client_cert_mode` field.\n', args=[]),
  ...
  '#withConnectionString':: d.fn(help='`azurerm.function_app.withConnectionString` constructs a mixin object that can be merged into the `function_app`\nTerraform resource block to set or update the connection_string field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `connection_string` field.\n', args=[]),
  ...
  '#withConnectionStringMixin':: d.fn(help='`azurerm.function_app.withConnectionStringMixin` constructs a mixin object that can be merged into the `function_app`\nTerraform resource block to set or update the connection_string field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.function_app.withConnectionString](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `connection_string` field.\n', args=[]),
  ...
  '#withDailyMemoryTimeQuota':: d.fn(help='`azurerm.function_app.withDailyMemoryTimeQuota` constructs a mixin object that can be merged into the `function_app`\nTerraform resource block to set or update the daily_memory_time_quota field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `daily_memory_time_quota` field.\n', args=[]),
  ...
  '#withEnableBuiltinLogging':: d.fn(help='`azurerm.function_app.withEnableBuiltinLogging` constructs a mixin object that can be merged into the `function_app`\nTerraform resource block to set or update the enable_builtin_logging field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enable_builtin_logging` field.\n', args=[]),
  ...
  '#withEnabled':: d.fn(help='`azurerm.function_app.withEnabled` constructs a mixin object that can be merged into the `function_app`\nTerraform resource block to set or update the enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enabled` field.\n', args=[]),
  ...
  '#withHttpsOnly':: d.fn(help='`azurerm.function_app.withHttpsOnly` constructs a mixin object that can be merged into the `function_app`\nTerraform resource block to set or update the https_only field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `https_only` field.\n', args=[]),
  ...
  '#withIdentity':: d.fn(help='`azurerm.function_app.withIdentity` constructs a mixin object that can be merged into the `function_app`\nTerraform resource block to set or update the identity field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `identity` field.\n', args=[]),
  ...
  '#withIdentityMixin':: d.fn(help='`azurerm.function_app.withIdentityMixin` constructs a mixin object that can be merged into the `function_app`\nTerraform resource block to set or update the identity field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.function_app.withIdentity](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `identity` field.\n', args=[]),
  ...
  '#withKeyVaultReferenceIdentityId':: d.fn(help='`azurerm.function_app.withKeyVaultReferenceIdentityId` constructs a mixin object that can be merged into the `function_app`\nTerraform resource block to set or update the key_vault_reference_identity_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `key_vault_reference_identity_id` field.\n', args=[]),
  ...
  '#withLocation':: d.fn(help='`azurerm.function_app.withLocation` constructs a mixin object that can be merged into the `function_app`\nTerraform resource block to set or update the location field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `location` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.function_app.withName` constructs a mixin object that can be merged into the `function_app`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withOsType':: d.fn(help='`azurerm.function_app.withOsType` constructs a mixin object that can be merged into the `function_app`\nTerraform resource block to set or update the os_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `os_type` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.function_app.withResourceGroupName` constructs a mixin object that can be merged into the `function_app`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withSiteConfig':: d.fn(help='`azurerm.function_app.withSiteConfig` constructs a mixin object that can be merged into the `function_app`\nTerraform resource block to set or update the site_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `site_config` field.\n', args=[]),
  ...
  '#withSiteConfigMixin':: d.fn(help='`azurerm.function_app.withSiteConfigMixin` constructs a mixin object that can be merged into the `function_app`\nTerraform resource block to set or update the site_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.function_app.withSiteConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `site_config` field.\n', args=[]),
  ...
  '#withSourceControl':: d.fn(help='`azurerm.function_app.withSourceControl` constructs a mixin object that can be merged into the `function_app`\nTerraform resource block to set or update the source_control field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `source_control` field.\n', args=[]),
  ...
  '#withSourceControlMixin':: d.fn(help='`azurerm.function_app.withSourceControlMixin` constructs a mixin object that can be merged into the `function_app`\nTerraform resource block to set or update the source_control field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.function_app.withSourceControl](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `source_control` field.\n', args=[]),
  ...
  '#withStorageAccountAccessKey':: d.fn(help='`azurerm.function_app.withStorageAccountAccessKey` constructs a mixin object that can be merged into the `function_app`\nTerraform resource block to set or update the storage_account_access_key field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `storage_account_access_key` field.\n', args=[]),
  ...
  '#withStorageAccountName':: d.fn(help='`azurerm.function_app.withStorageAccountName` constructs a mixin object that can be merged into the `function_app`\nTerraform resource block to set or update the storage_account_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `storage_account_name` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`azurerm.function_app.withTags` constructs a mixin object that can be merged into the `function_app`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.function_app.withTimeouts` constructs a mixin object that can be merged into the `function_app`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.function_app.withTimeoutsMixin` constructs a mixin object that can be merged into the `function_app`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.function_app.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withVersion':: d.fn(help='`azurerm.function_app.withVersion` constructs a mixin object that can be merged into the `function_app`\nTerraform resource block to set or update the version field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `version` field.\n', args=[]),
