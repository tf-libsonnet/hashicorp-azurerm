...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withTransparentDataEncryptionKeyAutomaticRotationEnabled':: d.fn(help='`azurerm.bool.withTransparentDataEncryptionKeyAutomaticRotationEnabled` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the transparent_data_encryption_key_automatic_rotation_enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `transparent_data_encryption_key_automatic_rotation_enabled` field.\n', args=[]),
  withTransparentDataEncryptionKeyAutomaticRotationEnabled(resourceLabel, value): {
    resource+: {
      azurerm_mssql_database+: {
        [resourceLabel]+: {
          transparent_data_encryption_key_automatic_rotation_enabled: value,
        },
      },
    },
  },
