...
{
  '#':: d.pkg(name='cosmosdb_mongo_user_definition', url='', help='`cosmosdb_mongo_user_definition` represents the `azurerm_cosmosdb_mongo_user_definition` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
