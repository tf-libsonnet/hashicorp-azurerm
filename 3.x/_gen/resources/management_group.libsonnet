...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withParentManagementGroupId':: d.fn(help='`azurerm.management_group.withParentManagementGroupId` constructs a mixin object that can be merged into the `management_group`\nTerraform resource block to set or update the parent_management_group_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `parent_management_group_id` field.\n', args=[]),
  ...
  '#withSubscriptionIds':: d.fn(help='`azurerm.management_group.withSubscriptionIds` constructs a mixin object that can be merged into the `management_group`\nTerraform resource block to set or update the subscription_ids field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `subscription_ids` field.\n', args=[]),
