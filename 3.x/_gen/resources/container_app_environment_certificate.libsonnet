...
{
  '#':: d.pkg(name='container_app_environment_certificate', url='', help='`container_app_environment_certificate` represents the `azurerm_container_app_environment_certificate` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withCertificateBlobBase64':: d.fn(help='`azurerm.string.withCertificateBlobBase64` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the certificate_blob_base64 field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `certificate_blob_base64` field.\n', args=[]),
  withCertificateBlobBase64(resourceLabel, value): {
    resource+: {
      azurerm_container_app_environment_certificate+: {
        [resourceLabel]+: {
          certificate_blob_base64: value,
        },
      },
    },
  },
  '#withCertificatePassword':: d.fn(help='`azurerm.string.withCertificatePassword` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the certificate_password field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `certificate_password` field.\n', args=[]),
  withCertificatePassword(resourceLabel, value): {
    resource+: {
      azurerm_container_app_environment_certificate+: {
        [resourceLabel]+: {
