...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAutoProvision':: d.fn(help='`azurerm.security_center_auto_provisioning.withAutoProvision` constructs a mixin object that can be merged into the `security_center_auto_provisioning`\nTerraform resource block to set or update the auto_provision field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `auto_provision` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.security_center_auto_provisioning.withTimeouts` constructs a mixin object that can be merged into the `security_center_auto_provisioning`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.security_center_auto_provisioning.withTimeoutsMixin` constructs a mixin object that can be merged into the `security_center_auto_provisioning`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.security_center_auto_provisioning.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
