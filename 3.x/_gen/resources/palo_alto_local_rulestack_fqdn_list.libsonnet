...
{
  '#':: d.pkg(name='palo_alto_local_rulestack_fqdn_list', url='', help='`palo_alto_local_rulestack_fqdn_list` represents the `azurerm_palo_alto_local_rulestack_fqdn_list` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withFullyQualifiedDomainNames':: d.fn(help='`azurerm.list.withFullyQualifiedDomainNames` constructs a mixin object that can be merged into the `list`\nTerraform resource block to set or update the fully_qualified_domain_names field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list`): The value to set for the `fully_qualified_domain_names` field.\n', args=[]),
  withFullyQualifiedDomainNames(resourceLabel, value): {
    resource+: {
      azurerm_palo_alto_local_rulestack_fqdn_list+: {
        [resourceLabel]+: {
          fully_qualified_domain_names: value,
        },
      },
    },
  },
