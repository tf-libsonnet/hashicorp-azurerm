...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withApiKey':: d.fn(help='`azurerm.api_management_identity_provider_twitter.withApiKey` constructs a mixin object that can be merged into the `api_management_identity_provider_twitter`\nTerraform resource block to set or update the api_key field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `api_key` field.\n', args=[]),
  ...
  '#withApiManagementName':: d.fn(help='`azurerm.api_management_identity_provider_twitter.withApiManagementName` constructs a mixin object that can be merged into the `api_management_identity_provider_twitter`\nTerraform resource block to set or update the api_management_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `api_management_name` field.\n', args=[]),
  ...
  '#withApiSecretKey':: d.fn(help='`azurerm.api_management_identity_provider_twitter.withApiSecretKey` constructs a mixin object that can be merged into the `api_management_identity_provider_twitter`\nTerraform resource block to set or update the api_secret_key field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `api_secret_key` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.api_management_identity_provider_twitter.withResourceGroupName` constructs a mixin object that can be merged into the `api_management_identity_provider_twitter`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.api_management_identity_provider_twitter.withTimeouts` constructs a mixin object that can be merged into the `api_management_identity_provider_twitter`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.api_management_identity_provider_twitter.withTimeoutsMixin` constructs a mixin object that can be merged into the `api_management_identity_provider_twitter`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.api_management_identity_provider_twitter.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
