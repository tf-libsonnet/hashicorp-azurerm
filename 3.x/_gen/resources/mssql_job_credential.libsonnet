...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withJobAgentId':: d.fn(help='`azurerm.mssql_job_credential.withJobAgentId` constructs a mixin object that can be merged into the `mssql_job_credential`\nTerraform resource block to set or update the job_agent_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `job_agent_id` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.mssql_job_credential.withName` constructs a mixin object that can be merged into the `mssql_job_credential`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withPassword':: d.fn(help='`azurerm.mssql_job_credential.withPassword` constructs a mixin object that can be merged into the `mssql_job_credential`\nTerraform resource block to set or update the password field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `password` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.mssql_job_credential.withTimeouts` constructs a mixin object that can be merged into the `mssql_job_credential`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.mssql_job_credential.withTimeoutsMixin` constructs a mixin object that can be merged into the `mssql_job_credential`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.mssql_job_credential.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withUsername':: d.fn(help='`azurerm.mssql_job_credential.withUsername` constructs a mixin object that can be merged into the `mssql_job_credential`\nTerraform resource block to set or update the username field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `username` field.\n', args=[]),
