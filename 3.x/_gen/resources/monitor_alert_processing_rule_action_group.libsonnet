...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  condition:: {
    ...
    '#new':: d.fn(help='\n`azurerm.monitor_alert_processing_rule_action_group.condition.new` constructs a new object with attributes and blocks configured for the `condition`\nTerraform sub block.\n\n\n\n**Args**:\n  - `alert_context` (`list[obj]`):  When `null`, the `alert_context` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.monitor_alert_processing_rule_action_group.condition.alert_context.new](#fn-conditionalertcontextnew) constructor.\n  - `alert_rule_id` (`list[obj]`):  When `null`, the `alert_rule_id` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.monitor_alert_processing_rule_action_group.condition.alert_rule_id.new](#fn-conditionalertruleidnew) constructor.\n  - `alert_rule_name` (`list[obj]`):  When `null`, the `alert_rule_name` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.monitor_alert_processing_rule_action_group.condition.alert_rule_name.new](#fn-conditionalertrulenamenew) constructor.\n  - `description` (`list[obj]`):  When `null`, the `description` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.monitor_alert_processing_rule_action_group.condition.description.new](#fn-conditiondescriptionnew) constructor.\n  - `monitor_condition` (`list[obj]`):  When `null`, the `monitor_condition` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.monitor_alert_processing_rule_action_group.condition.monitor_condition.new](#fn-conditionmonitorconditionnew) constructor.\n  - `monitor_service` (`list[obj]`):  When `null`, the `monitor_service` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.monitor_alert_processing_rule_action_group.condition.monitor_service.new](#fn-conditionmonitorservicenew) constructor.\n  - `severity` (`list[obj]`):  When `null`, the `severity` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.monitor_alert_processing_rule_action_group.condition.severity.new](#fn-conditionseveritynew) constructor.\n  - `signal_type` (`list[obj]`):  When `null`, the `signal_type` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.monitor_alert_processing_rule_action_group.condition.signal_type.new](#fn-conditionsignaltypenew) constructor.\n  - `target_resource` (`list[obj]`):  When `null`, the `target_resource` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.monitor_alert_processing_rule_action_group.condition.target_resource.new](#fn-conditiontargetresourcenew) constructor.\n  - `target_resource_group` (`list[obj]`):  When `null`, the `target_resource_group` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.monitor_alert_processing_rule_action_group.condition.target_resource_group.new](#fn-conditiontargetresourcegroupnew) constructor.\n  - `target_resource_type` (`list[obj]`):  When `null`, the `target_resource_type` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.monitor_alert_processing_rule_action_group.condition.target_resource_type.new](#fn-conditiontargetresourcetypenew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `condition` sub block.\n', args=[]),
    new(
      alert_context=null,
      alert_rule_id=null,
  ...
  '#withAddActionGroupIds':: d.fn(help='`azurerm.monitor_alert_processing_rule_action_group.withAddActionGroupIds` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_action_group`\nTerraform resource block to set or update the add_action_group_ids field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `add_action_group_ids` field.\n', args=[]),
  ...
  '#withCondition':: d.fn(help='`azurerm.monitor_alert_processing_rule_action_group.withCondition` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_action_group`\nTerraform resource block to set or update the condition field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `condition` field.\n', args=[]),
  ...
  '#withConditionMixin':: d.fn(help='`azurerm.monitor_alert_processing_rule_action_group.withConditionMixin` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_action_group`\nTerraform resource block to set or update the condition field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.monitor_alert_processing_rule_action_group.withCondition](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `condition` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`azurerm.monitor_alert_processing_rule_action_group.withDescription` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_action_group`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withEnabled':: d.fn(help='`azurerm.monitor_alert_processing_rule_action_group.withEnabled` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_action_group`\nTerraform resource block to set or update the enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enabled` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.monitor_alert_processing_rule_action_group.withName` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_action_group`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.monitor_alert_processing_rule_action_group.withResourceGroupName` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_action_group`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withSchedule':: d.fn(help='`azurerm.monitor_alert_processing_rule_action_group.withSchedule` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_action_group`\nTerraform resource block to set or update the schedule field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `schedule` field.\n', args=[]),
  ...
  '#withScheduleMixin':: d.fn(help='`azurerm.monitor_alert_processing_rule_action_group.withScheduleMixin` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_action_group`\nTerraform resource block to set or update the schedule field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.monitor_alert_processing_rule_action_group.withSchedule](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `schedule` field.\n', args=[]),
  ...
  '#withScopes':: d.fn(help='`azurerm.monitor_alert_processing_rule_action_group.withScopes` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_action_group`\nTerraform resource block to set or update the scopes field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `scopes` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`azurerm.monitor_alert_processing_rule_action_group.withTags` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_action_group`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.monitor_alert_processing_rule_action_group.withTimeouts` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_action_group`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.monitor_alert_processing_rule_action_group.withTimeoutsMixin` constructs a mixin object that can be merged into the `monitor_alert_processing_rule_action_group`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.monitor_alert_processing_rule_action_group.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
