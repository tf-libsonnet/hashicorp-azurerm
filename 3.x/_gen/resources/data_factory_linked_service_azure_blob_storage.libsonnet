...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withConnectionStringInsecure':: d.fn(help='`azurerm.string.withConnectionStringInsecure` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the connection_string_insecure field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `connection_string_insecure` field.\n', args=[]),
  withConnectionStringInsecure(resourceLabel, value): {
    resource+: {
      azurerm_data_factory_linked_service_azure_blob_storage+: {
        [resourceLabel]+: {
          connection_string_insecure: value,
        },
      },
    },
  },
