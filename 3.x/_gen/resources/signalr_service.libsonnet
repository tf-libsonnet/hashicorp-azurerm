...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withHttpRequestLogsEnabled':: d.fn(help='`azurerm.bool.withHttpRequestLogsEnabled` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the http_request_logs_enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `http_request_logs_enabled` field.\n', args=[]),
  withHttpRequestLogsEnabled(resourceLabel, value): {
    resource+: {
      azurerm_signalr_service+: {
        [resourceLabel]+: {
          http_request_logs_enabled: value,
        },
      },
    },
  },
