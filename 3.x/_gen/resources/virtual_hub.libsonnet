...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withHubRoutingPreference':: d.fn(help='`azurerm.string.withHubRoutingPreference` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the hub_routing_preference field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `hub_routing_preference` field.\n', args=[]),
  withHubRoutingPreference(resourceLabel, value): {
    resource+: {
      azurerm_virtual_hub+: {
        [resourceLabel]+: {
          hub_routing_preference: value,
        },
      },
    },
  },
  ...
  '#withVirtualRouterAutoScaleMinCapacity':: d.fn(help='`azurerm.number.withVirtualRouterAutoScaleMinCapacity` constructs a mixin object that can be merged into the `number`\nTerraform resource block to set or update the virtual_router_auto_scale_min_capacity field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`number`): The value to set for the `virtual_router_auto_scale_min_capacity` field.\n', args=[]),
  withVirtualRouterAutoScaleMinCapacity(resourceLabel, value): {
    resource+: {
      azurerm_virtual_hub+: {
        [resourceLabel]+: {
          virtual_router_auto_scale_min_capacity: value,
        },
      },
    },
  },
