...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#new':: d.fn(help="\n`azurerm.api_management.new` injects a new `azurerm_api_management` Terraform `resource`\nblock into the root module document.\n\nAdditionally, this inserts a private function into the `_ref` attribute that generates references to attributes of the\nresource. For example, if you added a new instance to the root using:\n\n    # arguments omitted for brevity\n    azurerm.api_management.new('some_id')\n\nYou can get the reference to the `id` field of the created `azurerm.api_management` using the reference:\n\n    $._ref.azurerm_api_management.some_id.get('id')\n\nThis is the same as directly entering `\"${ azurerm_api_management.some_id.id }\"` as the value.\n\nNOTE: if you are chaining multiple resources together in a merge operation, you may not be able to use `super`, `self`,\nor `$` to refer to the root object. Instead, make an explicit outer object using `local`.\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block.\n  - `client_certificate_enabled` (`bool`):  When `null`, the `client_certificate_enabled` field will be omitted from the resulting object.\n  - `gateway_disabled` (`bool`):  When `null`, the `gateway_disabled` field will be omitted from the resulting object.\n  - `location` (`string`): \n  - `min_api_version` (`string`):  When `null`, the `min_api_version` field will be omitted from the resulting object.\n  - `name` (`string`): \n  - `notification_sender_email` (`string`):  When `null`, the `notification_sender_email` field will be omitted from the resulting object.\n  - `policy` (`list`):  When `null`, the `policy` field will be omitted from the resulting object.\n  - `public_ip_address_id` (`string`):  When `null`, the `public_ip_address_id` field will be omitted from the resulting object.\n  - `public_network_access_enabled` (`bool`):  When `null`, the `public_network_access_enabled` field will be omitted from the resulting object.\n  - `publisher_email` (`string`): \n  - `publisher_name` (`string`): \n  - `resource_group_name` (`string`): \n  - `sku_name` (`string`): \n  - `tags` (`obj`):  When `null`, the `tags` field will be omitted from the resulting object.\n  - `virtual_network_type` (`string`):  When `null`, the `virtual_network_type` field will be omitted from the resulting object.\n  - `zones` (`list`):  When `null`, the `zones` field will be omitted from the resulting object.\n  - `additional_location` (`list[obj]`):  When `null`, the `additional_location` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management.additional_location.new](#fn-api_managementadditional_locationnew) constructor.\n  - `certificate` (`list[obj]`):  When `null`, the `certificate` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management.certificate.new](#fn-api_managementcertificatenew) constructor.\n  - `hostname_configuration` (`list[obj]`):  When `null`, the `hostname_configuration` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management.hostname_configuration.new](#fn-api_managementhostname_configurationnew) constructor.\n  - `identity` (`list[obj]`):  When `null`, the `identity` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management.identity.new](#fn-api_managementidentitynew) constructor.\n  - `protocols` (`list[obj]`):  When `null`, the `protocols` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management.protocols.new](#fn-api_managementprotocolsnew) constructor.\n  - `security` (`list[obj]`):  When `null`, the `security` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management.security.new](#fn-api_managementsecuritynew) constructor.\n  - `sign_in` (`list[obj]`):  When `null`, the `sign_in` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management.sign_in.new](#fn-api_managementsign_innew) constructor.\n  - `sign_up` (`list[obj]`):  When `null`, the `sign_up` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management.sign_up.new](#fn-api_managementsign_upnew) constructor.\n  - `tenant_access` (`list[obj]`):  When `null`, the `tenant_access` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management.tenant_access.new](#fn-api_managementtenant_accessnew) constructor.\n  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management.timeouts.new](#fn-api_managementtimeoutsnew) constructor.\n  - `virtual_network_configuration` (`list[obj]`):  When `null`, the `virtual_network_configuration` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management.virtual_network_configuration.new](#fn-api_managementvirtual_network_configurationnew) constructor.\n\n**Returns**:\n- A mixin object that injects the new resource into the root Terraform configuration.\n", args=[]),
  new(
    resourceLabel,
    location,
    name,
