...
{
  '#':: d.pkg(name='linux_web_app_slot', url='', help='`linux_web_app_slot` represents the `azurerm_linux_web_app_slot` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  auth_settings:: {
    active_directory:: {
  ...
  logs:: {
    ...
    http_logs:: {
      ...
      '#new':: d.fn(help='\n`azurerm.linux_web_app_slot.logs.http_logs.new` constructs a new object with attributes and blocks configured for the `http_logs`\nTerraform sub block.\n\n\n\n**Args**:\n  - `azure_blob_storage` (`list[obj]`):  When `null`, the `azure_blob_storage` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app_slot.logs.http_logs.azure_blob_storage.new](#fn-httplogsazureblobstoragenew) constructor.\n  - `file_system` (`list[obj]`):  When `null`, the `file_system` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app_slot.logs.http_logs.file_system.new](#fn-httplogsfilesystemnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `http_logs` sub block.\n', args=[]),
      new(
        azure_blob_storage=null,
        file_system=null
      ):: std.prune(a={
    ...
    '#new':: d.fn(help='\n`azurerm.linux_web_app_slot.logs.new` constructs a new object with attributes and blocks configured for the `logs`\nTerraform sub block.\n\n\n\n**Args**:\n  - `detailed_error_messages` (`bool`):  When `null`, the `detailed_error_messages` field will be omitted from the resulting object.\n  - `failed_request_tracing` (`bool`):  When `null`, the `failed_request_tracing` field will be omitted from the resulting object.\n  - `application_logs` (`list[obj]`):  When `null`, the `application_logs` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app_slot.logs.application_logs.new](#fn-logsapplicationlogsnew) constructor.\n  - `http_logs` (`list[obj]`):  When `null`, the `http_logs` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app_slot.logs.http_logs.new](#fn-logshttplogsnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `logs` sub block.\n', args=[]),
    new(
  ...
  '#new':: d.fn(help="\n`azurerm.linux_web_app_slot.new` injects a new `azurerm_linux_web_app_slot` Terraform `resource`\nblock into the root module document.\n\nAdditionally, this inserts a private function into the `_ref` attribute that generates references to attributes of the\nresource. For example, if you added a new instance to the root using:\n\n    # arguments omitted for brevity\n    azurerm.linux_web_app_slot.new('some_id')\n\nYou can get the reference to the `id` field of the created `azurerm.linux_web_app_slot` using the reference:\n\n    $._ref.azurerm_linux_web_app_slot.some_id.get('id')\n\nThis is the same as directly entering `\"${ azurerm_linux_web_app_slot.some_id.id }\"` as the value.\n\nNOTE: if you are chaining multiple resources together in a merge operation, you may not be able to use `super`, `self`,\nor `$` to refer to the root object. Instead, make an explicit outer object using `local`.\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block.\n  - `app_service_id` (`string`): \n  - `app_settings` (`obj`):  When `null`, the `app_settings` field will be omitted from the resulting object.\n  - `client_affinity_enabled` (`bool`):  When `null`, the `client_affinity_enabled` field will be omitted from the resulting object.\n  - `client_certificate_enabled` (`bool`):  When `null`, the `client_certificate_enabled` field will be omitted from the resulting object.\n  - `client_certificate_exclusion_paths` (`string`): Paths to exclude when using client certificates, separated by ; When `null`, the `client_certificate_exclusion_paths` field will be omitted from the resulting object.\n  - `client_certificate_mode` (`string`):  When `null`, the `client_certificate_mode` field will be omitted from the resulting object.\n  - `enabled` (`bool`):  When `null`, the `enabled` field will be omitted from the resulting object.\n  - `https_only` (`bool`):  When `null`, the `https_only` field will be omitted from the resulting object.\n  - `key_vault_reference_identity_id` (`string`):  When `null`, the `key_vault_reference_identity_id` field will be omitted from the resulting object.\n  - `name` (`string`): \n  - `tags` (`obj`):  When `null`, the `tags` field will be omitted from the resulting object.\n  - `virtual_network_subnet_id` (`string`):  When `null`, the `virtual_network_subnet_id` field will be omitted from the resulting object.\n  - `zip_deploy_file` (`string`): The local path and filename of the Zip packaged application to deploy to this Windows Web App. **Note:** Using this value requires `WEBSITE_RUN_FROM_PACKAGE=1` on the App in `app_settings`. When `null`, the `zip_deploy_file` field will be omitted from the resulting object.\n  - `auth_settings` (`list[obj]`):  When `null`, the `auth_settings` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app_slot.auth_settings.new](#fn-linuxwebappslotauthsettingsnew) constructor.\n  - `backup` (`list[obj]`):  When `null`, the `backup` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app_slot.backup.new](#fn-linuxwebappslotbackupnew) constructor.\n  - `connection_string` (`list[obj]`):  When `null`, the `connection_string` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app_slot.connection_string.new](#fn-linuxwebappslotconnectionstringnew) constructor.\n  - `identity` (`list[obj]`):  When `null`, the `identity` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app_slot.identity.new](#fn-linuxwebappslotidentitynew) constructor.\n  - `logs` (`list[obj]`):  When `null`, the `logs` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app_slot.logs.new](#fn-linuxwebappslotlogsnew) constructor.\n  - `site_config` (`list[obj]`):  When `null`, the `site_config` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app_slot.site_config.new](#fn-linuxwebappslotsiteconfignew) constructor.\n  - `storage_account` (`list[obj]`):  When `null`, the `storage_account` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app_slot.storage_account.new](#fn-linuxwebappslotstorageaccountnew) constructor.\n  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app_slot.timeouts.new](#fn-linuxwebappslottimeoutsnew) constructor.\n\n**Returns**:\n- A mixin object that injects the new resource into the root Terraform configuration.\n", args=[]),
  new(
    resourceLabel,
    app_service_id,
    name,
  ...
  site_config:: {
    ...
    auto_heal_setting:: {
      ...
      '#new':: d.fn(help='\n`azurerm.linux_web_app_slot.site_config.auto_heal_setting.new` constructs a new object with attributes and blocks configured for the `auto_heal_setting`\nTerraform sub block.\n\n\n\n**Args**:\n  - `action` (`list[obj]`):  When `null`, the `action` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app_slot.site_config.auto_heal_setting.action.new](#fn-autohealsettingactionnew) constructor.\n  - `trigger` (`list[obj]`):  When `null`, the `trigger` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app_slot.site_config.auto_heal_setting.trigger.new](#fn-autohealsettingtriggernew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `auto_heal_setting` sub block.\n', args=[]),
      new(
        action=null,
        trigger=null
      ):: std.prune(a={
      ...
      trigger:: {
        '#new':: d.fn(help='\n`azurerm.linux_web_app_slot.site_config.auto_heal_setting.trigger.new` constructs a new object with attributes and blocks configured for the `trigger`\nTerraform sub block.\n\n\n\n**Args**:\n  - `requests` (`list[obj]`):  When `null`, the `requests` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app_slot.site_config.auto_heal_setting.trigger.requests.new](#fn-triggerrequestsnew) constructor.\n  - `slow_request` (`list[obj]`):  When `null`, the `slow_request` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app_slot.site_config.auto_heal_setting.trigger.slow_request.new](#fn-triggerslowrequestnew) constructor.\n  - `status_code` (`list[obj]`):  When `null`, the `status_code` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.linux_web_app_slot.site_config.auto_heal_setting.trigger.status_code.new](#fn-triggerstatuscodenew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `trigger` sub block.\n', args=[]),
        new(
          requests=null,
          slow_request=null,
          status_code=null
  ...
  '#withAppServiceId':: d.fn(help='`azurerm.linux_web_app_slot.withAppServiceId` constructs a mixin object that can be merged into the `linux_web_app_slot`\nTerraform resource block to set or update the app_service_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `app_service_id` field.\n', args=[]),
  ...
  '#withAppSettings':: d.fn(help='`azurerm.linux_web_app_slot.withAppSettings` constructs a mixin object that can be merged into the `linux_web_app_slot`\nTerraform resource block to set or update the app_settings field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `app_settings` field.\n', args=[]),
  ...
  '#withAuthSettings':: d.fn(help='`azurerm.linux_web_app_slot.withAuthSettings` constructs a mixin object that can be merged into the `linux_web_app_slot`\nTerraform resource block to set or update the auth_settings field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `auth_settings` field.\n', args=[]),
  ...
  '#withAuthSettingsMixin':: d.fn(help='`azurerm.linux_web_app_slot.withAuthSettingsMixin` constructs a mixin object that can be merged into the `linux_web_app_slot`\nTerraform resource block to set or update the auth_settings field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.linux_web_app_slot.withAuthSettings](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `auth_settings` field.\n', args=[]),
  ...
  '#withBackup':: d.fn(help='`azurerm.linux_web_app_slot.withBackup` constructs a mixin object that can be merged into the `linux_web_app_slot`\nTerraform resource block to set or update the backup field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `backup` field.\n', args=[]),
  ...
  '#withBackupMixin':: d.fn(help='`azurerm.linux_web_app_slot.withBackupMixin` constructs a mixin object that can be merged into the `linux_web_app_slot`\nTerraform resource block to set or update the backup field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.linux_web_app_slot.withBackup](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `backup` field.\n', args=[]),
  ...
  '#withClientAffinityEnabled':: d.fn(help='`azurerm.linux_web_app_slot.withClientAffinityEnabled` constructs a mixin object that can be merged into the `linux_web_app_slot`\nTerraform resource block to set or update the client_affinity_enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `client_affinity_enabled` field.\n', args=[]),
  ...
  '#withClientCertificateEnabled':: d.fn(help='`azurerm.linux_web_app_slot.withClientCertificateEnabled` constructs a mixin object that can be merged into the `linux_web_app_slot`\nTerraform resource block to set or update the client_certificate_enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `client_certificate_enabled` field.\n', args=[]),
  ...
  '#withClientCertificateExclusionPaths':: d.fn(help='`azurerm.linux_web_app_slot.withClientCertificateExclusionPaths` constructs a mixin object that can be merged into the `linux_web_app_slot`\nTerraform resource block to set or update the client_certificate_exclusion_paths field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `client_certificate_exclusion_paths` field.\n', args=[]),
  ...
  '#withClientCertificateMode':: d.fn(help='`azurerm.linux_web_app_slot.withClientCertificateMode` constructs a mixin object that can be merged into the `linux_web_app_slot`\nTerraform resource block to set or update the client_certificate_mode field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `client_certificate_mode` field.\n', args=[]),
  ...
  '#withConnectionString':: d.fn(help='`azurerm.linux_web_app_slot.withConnectionString` constructs a mixin object that can be merged into the `linux_web_app_slot`\nTerraform resource block to set or update the connection_string field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `connection_string` field.\n', args=[]),
  ...
  '#withConnectionStringMixin':: d.fn(help='`azurerm.linux_web_app_slot.withConnectionStringMixin` constructs a mixin object that can be merged into the `linux_web_app_slot`\nTerraform resource block to set or update the connection_string field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.linux_web_app_slot.withConnectionString](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `connection_string` field.\n', args=[]),
  ...
  '#withEnabled':: d.fn(help='`azurerm.linux_web_app_slot.withEnabled` constructs a mixin object that can be merged into the `linux_web_app_slot`\nTerraform resource block to set or update the enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enabled` field.\n', args=[]),
  ...
  '#withHttpsOnly':: d.fn(help='`azurerm.linux_web_app_slot.withHttpsOnly` constructs a mixin object that can be merged into the `linux_web_app_slot`\nTerraform resource block to set or update the https_only field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `https_only` field.\n', args=[]),
  ...
  '#withIdentity':: d.fn(help='`azurerm.linux_web_app_slot.withIdentity` constructs a mixin object that can be merged into the `linux_web_app_slot`\nTerraform resource block to set or update the identity field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `identity` field.\n', args=[]),
  ...
  '#withIdentityMixin':: d.fn(help='`azurerm.linux_web_app_slot.withIdentityMixin` constructs a mixin object that can be merged into the `linux_web_app_slot`\nTerraform resource block to set or update the identity field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.linux_web_app_slot.withIdentity](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `identity` field.\n', args=[]),
  ...
  '#withKeyVaultReferenceIdentityId':: d.fn(help='`azurerm.linux_web_app_slot.withKeyVaultReferenceIdentityId` constructs a mixin object that can be merged into the `linux_web_app_slot`\nTerraform resource block to set or update the key_vault_reference_identity_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `key_vault_reference_identity_id` field.\n', args=[]),
  ...
  '#withLogs':: d.fn(help='`azurerm.linux_web_app_slot.withLogs` constructs a mixin object that can be merged into the `linux_web_app_slot`\nTerraform resource block to set or update the logs field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `logs` field.\n', args=[]),
  ...
  '#withLogsMixin':: d.fn(help='`azurerm.linux_web_app_slot.withLogsMixin` constructs a mixin object that can be merged into the `linux_web_app_slot`\nTerraform resource block to set or update the logs field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.linux_web_app_slot.withLogs](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `logs` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.linux_web_app_slot.withName` constructs a mixin object that can be merged into the `linux_web_app_slot`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withSiteConfig':: d.fn(help='`azurerm.linux_web_app_slot.withSiteConfig` constructs a mixin object that can be merged into the `linux_web_app_slot`\nTerraform resource block to set or update the site_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `site_config` field.\n', args=[]),
  ...
  '#withSiteConfigMixin':: d.fn(help='`azurerm.linux_web_app_slot.withSiteConfigMixin` constructs a mixin object that can be merged into the `linux_web_app_slot`\nTerraform resource block to set or update the site_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.linux_web_app_slot.withSiteConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `site_config` field.\n', args=[]),
  ...
  '#withStorageAccount':: d.fn(help='`azurerm.linux_web_app_slot.withStorageAccount` constructs a mixin object that can be merged into the `linux_web_app_slot`\nTerraform resource block to set or update the storage_account field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `storage_account` field.\n', args=[]),
  ...
  '#withStorageAccountMixin':: d.fn(help='`azurerm.linux_web_app_slot.withStorageAccountMixin` constructs a mixin object that can be merged into the `linux_web_app_slot`\nTerraform resource block to set or update the storage_account field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.linux_web_app_slot.withStorageAccount](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `storage_account` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`azurerm.linux_web_app_slot.withTags` constructs a mixin object that can be merged into the `linux_web_app_slot`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.linux_web_app_slot.withTimeouts` constructs a mixin object that can be merged into the `linux_web_app_slot`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.linux_web_app_slot.withTimeoutsMixin` constructs a mixin object that can be merged into the `linux_web_app_slot`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.linux_web_app_slot.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withVirtualNetworkSubnetId':: d.fn(help='`azurerm.linux_web_app_slot.withVirtualNetworkSubnetId` constructs a mixin object that can be merged into the `linux_web_app_slot`\nTerraform resource block to set or update the virtual_network_subnet_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `virtual_network_subnet_id` field.\n', args=[]),
  ...
  '#withZipDeployFile':: d.fn(help='`azurerm.linux_web_app_slot.withZipDeployFile` constructs a mixin object that can be merged into the `linux_web_app_slot`\nTerraform resource block to set or update the zip_deploy_file field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `zip_deploy_file` field.\n', args=[]),
