...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withName':: d.fn(help='`azurerm.spring_cloud_app_redis_association.withName` constructs a mixin object that can be merged into the `spring_cloud_app_redis_association`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withRedisAccessKey':: d.fn(help='`azurerm.spring_cloud_app_redis_association.withRedisAccessKey` constructs a mixin object that can be merged into the `spring_cloud_app_redis_association`\nTerraform resource block to set or update the redis_access_key field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `redis_access_key` field.\n', args=[]),
  ...
  '#withRedisCacheId':: d.fn(help='`azurerm.spring_cloud_app_redis_association.withRedisCacheId` constructs a mixin object that can be merged into the `spring_cloud_app_redis_association`\nTerraform resource block to set or update the redis_cache_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `redis_cache_id` field.\n', args=[]),
  ...
  '#withSpringCloudAppId':: d.fn(help='`azurerm.spring_cloud_app_redis_association.withSpringCloudAppId` constructs a mixin object that can be merged into the `spring_cloud_app_redis_association`\nTerraform resource block to set or update the spring_cloud_app_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `spring_cloud_app_id` field.\n', args=[]),
  ...
  '#withSslEnabled':: d.fn(help='`azurerm.spring_cloud_app_redis_association.withSslEnabled` constructs a mixin object that can be merged into the `spring_cloud_app_redis_association`\nTerraform resource block to set or update the ssl_enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ssl_enabled` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.spring_cloud_app_redis_association.withTimeouts` constructs a mixin object that can be merged into the `spring_cloud_app_redis_association`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.spring_cloud_app_redis_association.withTimeoutsMixin` constructs a mixin object that can be merged into the `spring_cloud_app_redis_association`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.spring_cloud_app_redis_association.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
