...
{
  '#':: d.pkg(name='automation_python3_package', url='', help='`automation_python3_package` represents the `azurerm_automation_python3_package` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withContentUri':: d.fn(help='`azurerm.string.withContentUri` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the content_uri field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `content_uri` field.\n', args=[]),
  withContentUri(resourceLabel, value): {
    resource+: {
      azurerm_automation_python3_package+: {
        [resourceLabel]+: {
          content_uri: value,
  ...
  '#withContentVersion':: d.fn(help='`azurerm.string.withContentVersion` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the content_version field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `content_version` field.\n', args=[]),
  withContentVersion(resourceLabel, value): {
    resource+: {
      azurerm_automation_python3_package+: {
        [resourceLabel]+: {
  ...
  '#withHashAlgorithm':: d.fn(help='`azurerm.string.withHashAlgorithm` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the hash_algorithm field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `hash_algorithm` field.\n', args=[]),
  withHashAlgorithm(resourceLabel, value): {
    resource+: {
      azurerm_automation_python3_package+: {
        [resourceLabel]+: {
  ...
  '#withHashValue':: d.fn(help='`azurerm.string.withHashValue` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the hash_value field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `hash_value` field.\n', args=[]),
  withHashValue(resourceLabel, value): {
    resource+: {
      azurerm_automation_python3_package+: {
        [resourceLabel]+: {
          hash_value: value,
