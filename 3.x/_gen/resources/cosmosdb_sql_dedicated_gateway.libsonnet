...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCosmosdbAccountId':: d.fn(help='`azurerm.cosmosdb_sql_dedicated_gateway.withCosmosdbAccountId` constructs a mixin object that can be merged into the `cosmosdb_sql_dedicated_gateway`\nTerraform resource block to set or update the cosmosdb_account_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cosmosdb_account_id` field.\n', args=[]),
  ...
  '#withInstanceCount':: d.fn(help='`azurerm.cosmosdb_sql_dedicated_gateway.withInstanceCount` constructs a mixin object that can be merged into the `cosmosdb_sql_dedicated_gateway`\nTerraform resource block to set or update the instance_count field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `instance_count` field.\n', args=[]),
  ...
  '#withInstanceSize':: d.fn(help='`azurerm.cosmosdb_sql_dedicated_gateway.withInstanceSize` constructs a mixin object that can be merged into the `cosmosdb_sql_dedicated_gateway`\nTerraform resource block to set or update the instance_size field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `instance_size` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.cosmosdb_sql_dedicated_gateway.withTimeouts` constructs a mixin object that can be merged into the `cosmosdb_sql_dedicated_gateway`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.cosmosdb_sql_dedicated_gateway.withTimeoutsMixin` constructs a mixin object that can be merged into the `cosmosdb_sql_dedicated_gateway`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.cosmosdb_sql_dedicated_gateway.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
