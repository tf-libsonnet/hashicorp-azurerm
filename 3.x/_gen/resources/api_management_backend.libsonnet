...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#new':: d.fn(help="\n`azurerm.api_management_backend.new` injects a new `azurerm_api_management_backend` Terraform `resource`\nblock into the root module document.\n\nAdditionally, this inserts a private function into the `_ref` attribute that generates references to attributes of the\nresource. For example, if you added a new instance to the root using:\n\n    # arguments omitted for brevity\n    azurerm.api_management_backend.new('some_id')\n\nYou can get the reference to the `id` field of the created `azurerm.api_management_backend` using the reference:\n\n    $._ref.azurerm_api_management_backend.some_id.get('id')\n\nThis is the same as directly entering `\"${ azurerm_api_management_backend.some_id.id }\"` as the value.\n\nNOTE: if you are chaining multiple resources together in a merge operation, you may not be able to use `super`, `self`,\nor `$` to refer to the root object. Instead, make an explicit outer object using `local`.\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block.\n  - `api_management_name` (`string`): \n  - `description` (`string`):  When `null`, the `description` field will be omitted from the resulting object.\n  - `name` (`string`): \n  - `protocol` (`string`): \n  - `resource_group_name` (`string`): \n  - `resource_id` (`string`):  When `null`, the `resource_id` field will be omitted from the resulting object.\n  - `title` (`string`):  When `null`, the `title` field will be omitted from the resulting object.\n  - `url` (`string`): \n  - `credentials` (`list[obj]`):  When `null`, the `credentials` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management_backend.credentials.new](#fn-apimanagementbackendcredentialsnew) constructor.\n  - `proxy` (`list[obj]`):  When `null`, the `proxy` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management_backend.proxy.new](#fn-apimanagementbackendproxynew) constructor.\n  - `service_fabric_cluster` (`list[obj]`):  When `null`, the `service_fabric_cluster` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management_backend.service_fabric_cluster.new](#fn-apimanagementbackendservicefabricclusternew) constructor.\n  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management_backend.timeouts.new](#fn-apimanagementbackendtimeoutsnew) constructor.\n  - `tls` (`list[obj]`):  When `null`, the `tls` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.api_management_backend.tls.new](#fn-apimanagementbackendtlsnew) constructor.\n\n**Returns**:\n- A mixin object that injects the new resource into the root Terraform configuration.\n", args=[]),
  new(
    resourceLabel,
    api_management_name,
    name,
  ...
  '#withApiManagementName':: d.fn(help='`azurerm.api_management_backend.withApiManagementName` constructs a mixin object that can be merged into the `api_management_backend`\nTerraform resource block to set or update the api_management_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `api_management_name` field.\n', args=[]),
  ...
  '#withCredentials':: d.fn(help='`azurerm.api_management_backend.withCredentials` constructs a mixin object that can be merged into the `api_management_backend`\nTerraform resource block to set or update the credentials field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `credentials` field.\n', args=[]),
  ...
  '#withCredentialsMixin':: d.fn(help='`azurerm.api_management_backend.withCredentialsMixin` constructs a mixin object that can be merged into the `api_management_backend`\nTerraform resource block to set or update the credentials field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.api_management_backend.withCredentials](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `credentials` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`azurerm.api_management_backend.withDescription` constructs a mixin object that can be merged into the `api_management_backend`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.api_management_backend.withName` constructs a mixin object that can be merged into the `api_management_backend`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withProtocol':: d.fn(help='`azurerm.api_management_backend.withProtocol` constructs a mixin object that can be merged into the `api_management_backend`\nTerraform resource block to set or update the protocol field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `protocol` field.\n', args=[]),
  ...
  '#withProxy':: d.fn(help='`azurerm.api_management_backend.withProxy` constructs a mixin object that can be merged into the `api_management_backend`\nTerraform resource block to set or update the proxy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `proxy` field.\n', args=[]),
  ...
  '#withProxyMixin':: d.fn(help='`azurerm.api_management_backend.withProxyMixin` constructs a mixin object that can be merged into the `api_management_backend`\nTerraform resource block to set or update the proxy field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.api_management_backend.withProxy](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `proxy` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.api_management_backend.withResourceGroupName` constructs a mixin object that can be merged into the `api_management_backend`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withResourceId':: d.fn(help='`azurerm.api_management_backend.withResourceId` constructs a mixin object that can be merged into the `api_management_backend`\nTerraform resource block to set or update the resource_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_id` field.\n', args=[]),
  ...
  '#withServiceFabricCluster':: d.fn(help='`azurerm.api_management_backend.withServiceFabricCluster` constructs a mixin object that can be merged into the `api_management_backend`\nTerraform resource block to set or update the service_fabric_cluster field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service_fabric_cluster` field.\n', args=[]),
  ...
  '#withServiceFabricClusterMixin':: d.fn(help='`azurerm.api_management_backend.withServiceFabricClusterMixin` constructs a mixin object that can be merged into the `api_management_backend`\nTerraform resource block to set or update the service_fabric_cluster field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.api_management_backend.withServiceFabricCluster](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service_fabric_cluster` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.api_management_backend.withTimeouts` constructs a mixin object that can be merged into the `api_management_backend`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.api_management_backend.withTimeoutsMixin` constructs a mixin object that can be merged into the `api_management_backend`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.api_management_backend.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTitle':: d.fn(help='`azurerm.api_management_backend.withTitle` constructs a mixin object that can be merged into the `api_management_backend`\nTerraform resource block to set or update the title field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `title` field.\n', args=[]),
  ...
  '#withTls':: d.fn(help='`azurerm.api_management_backend.withTls` constructs a mixin object that can be merged into the `api_management_backend`\nTerraform resource block to set or update the tls field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tls` field.\n', args=[]),
  ...
  '#withTlsMixin':: d.fn(help='`azurerm.api_management_backend.withTlsMixin` constructs a mixin object that can be merged into the `api_management_backend`\nTerraform resource block to set or update the tls field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.api_management_backend.withTls](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tls` field.\n', args=[]),
  ...
  '#withUrl':: d.fn(help='`azurerm.api_management_backend.withUrl` constructs a mixin object that can be merged into the `api_management_backend`\nTerraform resource block to set or update the url field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `url` field.\n', args=[]),
