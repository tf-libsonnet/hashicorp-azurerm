...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDedicatedHostId':: d.fn(help='`azurerm.maintenance_assignment_dedicated_host.withDedicatedHostId` constructs a mixin object that can be merged into the `maintenance_assignment_dedicated_host`\nTerraform resource block to set or update the dedicated_host_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `dedicated_host_id` field.\n', args=[]),
  ...
  '#withLocation':: d.fn(help='`azurerm.maintenance_assignment_dedicated_host.withLocation` constructs a mixin object that can be merged into the `maintenance_assignment_dedicated_host`\nTerraform resource block to set or update the location field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `location` field.\n', args=[]),
  ...
  '#withMaintenanceConfigurationId':: d.fn(help='`azurerm.maintenance_assignment_dedicated_host.withMaintenanceConfigurationId` constructs a mixin object that can be merged into the `maintenance_assignment_dedicated_host`\nTerraform resource block to set or update the maintenance_configuration_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `maintenance_configuration_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.maintenance_assignment_dedicated_host.withTimeouts` constructs a mixin object that can be merged into the `maintenance_assignment_dedicated_host`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.maintenance_assignment_dedicated_host.withTimeoutsMixin` constructs a mixin object that can be merged into the `maintenance_assignment_dedicated_host`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.maintenance_assignment_dedicated_host.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
