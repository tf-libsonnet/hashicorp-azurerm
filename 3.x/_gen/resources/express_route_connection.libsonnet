...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  new(
    ...
    express_route_gateway_bypass_enabled=null,
    routing=null,
    routing_weight=null,
    timeouts=null,
    _meta={}
  ...
  '#withExpressRouteGatewayBypassEnabled':: d.fn(help='`azurerm.bool.withExpressRouteGatewayBypassEnabled` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the express_route_gateway_bypass_enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `express_route_gateway_bypass_enabled` field.\n', args=[]),
  withExpressRouteGatewayBypassEnabled(resourceLabel, value): {
    resource+: {
      azurerm_express_route_connection+: {
        [resourceLabel]+: {
          express_route_gateway_bypass_enabled: value,
        },
      },
    },
  },
