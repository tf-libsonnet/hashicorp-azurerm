...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDebugLevel':: d.fn(help='`azurerm.subscription_template_deployment.withDebugLevel` constructs a mixin object that can be merged into the `subscription_template_deployment`\nTerraform resource block to set or update the debug_level field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `debug_level` field.\n', args=[]),
  ...
  '#withLocation':: d.fn(help='`azurerm.subscription_template_deployment.withLocation` constructs a mixin object that can be merged into the `subscription_template_deployment`\nTerraform resource block to set or update the location field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `location` field.\n', args=[]),
  ...
  '#withParametersContent':: d.fn(help='`azurerm.subscription_template_deployment.withParametersContent` constructs a mixin object that can be merged into the `subscription_template_deployment`\nTerraform resource block to set or update the parameters_content field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `parameters_content` field.\n', args=[]),
  ...
  '#withTags':: d.fn(help='`azurerm.subscription_template_deployment.withTags` constructs a mixin object that can be merged into the `subscription_template_deployment`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tags` field.\n', args=[]),
  ...
  '#withTemplateContent':: d.fn(help='`azurerm.subscription_template_deployment.withTemplateContent` constructs a mixin object that can be merged into the `subscription_template_deployment`\nTerraform resource block to set or update the template_content field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `template_content` field.\n', args=[]),
  ...
  '#withTemplateSpecVersionId':: d.fn(help='`azurerm.subscription_template_deployment.withTemplateSpecVersionId` constructs a mixin object that can be merged into the `subscription_template_deployment`\nTerraform resource block to set or update the template_spec_version_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `template_spec_version_id` field.\n', args=[]),
