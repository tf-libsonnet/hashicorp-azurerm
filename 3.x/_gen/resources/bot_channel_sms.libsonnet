...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBotName':: d.fn(help='`azurerm.bot_channel_sms.withBotName` constructs a mixin object that can be merged into the `bot_channel_sms`\nTerraform resource block to set or update the bot_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `bot_name` field.\n', args=[]),
  ...
  '#withLocation':: d.fn(help='`azurerm.bot_channel_sms.withLocation` constructs a mixin object that can be merged into the `bot_channel_sms`\nTerraform resource block to set or update the location field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `location` field.\n', args=[]),
  ...
  '#withPhoneNumber':: d.fn(help='`azurerm.bot_channel_sms.withPhoneNumber` constructs a mixin object that can be merged into the `bot_channel_sms`\nTerraform resource block to set or update the phone_number field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `phone_number` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.bot_channel_sms.withResourceGroupName` constructs a mixin object that can be merged into the `bot_channel_sms`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withSmsChannelAccountSecurityId':: d.fn(help='`azurerm.bot_channel_sms.withSmsChannelAccountSecurityId` constructs a mixin object that can be merged into the `bot_channel_sms`\nTerraform resource block to set or update the sms_channel_account_security_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `sms_channel_account_security_id` field.\n', args=[]),
  ...
  '#withSmsChannelAuthToken':: d.fn(help='`azurerm.bot_channel_sms.withSmsChannelAuthToken` constructs a mixin object that can be merged into the `bot_channel_sms`\nTerraform resource block to set or update the sms_channel_auth_token field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `sms_channel_auth_token` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.bot_channel_sms.withTimeouts` constructs a mixin object that can be merged into the `bot_channel_sms`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.bot_channel_sms.withTimeoutsMixin` constructs a mixin object that can be merged into the `bot_channel_sms`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.bot_channel_sms.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
