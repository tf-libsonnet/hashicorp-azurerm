...
{
  '#':: d.pkg(name='cosmosdb_notebook_workspace', url='', help='`cosmosdb_notebook_workspace` represents the `azurerm_cosmosdb_notebook_workspace` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withAccountName':: d.fn(help='`azurerm.cosmosdb_notebook_workspace.withAccountName` constructs a mixin object that can be merged into the `cosmosdb_notebook_workspace`\nTerraform resource block to set or update the account_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `account_name` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.cosmosdb_notebook_workspace.withName` constructs a mixin object that can be merged into the `cosmosdb_notebook_workspace`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.cosmosdb_notebook_workspace.withResourceGroupName` constructs a mixin object that can be merged into the `cosmosdb_notebook_workspace`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.cosmosdb_notebook_workspace.withTimeouts` constructs a mixin object that can be merged into the `cosmosdb_notebook_workspace`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.cosmosdb_notebook_workspace.withTimeoutsMixin` constructs a mixin object that can be merged into the `cosmosdb_notebook_workspace`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.cosmosdb_notebook_workspace.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
