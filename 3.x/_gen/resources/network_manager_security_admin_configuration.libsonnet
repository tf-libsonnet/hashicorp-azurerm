...
{
  '#':: d.pkg(name='network_manager_security_admin_configuration', url='', help='`network_manager_security_admin_configuration` represents the `azurerm_network_manager_security_admin_configuration` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  new(
    ...
    name,
    network_manager_id,
    apply_on_network_intent_policy_based_services=null,
    description=null,
    timeouts=null,
    _meta={}
  ):: tf.withResource(
  ...
  '#withApplyOnNetworkIntentPolicyBasedServices':: d.fn(help='`azurerm.list.withApplyOnNetworkIntentPolicyBasedServices` constructs a mixin object that can be merged into the `list`\nTerraform resource block to set or update the apply_on_network_intent_policy_based_services field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list`): The value to set for the `apply_on_network_intent_policy_based_services` field.\n', args=[]),
  withApplyOnNetworkIntentPolicyBasedServices(resourceLabel, value): {
    resource+: {
      azurerm_network_manager_security_admin_configuration+: {
        [resourceLabel]+: {
          apply_on_network_intent_policy_based_services: value,
        },
      },
    },
  },
