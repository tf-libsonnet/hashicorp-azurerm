...
{
  '#':: d.pkg(name='logic_app_trigger_http_request', url='', help='`logic_app_trigger_http_request` represents the `azurerm_logic_app_trigger_http_request` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withLogicAppId':: d.fn(help='`azurerm.logic_app_trigger_http_request.withLogicAppId` constructs a mixin object that can be merged into the `logic_app_trigger_http_request`\nTerraform resource block to set or update the logic_app_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `logic_app_id` field.\n', args=[]),
  ...
  '#withMethod':: d.fn(help='`azurerm.logic_app_trigger_http_request.withMethod` constructs a mixin object that can be merged into the `logic_app_trigger_http_request`\nTerraform resource block to set or update the method field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `method` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.logic_app_trigger_http_request.withName` constructs a mixin object that can be merged into the `logic_app_trigger_http_request`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withRelativePath':: d.fn(help='`azurerm.logic_app_trigger_http_request.withRelativePath` constructs a mixin object that can be merged into the `logic_app_trigger_http_request`\nTerraform resource block to set or update the relative_path field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `relative_path` field.\n', args=[]),
  ...
  '#withSchema':: d.fn(help='`azurerm.logic_app_trigger_http_request.withSchema` constructs a mixin object that can be merged into the `logic_app_trigger_http_request`\nTerraform resource block to set or update the schema field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `schema` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.logic_app_trigger_http_request.withTimeouts` constructs a mixin object that can be merged into the `logic_app_trigger_http_request`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.logic_app_trigger_http_request.withTimeoutsMixin` constructs a mixin object that can be merged into the `logic_app_trigger_http_request`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.logic_app_trigger_http_request.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
