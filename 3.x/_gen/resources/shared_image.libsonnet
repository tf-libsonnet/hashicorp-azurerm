...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  new(
    ...
    architecture=null,
    confidential_vm_enabled=null,
    confidential_vm_supported=null,
    description=null,
  ...
  '#withConfidentialVmEnabled':: d.fn(help='`azurerm.bool.withConfidentialVmEnabled` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the confidential_vm_enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `confidential_vm_enabled` field.\n', args=[]),
  withConfidentialVmEnabled(resourceLabel, value): {
    resource+: {
      azurerm_shared_image+: {
        [resourceLabel]+: {
          confidential_vm_enabled: value,
        },
      },
    },
  },
  '#withConfidentialVmSupported':: d.fn(help='`azurerm.bool.withConfidentialVmSupported` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the confidential_vm_supported field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `confidential_vm_supported` field.\n', args=[]),
  withConfidentialVmSupported(resourceLabel, value): {
    resource+: {
      azurerm_shared_image+: {
        [resourceLabel]+: {
          confidential_vm_supported: value,
        },
      },
    },
  },
  ...
  '#withTrustedLaunchSupported':: d.fn(help='`azurerm.bool.withTrustedLaunchSupported` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the trusted_launch_supported field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `trusted_launch_supported` field.\n', args=[]),
  withTrustedLaunchSupported(resourceLabel, value): {
    resource+: {
      azurerm_shared_image+: {
        [resourceLabel]+: {
          trusted_launch_supported: value,
        },
      },
    },
  },
