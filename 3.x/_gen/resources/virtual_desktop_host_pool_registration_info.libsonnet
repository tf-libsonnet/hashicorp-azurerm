...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withExpirationDate':: d.fn(help='`azurerm.virtual_desktop_host_pool_registration_info.withExpirationDate` constructs a mixin object that can be merged into the `virtual_desktop_host_pool_registration_info`\nTerraform resource block to set or update the expiration_date field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `expiration_date` field.\n', args=[]),
  ...
  '#withHostpoolId':: d.fn(help='`azurerm.virtual_desktop_host_pool_registration_info.withHostpoolId` constructs a mixin object that can be merged into the `virtual_desktop_host_pool_registration_info`\nTerraform resource block to set or update the hostpool_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `hostpool_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.virtual_desktop_host_pool_registration_info.withTimeouts` constructs a mixin object that can be merged into the `virtual_desktop_host_pool_registration_info`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.virtual_desktop_host_pool_registration_info.withTimeoutsMixin` constructs a mixin object that can be merged into the `virtual_desktop_host_pool_registration_info`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.virtual_desktop_host_pool_registration_info.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
