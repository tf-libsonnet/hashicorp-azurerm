...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAuxiliaryMode':: d.fn(help='`azurerm.string.withAuxiliaryMode` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the auxiliary_mode field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `auxiliary_mode` field.\n', args=[]),
  withAuxiliaryMode(resourceLabel, value): {
    resource+: {
      azurerm_network_interface+: {
        [resourceLabel]+: {
          auxiliary_mode: value,
        },
      },
    },
  },
  '#withAuxiliarySku':: d.fn(help='`azurerm.string.withAuxiliarySku` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the auxiliary_sku field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `auxiliary_sku` field.\n', args=[]),
  withAuxiliarySku(resourceLabel, value): {
    resource+: {
      azurerm_network_interface+: {
        [resourceLabel]+: {
          auxiliary_sku: value,
