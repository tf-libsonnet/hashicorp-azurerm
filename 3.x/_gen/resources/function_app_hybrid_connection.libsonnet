...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withFunctionAppId':: d.fn(help='`azurerm.function_app_hybrid_connection.withFunctionAppId` constructs a mixin object that can be merged into the `function_app_hybrid_connection`\nTerraform resource block to set or update the function_app_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `function_app_id` field.\n', args=[]),
  ...
  '#withHostname':: d.fn(help='`azurerm.function_app_hybrid_connection.withHostname` constructs a mixin object that can be merged into the `function_app_hybrid_connection`\nTerraform resource block to set or update the hostname field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `hostname` field.\n', args=[]),
  ...
  '#withPort':: d.fn(help='`azurerm.function_app_hybrid_connection.withPort` constructs a mixin object that can be merged into the `function_app_hybrid_connection`\nTerraform resource block to set or update the port field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `port` field.\n', args=[]),
  ...
  '#withRelayId':: d.fn(help='`azurerm.function_app_hybrid_connection.withRelayId` constructs a mixin object that can be merged into the `function_app_hybrid_connection`\nTerraform resource block to set or update the relay_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `relay_id` field.\n', args=[]),
  ...
  '#withSendKeyName':: d.fn(help='`azurerm.function_app_hybrid_connection.withSendKeyName` constructs a mixin object that can be merged into the `function_app_hybrid_connection`\nTerraform resource block to set or update the send_key_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `send_key_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.function_app_hybrid_connection.withTimeouts` constructs a mixin object that can be merged into the `function_app_hybrid_connection`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.function_app_hybrid_connection.withTimeoutsMixin` constructs a mixin object that can be merged into the `function_app_hybrid_connection`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.function_app_hybrid_connection.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
