...
{
  '#':: d.pkg(name='web_pubsub_custom_certificate', url='', help='`web_pubsub_custom_certificate` represents the `azurerm_web_pubsub_custom_certificate` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
