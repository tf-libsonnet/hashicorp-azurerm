...
{
  '#':: d.pkg(name='cosmosdb_mongo_database', url='', help='`cosmosdb_mongo_database` represents the `azurerm_cosmosdb_mongo_database` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  autoscale_settings:: {
  ...
  '#withAutoscaleSettings':: d.fn(help='`azurerm.cosmosdb_mongo_database.withAutoscaleSettings` constructs a mixin object that can be merged into the `cosmosdb_mongo_database`\nTerraform resource block to set or update the autoscale_settings field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `autoscale_settings` field.\n', args=[]),
  ...
  '#withAutoscaleSettingsMixin':: d.fn(help='`azurerm.cosmosdb_mongo_database.withAutoscaleSettingsMixin` constructs a mixin object that can be merged into the `cosmosdb_mongo_database`\nTerraform resource block to set or update the autoscale_settings field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [azurerm.cosmosdb_mongo_database.withAutoscaleSettings](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `autoscale_settings` field.\n', args=[]),
  ...
  '#withThroughput':: d.fn(help='`azurerm.cosmosdb_mongo_database.withThroughput` constructs a mixin object that can be merged into the `cosmosdb_mongo_database`\nTerraform resource block to set or update the throughput field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `throughput` field.\n', args=[]),
