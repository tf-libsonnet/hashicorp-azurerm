...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withName':: d.fn(help='`azurerm.virtual_hub_ip.withName` constructs a mixin object that can be merged into the `virtual_hub_ip`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withPrivateIpAddress':: d.fn(help='`azurerm.virtual_hub_ip.withPrivateIpAddress` constructs a mixin object that can be merged into the `virtual_hub_ip`\nTerraform resource block to set or update the private_ip_address field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `private_ip_address` field.\n', args=[]),
  ...
  '#withPrivateIpAllocationMethod':: d.fn(help='`azurerm.virtual_hub_ip.withPrivateIpAllocationMethod` constructs a mixin object that can be merged into the `virtual_hub_ip`\nTerraform resource block to set or update the private_ip_allocation_method field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `private_ip_allocation_method` field.\n', args=[]),
  ...
  '#withPublicIpAddressId':: d.fn(help='`azurerm.virtual_hub_ip.withPublicIpAddressId` constructs a mixin object that can be merged into the `virtual_hub_ip`\nTerraform resource block to set or update the public_ip_address_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `public_ip_address_id` field.\n', args=[]),
  ...
  '#withSubnetId':: d.fn(help='`azurerm.virtual_hub_ip.withSubnetId` constructs a mixin object that can be merged into the `virtual_hub_ip`\nTerraform resource block to set or update the subnet_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `subnet_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.virtual_hub_ip.withTimeouts` constructs a mixin object that can be merged into the `virtual_hub_ip`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.virtual_hub_ip.withTimeoutsMixin` constructs a mixin object that can be merged into the `virtual_hub_ip`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.virtual_hub_ip.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withVirtualHubId':: d.fn(help='`azurerm.virtual_hub_ip.withVirtualHubId` constructs a mixin object that can be merged into the `virtual_hub_ip`\nTerraform resource block to set or update the virtual_hub_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `virtual_hub_id` field.\n', args=[]),
