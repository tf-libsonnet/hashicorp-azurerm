...
{
  '#':: d.pkg(name='monitor_private_link_scoped_service', url='', help='`monitor_private_link_scoped_service` represents the `azurerm_monitor_private_link_scoped_service` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withLinkedResourceId':: d.fn(help='`azurerm.monitor_private_link_scoped_service.withLinkedResourceId` constructs a mixin object that can be merged into the `monitor_private_link_scoped_service`\nTerraform resource block to set or update the linked_resource_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `linked_resource_id` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.monitor_private_link_scoped_service.withName` constructs a mixin object that can be merged into the `monitor_private_link_scoped_service`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.monitor_private_link_scoped_service.withResourceGroupName` constructs a mixin object that can be merged into the `monitor_private_link_scoped_service`\nTerraform resource block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withScopeName':: d.fn(help='`azurerm.monitor_private_link_scoped_service.withScopeName` constructs a mixin object that can be merged into the `monitor_private_link_scoped_service`\nTerraform resource block to set or update the scope_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `scope_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.monitor_private_link_scoped_service.withTimeouts` constructs a mixin object that can be merged into the `monitor_private_link_scoped_service`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.monitor_private_link_scoped_service.withTimeoutsMixin` constructs a mixin object that can be merged into the `monitor_private_link_scoped_service`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.monitor_private_link_scoped_service.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
