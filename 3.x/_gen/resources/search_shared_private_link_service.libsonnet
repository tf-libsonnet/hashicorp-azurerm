...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withName':: d.fn(help='`azurerm.search_shared_private_link_service.withName` constructs a mixin object that can be merged into the `search_shared_private_link_service`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withRequestMessage':: d.fn(help='`azurerm.search_shared_private_link_service.withRequestMessage` constructs a mixin object that can be merged into the `search_shared_private_link_service`\nTerraform resource block to set or update the request_message field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `request_message` field.\n', args=[]),
  ...
  '#withSearchServiceId':: d.fn(help='`azurerm.search_shared_private_link_service.withSearchServiceId` constructs a mixin object that can be merged into the `search_shared_private_link_service`\nTerraform resource block to set or update the search_service_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `search_service_id` field.\n', args=[]),
  ...
  '#withSubresourceName':: d.fn(help='`azurerm.search_shared_private_link_service.withSubresourceName` constructs a mixin object that can be merged into the `search_shared_private_link_service`\nTerraform resource block to set or update the subresource_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `subresource_name` field.\n', args=[]),
  ...
  '#withTargetResourceId':: d.fn(help='`azurerm.search_shared_private_link_service.withTargetResourceId` constructs a mixin object that can be merged into the `search_shared_private_link_service`\nTerraform resource block to set or update the target_resource_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target_resource_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.search_shared_private_link_service.withTimeouts` constructs a mixin object that can be merged into the `search_shared_private_link_service`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.search_shared_private_link_service.withTimeoutsMixin` constructs a mixin object that can be merged into the `search_shared_private_link_service`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.search_shared_private_link_service.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
