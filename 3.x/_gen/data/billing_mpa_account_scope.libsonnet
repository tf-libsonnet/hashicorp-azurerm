...
{
  '#':: d.pkg(name='billing_mpa_account_scope', url='', help='`billing_mpa_account_scope` represents the `azurerm_billing_mpa_account_scope` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(billing_account_name=billing_account_name, customer_name=customer_name, timeouts=timeouts),
    _meta=_meta
  ),
  ...
  '#withBillingAccountName':: d.fn(help='`azurerm.billing_mpa_account_scope.withBillingAccountName` constructs a mixin object that can be merged into the `billing_mpa_account_scope`\nTerraform data source block to set or update the billing_account_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `billing_account_name` field.\n', args=[]),
  ...
  '#withCustomerName':: d.fn(help='`azurerm.billing_mpa_account_scope.withCustomerName` constructs a mixin object that can be merged into the `billing_mpa_account_scope`\nTerraform data source block to set or update the customer_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `customer_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.billing_mpa_account_scope.withTimeouts` constructs a mixin object that can be merged into the `billing_mpa_account_scope`\nTerraform data source block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.billing_mpa_account_scope.withTimeoutsMixin` constructs a mixin object that can be merged into the `billing_mpa_account_scope`\nTerraform data source block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.billing_mpa_account_scope.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
