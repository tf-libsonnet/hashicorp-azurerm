...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBlueprintName':: d.fn(help='`azurerm.blueprint_published_version.withBlueprintName` constructs a mixin object that can be merged into the `blueprint_published_version`\nTerraform data source block to set or update the blueprint_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `blueprint_name` field.\n', args=[]),
  ...
  '#withScopeId':: d.fn(help='`azurerm.blueprint_published_version.withScopeId` constructs a mixin object that can be merged into the `blueprint_published_version`\nTerraform data source block to set or update the scope_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `scope_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.blueprint_published_version.withTimeouts` constructs a mixin object that can be merged into the `blueprint_published_version`\nTerraform data source block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.blueprint_published_version.withTimeoutsMixin` constructs a mixin object that can be merged into the `blueprint_published_version`\nTerraform data source block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.blueprint_published_version.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withVersion':: d.fn(help='`azurerm.blueprint_published_version.withVersion` constructs a mixin object that can be merged into the `blueprint_published_version`\nTerraform data source block to set or update the version field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `version` field.\n', args=[]),
