...
{
  '#':: d.pkg(name='servicebus_topic', url='', help='`servicebus_topic` represents the `azurerm_servicebus_topic` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withNamespaceName':: d.fn(help='`azurerm.servicebus_topic.withNamespaceName` constructs a mixin object that can be merged into the `servicebus_topic`\nTerraform data source block to set or update the namespace_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `namespace_name` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.servicebus_topic.withResourceGroupName` constructs a mixin object that can be merged into the `servicebus_topic`\nTerraform data source block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
