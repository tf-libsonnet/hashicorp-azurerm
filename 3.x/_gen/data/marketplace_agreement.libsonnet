...
{
  '#':: d.pkg(name='marketplace_agreement', url='', help='`marketplace_agreement` represents the `azurerm_marketplace_agreement` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
