...
{
  '#':: d.pkg(name='container_registry_scope_map', url='', help='`container_registry_scope_map` represents the `azurerm_container_registry_scope_map` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
