...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withLocation':: d.fn(help='`azurerm.public_maintenance_configurations.withLocation` constructs a mixin object that can be merged into the `public_maintenance_configurations`\nTerraform data source block to set or update the location field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `location` field.\n', args=[]),
  ...
  '#withRecurEvery':: d.fn(help='`azurerm.public_maintenance_configurations.withRecurEvery` constructs a mixin object that can be merged into the `public_maintenance_configurations`\nTerraform data source block to set or update the recur_every field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `recur_every` field.\n', args=[]),
  ...
  '#withScope':: d.fn(help='`azurerm.public_maintenance_configurations.withScope` constructs a mixin object that can be merged into the `public_maintenance_configurations`\nTerraform data source block to set or update the scope field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `scope` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.public_maintenance_configurations.withTimeouts` constructs a mixin object that can be merged into the `public_maintenance_configurations`\nTerraform data source block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.public_maintenance_configurations.withTimeoutsMixin` constructs a mixin object that can be merged into the `public_maintenance_configurations`\nTerraform data source block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.public_maintenance_configurations.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
