...
{
  '#':: d.pkg(name='mobile_network_sim', url='', help='`mobile_network_sim` represents the `azurerm_mobile_network_sim` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(mobile_network_sim_group_id=mobile_network_sim_group_id, name=name, timeouts=timeouts),
    _meta=_meta
  ),
  ...
  withMobileNetworkSimGroupId(dataSrcLabel, value): {
    data+: {
