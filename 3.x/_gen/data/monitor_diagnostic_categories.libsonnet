...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withResourceId':: d.fn(help='`azurerm.monitor_diagnostic_categories.withResourceId` constructs a mixin object that can be merged into the `monitor_diagnostic_categories`\nTerraform data source block to set or update the resource_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.monitor_diagnostic_categories.withTimeouts` constructs a mixin object that can be merged into the `monitor_diagnostic_categories`\nTerraform data source block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.monitor_diagnostic_categories.withTimeoutsMixin` constructs a mixin object that can be merged into the `monitor_diagnostic_categories`\nTerraform data source block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.monitor_diagnostic_categories.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
