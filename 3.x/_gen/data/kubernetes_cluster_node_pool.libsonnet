...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withKubernetesClusterName':: d.fn(help='`azurerm.kubernetes_cluster_node_pool.withKubernetesClusterName` constructs a mixin object that can be merged into the `kubernetes_cluster_node_pool`\nTerraform data source block to set or update the kubernetes_cluster_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `kubernetes_cluster_name` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.kubernetes_cluster_node_pool.withResourceGroupName` constructs a mixin object that can be merged into the `kubernetes_cluster_node_pool`\nTerraform data source block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
