...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withSortVersionsBySemver':: d.fn(help='`azurerm.shared_image_version.withSortVersionsBySemver` constructs a mixin object that can be merged into the `shared_image_version`\nTerraform data source block to set or update the sort_versions_by_semver field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `sort_versions_by_semver` field.\n', args=[]),
