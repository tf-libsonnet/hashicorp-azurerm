...
{
  '#':: d.pkg(name='private_dns_zone_virtual_network_link', url='', help='`private_dns_zone_virtual_network_link` represents the `azurerm_private_dns_zone_virtual_network_link` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
