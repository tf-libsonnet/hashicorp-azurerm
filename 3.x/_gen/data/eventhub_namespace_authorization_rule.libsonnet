...
{
  '#':: d.pkg(name='eventhub_namespace_authorization_rule', url='', help='`eventhub_namespace_authorization_rule` represents the `azurerm_eventhub_namespace_authorization_rule` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
