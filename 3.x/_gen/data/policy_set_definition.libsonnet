...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withManagementGroupName':: d.fn(help='`azurerm.policy_set_definition.withManagementGroupName` constructs a mixin object that can be merged into the `policy_set_definition`\nTerraform data source block to set or update the management_group_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `management_group_name` field.\n', args=[]),
