...
{
  '#':: d.pkg(name='monitor_scheduled_query_rules_log', url='', help='`monitor_scheduled_query_rules_log` represents the `azurerm_monitor_scheduled_query_rules_log` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
