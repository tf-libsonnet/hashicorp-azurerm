...
{
  '#':: d.pkg(name='eventhub_sas', url='', help='`eventhub_sas` represents the `azurerm_eventhub_sas` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(connection_string=connection_string, expiry=expiry, timeouts=timeouts),
    _meta=_meta
  ),
