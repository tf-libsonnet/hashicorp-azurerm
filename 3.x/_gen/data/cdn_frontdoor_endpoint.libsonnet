...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withProfileName':: d.fn(help='`azurerm.cdn_frontdoor_endpoint.withProfileName` constructs a mixin object that can be merged into the `cdn_frontdoor_endpoint`\nTerraform data source block to set or update the profile_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `profile_name` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.cdn_frontdoor_endpoint.withResourceGroupName` constructs a mixin object that can be merged into the `cdn_frontdoor_endpoint`\nTerraform data source block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
