...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAttachmentStatus':: d.fn(help='`azurerm.public_ips.withAttachmentStatus` constructs a mixin object that can be merged into the `public_ips`\nTerraform data source block to set or update the attachment_status field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `attachment_status` field.\n', args=[]),
  ...
  '#withNamePrefix':: d.fn(help='`azurerm.public_ips.withNamePrefix` constructs a mixin object that can be merged into the `public_ips`\nTerraform data source block to set or update the name_prefix field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name_prefix` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.public_ips.withResourceGroupName` constructs a mixin object that can be merged into the `public_ips`\nTerraform data source block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.public_ips.withTimeouts` constructs a mixin object that can be merged into the `public_ips`\nTerraform data source block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.public_ips.withTimeoutsMixin` constructs a mixin object that can be merged into the `public_ips`\nTerraform data source block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.public_ips.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
