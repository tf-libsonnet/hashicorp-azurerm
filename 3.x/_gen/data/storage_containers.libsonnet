...
{
  '#':: d.pkg(name='storage_containers', url='', help='`storage_containers` represents the `azurerm_storage_containers` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(name_prefix=name_prefix, storage_account_id=storage_account_id, timeouts=timeouts),
    _meta=_meta
  ),
