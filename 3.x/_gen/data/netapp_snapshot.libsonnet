...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAccountName':: d.fn(help='`azurerm.netapp_snapshot.withAccountName` constructs a mixin object that can be merged into the `netapp_snapshot`\nTerraform data source block to set or update the account_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `account_name` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.netapp_snapshot.withName` constructs a mixin object that can be merged into the `netapp_snapshot`\nTerraform data source block to set or update the name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withPoolName':: d.fn(help='`azurerm.netapp_snapshot.withPoolName` constructs a mixin object that can be merged into the `netapp_snapshot`\nTerraform data source block to set or update the pool_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `pool_name` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.netapp_snapshot.withResourceGroupName` constructs a mixin object that can be merged into the `netapp_snapshot`\nTerraform data source block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.netapp_snapshot.withTimeouts` constructs a mixin object that can be merged into the `netapp_snapshot`\nTerraform data source block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.netapp_snapshot.withTimeoutsMixin` constructs a mixin object that can be merged into the `netapp_snapshot`\nTerraform data source block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.netapp_snapshot.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withVolumeName':: d.fn(help='`azurerm.netapp_snapshot.withVolumeName` constructs a mixin object that can be merged into the `netapp_snapshot`\nTerraform data source block to set or update the volume_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `volume_name` field.\n', args=[]),
