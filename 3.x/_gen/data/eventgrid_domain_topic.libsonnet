...
{
  '#':: d.pkg(name='eventgrid_domain_topic', url='', help='`eventgrid_domain_topic` represents the `azurerm_eventgrid_domain_topic` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withDomainName':: d.fn(help='`azurerm.eventgrid_domain_topic.withDomainName` constructs a mixin object that can be merged into the `eventgrid_domain_topic`\nTerraform data source block to set or update the domain_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `domain_name` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.eventgrid_domain_topic.withName` constructs a mixin object that can be merged into the `eventgrid_domain_topic`\nTerraform data source block to set or update the name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.eventgrid_domain_topic.withResourceGroupName` constructs a mixin object that can be merged into the `eventgrid_domain_topic`\nTerraform data source block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.eventgrid_domain_topic.withTimeouts` constructs a mixin object that can be merged into the `eventgrid_domain_topic`\nTerraform data source block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.eventgrid_domain_topic.withTimeoutsMixin` constructs a mixin object that can be merged into the `eventgrid_domain_topic`\nTerraform data source block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.eventgrid_domain_topic.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
