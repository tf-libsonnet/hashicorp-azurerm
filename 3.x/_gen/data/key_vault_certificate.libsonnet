...
{
  '#':: d.pkg(name='key_vault_certificate', url='', help='`key_vault_certificate` represents the `azurerm_key_vault_certificate` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withVersion':: d.fn(help='`azurerm.key_vault_certificate.withVersion` constructs a mixin object that can be merged into the `key_vault_certificate`\nTerraform data source block to set or update the version field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `version` field.\n', args=[]),
