...
{
  '#':: d.pkg(name='web_pubsub_private_link_resource', url='', help='`web_pubsub_private_link_resource` represents the `azurerm_web_pubsub_private_link_resource` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.web_pubsub_private_link_resource.withTimeouts` constructs a mixin object that can be merged into the `web_pubsub_private_link_resource`\nTerraform data source block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.web_pubsub_private_link_resource.withTimeoutsMixin` constructs a mixin object that can be merged into the `web_pubsub_private_link_resource`\nTerraform data source block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.web_pubsub_private_link_resource.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withWebPubsubId':: d.fn(help='`azurerm.web_pubsub_private_link_resource.withWebPubsubId` constructs a mixin object that can be merged into the `web_pubsub_private_link_resource`\nTerraform data source block to set or update the web_pubsub_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `web_pubsub_id` field.\n', args=[]),
