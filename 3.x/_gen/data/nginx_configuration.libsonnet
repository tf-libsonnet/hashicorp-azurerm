...
{
  '#':: d.pkg(name='nginx_configuration', url='', help='`nginx_configuration` represents the `azurerm_nginx_configuration` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(nginx_deployment_id=nginx_deployment_id, timeouts=timeouts),
    _meta=_meta
  ),
