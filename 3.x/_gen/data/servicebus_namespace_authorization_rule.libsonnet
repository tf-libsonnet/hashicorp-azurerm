...
{
  '#':: d.pkg(name='servicebus_namespace_authorization_rule', url='', help='`servicebus_namespace_authorization_rule` represents the `azurerm_servicebus_namespace_authorization_rule` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withNamespaceName':: d.fn(help='`azurerm.servicebus_namespace_authorization_rule.withNamespaceName` constructs a mixin object that can be merged into the `servicebus_namespace_authorization_rule`\nTerraform data source block to set or update the namespace_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `namespace_name` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.servicebus_namespace_authorization_rule.withResourceGroupName` constructs a mixin object that can be merged into the `servicebus_namespace_authorization_rule`\nTerraform data source block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
