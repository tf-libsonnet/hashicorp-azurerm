...
{
  '#':: d.pkg(name='cosmosdb_restorable_database_accounts', url='', help='`cosmosdb_restorable_database_accounts` represents the `azurerm_cosmosdb_restorable_database_accounts` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withLocation':: d.fn(help='`azurerm.cosmosdb_restorable_database_accounts.withLocation` constructs a mixin object that can be merged into the `cosmosdb_restorable_database_accounts`\nTerraform data source block to set or update the location field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `location` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`azurerm.cosmosdb_restorable_database_accounts.withName` constructs a mixin object that can be merged into the `cosmosdb_restorable_database_accounts`\nTerraform data source block to set or update the name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.cosmosdb_restorable_database_accounts.withTimeouts` constructs a mixin object that can be merged into the `cosmosdb_restorable_database_accounts`\nTerraform data source block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.cosmosdb_restorable_database_accounts.withTimeoutsMixin` constructs a mixin object that can be merged into the `cosmosdb_restorable_database_accounts`\nTerraform data source block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.cosmosdb_restorable_database_accounts.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
