...
{
  '#':: d.pkg(name='automation_variables', url='', help='`automation_variables` represents the `azurerm_automation_variables` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(automation_account_id=automation_account_id, timeouts=timeouts),
    _meta=_meta
  ),
  ...
  withAutomationAccountId(dataSrcLabel, value): {
    data+: {
