...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withPublicIpAddressIds':: d.fn(help='`azurerm.nat_gateway.withPublicIpAddressIds` constructs a mixin object that can be merged into the `nat_gateway`\nTerraform data source block to set or update the public_ip_address_ids field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `public_ip_address_ids` field.\n', args=[]),
  ...
  '#withPublicIpPrefixIds':: d.fn(help='`azurerm.nat_gateway.withPublicIpPrefixIds` constructs a mixin object that can be merged into the `nat_gateway`\nTerraform data source block to set or update the public_ip_prefix_ids field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `public_ip_prefix_ids` field.\n', args=[]),
