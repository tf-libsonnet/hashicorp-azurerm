...
{
  '#':: d.pkg(name='data_share_dataset_blob_storage', url='', help='`data_share_dataset_blob_storage` represents the `azurerm_data_share_dataset_blob_storage` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(data_share_id=data_share_id, name=name, timeouts=timeouts),
    _meta=_meta
  ),
