...
{
  '#':: d.pkg(name='blueprint_definition', url='', help='`blueprint_definition` represents the `azurerm_blueprint_definition` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withName':: d.fn(help='`azurerm.blueprint_definition.withName` constructs a mixin object that can be merged into the `blueprint_definition`\nTerraform data source block to set or update the name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withScopeId':: d.fn(help='`azurerm.blueprint_definition.withScopeId` constructs a mixin object that can be merged into the `blueprint_definition`\nTerraform data source block to set or update the scope_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `scope_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.blueprint_definition.withTimeouts` constructs a mixin object that can be merged into the `blueprint_definition`\nTerraform data source block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.blueprint_definition.withTimeoutsMixin` constructs a mixin object that can be merged into the `blueprint_definition`\nTerraform data source block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.blueprint_definition.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
