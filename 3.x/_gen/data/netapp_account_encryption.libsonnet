...
{
  '#':: d.pkg(name='netapp_account_encryption', url='', help='`netapp_account_encryption` represents the `azurerm_netapp_account_encryption` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    netapp_account_id,
    encryption_key=null,
    system_assigned_identity_principal_id=null,
    timeouts=null,
  ...
  '#withEncryptionKey':: d.fn(help='`azurerm.string.withEncryptionKey` constructs a mixin object that can be merged into the `string`\nTerraform data source block to set or update the encryption_key field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `encryption_key` field.\n', args=[]),
  withEncryptionKey(dataSrcLabel, value): {
    data+: {
  ...
  '#withNetappAccountId':: d.fn(help='`azurerm.string.withNetappAccountId` constructs a mixin object that can be merged into the `string`\nTerraform data source block to set or update the netapp_account_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `netapp_account_id` field.\n', args=[]),
  withNetappAccountId(dataSrcLabel, value): {
    data+: {
      azurerm_netapp_account_encryption+: {
        [dataSrcLabel]+: {
          netapp_account_id: value,
        },
      },
    },
  },
  '#withSystemAssignedIdentityPrincipalId':: d.fn(help='`azurerm.string.withSystemAssignedIdentityPrincipalId` constructs a mixin object that can be merged into the `string`\nTerraform data source block to set or update the system_assigned_identity_principal_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `system_assigned_identity_principal_id` field.\n', args=[]),
  withSystemAssignedIdentityPrincipalId(dataSrcLabel, value): {
    data+: {
      azurerm_netapp_account_encryption+: {
        [dataSrcLabel]+: {
          system_assigned_identity_principal_id: value,
        },
      },
    },
  },
  ...
  withUserAssignedIdentityId(dataSrcLabel, value): {
    data+: {
      azurerm_netapp_account_encryption+: {
        [dataSrcLabel]+: {
