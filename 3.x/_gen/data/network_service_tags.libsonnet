...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#newAttrs':: d.fn(help='\n`azurerm.data.network_service_tags.newAttrs` constructs a new object with attributes and blocks configured for the `network_service_tags`\nTerraform data source.\n\nUnlike [azurerm.data.network_service_tags.new](#fn-new), this function will not inject the `data source`\nblock into the root Terraform document. Instead, this must be passed in as the `attrs` argument for the\n[tf.withData](https://github.com/tf-libsonnet/core/tree/main/docs#fn-withdata) function to build a complete block.\n\nThis is most useful when you need to preprocess the attributes with functions, conditional, or looping logic prior to\ninjecting into a complete block.\n\n**Args**:\n  - `location` (`string`): Set the `location` field on the resulting object.\n  - `location_filter` (`string`): Set the `location_filter` field on the resulting object. When `null`, the `location_filter` field will be omitted from the resulting object.\n  - `service` (`string`): Set the `service` field on the resulting object.\n  - `timeouts` (`obj`): Set the `timeouts` field on the resulting object. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azurerm.data.network_service_tags.timeouts.new](#fn-timeoutsnew) constructor.\n\n**Returns**:\n  - An attribute object that can be used with [tf.withData](https://github.com/tf-libsonnet/core/tree/main/docs#fn-withdata) to construct a new `network_service_tags` data source into the root Terraform configuration.\n', args=[]),
  newAttrs(
    location,
    service,
    location_filter=null,
  ...
  '#withLocationFilter':: d.fn(help='`azurerm.string.withLocationFilter` constructs a mixin object that can be merged into the `string`\nTerraform data source block to set or update the location_filter field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `location_filter` field.\n', args=[]),
