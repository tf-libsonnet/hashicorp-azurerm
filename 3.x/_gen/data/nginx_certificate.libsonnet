...
{
  '#':: d.pkg(name='nginx_certificate', url='', help='`nginx_certificate` represents the `azurerm_nginx_certificate` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(name=name, nginx_deployment_id=nginx_deployment_id, timeouts=timeouts),
    _meta=_meta
  ),
  ...
  withNginxDeploymentId(dataSrcLabel, value): {
    data+: {
      azurerm_nginx_certificate+: {
        [dataSrcLabel]+: {
