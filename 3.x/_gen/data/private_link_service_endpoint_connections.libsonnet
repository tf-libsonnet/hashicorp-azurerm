...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.private_link_service_endpoint_connections.withResourceGroupName` constructs a mixin object that can be merged into the `private_link_service_endpoint_connections`\nTerraform data source block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withServiceId':: d.fn(help='`azurerm.private_link_service_endpoint_connections.withServiceId` constructs a mixin object that can be merged into the `private_link_service_endpoint_connections`\nTerraform data source block to set or update the service_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.private_link_service_endpoint_connections.withTimeouts` constructs a mixin object that can be merged into the `private_link_service_endpoint_connections`\nTerraform data source block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.private_link_service_endpoint_connections.withTimeoutsMixin` constructs a mixin object that can be merged into the `private_link_service_endpoint_connections`\nTerraform data source block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.private_link_service_endpoint_connections.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
