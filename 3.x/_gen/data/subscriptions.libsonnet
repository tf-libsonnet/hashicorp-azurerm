...
{
  '#':: d.pkg(name='subscriptions', url='', help='`subscriptions` represents the `azurerm_subscriptions` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withDisplayNamePrefix':: d.fn(help='`azurerm.subscriptions.withDisplayNamePrefix` constructs a mixin object that can be merged into the `subscriptions`\nTerraform data source block to set or update the display_name_prefix field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `display_name_prefix` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.subscriptions.withTimeouts` constructs a mixin object that can be merged into the `subscriptions`\nTerraform data source block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.subscriptions.withTimeoutsMixin` constructs a mixin object that can be merged into the `subscriptions`\nTerraform data source block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.subscriptions.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
