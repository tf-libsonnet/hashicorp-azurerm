...
{
  '#':: d.pkg(name='api_management_gateway_host_name_configuration', url='', help='`api_management_gateway_host_name_configuration` represents the `azurerm_api_management_gateway_host_name_configuration` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
