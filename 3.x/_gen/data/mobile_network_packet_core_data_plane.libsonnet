...
{
  '#':: d.pkg(name='mobile_network_packet_core_data_plane', url='', help='`mobile_network_packet_core_data_plane` represents the `azurerm_mobile_network_packet_core_data_plane` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(mobile_network_packet_core_control_plane_id=mobile_network_packet_core_control_plane_id, name=name, timeouts=timeouts),
    _meta=_meta
  ),
  ...
  withMobileNetworkPacketCoreControlPlaneId(dataSrcLabel, value): {
    data+: {
