...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withIncludePreview':: d.fn(help='`azurerm.kubernetes_service_versions.withIncludePreview` constructs a mixin object that can be merged into the `kubernetes_service_versions`\nTerraform data source block to set or update the include_preview field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `include_preview` field.\n', args=[]),
  ...
  '#withLocation':: d.fn(help='`azurerm.kubernetes_service_versions.withLocation` constructs a mixin object that can be merged into the `kubernetes_service_versions`\nTerraform data source block to set or update the location field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `location` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.kubernetes_service_versions.withTimeouts` constructs a mixin object that can be merged into the `kubernetes_service_versions`\nTerraform data source block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.kubernetes_service_versions.withTimeoutsMixin` constructs a mixin object that can be merged into the `kubernetes_service_versions`\nTerraform data source block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.kubernetes_service_versions.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withVersionPrefix':: d.fn(help='`azurerm.kubernetes_service_versions.withVersionPrefix` constructs a mixin object that can be merged into the `kubernetes_service_versions`\nTerraform data source block to set or update the version_prefix field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `version_prefix` field.\n', args=[]),
