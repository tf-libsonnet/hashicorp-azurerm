...
{
  '#':: d.pkg(name='data_factory_trigger_schedules', url='', help='`data_factory_trigger_schedules` represents the `azurerm_data_factory_trigger_schedules` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(data_factory_id=data_factory_id, timeouts=timeouts),
    _meta=_meta
  ),
