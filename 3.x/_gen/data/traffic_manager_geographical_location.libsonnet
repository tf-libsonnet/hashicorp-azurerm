...
{
  '#':: d.pkg(name='traffic_manager_geographical_location', url='', help='`traffic_manager_geographical_location` represents the `azurerm_traffic_manager_geographical_location` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withName':: d.fn(help='`azurerm.traffic_manager_geographical_location.withName` constructs a mixin object that can be merged into the `traffic_manager_geographical_location`\nTerraform data source block to set or update the name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.traffic_manager_geographical_location.withTimeouts` constructs a mixin object that can be merged into the `traffic_manager_geographical_location`\nTerraform data source block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.traffic_manager_geographical_location.withTimeoutsMixin` constructs a mixin object that can be merged into the `traffic_manager_geographical_location`\nTerraform data source block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.traffic_manager_geographical_location.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
