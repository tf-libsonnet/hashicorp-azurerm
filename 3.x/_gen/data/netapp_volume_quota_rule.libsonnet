...
{
  '#':: d.pkg(name='netapp_volume_quota_rule', url='', help='`netapp_volume_quota_rule` represents the `azurerm_netapp_volume_quota_rule` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(name=name, timeouts=timeouts, volume_id=volume_id),
    _meta=_meta
  ),
  ...
  withVolumeId(dataSrcLabel, value): {
    data+: {
      azurerm_netapp_volume_quota_rule+: {
        [dataSrcLabel]+: {
          volume_id: value,
