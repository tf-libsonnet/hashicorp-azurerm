...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withNamespaceName':: d.fn(help='`azurerm.servicebus_queue.withNamespaceName` constructs a mixin object that can be merged into the `servicebus_queue`\nTerraform data source block to set or update the namespace_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `namespace_name` field.\n', args=[]),
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.servicebus_queue.withResourceGroupName` constructs a mixin object that can be merged into the `servicebus_queue`\nTerraform data source block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
