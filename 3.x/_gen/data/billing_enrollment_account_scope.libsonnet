...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBillingAccountName':: d.fn(help='`azurerm.billing_enrollment_account_scope.withBillingAccountName` constructs a mixin object that can be merged into the `billing_enrollment_account_scope`\nTerraform data source block to set or update the billing_account_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `billing_account_name` field.\n', args=[]),
  ...
  '#withEnrollmentAccountName':: d.fn(help='`azurerm.billing_enrollment_account_scope.withEnrollmentAccountName` constructs a mixin object that can be merged into the `billing_enrollment_account_scope`\nTerraform data source block to set or update the enrollment_account_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enrollment_account_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azurerm.billing_enrollment_account_scope.withTimeouts` constructs a mixin object that can be merged into the `billing_enrollment_account_scope`\nTerraform data source block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azurerm.billing_enrollment_account_scope.withTimeoutsMixin` constructs a mixin object that can be merged into the `billing_enrollment_account_scope`\nTerraform data source block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azurerm.billing_enrollment_account_scope.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
