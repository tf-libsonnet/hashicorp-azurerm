...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withVirtualMachineName':: d.fn(help='`azurerm.string.withVirtualMachineName` constructs a mixin object that can be merged into the `string`\nTerraform data source block to set or update the virtual_machine_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `virtual_machine_name` field.\n', args=[]),
