...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withResourceGroupName':: d.fn(help='`azurerm.policy_virtual_machine_configuration_assignment.withResourceGroupName` constructs a mixin object that can be merged into the `policy_virtual_machine_configuration_assignment`\nTerraform data source block to set or update the resource_group_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_group_name` field.\n', args=[]),
  ...
  '#withVirtualMachineName':: d.fn(help='`azurerm.policy_virtual_machine_configuration_assignment.withVirtualMachineName` constructs a mixin object that can be merged into the `policy_virtual_machine_configuration_assignment`\nTerraform data source block to set or update the virtual_machine_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `virtual_machine_name` field.\n', args=[]),
